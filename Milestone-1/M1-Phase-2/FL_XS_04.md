IMPORTANT UPDATE - DB Function Signatures:

The DB helper functions require a Database parameter:
- dbLoadIdentityRow(Database db) → Future<Map<String, Object?>?>
- dbUpsertIdentityRow(Database db, Map<String, Object?> row) → Future<void>

The IdentityRepositoryImpl should accept a Database instance in its constructor
and pass it to the DB helper functions.
