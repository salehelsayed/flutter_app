// Generated from tool/call_diagnostics/schema_v1.json.
const Map<String, dynamic> callDiagnosticSchemaV1 = {
  "schemaVersion": 1,
  "required": [
    "schemaVersion",
    "eventId",
  ...
  "role": ["caller", "callee", "local", "server"],
  "stage": [
    "attempt",
    "preflight",
    "authority",
  ...
  "enumValues": {
    ...
    "network": ["wifi", "cellular", "ethernet", "offline", "unknown"],
