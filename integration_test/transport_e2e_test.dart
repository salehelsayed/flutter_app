...
Future<_TestStack> _setupStack() async {
  ...
  print('[TEST] Database initialized (current production schema)');
...
Future<Map<String, dynamic>> _waitForProfileDownload(
  Bridge bridge, {
...
void main() {
  ...
  testWidgets(
    'Full orchestrated E2E transport test',
    (tester) async {
        ...
        if (hasCli) {
          ...
          for (var sec = 0; sec < 60; sec++) {
            ...
            if (sec % 10 == 9) {
              ...
              print(
                '[TEST] ... ${sec + 1}s: $incoming incoming messages so far',
              );
            }
          }
          ...
          if (a2.isNotEmpty) {
            ...
            results.add(
              _ScenarioResult('A2', a2Pass, 'transport=$a2Transport'),
            );
            print(
          ...
          if (b2.isNotEmpty) {
            ...
            results.add(
              _ScenarioResult('B2', b2Pass, 'transport=$b2Transport'),
            );
            print(
          ...
          try {
            ...
            results.add(
              _ScenarioResult(
                'B4',
                pass,
                'second drain: ${secondDrain.length}',
              ),
            );
            print(
          ...
          results.add(
            _ScenarioResult(
              ...
              b5Pass
                  ? 'correctly dropped'
                  : 'unexpected: ${b5.length} persisted',
            ),
          );
          print(
          ...
          if (e3.isNotEmpty) {
            results.add(
              _ScenarioResult(
                'E3',
                true,
                'quotedId=${e3.first.quotedMessageId}',
              ),
            );
            print(
              '[TEST] E3 PASS: quotedMessageId=${e3.first.quotedMessageId}',
            );
          } else {
          ...
          if (a7.isNotEmpty) {
            ...
            results.add(
              _ScenarioResult('A7', a7Pass, 'transport=$a7Transport'),
            );
            print(
        ...
        if (hasCli) {
          ...
          try {
            ...
            if (uploaded) {
              ...
              File(
                _writeSignalPath('e2e_e8_blobid'),
              ).writeAsStringSync(e8BlobId);
          ...
          try {
            ...
            if (uploaded) {
              ...
              if (cliUploaded) {
                ...
                final dlResult = await _waitForProfileDownload(
                  stack.bridge,
              ...
              results.add(
                _ScenarioResult('G6', false, 'Flutter upload failed'),
              );
