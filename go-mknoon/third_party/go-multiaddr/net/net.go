...
//
// The interface-address source is routed through a per-platform provider (see
// interface_provider.go): stdlib net.InterfaceAddrs on non-Android, wlynxg/anet
// on Android where SELinux denies the netlink route-socket bind (b/155595000)
// that stdlib enumeration performs. The default provider is byte-for-byte
// net.InterfaceAddrs on every non-Android platform.
