...
- **Implementation/evidence refresh:** 9 August 2026; this adds Plan 348's default-off external-share adopter and host closure evidence without changing the strict score or claiming production activation
- **Repository baseline:** Branch `protected-view`; Plan 347 implementation commit `9d344e3867e8ee253a393fcadb43f1ef9a76b160` (`feat: adopt direct media blob custody`). Plan 348 is implemented in the current working changeset against that exact baseline.
- **Assessment scope:** Current implementation through Plan 348's default-off adoption of the protected media-blob lane for marker-free external-OS media sent to ordinary direct contacts, in addition to Plan 347's prepared composer/voice and exact reopen-only lanes. Retained Plans 342-347 evidence plus Plan 348's same-schema fresh stage, production capability binding, authority-aware share flow, source-free restart, focused/preservation/curated/feature/core host gates, analyzer, hygiene, and Graphify evidence are in scope. Private/disappearing media, edit/delete, group/announcement, historical/no-intent rows, per-device fanout, production activation/operations/cohort selection, aggregate local quota/UX, wave-level full `host-all`, consolidated iOS, and release closure remain outside this slice.
...
| WP-01: Authenticated event and durable custody contract | A-01 through A-04, A-17, A-18, A-24, A-26 | Preserve Plans 342 through 348's implemented fresh-text, fresh ordinary-media/voice initial-envelope, direct-reaction, protected-inbox-capacity, relay/native media-blob primitive, bounded prepared composer/voice adopter, and marker-free external-OS media -> ordinary-direct adopter slices. Plans 347/348 provide durable exact-ciphertext reuse, strict upload/download/source-pinned ACK, persisted relay proof, v108 manifest/expiry coupling, and same-schema fresh absent-parent authority for complete DB-v111 generations and their reopen-only retries. Next close private/disappearing media, edit/delete, group/announcement, historical/no-intent, and device-fanout custody so every notification-worthy event has one authenticated identity/hash and per-device inbox custody independent of fast path. Carry all three default-off activation controls, operations/cohort selection, aggregate quota/UX, wave-level full `host-all`, consolidated iOS, legacy retirement, and release evidence into WP-07. |
