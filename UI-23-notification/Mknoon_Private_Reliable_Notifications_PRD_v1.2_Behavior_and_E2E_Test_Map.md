...
### 4.6 Closed by Plan 384 (2026-08-19) — G19 (device tier) and G26 (host tier)
...
#### 4.6.2 G26 — the strict-authority lane's missing push (Wave 2, host tier, pending a relay deploy)
