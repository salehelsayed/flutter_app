...
### 4.7 Closed by Plan 387 (host tier, 2026-08-19) — G26, pending a relay deploy

**G26 — a strict-authority group's messages were delivered to custody and then went silent.**
Closure vehicle: [Plan 387](../Test-Flight-Improv/387-strict-authority-group-content-wake-tdd-plan.md).
