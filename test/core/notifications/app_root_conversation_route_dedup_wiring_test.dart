...
/// (`lib/main.dart`) must consult the shared already-active guard — passing
...
///
/// Private main.dart glue can't be unit-tested directly, so this token-level
...
void main() {
  test(
    'main.dart conversation notification case consults the already-active '
    ...
    () {
      ...
      expect(
        ...
        reason:
            'conversation case must exist in _handleNotificationRouteTarget',
      );
