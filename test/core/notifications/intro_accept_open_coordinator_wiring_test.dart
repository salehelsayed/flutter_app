...
///
/// The Intros case in `_handleNotificationRouteTarget` (`lib/main.dart`) must
...
/// resolver are host-proven in isolation, but `main.dart`'s private dispatcher
/// cannot be invoked by the exported Orbit widget test, so a correct
/// coordinator with a reverted `main.dart` branch would otherwise stay GREEN
...
void main() {
  test('main intros branch wires the accept open coordinator', () {
