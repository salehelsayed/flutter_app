...
void main() {
  ...
  group('command routing - with payload', () {
    final payloadCmds = <String, String>{
      ...
      'call_cancel_v1': 'callCancelV1',
      'call_endpoint_set_v1': 'callEndpointSetV1',
      'call_endpoint_get_v1': 'callEndpointGetV1',
      'call_endpoint_revoke_v1': 'callEndpointRevokeV1',
      'call_wake_handle_set_v1': 'callWakeHandleSetV1',
      'call_wake_handle_revoke_v1': 'callWakeHandleRevokeV1',
      'call_token_set_v1': 'callTokenSetV1',
      'call_token_revoke_v1': 'callTokenRevokeV1',
      'peer:dial': 'dialPeer',
