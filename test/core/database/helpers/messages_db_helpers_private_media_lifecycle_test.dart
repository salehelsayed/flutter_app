...
void main() {
  ...
  test('TC-358-03b disappearing expiry retires only the exact message marker '
      'atomically', () async {
    ...
    expect(
      (await parent(messageId))['private_media_clock_high_water_ms'],
      4000,
    );
  ...
  test('TC-358-03b protected and view-once terminal transitions keep their '
      'incumbent marker authority', () async {
    const peerId = 'contact-1';
    const t0 = '2026-08-11T00:00:00.000Z';
