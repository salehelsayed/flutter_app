  ...
  test(
    ...
    () async {
      ...
      for (final registry in <List<ProductionMigrationEntry>>[
        ...
        expect(registry[registry.length - 4].version, 116);
        expect(registry[registry.length - 5].version, 115);
        expect(registry[registry.length - 6].version, 114);
        expect(registry[registry.length - 7].version, 113);
        expect(registry[registry.length - 8].version, 112);
        expect(registry[registry.length - 9].version, 111);
        expect(registry[registry.length - 10].version, 110);
        expect(registry[registry.length - 11].version, 109);
        expect(registry[registry.length - 12].version, 108);
        expect(registry[registry.length - 13].version, 107);
        expect(registry[registry.length - 14].version, 106);
        expect(registry[registry.length - 15].version, 105);
      }
