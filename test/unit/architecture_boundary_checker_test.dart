...
''',
  ...
  test(
    'canonical DTR-12 manifest pins 182 dependency and 24 placement exceptions',
    () {
      ...
      expect(manifest.dependencyExceptions, hasLength(182));
      expect(manifest.placementExceptions, hasLength(24));
      expect(
      ...
      expect(result.dependencyViolations, hasLength(182));
      expect(result.placementViolations, hasLength(24));
      expect(
