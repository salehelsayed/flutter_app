...
void main() {
  ...
  group('LetterCard', () {
    ...
    group('sent (outgoing) card', () {
      ...
      testWidgets('shows "Sent" when status is sent', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          isIncoming: false,
          status: 'sent',
        ));
      ...
      testWidgets('shows "Delivered" when status is delivered', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          isIncoming: false,
          status: 'delivered',
        ));
      ...
      testWidgets('shows "Failed" when status is failed', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          isIncoming: false,
          status: 'failed',
        ));
