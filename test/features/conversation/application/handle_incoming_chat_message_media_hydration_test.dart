...
void main() {
  group('handleIncomingChatMessage — media hydration on returned message', () {
    ...
    test(
      'returned message carries image attachment from wire payload',
      () async {
        final wireJson =
    ...
    test('returned message hydrates blob-encryption key fields from wire '
        'payload (112)', () async {
      final wireJson =
          '{"type":"chat_message","version":"1","payload":{'
    ...
    test(
      'returned message carries audio attachment from wire payload',
      () async {
        final wireJson =
            '{"type":"chat_message","version":"1","payload":{'
