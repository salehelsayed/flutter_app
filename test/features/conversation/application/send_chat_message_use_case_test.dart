...
void main() {
  ...
  group('sendChatMessage', () {
    ...
    test('TC-358-02a disappearing strict initial keeps ACK-or-expiry custody '
        'across node live and inbox', () async {
      ...
      expect(
        ...
        0,
        reason: 'a proof-less disappearing parent never enters strict custody',
      );
