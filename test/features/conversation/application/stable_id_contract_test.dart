  ...
  group('Stable-ID contract: no orphan rows', () {
    ...
    test(
      ...
      () async {
        ...
        final attachments = await repo.getAttachmentsForMessage(
          messageId,
          owner: MediaOwnerLane.direct,
        );
        expect(
    ...
    test(
      ...
      () async {
        ...
        await repo.deleteAttachmentsForMessage(
          messageId,
          owner: MediaOwnerLane.direct,
        );
    ...
    test(
      ...
      () async {
        ...
        if (uploaded != null) {
          await repo.saveAttachment(uploaded, owner: MediaOwnerLane.direct);
        }
