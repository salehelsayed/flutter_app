...
void main() {
  ...
  group('Media attachment flow', () {
    test('6a. Send message with media — wire envelope includes metadata',
        () async {
    ...
    test('6b. Receive message with media — metadata persisted to repo',
        () async {
      ...
      final attachments =
          await mediaRepo.getAttachmentsForMessage('msg-with-media-001');
