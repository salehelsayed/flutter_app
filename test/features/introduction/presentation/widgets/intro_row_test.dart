...
void main() {
  ...
  group('IntroRow', () {
    ...
    testWidgets('processing state disables both actions and shows feedback', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildWidget(
      ...
      final passButton = tester.widget<OutlinedButton>(
        find.byKey(const ValueKey('intro-pass-intro-1')),
      );
      final acceptButton = tester.widget<FilledButton>(
        find.byKey(const ValueKey('intro-accept-intro-1')),
      );
    ...
    testWidgets(
      'introducer attribution keeps English-first username explicit',
      (tester) async {
