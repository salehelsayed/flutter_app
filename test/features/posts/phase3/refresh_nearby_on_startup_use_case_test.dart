...
void main() {
  test('startup refresh uses the silent nearby path', () async {
    final service = _FakeNearbyLocationService();

    await refreshNearbyOnStartup(nearbyLocationService: service);

    expect(service.refreshSilentlyOnStartupCallCount, 1);
