...
void main() {
  ...
  group('handleIncomingGroupInvite', () {
    // --- Cycle 4.1 ---
    test('persists group, members, and key for a valid invite payload',
        () async {
    ...
    // --- Cycle 4.8 ---
    test('joining user gets myRole=member in the persisted GroupModel',
        () async {
      await handleIncomingGroupInvite(
        message: _makeV1Message(),
        groupRepo: groupRepo,
    ...
    // --- Cycle 4.11 ---
    test('returns decryptionFailed when bridge decrypt returns ok=false',
        () async {
