...
Status: executing — Wave 0 accepted on 2026-07-25; Wave 1 is in progress with
DTR-03 and DTR-04 Plan-green and DTR-05 execution-ready.
...
| DTR-05 | P1 | Remove the suppressed unused 1:1 relay-probe branch | DTR-01, DTR-08; transport/protocol owner decision | Causal structural and 1:1 preservation tests; `1to1`; `transport`; `feature-host-all`; the approved helper-only two-peer waiver below; conditional Go/native proof if a live protocol boundary changes | **Execution-ready** — [Plan 276](276-dormant-chat-relay-probe-helper-removal-tdd-plan.md); `DTR05-AUTH-01` approves only the zero-call-site private chat-helper removal and retains the live shared relay protocol |
...
| Wave 1 | DTR-03, DTR-04, DTR-05 | In progress — DTR-03 and DTR-04 Plan-green; DTR-05 execution-ready | `host-all` pending until every Wave 1 plan is complete or terminal | — | Per-plan DTR-03 and DTR-04 proof is green; `DTR05-AUTH-01` resolved the helper-only disposition/waiver on 2026-07-26; aggregate acceptance is not yet claimed | 2026-07-26 / DTR-03, DTR-04, DTR-05 |
