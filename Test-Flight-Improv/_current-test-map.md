...
| Group Messaging | Group send, invite, resume, membership, announcement-adjacent behavior | `./scripts/run_test_gates.sh groups` | Group messaging smoke, resume recovery, edge cases, invite round trip, membership, startup rejoin |
