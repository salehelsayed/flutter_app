...
The multi-party harness criteria binds receiver `messageId`, text/plaintext, `senderPeerId`, and `keyEpoch` to the sender `sentMessages` tuple. Row-specific sessions consume it with direct scenario commands such as `gm001`, `gm002`, `gm003`, `ge006`, `ge007`, `ge008`, `ge009`, `ge010`, `ge011`, `ge012`, `ge013`, `ge016`, `ge021`, `ge023`, `go001`, `go002`, and `go003`.
...
| Application (use cases, listeners) | 37 | 426 |
| Presentation (widgets, screens) | 20 | 255 |
| Integration (smoke, round-trip, recovery) | 9 | 111 |
...
| Group Inbox (`node/group_inbox*.go`) | 1 | 13 |
...
| Node / Relay Session / Stream (`node/node*.go`, `node/relay_session*.go`, `node/stream_timeout*.go`) | 3 | 14 |
...
### 12.7 Group Inbox
**File:** `go-mknoon/node/group_inbox_test.go` (13 tests)
...
**Files:** `go-mknoon/node/node_test.go` (8 of 56 tests), `go-mknoon/node/relay_session_test.go` (5 of 21 tests), `go-mknoon/node/stream_timeout_test.go` (1 of 3 tests)
