...
The multi-party harness is prerequisite evidence only; its criteria binds receiver `messageId`, text/plaintext, `senderPeerId`, and `keyEpoch` to the sender `sentMessages` tuple, but GM-001/GM-002/GM-003 rows remain open until their row-specific sessions consume it and record row closure evidence.
