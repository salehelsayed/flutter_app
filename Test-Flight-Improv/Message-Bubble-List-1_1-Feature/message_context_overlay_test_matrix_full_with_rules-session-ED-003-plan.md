...
- Close source row ED-003 for "Tapping Edit enters edit mode, pre-fills text, clears quote mode, and shows the banner" without merging it into adjacent rows; prove the row contract across the stated hosts, persistence, and transport semantics that the matrix requires.
- Execution ownership for this session: tests only.

### closure bar

- Source row ED-003 is updated in Test-Flight-Improv/Message-Bubble-List-Feature/message_context_overlay_test_matrix_full_with_rules.md to Covered or Closed with exact file-and-test evidence.
...
- Tapping Edit enters edit mode, pre-fills text, clears quote mode, and shows the banner
