...
- Close source row SC-007 for "Localization, mixed-script, and RTL content stay correct across quote bars, deleted placeholders, edited indicators, snackbars, and reaction chips" without merging it into adjacent rows; prove the row contract across the stated hosts, persistence, and transport semantics that the matrix requires.
- Execution ownership for this session: tests only.

### closure bar

- Source row SC-007 is updated in Test-Flight-Improv/Message-Bubble-List-Feature/message_context_overlay_test_matrix_full_with_rules.md to Covered or Closed with exact file-and-test evidence.
...
- Localization, mixed-script, and RTL content stay correct across quote bars, deleted placeholders, edited indicators, snackbars, and reaction chips
