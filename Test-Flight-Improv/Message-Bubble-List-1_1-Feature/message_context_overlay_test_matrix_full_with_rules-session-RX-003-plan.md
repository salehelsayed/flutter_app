...
- Close source row RX-003 for "Tapping a different emoji replaces the previous own reaction instead of creating duplicates" without merging it into adjacent rows; prove the row contract across the stated hosts, persistence, and transport semantics that the matrix requires.
- Execution ownership for this session: no execution because already covered.

### closure bar

- Source row RX-003 is updated in Test-Flight-Improv/Message-Bubble-List-Feature/message_context_overlay_test_matrix_full_with_rules.md to Covered or Closed with exact file-and-test evidence.
...
- Tapping a different emoji replaces the previous own reaction instead of creating duplicates
- Exact repo proof exists for replace/upsert semantics and the UNIQUE(message_id, sender_peer_id) constraint.
...
- test/features/conversation/integration/emoji_reaction_exchange_test.dart:164
- test/core/database/migrations/016_message_reactions_test.dart:52

### existing tests covering this area

- Re-audit test/features/conversation/integration/emoji_reaction_exchange_test.dart:164 for exact row proof before adding new coverage.
- Re-audit test/core/database/migrations/016_message_reactions_test.dart:52 for exact row proof before adding new coverage.
...
- flutter test --no-pub test/features/conversation/integration/emoji_reaction_exchange_test.dart:164
- flutter test --no-pub test/core/database/migrations/016_message_reactions_test.dart:52
