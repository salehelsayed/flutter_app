// Standalone, dependency-free Flutter port of the "Background-Feed 6-1"
// ambient sky used in the web mockup (Circle-Feed 6's background).
//
...
//   3. 70 twinkling white stars sprinkled across the field
...
class _CosmicPainter extends CustomPainter {
  ...
  void _paintBlooms(Canvas canvas, Size size) {
    ...
    // Web ref alphas + ellipse extents, ported as fractions of the viewport.
