...
# Execution 2 agents 
  ...
  Open  and execute Session-30-plan.mde <N> using 2 agents in strict sequence:

  1. Executor
  2. QA Reviewer

  Use the approved Session-30-plan.md <N> plan as the source of truth.
  ...
  Executor must:
  - read the Session-30-plan.md <N> , source reports, code-entry files, and approved plan
  ...
  - use the exact Baseline Gate defined in the approved Session-30-plan.md <N> plan and [14-regression-test-strategy.md](/
  ...
  7. why Session-30-plan.md <N> is safe or unsafe to consider complete
...
# Session 
  ...
  - Repeat in strict sequence until:
    ...
    - the same blocking issues repeat without meaningful reduction across 4 consecutive fix rounds, in which case mark Session N as `blocked`
  ...
  Work through Test-Flight-Improv/session-24-plan.md strict order.
  For this session plan, complete planning, review, plan-fix, execution, and QA
