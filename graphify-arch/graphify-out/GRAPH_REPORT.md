# Graph Report - graphify-arch  (2026-07-02)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 43164 nodes · 67252 edges · 933 communities (887 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2603 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d84b76fb`
...
## Communities (933 total, 46 thin omitted)
...
Cohesion: 0.01
Nodes (356): AlertDialog, AnimatedContainer, AnnotatedRegion, showGroupMissingNotificationFeedback, BoxDecoration, CircularProgressIndicator, DecoratedBox, Directionality (+348 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (347): AnimatedOpacity, contactRepo, main, requestRepo, testRequest, main, GateableMediaAttachmentRepository, RecordingSecureKeyStore (+339 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (214): channel, log, main, logOnlyToken, main, mainPath, nsePath, readSource (+206 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (256): main, bridge, buildHost, buildMaterializer, contactRepository, identityRepository, main, _makeContact (+248 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (167): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+159 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (257): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode (+249 more)
...
Cohesion: 0.01
Nodes (190): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+182 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (221): db, main, makeContactRow, db, main, makeIdentityRow, db, main (+213 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (261): AnimatedBuilder, Animation, CustomPaint, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, MyApp, _MyAppState, NotificationTapLiveRenderTiming (+253 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (238): main, ../../core/secure_storage/fake_secure_key_store.dart, generateRandomKey, main, fake_p2p_service.dart, EncryptedMediaTestBridge, RelayMediaStore, InMemoryPostRepository (+230 more)
...
Cohesion: 0.01
Nodes (237): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+229 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (229): ContactRequestNotificationMaterializer, buildRepo, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main, db (+221 more)
...
Cohesion: 0.01
Nodes (303): dart:ui, ../../domain/orbit3_arch_layout.dart, IconData, Key, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, _DeleteMessageSheet, _DeleteSheetAction (+295 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (152): Color, CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth (+144 more)
...
Cohesion: 0.01
Nodes (208): ../../application/orbit3_archetype_data.dart, ../../application/orbit3_dimension_preferences_use_cases.dart, build, ../../application/orbit3_mock_data.dart, _groups, _member, _names, Orbit3MockData (+200 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (101): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment (+93 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (158): Database, DatabaseException, fake_secure_key_store.dart, db, main, makeRequestRow, db, main (+150 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (153): bridge, deleteMessagesForGroup, _FailingGroupMessageRepository, groupId, groupMessageRepo, groupRepo, main, _CursorInboxBridge (+145 more)
...
Cohesion: 0.01
Nodes (178): Align, ClipRRect, ConstrainedBox, _incoming, main, isDeleted, isIncoming, main (+170 more)

### Community 28 - "Community 28"
Cohesion: 0.01
Nodes (147): addContact, AddContactResult, archiveContact, fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write (+139 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (163): client, lastCall, main, GoBridgeClient, GroupDiagnosticEvent, GroupMembershipUpdateListener, db, distributionRow (+155 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (158): ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), isAllowedWriter(), assertGK019DirectJumpKeyInfo() (+150 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (142): _FakeIdentityRepo, _fakeIdentityResponse, _fakeMlKemResponse, fakeRestore, lastRestoredMnemonic, loadIdentity, main, progressStages (+134 more)
...
Cohesion: 0.03
Nodes (170): fakeHostWithAddrs, TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), disableGroupInboxRecoveryForFakeRelayTest(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation(), TestGroupInboxRetrieveCursor_StableAcrossPages() (+162 more)
...
Cohesion: 0.03
Nodes (113): GroupMessagePayload, builtGroupMessageEnvelope, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, groupSenderDeviceBinding (+105 more)

### Community 38 - "Community 38"
Cohesion: 0.02
Nodes (135): bridge, _expectSignedReactionReplayEnvelope, groupRepo, jsonDecode, main, msgRepo, payload, reactionReplayOutboxRepo (+127 more)
...
Cohesion: 0.02
Nodes (119): ../../domain/orbit3_one_circle_layout.dart, contact, main, orbital_avatar.dart, orbital_ring_painter.dart, overflow_badge.dart, package:flutter_app/features/orbit/domain/models/orbit_friend.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart (+111 more)
...
Cohesion: 0.01
Nodes (132): package:flutter_app/features/conversation/presentation/widgets/undelivered_messages_banner.dart, activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername, build (+124 more)

### Community 44 - "Community 44"
Cohesion: 0.01
Nodes (179): ../../application/orbit2_mock_data.dart, Orbit2ChatLine, Orbit2InboxEntry, ../domain/models/orbit2_friend.dart, ../domain/models/orbit2_group.dart, ../../domain/models/orbit2_layout_template.dart, ../../domain/models/orbit2_view_mode.dart, Orbit2ViewMode (+171 more)
...
Cohesion: 0.02
Nodes (145): _aPeerId, _bPeerId, checkHealth, dispose, incomingPayload, initialize, isInitialized, main (+137 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (131): buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash(), lp013GroupHarness, TestGA002NonMemberCannotPublishValidEnvelope() (+123 more)

### Community 49 - "Community 49"
Cohesion: 0.01
Nodes (133): InkWell, addContact, archiveContact, blockContact, callOrder, conditionalTransitionStatus, contactExists, copyCalls (+125 more)
...
Cohesion: 0.02
Nodes (136): _InstrumentedGroupMessageRepository, _InstrumentedGroupMessageRepository, addDeleteEvent, adminMember, append, attempts, baseAdmin, baseSender (+128 more)
...
Cohesion: 0.02
Nodes (121): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, dismissedAt, dismissPin, savePinDismissal, _FakeContactRepository, _FakeContactRepository (+113 more)
...
Cohesion: 0.02
Nodes (120): AccountMigrationReceiverEvents, AccountMigrationMoveSizeEstimate, calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath, listFilesRecursively (+112 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (76): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+68 more)

### Community 59 - "Community 59"
Cohesion: 0.02
Nodes (123): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+115 more)

### Community 60 - "Community 60"
Cohesion: 0.02
Nodes (121): GroupMessageListener, GroupMessageRepository, _FakeGroupMessageListener, _NoOpMsgRepo, _ControlledGroupMessageListener, package:flutter_app/features/groups/presentation/screens/create_group_picker_wired.dart, package:flutter_app/features/groups/presentation/screens/group_conversation_wired.dart, buildContact (+113 more)

### Community 61 - "Community 61"
Cohesion: 0.02
Nodes (117): addedMembers, _addMemberFailures, allMembers, buildCreateWarningMessage, byPeerId, CreateGroupMemberAddFailure, createGroupWithMembers, CreateGroupWithMembersResult (+109 more)
...
Cohesion: 0.02
Nodes (115): main, member, GroupModel, _contactFor, _dm, main, pump, MapEntry (+107 more)

### Community 65 - "Community 65"
Cohesion: 0.02
Nodes (111): avatarBase64, avatarBlob, candidate, contactRepo, current, currentLocalPassCount, currentLocalSharedToCount, currentPassRecipientCount (+103 more)
...
Cohesion: 0.02
Nodes (116): main, package:flutter_app/features/contacts/domain/models/contact_safety_number.dart, actionButton, attempts, beginRecoveryOnNextLoad, bridge, button, ciphertext (+108 more)
...
Cohesion: 0.02
Nodes (112): allowStaging, authorUsername, comment, envelope, handleIncomingPostComment, HandleIncomingPostCommentResult, parent, persistRepostEngagementParticipantIfNeeded (+104 more)
...
Cohesion: 0.02
Nodes (106): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, connectionItem, contact, ContactFeedSnapshot (+98 more)
...
Cohesion: 0.05
Nodes (38): package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/domain/models/orbit_group.dart, package:flutter_app/features/orbit/presentation/widgets/group_row.dart, build, child, _controller, createState, dispose (+30 more)
...
Cohesion: 0.02
Nodes (103): introsBannerDismissed, isArchived, isBlocked, main, _makeContact, username, contactRepo, introsBannerDismissed (+95 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (57): AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock, _AccountMigrationProgressWakeLockState, actionLabel, active, backgroundPreference, body, build (+49 more)
...
Cohesion: 0.02
Nodes (80): bridge, contactRepo, identityRepo, main, p2pService, retrier, main, bridge (+72 more)

### Community 79 - "Community 79"
Cohesion: 0.02
Nodes (102): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+94 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (115): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, identityRepo, main (+107 more)

### Community 81 - "Community 81"
Cohesion: 0.01
Nodes (158): addContact, author, comment, commentListener, condition, _contact, contactRepo, create (+150 more)

### Community 82 - "Community 82"
Cohesion: 0.02
Nodes (103): applied, pendingEvents, reconcilePendingPostChildEvents, buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage (+95 more)
...
Cohesion: 0.02
Nodes (99): archiveGroup, deleteGroupAndMessages, deleteLocallyIfDissolved, DissolveGroupResult, eventAt, group, hadBridgeRecoveryGap, inboxPayload (+91 more)

### Community 85 - "Community 85"
Cohesion: 0.03
Nodes (70): encPendingAttachment, main, detailsFor, eventNames, events, main, mediaReady, pendingAttachment (+62 more)

### Community 86 - "Community 86"
Cohesion: 0.02
Nodes (100): DeliveryReceiptListener, dispose, messageRepo, receiptStream, start, stop, _subscription, fromPreview (+92 more)

### Community 87 - "Community 87"
Cohesion: 0.03
Nodes (62): bytesToWrite, captureCipherMetadata, commands, _createSeededAccountDb, execute, exportDestinationKey, exportDestinationPath, exportSqlCipherDatabase (+54 more)

### Community 88 - "Community 88"
Cohesion: 0.04
Nodes (79): chatPushMetadata, scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData() (+71 more)
...
Cohesion: 0.02
Nodes (78): deliveredWritePatterns, main, scanDeliveredWrites, BoxFit, File, allPaths, build, _buildErrorState (+70 more)

### Community 91 - "Community 91"
Cohesion: 0.02
Nodes (101): deliveryResult, EditPinnedPostResult, _editPinnedPostResultForSettlement, envelope, existingState, media, now, pinState (+93 more)
...
Cohesion: 0.02
Nodes (96): benchmark_helpers.dart, runOneToOneSendBenchmark, details, events, _findRecoveredOutage, firstEventDetails, firstInbox, firstSend (+88 more)
...
Cohesion: 0.02
Nodes (100): _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _TrackingInviteDeliveryAttemptRepository, bobContact, bridge, declinedByPeerId, deliveryRepo, envelope (+92 more)
...
Cohesion: 0.02
Nodes (94): id, lastSendAttemptAt, main, _makeSendingMessage, ts, ../bridge/fake_bridge.dart, BridgeCallInsideDbTransactionError, main (+86 more)
...
Cohesion: 0.02
Nodes (93): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+85 more)
...
Cohesion: 0.08
Nodes (85): newMemoryInboxBackend(), failingStoreInboxBackend, requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs() (+77 more)
...
Cohesion: 0.02
Nodes (82): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+74 more)
...
Cohesion: 0.03
Nodes (70): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, AccountMigrationBlockedScreen, _AccountMigrationBlockedScreenState, build, _confirmErase (+62 more)
...
Cohesion: 0.03
Nodes (62): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, avatarBytes, backgroundPreference, build (+54 more)

### Community 117 - "Community 117"
Cohesion: 0.03
Nodes (64): _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo, BackgroundPreference, package:flutter_app/features/introduction/presentation/screens/sent_confirmation_screen.dart (+56 more)

### Community 118 - "Community 118"
Cohesion: 0.02
Nodes (85): main, _pendingRequest, requestRepo, build, createState, initState, main, _SettleHarness (+77 more)
...
Cohesion: 0.03
Nodes (62): main, package:flutter/services.dart, _accent, background, borderColor, build, _buildHero, _buildMessageButton (+54 more)
...
Cohesion: 0.02
Nodes (83): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult (+75 more)
...
Cohesion: 0.03
Nodes (78): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, AudioRecorderService, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, RecordAudioRecorderService, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents (+70 more)
...
Cohesion: 0.02
Nodes (74): conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart, group_delete_preserves_friends_simulator_test.dart, group_invite_accept_spinner_simulator_test.dart, group_new_member_media_simulator_proof_test.dart (+66 more)
...
Cohesion: 0.03
Nodes (74): contactRepo, main, messageRepo, mutualIntro, acceptFoldedIntroduction, appliedResults, _applyFoldedIntroductionAction, currentViewerStatus (+66 more)
...
Cohesion: 0.03
Nodes (75): _FakeIdentityRepo, _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity (+67 more)

### Community 135 - "Community 135"
Cohesion: 0.05
Nodes (44): AggregateRelayState, testRelayCircuitAddr(), TestRelaySessionRuntimeSync_EndsReservationWhenCircuitAddressDisappears(), TestRelaySessionRuntimeSync_IgnoresStaleCircuitAddressWithoutConnectedRelay(), TestRelaySessionRuntimeSync_OpensReservationAndEmitsRelayState(), recoveryPromise, RecoveryResult, NewRelaySessionManager() (+36 more)

### Community 136 - "Community 136"
Cohesion: 0.03
Nodes (72): buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, id, insertIntroSystemMessage, message, now, saveMessage (+64 more)

### Community 137 - "Community 137"
Cohesion: 0.03
Nodes (74): _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry, group, groupId (+66 more)
...
Cohesion: 0.03
Nodes (73): actor, actorEnvelope, actorPeerId, actorUsername, ApplyGroupConfigResponseResult, applyOnJoinGroupConfigResponse, config, decodedSigned (+65 more)
...
Cohesion: 0.03
Nodes (71): AdmitSiblingDeviceFn, admitSiblingDeviceIfTrusted, alreadyPresent, deviceId, EnqueueDeferredGroupKeyDistributionFn, existingById, existingByTransport, latestKey (+63 more)

### Community 148 - "Community 148"
Cohesion: 0.03
Nodes (61): avatarPath, _contact, contactPeerId, contactRepo, _group, groupId, _groupMessage, groupMessageRepo (+53 more)
...
Cohesion: 0.04
Nodes (59): main, map, benchmark_harness.dart, BenchmarkHarness, LifecycleBridge, bridge, main, service (+51 more)
...
Cohesion: 0.03
Nodes (62): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, bridge, contactPeerId, contactRepo, _contactWithMlKem (+54 more)
...
Cohesion: 0.04
Nodes (53): db, main, makeKeyRow, db, main, makeMemberRow, db, main (+45 more)
...
Cohesion: 0.03
Nodes (59): _SharedFakeDiscovery, _SharedFakeDiscovery, buildBridgeMigrationCutoverLeaseCleanup, _SharedFakeDiscovery, _SharedFakeDiscovery, BonsoirDiscoveryService, FakeLocalDiscoveryService, LocalDiscoveryService (+51 more)
...
Cohesion: 0.03
Nodes (67): AccountMigrationSizeGate, FakeIntroductionRepository, buildIdentity, main, tempDir, IntroductionRepository, package:flutter_app/features/home/application/identity_avatar_resolver.dart, package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart (+59 more)
...
Cohesion: 0.03
Nodes (66): clearPendingKeyRotation, clearPendingKeyRotations, _Clock, contact, contains, deleteGroup, deleteMessagesForGroup, endedAt (+58 more)
...
Cohesion: 0.03
Nodes (66): _FakeMediaAttachmentRepo, _FakeMediaFileManager, FakeMediaAttachmentRepository, FakeMediaFileManager, _FakeMediaAttachmentRepo, _FakeMediaFileManager, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository (+58 more)
...
Cohesion: 0.03
Nodes (62): Canvas, capture, drain, goTo, main, outDir, capture, main (+54 more)
...
Cohesion: 0.03
Nodes (83): ChatMessageListener, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, Request, _FakeIncomingConversationListener, FeedScreen (+75 more)
...
Cohesion: 0.03
Nodes (64): AppendGroupEventLogEntry, _acceptedSignedTransitionAuditHashesBySourceId, _appendGroupEventLogEntry, _bridge, dispose, _enqueueMessage, _groupRepo, _handleMessage (+56 more)
...
Cohesion: 0.02
Nodes (115): AspectRatio, DateSeparator, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce (+107 more)
...
Cohesion: 0.03
Nodes (62): loadReactionsForConversation, result, buildShareTargetPickerRoute, package:flutter_app/core/media/audio_recorder_service.dart, package:flutter_app/features/conversation/domain/repositories/reaction_repository.dart, package:flutter_app/features/share/application/share_batch_delivery_coordinator.dart, package:flutter_app/features/share/presentation/screens/share_target_picker_wired.dart, appShellController (+54 more)
...
Cohesion: 0.03
Nodes (60): AccountMigrationProductionBundleSource, failureEvent, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, GroupInviteListener, _bridge, dispose, DistributeGroupKeyAtEpochToPeer (+52 more)
...
Cohesion: 0.04
Nodes (54): bridge, contactRepo, _failedOutgoing, id, identityRepo, main, _makeIdentity, messageRepo (+46 more)
...
Cohesion: 0.04
Nodes (50): comments, loadPostComments, wait, _assertAllRecipientsStarted, _assertBoundedStart, _contact, contacts, _ControlledP2PService (+42 more)
...
Cohesion: 0.04
Nodes (51): archiveGroup, _FailingGroupRepository, groupId, groupRepo, main, _contactFor, decrypted, deleteGroup (+43 more)
...
Cohesion: 0.03
Nodes (56): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+48 more)
...
Cohesion: 0.03
Nodes (72): main, _captureFlowEvents, creatorPeerId, generation, groupId, groupRepo, _InboxStoreOkFalseBridge, joinerPeerId (+64 more)
...
Cohesion: 0.04
Nodes (55): ../local_discovery/fake_local_p2p_service.dart, FakeLocalP2PService, LocalMessage, LocalP2PService, _RecordingBridge, bridge, calledCommands, checkHealth (+47 more)

### Community 218 - "Community 218"
Cohesion: 0.04
Nodes (55): appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn, _enqueueMessage (+47 more)
...
Cohesion: 0.04
Nodes (54): NearbyLocationServiceImpl, refreshNearbyOnStartup, _FakeNearbyLocationPlatformAdapter, NearbyLocationService, package:flutter_app/features/posts/application/nearby_location_service.dart, package:flutter_app/features/posts/application/refresh_nearby_on_startup_use_case.dart, _FakeNearbyLocationService, accuracyM (+46 more)
...
Cohesion: 0.04
Nodes (50): AccountMigrationNetworkGate, accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo, _coordinator, _debounceTimer, dispose (+42 more)
...
Cohesion: 0.04
Nodes (47): main, main, package:flutter_app/core/debug/transport_metrics.dart, package:flutter_app/features/settings/presentation/widgets/settings_transport_diagnostics_card.dart, _buildTestWidget, chatListener, conditionalTransitionStatus, _contact (+39 more)

### Community 246 - "Community 246"
Cohesion: 0.02
Nodes (79): attachment, createdAt, cryptoEntry, envelope, main, clearWriteLog, close, _contact (+71 more)
...
Cohesion: 0.04
Nodes (47): AccountMigrationStreamingEntry, build, chunkSize, entryId, _FileAccountMigrationStreamingEntry, filePath, fileReader, kind (+39 more)
...
Cohesion: 0.04
Nodes (45): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+37 more)
...
Cohesion: 0.04
Nodes (45): bridge, checkHealth, dispose, _FakeBridge, initialize, isInitialized, main, _otherPeerId (+37 more)
...
Cohesion: 0.04
Nodes (45): package:flutter_app/core/theme/feed_colors.dart, package:url_launcher/url_launcher.dart, TextOverflow, main, build, createState, didUpdateWidget, dispose (+37 more)

### Community 265 - "Community 265"
Cohesion: 0.04
Nodes (46): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+38 more)
...
Cohesion: 0.04
Nodes (45): AppLocalizations, LocalizationsDelegate, MemberRole, Opacity, package:flutter_app/features/groups/presentation/group_invite_status_presentation.dart, package:flutter_localizations/flutter_localizations.dart, l10n, main (+37 more)
...
Cohesion: 0.04
Nodes (42): emoji, id, main, messageId, _reaction, senderPeerId, contact, currentReaction (+34 more)

### Community 275 - "Community 275"
Cohesion: 0.04
Nodes (44): _attemptRegistration, dispose, _disposed, ensureStarted, _inFlightAttempt, _permissionState, _PushPermissionState, PushRegistrationCoordinator (+36 more)
...
Cohesion: 0.04
Nodes (44): bridge, chatListener, cliMlKemPublicKey, cliPeer, cliPeerId, cliPublicKey, _configuredTempDir, _configuredWriteDir (+36 more)
...
Cohesion: 0.04
Nodes (45): conditionalTransitionCallCount, conditionalTransitionStatus, deleteMessage, deleteMessagesCallCount, deleteMessagesForContact, existsByContent, existsByDedupKey, failedOutgoingOverride (+37 more)
...
Cohesion: 0.04
Nodes (42): allowStaging, clearPinDismissal, compareTo, envelope, existingByMediaId, existingMedia, existingState, handleIncomingPostPinRemove (+34 more)

### Community 293 - "Community 293"
Cohesion: 0.05
Nodes (40): MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator, file (+32 more)

### Community 294 - "Community 294"
Cohesion: 0.05
Nodes (40): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+32 more)
...
Cohesion: 0.03
Nodes (62): Column, EdgeInsets, nav_bar_button.dart, nav_bar_theme.dart, main, suppressAssetErrors, wrap, package:flutter_app/features/feed/presentation/widgets/feed_navigation_bar.dart (+54 more)
...
Cohesion: 0.05
Nodes (37): main, ../application/send_chat_message_use_case_test.dart, main, ../domain/repositories/fake_media_attachment_repository.dart, fake_media_attachment_repository.dart, _attachments, count, deleteAttachmentsForContact (+29 more)

### Community 301 - "Community 301"
Cohesion: 0.05
Nodes (41): intros, _otherPeerIdFor, _ownSideAccepted, resolveUnknownInboxSender, sawRetryableIntroduction, UnknownInboxSenderResolution, config, configFile (+33 more)

### Community 302 - "Community 302"
Cohesion: 0.05
Nodes (42): bridge, contactPeerId, contactRepo, downloadStatus, durationMs, fakeUploadFn, id, identityRepo (+34 more)

### Community 303 - "Community 303"
Cohesion: 0.02
Nodes (79): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, archived, blocked, _contact, contacts, _FailAfterPostSaveRepository, lastSavedPostId (+71 more)

### Community 304 - "Community 304"
Cohesion: 0.05
Nodes (39): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+31 more)

### Community 305 - "Community 305"
Cohesion: 0.05
Nodes (43): _attemptCounts, _attemptFailureCounts, baselineReport, _canonicalRung, _canonicalTransport, discoveredPeerCount, discoveryActive, empty (+35 more)
...
Cohesion: 0.06
Nodes (36): fake_local_discovery_service.dart, main, peerA, peerB, ../local_discovery/fake_local_discovery_service.dart, LanSendAck, _createTestFile, main (+28 more)
...
Cohesion: 0.05
Nodes (38): addContact, archiveContact, archivedPeerIds, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository (+30 more)
...
Cohesion: 0.05
Nodes (39): DeliveryReceiptListener, addContact, bridge, chatListener, contactRepo, create, deleteMessageForEveryone, deliveryReceiptListener (+31 more)
...
Cohesion: 0.05
Nodes (38): media_attachment_repository.dart, ../models/media_attachment.dart, ../models/media_preview_descriptor.dart, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage, getAttachmentsForMessages (+30 more)

### Community 335 - "Community 335"
Cohesion: 0.05
Nodes (36): main, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, backgroundPreference, build, contactRepo, createState (+28 more)
...
Cohesion: 0.12
Nodes (15): bridge, _callCount, contactRepo, failOnCall, _FailOnNthBridge, identityRepo, isArchived, isBlocked (+7 more)
...
Cohesion: 0.10
Nodes (37): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), countRemoteGroupMembers(), groupRendezvousNamespace(), assertGM030DiscoveryEventTotals(), assertGP012NumericField(), assertGP014KnownMemberTopicMissingRelayFallback(), assertRP017DiscoveryIgnoredNonMembers() (+29 more)

### Community 358 - "Community 358"
Cohesion: 0.06
Nodes (31): _attachment, main, consume, main, mark, notificationService, showLive, tracker (+23 more)
...
Cohesion: 0.02
Nodes (102): Alignment, package:flutter_app/features/feed/presentation/widgets/feed_swipe_card.dart, animatedOpacityDurations, animatedSizeDurations, buildFeedScreen, buildThreadItem, items, main (+94 more)
...
Cohesion: 0.06
Nodes (33): Incoming, package:flutter_app/core/permissions/mic_permission_gateway.dart, package:flutter_app/core/permissions/mic_permission_prompt.dart, package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, showMicPermissionDeniedPrompt, main, openPrompt, ConversationScreen (+25 more)
...
Cohesion: 0.02
Nodes (95): _RecordingSnapshotExportAdapter, _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiSnapshotExportAdapter, _FfiStagedDatabaseOpener, activeDatabase, importedRows, importedTables (+87 more)
...
Cohesion: 0.02
Nodes (75): post, postCommentExpiryExtension, refreshPostExpiryForComment, savePost, timestamp, updatedPost, audience, authorPeerId (+67 more)
...
Cohesion: 0.06
Nodes (32): captureFlowEvents, contactPeerId, decodeWirePayload, encrypted, envelope, gate, _GatedInboxP2PService, id (+24 more)

### Community 402 - "Community 402"
Cohesion: 0.07
Nodes (32): RelayLiveSendObserver, FakeP2PService, DetailedInboxStore, ReadinessProofRecorder, _FakeProbe, FakeP2PService, P2PServiceImpl, InboxAttentionSignal (+24 more)
...
Cohesion: 0.06
Nodes (30): _consumption, createdAt, expiresAt, groupId, _invite, main, repo, _revocation (+22 more)
...
Cohesion: 0.06
Nodes (30): _bridgeResponses, _canonicalize, canonicalJson, _diagnostics, _failure, _operations, recordBridgeResponse, recordDiagnostic (+22 more)
...
Cohesion: 0.09
Nodes (30): _FakeMessageRepository, FakeMessageRepository, _FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, _FakeMessageRepo (+22 more)
...
Cohesion: 0.07
Nodes (28): FakeReactionRepository, bridge, contactRepo, dispose, incomingReactionChangeStream, incomingReactionStream, messageRepo, _onMessage (+20 more)
...
Cohesion: 0.02
Nodes (95): package:flutter_app/core/utils/text_direction_utils.dart, build, createState, dispose, _handleRestorePressed, _isLoading, _mnemonicController, MnemonicInputScreen (+87 more)
...
Cohesion: 0.07
Nodes (24): main, GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, main (+16 more)

### Community 448 - "Community 448"
Cohesion: 0.07
Nodes (27): main, messageRepo, ../../conversation/domain/repositories/fake_message_repository.dart, ack, _AckGatedRelay, base, calledCommands, checkHealth (+19 more)
...
Cohesion: 0.07
Nodes (28): bridge, captureFlowEvents, contactPeerId, contactRepo, _contactWithMlKem, _doneAttachment, durationMs, fakeUploadFn (+20 more)
...
Cohesion: 0.09
Nodes (22): handleShareIntent, ShareIntentRouteBuilder, build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt (+14 more)
...
Cohesion: 0.07
Nodes (26): backgroundLuminance, contrastRatio, darker, effectiveForeground, expectComponentContrast, expectTextContrast, foregroundLuminance, lighter (+18 more)
...
Cohesion: 0.08
Nodes (23): main, main, main, package:fake_async/fake_async.dart, package:flutter_app/core/services/active_peer_keepalive_use_case.dart, package:flutter_app/features/groups/application/group_pending_key_repair_backoff_timer.dart, package:flutter_app/features/push/application/push_registration_coordinator.dart, package:flutter_app/features/push/application/register_push_token_use_case.dart (+15 more)
...
Cohesion: 0.07
Nodes (25): fake_p2p_network.dart, ChaosConfig, config, content, deliver, deliveredCount, _deliverWithDuplicate, droppedMessages (+17 more)
...
Cohesion: 0.08
Nodes (23): block, contentHashValidation, copyWith, _emitGroupFeedMediaVerifyEvent, file, fileBytes, fileExists, _idPrefix (+15 more)

### Community 480 - "Community 480"
Cohesion: 0.07
Nodes (24): _cleanDisplayName, groupPeerFallbackLabel, memberName, preferMemberName, resolveGroupSenderDisplayName, sanitized, senderPeerId, shortPeerId (+16 more)
...
Cohesion: 0.08
Nodes (22): main, main, package:flutter_app/features/p2p/domain/models/discovered_peer.dart, package:flutter_app/features/p2p/domain/models/send_message_result.dart, ControlledPostPinDeliveryP2PService, _dialedPeers, dialPeer, discoverPeer (+14 more)
...
Cohesion: 0.08
Nodes (22): acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer, declineRequest, _defaultShowError, handleRoute, identityRepository (+14 more)
...
Cohesion: 0.09
Nodes (21): alice, bob, main, network, _attachments, deleteAttachmentsForContact, deleteAttachmentsForMessage, _FakeMediaAttachmentRepository (+13 more)
...
Cohesion: 0.09
Nodes (21): MediaAttachment, package:flutter_app/features/conversation/domain/repositories/media_attachment_repository_impl.dart, containsKey, delete, main, read, readCount, _ReadForbiddenSecureKeyStore (+13 more)
...
Cohesion: 0.04
Nodes (42): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, main, testReaction, package:flutter_app/features/conversation/domain/models/message_reaction.dart, AppTheme (+34 more)

### Community 541 - "Community 541"
Cohesion: 0.09
Nodes (19): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+11 more)

### Community 542 - "Community 542"
Cohesion: 0.09
Nodes (18): asGroupMemberDeviceSnapshotRepository, compare, multiDeviceSyncEnabled, resolveGroupMemberDeviceSafety, savedDevices, deletePendingSiblingDevice, holdPendingSiblingDevice, HoldPendingSiblingDeviceFn (+10 more)
...
Cohesion: 0.10
Nodes (20): _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake, getApplicationDocumentsPath (+12 more)
...
Cohesion: 0.04
Nodes (48): _CountingGroupMessageRepository, getGroupThreadSummaries, getGroupThreadSummariesCallCount, getGroupThreadSummary, getGroupThreadSummaryCallCount, groupId, id, isArchived (+40 more)
...
Cohesion: 0.04
Nodes (47): blurb, build, _connector, _h, _item, label, _loud, _name (+39 more)
...
Cohesion: 0.17
Nodes (12): Network, startDeadDialListener(), TestDcutrFlagOff_ForcesPrivate_ZeroPunches(), TestDcutrFlagOn_SelectsUpgradeReachability(), dcutrReachabilityMode(), newPeerSessionNotifiee(), selectBestConnAddr(), peerSessionNotifiee (+4 more)
...
Cohesion: 0.12
Nodes (17): action, bridge, contactRepo, listener, main, _makeV2ReactionMessage, messageRepo, reactionRepo (+9 more)
...
Cohesion: 0.23
Nodes (20): eventCollector, TestDialPeerViaRelayMultiAddrFailover(), TestDualStackNodeWithIPv4Relay(), newLocalRelaySharedState(), startLocalRelayPair(), waitForNodeStatus(), assertNoRelayUpgradeEvents(), statusBool() (+12 more)
...
Cohesion: 0.12
Nodes (16): contactPeerId, groupId, id, inboxRetryPayload, inboxStored, main, _makeGroupSendingMessage, _makeSendingMessage (+8 more)
...
Cohesion: 0.12
Nodes (14): _cache, _cacheKey, _generation, IdentityAvatarDocumentsDirLoader, IdentityAvatarResolver, _inFlight, invalidatePeer, _loadFromDisk (+6 more)
...
Cohesion: 0.12
Nodes (15): apnsToken, build, deadline, encoded, fcmToken, initial, main, prefix (+7 more)
...
Cohesion: 0.14
Nodes (12): main, tempDir, docsPath, Fake, fileManager, getApplicationDocumentsPath, main, tempDir (+4 more)
...
Cohesion: 0.13
Nodes (14): ContactRequestPresentationGate, ../features/contact_request/domain/repositories/fake_contact_request_repository.dart, bridge, contactRepository, contactRequestStream, _flushMicrotasks, listener, liveRequests (+6 more)

### Community 705 - "Community 705"
Cohesion: 0.15
Nodes (11): package:flutter_app/features/feed/domain/utils/format_message_time.dart, main, aboveDivider, belowDivider, byContact, contactBlocked, filteredMessages, groupMessagesIntoThreads (+3 more)
...
Cohesion: 0.23
Nodes (9): Listener, TestConcurrentSendDialNoSerialize(), TestStartEmitsColdStartLockWindow(), waitForStartupPhase(), deadDialListener, Conn, Duration, Mutex (+1 more)
...
Cohesion: 0.18
Nodes (10): expectInvalid, expectTamperRejected, main, makeFreshnessProof, makePayload, makePolicy, makeWelcomePackage, signedInnerMap (+2 more)
...
Cohesion: 0.29
Nodes (6): mapMessageDeletionReplayResultToDisposition, mapReactionReplayResultToDisposition, main, package:flutter_app/features/conversation/application/handle_incoming_message_deletion_use_case.dart, package:flutter_app/features/conversation/application/handle_incoming_reaction_use_case.dart, package:flutter_app/features/conversation/application/recovered_inbox_sibling_dispositions.dart
...
Cohesion: 0.29
Nodes (7): GroupInviteListener, _SimGroupInviteListener, JoinedGroup, PendingInvite, FakeGroupInviteListener, _FakeGroupInviteListener, _FakeGroupInviteListener
...
Cohesion: 0.29
Nodes (6): main, minHeight, minWidth, _noOpCompress, _noOpVideoCompress, package:flutter_image_compress/flutter_image_compress.dart
...
Cohesion: 0.40
Nodes (6): IntroductionListener, IntroductionListener, IntroReceived, IntroStatusChanged, _FakeIntroductionListener, _FakeIntroductionListener
...
## Knowledge Gaps
- **34792 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+34787 more)
...
- **Why does `incomingMessage` connect `Community 172` to `Community 606`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 347` to `Community 520`, `Community 606`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 77` to `Community 640`, `Community 644`, `Community 135`, `Community 520`, `Community 149`, `Community 534`, `Community 535`, `Community 280`, `Community 30`, `Community 33`, `Community 547`, `Community 37`, `Community 169`, `Community 48`, `Community 442`, `Community 317`, `Community 578`, `Community 323`, `Community 835`, `Community 459`, `Community 716`, `Community 589`, `Community 600`, `Community 89`, `Community 232`, `Community 105`, `Community 746`, `Community 106`, `Community 362`, `Community 628`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _34792 weakly-connected nodes found - possible documentation gaps or missing edges._
