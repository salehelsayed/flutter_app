# Graph Report - graphify-arch  (2026-06-26)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 41979 nodes · 65280 edges · 928 communities (880 shown, 48 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2413 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17a32bef`
...
## Communities (928 total, 48 thin omitted)
...
Cohesion: 0.01
Nodes (342): AlertDialog, Align, AnimatedContainer, showGroupMissingNotificationFeedback, CircularProgressIndicator, ClipRRect, ConstrainedBox, DateSeparator (+334 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (380): AnimatedOpacity, main, main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames (+372 more)
...
Cohesion: 0.01
Nodes (281): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+273 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (284): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, bridge, buildMigrationQRData, buildValidQRData, contactRepo (+276 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (129): db, main, makeIntroductionRow, makeOutboxRow, makePendingResponseRow, buildIntroductionRepository, buildMessageRepository, db (+121 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (171): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+163 more)
...
Cohesion: 0.01
Nodes (204): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+196 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (238): main, makeInvite, pendingInviteRepo, ../../contacts/domain/repositories/fake_contact_repository.dart, _FakeNearbyLocationService, InMemoryPostRepository, InMemoryPostsPrivacySettingsRepository, ../../identity/domain/repositories/fake_identity_repository.dart (+230 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (219): MemberRole, PostModel, AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock, _AccountMigrationProgressWakeLockState, actionLabel, active, backgroundPreference (+211 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (211): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+203 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (218): Animation, CustomPaint, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, package:flutter_app/core/theme/glassmorphism.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, AccountMigrationBlockedScreen, _AccountMigrationBlockedScreenState (+210 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (233): ContactRequestNotificationMaterializer, buildRepo, main, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main (+225 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (238): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+230 more)
...
Cohesion: 0.01
Nodes (190): bridge, groupRepo, main, ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, fake_group_reaction_replay_outbox_repository.dart, FakeGroupPubSubNetwork, addMember (+182 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (177): client, lastCall, main, GoBridgeClient, client, closeMockGoBridgeEventChannel, defaultHandler, exerciseNativeFailure (+169 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (152): alice, bob, main, network, _originalText, FakeP2PNetwork, ChaosP2PNetwork, ../../features/conversation/integration/two_user_message_exchange_test.dart (+144 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (190): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+182 more)
...
Cohesion: 0.01
Nodes (173): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+165 more)
...
Cohesion: 0.01
Nodes (118): main, _makeAcceptPayload, _makeSendPayload, main, main, _makeSettings, status, main (+110 more)
...
Cohesion: 0.01
Nodes (152): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, DeliveryReceiptListener, dispose, messageRepo, receiptStream, start (+144 more)

### Community 35 - "Community 35"
Cohesion: 0.01
Nodes (150): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request (+142 more)

### Community 36 - "Community 36"
Cohesion: 0.02
Nodes (125): deliveredWritePatterns, main, scanDeliveredWrites, AspectRatio, File, FileImage, GestureDetector, IconButton (+117 more)
...
Cohesion: 0.01
Nodes (151): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+143 more)

### Community 39 - "Community 39"
Cohesion: 0.01
Nodes (145): Color, CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth (+137 more)
...
Cohesion: 0.02
Nodes (148): Database, db, main, makeAttachmentRow, makeMessageRow, db, main, makePassRow (+140 more)
...
Cohesion: 0.01
Nodes (160): AnimatedBuilder, AnnotatedRegion, _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo (+152 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (141): BuildGroupSignatureData(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateGroupEnvelope(), publishRawGroupEnvelope(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash(), lp013GroupHarness (+133 more)

### Community 46 - "Community 46"
Cohesion: 0.01
Nodes (143): main, _makeAttachment, mime, PendingGroupInvite, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart (+135 more)

### Community 47 - "Community 47"
Cohesion: 0.02
Nodes (90): bridge, contactPeerId, contactRepo, _contactWithMlKem, _doneAttachment, durationMs, fakeUploadFn, id (+82 more)

### Community 48 - "Community 48"
Cohesion: 0.04
Nodes (99): GroupMessagePayload, builtGroupMessageEnvelope, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, groupSenderDeviceBinding (+91 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (115): dart:ui, LanAvailabilitySnapshot, ../../domain/orbit3_arch_layout.dart, Key, detectTextDirection, _isLtrChar, _isRtlChar, VoidCallback (+107 more)
...
Cohesion: 0.03
Nodes (63): bridge, command, _expectNoPublicRouteFields, expectRejected, _gl005ForbiddenPublicRouteKeys, groupRepo, main, send (+55 more)
...
Cohesion: 0.02
Nodes (122): _incoming, main, isDeleted, isIncoming, main, _msg, authorPeerId, authorUsername (+114 more)
...
Cohesion: 0.03
Nodes (108): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), buildGroupMessageExtra(), cloneGroupConfig(), countRemoteGroupMembers(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), groupRendezvousNamespace() (+100 more)
...
Cohesion: 0.02
Nodes (108): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+100 more)
...
Cohesion: 0.03
Nodes (84): archiveGroup, _FailingGroupRepository, groupId, groupRepo, main, _InstrumentedGroupRepository, _DelayedGroupRepository, _FailingGroupRepository (+76 more)

### Community 77 - "Community 77"
Cohesion: 0.03
Nodes (69): ContactModel, _accent, background, borderColor, build, _buildHero, _buildMessageButton, _buildMetaCard (+61 more)

### Community 78 - "Community 78"
Cohesion: 0.02
Nodes (101): accuracyM, _buildActiveSnapshot, _buildInactiveSnapshot, capturedAt, _compareIso, existing, handleIncomingPostPresence, HandleIncomingPostPresenceResult (+93 more)
...
Cohesion: 0.02
Nodes (90): bridge, deleteMessagesForGroup, _FailingGroupMessageRepository, groupId, groupMessageRepo, groupRepo, main, _InstrumentedGroupMessageRepository (+82 more)

### Community 82 - "Community 82"
Cohesion: 0.02
Nodes (110): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, main, sendMessage (+102 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (36): avatarPath, _contact, contactPeerId, contactRepo, _group, groupId, _groupMessage, groupMessageRepo (+28 more)

### Community 84 - "Community 84"
Cohesion: 0.01
Nodes (138): core_fake_p2p.FakeP2PService, GroupTestUser, GroupMessage, GroupMessageListener, _FakeGroupMessageListener, addPage, addSignedInboxPage, admin (+130 more)
...
Cohesion: 0.03
Nodes (70): comments, loadPostComments, wait, post, postCommentExpiryExtension, refreshPostExpiryForComment, savePost, timestamp (+62 more)
...
Cohesion: 0.02
Nodes (96): _HarnessEnvironment, audioRecorderService, binding, bridge, build, _callback, _canUseVmServiceTimeline, _captureScenario (+88 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (96): ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo(), assertRingEpochsNewestFirst(), gk019DirectJumpKeyInfo() (+88 more)

### Community 99 - "Community 99"
Cohesion: 0.02
Nodes (91): AccountMigrationSizeGate, FakeIntroductionRepository, buildIdentity, main, tempDir, _changes, dispose, load (+83 more)
...
Cohesion: 0.02
Nodes (82): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, orbital_avatar.dart, orbital_ring_painter.dart, overflow_badge.dart, avatarBytes (+74 more)
...
Cohesion: 0.02
Nodes (91): EncryptedMediaTestBridge, RelayMediaStore, bridge, _createdAt, encTempsUnder, imageProcessor, main, mediaFileManager (+83 more)

### Community 109 - "Community 109"
Cohesion: 0.04
Nodes (54): NearbyDevicePosition, _contact, main, peerId, username, _contact, main, peerId (+46 more)
...
Cohesion: 0.02
Nodes (109): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _ThrowingActiveImporter, _MigrationPostException, _DeletionWireEnvelopeEncryptFailed, GroupOfflineReplaySignatureException, activeDatabase, importedRows (+101 more)
...
Cohesion: 0.03
Nodes (81): ChatMessageListener, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, Request, _FakeIncomingConversationListener, appShellController (+73 more)

### Community 125 - "Community 125"
Cohesion: 0.03
Nodes (74): benchmark_helpers.dart, details, events, _findRecoveredOutage, firstEventDetails, firstInbox, firstSend, honestyGap (+66 more)

### Community 126 - "Community 126"
Cohesion: 0.03
Nodes (78): _FakeContactRepository, add, attemptSilentIntroRecovery, bridge, _contactKeyUpdatedController, contactKeyUpdatedStream, contactRepo, ContactRequestListener (+70 more)

### Community 127 - "Community 127"
Cohesion: 0.03
Nodes (74): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult (+66 more)
...
Cohesion: 0.06
Nodes (51): chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData(), addTrimmedData() (+43 more)
...
Cohesion: 0.03
Nodes (76): AudioRecorderService, clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository, markCleared, feed_cleared_repository.dart (+68 more)
...
Cohesion: 0.02
Nodes (115): package:flutter_app/core/theme/feed_colors.dart, package:flutter_app/core/utils/text_direction_utils.dart, package:url_launcher/url_launcher.dart, TextOverflow, main, main, build, _controller (+107 more)
...
Cohesion: 0.04
Nodes (45): AppLocalizations, LocalizationsDelegate, Opacity, package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/presentation/widgets/orbit_media_preview_label.dart, package:flutter_app/l10n/app_localizations_en.dart, package:flutter_localizations/flutter_localizations.dart (+37 more)
...
Cohesion: 0.03
Nodes (71): Alignment, Column, nav_bar_button.dart, nav_bar_theme.dart, main, suppressAssetErrors, wrap, package:flutter_app/features/feed/domain/models/app_shell_tab.dart (+63 more)
...
Cohesion: 0.03
Nodes (66): addContact, author, condition, contactRepo, create, deadline, dispose, main (+58 more)
...
Cohesion: 0.03
Nodes (65): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+57 more)

### Community 156 - "Community 156"
Cohesion: 0.03
Nodes (67): bridge, _confirmationValueForState, contactRepo, dispose, emitIntroStatusChanged, finish, introduction, IntroductionMessageProcessOutcome (+59 more)
...
Cohesion: 0.03
Nodes (63): deliveryResult, EditPinnedPostResult, _editPinnedPostResultForSettlement, envelope, existingState, media, now, pinState (+55 more)
...
Cohesion: 0.03
Nodes (67): _FakeMediaFileManager, FakeMediaFileManager, _FakeMediaFileManager, _FakeMediaFileManager, _TempMediaFileManager, emitRetryTiming, limit, messages (+59 more)
...
Cohesion: 0.03
Nodes (64): _FakeP2PService, _FakeP2PService, _FakeP2PService, FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService, _ThrowOnSendP2PService (+56 more)
...
Cohesion: 0.03
Nodes (55): addContact, AddContactResult, archiveContact, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, c (+47 more)
...
Cohesion: 0.04
Nodes (52): handleShareIntent, ShareIntentRouteBuilder, build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt (+44 more)
...
Cohesion: 0.03
Nodes (66): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+58 more)
...
Cohesion: 0.03
Nodes (52): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+44 more)
...
Cohesion: 0.04
Nodes (55): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+47 more)
...
Cohesion: 0.04
Nodes (51): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, appDir, canonicalPath, commitPreparedGroupAvatar (+43 more)
...
Cohesion: 0.02
Nodes (123): DatabaseException, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, makeContactRow (+115 more)

### Community 213 - "Community 213"
Cohesion: 0.04
Nodes (53): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _FakeBridge (+45 more)
...
Cohesion: 0.04
Nodes (52): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, _RecorderRepo, _FakeMediaAttachmentRepository (+44 more)
...
Cohesion: 0.04
Nodes (49): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+41 more)
...
Cohesion: 0.04
Nodes (48): AccountMigrationNetworkGate, accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo, _coordinator, _debounceTimer, dispose (+40 more)
...
Cohesion: 0.04
Nodes (50): allFriends, fromMap, kind, peopleNearby, pickPeople, PostAudience, PostAudienceKind, PostAudienceKindWireValue (+42 more)
...
Cohesion: 0.04
Nodes (50): package:flutter_app/features/settings/presentation/screens/settings_wired.dart, checkHealth, currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox (+42 more)
...
Cohesion: 0.04
Nodes (44): main, dart:async, fake_group_pubsub_network.dart, deliveries, _Go012Run, main, publishBatch, runScenario (+36 more)
...
Cohesion: 0.04
Nodes (47): CountingSecureKeyStore, _MemorySecureKeyStore, _TrackingSecureKeyStore, _FakeSecureKeyStore, _InMemorySecureKeyStore, backingSecureKeyStore, containsKey, containsKeyCount (+39 more)
...
Cohesion: 0.05
Nodes (40): main, events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness (+32 more)

### Community 252 - "Community 252"
Cohesion: 0.03
Nodes (65): adminPeerId, baseGroup, bridge, createdAt, expectMembershipVersionWatermarkAlignment, groupId, groupRepo, laterMetadataEventAt (+57 more)
...
Cohesion: 0.07
Nodes (42): backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), newMemoryInboxBackendWithLimits(), relayResourcesFromServerLimits(), TestAdmissionControl_PreservesLatencyForAdmittedPeersUnderPressure() (+34 more)
...
Cohesion: 0.04
Nodes (43): group_pending_key_distribution_repository.dart, attempts, copyWith, createdAt, ../models/group_pending_key_distribution.dart, deviceId, finalizedAt, fromMap (+35 more)
...
Cohesion: 0.16
Nodes (41): NewMediaStore(), downloadMedia(), recvMediaResp(), sendMediaReq(), setupTestEnv(), TestBackwardCompat(), TestDeleteAfterDownloadRemovesBlob(), TestDirectMediaCountCapDoesNotUndercutInboxRetention() (+33 more)
...
Cohesion: 0.05
Nodes (37): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+29 more)
...
Cohesion: 0.05
Nodes (38): GenerateIdentityResult, generateNewIdentity, identity, identityJson, keygenStopwatch, mlKemFuture, mlKemResponse, ok (+30 more)
...
Cohesion: 0.04
Nodes (52): addContact, _AvatarProcessingProbe, avatarsDir, _avatarSnapshotBytes, bridge, builder, contactRepo, create (+44 more)
...
Cohesion: 0.05
Nodes (33): channel, log, main, flutter_secure_key_store.dart, AppPausedResult, groupTransitionedCount, handleAppPaused, kPausedGroupSendingRecoveryThreshold (+25 more)
...
Cohesion: 0.05
Nodes (38): main, main, currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox (+30 more)
...
Cohesion: 0.03
Nodes (75): _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry, group, groupId (+67 more)
...
Cohesion: 0.05
Nodes (34): basePath, bridge, captureFlowEvents, checkHealth, commandLog, dispose, encryptResponse, _extFromMime (+26 more)
...
Cohesion: 0.02
Nodes (123): ../../application/orbit3_profile_adapter.dart, ../../domain/orbit3_constellation_geometry.dart, Orbit3ConstellationMode, ../../domain/orbit3_one_circle_layout.dart, orbit3_constellation.dart, orbit3_constellation_painters.dart, orbit3_one_circle.dart, package:flutter_app/features/orbit/presentation/widgets/orbital_avatar.dart (+115 more)
...
Cohesion: 0.07
Nodes (27): class, group_invite_delivery_attempt_repository.dart, group_reaction_replay_outbox_repository.dart, ../models/group_reaction_replay_outbox_entry.dart, deleteAttempt, deleteAttemptsForGroup, getAttempt, getAttemptsForGroup (+19 more)
...
Cohesion: 0.07
Nodes (25): id, insertIntroSystemMessage, message, now, saveMessage, jsonString, payload, reactionId (+17 more)
...
Cohesion: 0.07
Nodes (26): _jpegBytes, main, _pngBytes, groupMediaPerTypeLimitBytes, GroupMediaSizePolicy, kGroupMediaAudioLimitBytes, kGroupMediaFileLimitBytes, kGroupMediaImageLimitBytes (+18 more)
...
Cohesion: 0.07
Nodes (28): archAvatars, archLabel, archOverflow, archPanel, archPitch, centreOf, circleAvatars, drawLine (+20 more)
...
Cohesion: 0.07
Nodes (24): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, block, contentHashValidation, copyWith (+16 more)
...
Cohesion: 0.07
Nodes (25): countQuarantinedEntries, deleteEntry, _entries, entry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, markQuarantined (+17 more)
...
Cohesion: 0.08
Nodes (22): MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator, file (+14 more)
...
Cohesion: 0.13
Nodes (23): FileMode, logPeerConnected(), logStatsPeriodically(), main(), shortPeerId(), TestResolveStorageConfig_FallsBackToWorkingDirectoryWhenDefaultUnavailable(), DefaultServerConfig(), envStrOrDefault() (+15 more)
...
Cohesion: 0.08
Nodes (23): addContact, author, bridge, _contact, contactRepo, create, deadline, dispose (+15 more)
...
Cohesion: 0.08
Nodes (21): capture, drain, goTo, main, outDir, capture, main, outDir (+13 more)
...
Cohesion: 0.02
Nodes (77): ElevatedButton, ImagePicker, _contact, contacts, imageProcessor, main, mlKemKey, peerId (+69 more)
...
Cohesion: 0.09
Nodes (22): _FakeIdentityRepo, _FakeIdentityRepo, _FakeIdentityRepository, _FakeIdentityRepository, IdentityRepository, _Section10IdentityRepository, _FakeIdentityRepository, _FakeIdentityRepository (+14 more)
...
Cohesion: 0.03
Nodes (61): _MemoryPairingSessionRepository, _MemoryPairingSessionRepository, authenticatedChannelBinding, AuthenticatedMigrationChannelTranscript, authorizationNonce, authorizedAt, authorizeMigrationExport, authorizes (+53 more)
...
Cohesion: 0.13
Nodes (14): ../bridge/fake_bridge.dart, eventsNamed, main, bridge, main, p2pService, bridge, main (+6 more)
...
Cohesion: 0.03
Nodes (68): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+60 more)
...
Cohesion: 0.03
Nodes (58): isUnsafeLegacyOutboundEnvelope, _captureFlowEvents, creatorPeerId, generation, groupId, groupRepo, _InboxStoreOkFalseBridge, joinerPeerId (+50 more)
...
Cohesion: 0.13
Nodes (13): main, appWith, chatScreen, edgeDrag, logicalSize, main, seedMessages, settleFrames (+5 more)
...
Cohesion: 0.12
Nodes (14): MediaAttachment, package:flutter_app/features/contact_request/domain/repositories/contact_request_repository_impl.dart, package:flutter_app/features/conversation/domain/repositories/media_attachment_repository_impl.dart, deleteCalls, main, makeRow, repo, store (+6 more)
...
Cohesion: 0.14
Nodes (12): package:flutter_app/core/utils/ring_avatar_spec.dart, RingAvatarData, glow, main, ring, data, _drawCenterGlow, _drawDashedRing (+4 more)
...
Cohesion: 0.24
Nodes (10): TestProfileAnyPeerCanDownload(), TestProfileDelete(), TestProfileDeleteIdempotent(), TestProfileDownloadNotFound(), TestProfileReplace(), TestProfileSizeLimit(), TestProfileUploadDownload(), testEnv (+2 more)
...
Cohesion: 0.05
Nodes (37): DrainGroupOfflineInboxForGroupFn, error, failed, ok, prepareNotificationOpen, PrepareNotificationOpenResult, success, _AppRootNotificationHarness (+29 more)
...
Cohesion: 0.04
Nodes (47): buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage, innerPayload, _keyedRow, kMediaAttachmentEncryptionSchemeBlobAesGcmV1 (+39 more)
...
Cohesion: 0.04
Nodes (45): EdgeInsets, IconData, anchor, build, _buildMenuItem, _close, _controller, createState (+37 more)
...
Cohesion: 0.20
Nodes (9): avatarSizes, coreCentre, drain, main, tall, wrap, package:flutter_app/features/orbit3/presentation/widgets/orbit3_arch_panel.dart, package:flutter_app/features/orbit3/presentation/widgets/orbit3_one_circle.dart (+1 more)
...
Cohesion: 0.25
Nodes (7): clearOrbit3DimensionPreferences, delete, fromStorageString, loadOrbit3DimensionPreferences, saveOrbit3DimensionPreferences, value, write
...
Cohesion: 0.36
Nodes (6): histogramSampleCount(), metricValue(), TestInboxRejectAndTTLPruneTelemetry(), TestRelayMetricsDeltas(), Metric, Observer
...
Cohesion: 0.33
Nodes (4): main, main, package:flutter_app/features/orbit3/application/orbit3_dimension_preferences_use_cases.dart, package:flutter_app/features/orbit3/domain/orbit3_dimension_preferences.dart
...
Cohesion: 0.05
Nodes (36): conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart, group_delete_preserves_friends_simulator_test.dart, group_invite_accept_spinner_simulator_test.dart, group_new_member_media_simulator_proof_test.dart (+28 more)
...
Cohesion: 0.10
Nodes (18): main, member, absolutePath, age, doneCount, emitRetryTiming, _isFreshOutgoingGroupSend, kFreshGroupUploadRetrySendingThreshold (+10 more)
...
## Knowledge Gaps
- **33974 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+33969 more)
...
- **Why does `incomingMessage` connect `Community 124` to `Community 582`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 328` to `Community 529`, `Community 582`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 529` to `Community 88`, `Community 328`, `Community 318`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _33974 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.0076073112801624725 - nodes in this community are weakly interconnected._