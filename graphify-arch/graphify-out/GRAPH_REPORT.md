# Graph Report - graphify-arch  (2026-07-04)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 42945 nodes · 67206 edges · 939 communities (890 shown, 49 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2626 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c433462f`
...
## Communities (939 total, 49 thin omitted)
...
Cohesion: 0.01
Nodes (549): AnimatedOpacity, main, main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, encPendingAttachment, main (+541 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (347): post, postCommentExpiryExtension, refreshPostExpiryForComment, savePost, timestamp, updatedPost, EncryptedMediaTestBridge, RelayMediaStore (+339 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (282): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+274 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (392): main, makeInvite, pendingInviteRepo, copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, bridge (+384 more)
...
Cohesion: 0.01
Nodes (331): AlertDialog, Align, AnimatedContainer, showGroupMissingNotificationFeedback, CircularProgressIndicator, ClipRRect, ConstrainedBox, Directionality (+323 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (264): absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub, _applyMessageUpdate (+256 more)
...
Cohesion: 0.01
Nodes (222): main, main, mapMessageDeletionReplayResultToDisposition, mapReactionReplayResultToDisposition, main, ContactRequestNotificationMaterializer, main, buildRepo (+214 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (202): DatabaseException, db, main, makeContactRow, db, main, makeIdentityRow, db (+194 more)
...
Cohesion: 0.01
Nodes (152): dbDeleteExpiredGroupInviteConsumptions, dbLoadGroupInviteConsumption, dbUpsertGroupInviteConsumption, inviteId, dbDeleteExpiredGroupWelcomeKeyPackageTombstones, dbLoadGroupWelcomeKeyPackageTombstone, dbUpsertGroupWelcomeKeyPackageTombstone, packageId (+144 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (216): IconData, Key, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock, _AccountMigrationProgressWakeLockState, actionLabel (+208 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (136): ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, FakeGroupPubSubNetwork, GroupModel, GroupPendingKeyDistributionRunner, expectRotatedRemainingMember, main, network (+128 more)
...
Cohesion: 0.01
Nodes (203): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+195 more)

### Community 19 - "Community 19"
Cohesion: 0.01
Nodes (206): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+198 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (209): CurvedAnimation, orbit_screen.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate (+201 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (200): _assertAllRecipientsStarted, _assertBoundedStart, _contact, contacts, _ControlledP2PService, _createControlledService, _dialedPeers, dialPeer (+192 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (201): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+193 more)

### Community 23 - "Community 23"
Cohesion: 0.02
Nodes (167): main, _makeAcceptPayload, _makeSendPayload, main, alice, bob, main, network (+159 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (178): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+170 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (182): NewEventDispatcher(), fakeHostWithAddrs, TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), generateFakeRelayAddr(), TestBuildRelaySelector_FallsBackToDefault(), TestBuildRelaySelector_UsesServerAddresses(), TestDefaultRelayAddresses_IncludesWssAndQuic() (+174 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (220): Animation, OrbitScreen, package:flutter_app/core/theme/glassmorphism.dart, _AnimatedLetterCard, _AnimatedLetterCardState, FirstTimeExperienceScreen, _FirstTimeExperienceScreenState, _animationController (+212 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (126): addedMembers, _addMemberFailures, allMembers, buildCreateWarningMessage, byPeerId, CreateGroupMemberAddFailure, createGroupWithMembers, CreateGroupWithMembersResult (+118 more)

### Community 28 - "Community 28"
Cohesion: 0.01
Nodes (193): addGroup, announceCalls, announceSpy, bridge, groupRepo, identity, main, run (+185 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (185): AnimatedBuilder, items, mergeInnerCircleItems, _friend, _g, _group, main, provOf (+177 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (167): _CursorInboxBridge, _FailDecryptBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole (+159 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (112): GroupMessagePayload, builtGroupMessageEnvelope, normalizeGroupInboxRecipientPeerIds(), groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult (+104 more)

### Community 32 - "Community 32"
Cohesion: 0.01
Nodes (170): AnnotatedRegion, BackgroundPreference, BoxDecoration, DateSeparator, DecoratedBox, _assertBackgroundScrollDoesNotRegress, _assertThresholds, average (+162 more)
...
Cohesion: 0.01
Nodes (131): dart:ui, detectTextDirection, _isLtrChar, _isRtlChar, main, ValueChanged, VoidCallback, AttachmentPreviewStrip (+123 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (129): Database, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, repairRow (+121 more)
...
Cohesion: 0.04
Nodes (141): ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo() (+133 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (135): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+127 more)
...
Cohesion: 0.06
Nodes (141): BuildGroupSignatureData(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash() (+133 more)
...
Cohesion: 0.02
Nodes (114): db, main, makePassRow, openWithMigrations, db, main, makeRecipientRow, openWithMigrations (+106 more)
...
Cohesion: 0.02
Nodes (106): main, _dbKey, fixedKey, main, errors, hasError, isAccepted, MigrationDatabaseImportError (+98 more)

### Community 50 - "Community 50"
Cohesion: 0.01
Nodes (138): core_fake_p2p.FakeP2PService, GroupTestUser, addPage, addSignedInboxPage, admin, create, _CursorInboxBridge, dispose (+130 more)
...
Cohesion: 0.02
Nodes (102): _incoming, main, isDeleted, isIncoming, main, _msg, FileImage, Image (+94 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (119): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+111 more)
...
Cohesion: 0.02
Nodes (126): activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername, build, _buildComposerSection (+118 more)
...
Cohesion: 0.02
Nodes (125): Route, acceptedUpdates, acceptGate, allGroupsGate, alphaGroup, archivedContactsGate, bridge, buildOrbitWired (+117 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (116): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, DeliveryReceiptListener, dispose, messageRepo, receiptStream, start (+108 more)

### Community 59 - "Community 59"
Cohesion: 0.01
Nodes (179): Color, CustomPainter, dart:math, GestureDragEndCallback, GestureDragStartCallback, GestureDragUpdateCallback, AmplitudeBars, _AmplitudeBarsPainter (+171 more)
...
Cohesion: 0.01
Nodes (133): MapEntry, main, compare, currentSafetyNumber, _fingerprints, GroupMemberIdentitySafety, identityChanged, _normalize (+125 more)

### Community 62 - "Community 62"
Cohesion: 0.04
Nodes (102): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+94 more)

### Community 63 - "Community 63"
Cohesion: 0.02
Nodes (112): clearWriteLog, close, _contact, contacts, _ControlledEncryptBridge, _ControlledP2PService, created, _createLocalPost (+104 more)
...
Cohesion: 0.03
Nodes (80): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, archiveGroup, _FailingGroupRepository, groupId, groupRepo, main (+72 more)

### Community 66 - "Community 66"
Cohesion: 0.02
Nodes (114): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart (+106 more)
...
Cohesion: 0.02
Nodes (102): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, Stopwatch, AppTheme, blurSigma, borderRadius (+94 more)

### Community 73 - "Community 73"
Cohesion: 0.02
Nodes (85): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+77 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (77): TestGroupInboxStore_RetrieveCursorReportsHistoryGapForMissingCursor(), containsPeer(), handleMediaDelete(), handleMediaDownload(), handleMediaList(), HandleMediaStream(), handleMediaUpload(), NewMediaStore() (+69 more)

### Community 75 - "Community 75"
Cohesion: 0.02
Nodes (98): AccountMigrationStreamingEntry, build, chunkSize, entryId, _FileAccountMigrationStreamingEntry, filePath, fileReader, kind (+90 more)

### Community 76 - "Community 76"
Cohesion: 0.03
Nodes (62): _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry, group, groupId (+54 more)
...
Cohesion: 0.02
Nodes (82): AppendGroupEventLogEntry, announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled (+74 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (98): client, lastCall, main, GoBridgeClient, event, main, GroupDiagnosticEvent, _badgeLabel (+90 more)
...
Cohesion: 0.02
Nodes (103): CountingGroupMessageRepository, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay, deleteAttempt (+95 more)

### Community 83 - "Community 83"
Cohesion: 0.03
Nodes (77): main, _absoluteForRelativePath, acceptSizeDivergence, _addBestPathFailureIssue, addCandidate, _addChatMedia, _addPathBackedItem, _addPathCandidateIfUsable (+69 more)
...
Cohesion: 0.04
Nodes (55): package:flutter_app/core/utils/url_parser.dart, package:url_launcher/url_launcher.dart, TextOverflow, main, build, _controller, createState, didUpdateWidget (+47 more)
...
Cohesion: 0.02
Nodes (81): addContact, AddContactResult, archiveContact, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, _diagnostic (+73 more)
...
Cohesion: 0.02
Nodes (89): _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiStagedDatabaseOpener, computeDatabaseChecksumForTesting, database, DefaultMigrationStagedDatabaseOpener, manifest, message (+81 more)

### Community 93 - "Community 93"
Cohesion: 0.02
Nodes (88): deliveryResult, EditPinnedPostResult, _editPinnedPostResultForSettlement, envelope, existingState, media, now, pinState (+80 more)
...
Cohesion: 0.02
Nodes (88): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+80 more)

### Community 98 - "Community 98"
Cohesion: 0.02
Nodes (67): logOnlyToken, main, mainPath, nsePath, readSource, routerPath, senderToken, main (+59 more)

### Community 99 - "Community 99"
Cohesion: 0.02
Nodes (90): addContact, avatarPath, contact, dlFn, existingContact, handleMutualAcceptance, isIntroduced, isRecipient (+82 more)

### Community 100 - "Community 100"
Cohesion: 0.05
Nodes (42): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, lanDialHandler, EventCallback, messageEnvelopeType(), readFrame() (+34 more)
...
Cohesion: 0.05
Nodes (38): package:flutter_app/features/feed/presentation/widgets/feed_header.dart, package:flutter_app/features/home/presentation/widgets/editable_username_widget.dart, package:flutter_app/features/p2p/presentation/widgets/connection_status_indicator.dart, avatarBytes, backgroundPreference, build, _buildHeader, _controller (+30 more)
...
Cohesion: 0.02
Nodes (90): AccountMigrationReceiverEvents, AccountMigrationSizeGate, AccountMigrationMoveSizeEstimate, AccountMigrationOldPhonePresentationState, AccountMigrationOldPhoneStatus, AccountMigrationProgressStage, AccountMigrationProgressStageStatus, AccountMigrationQrPresentationState (+82 more)

### Community 105 - "Community 105"
Cohesion: 0.02
Nodes (100): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+92 more)

### Community 106 - "Community 106"
Cohesion: 0.02
Nodes (114): bridge, command, _expectNoPublicRouteFields, expectRejected, _gl005ForbiddenPublicRouteKeys, groupRepo, main, send (+106 more)

### Community 107 - "Community 107"
Cohesion: 0.03
Nodes (64): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, AccountMigrationBlockedScreen, _AccountMigrationBlockedScreenState, build, _confirmErase (+56 more)
...
Cohesion: 0.02
Nodes (126): authenticatedChannelBinding, AuthenticatedMigrationChannelTranscript, authorizationNonce, authorizedAt, authorizeMigrationExport, authorizes, bytes, consumeResult (+118 more)
...
Cohesion: 0.02
Nodes (84): clearWriteLog, _contact, contacts, created, _createLocalPost, dialAttempts, _dialedPeers, dialPeer (+76 more)
...
Cohesion: 0.02
Nodes (85): package:flutter_app/features/feed/domain/models/feed_session_reply.dart, activeTab, backgroundPreference, bottomInset, build, _buildComposer, _buildFeedContent, _buildFeedEntries (+77 more)

### Community 118 - "Community 118"
Cohesion: 0.02
Nodes (78): main, FakeIntroductionRepository, buildIdentity, main, tempDir, main, main, IntroductionRepository (+70 more)

### Community 119 - "Community 119"
Cohesion: 0.03
Nodes (74): FakeReactionRepository, applyChange, clearMessageIds, dispose, FeedReactionStore, listenableForMessage, _notifierFor, _notifiers (+66 more)
...
Cohesion: 0.03
Nodes (71): DatabaseExecutor, db, insertOutgoing, main, row, assertOutgoingTransition, db, main (+63 more)

### Community 124 - "Community 124"
Cohesion: 0.02
Nodes (82): GroupInviteListener, GroupMessageRepository, _NoOpMsgRepo, _SimGroupInviteListener, JoinedGroup, PendingInvite, _NoOpMsgRepo, _NoOpMsgRepo (+74 more)

### Community 125 - "Community 125"
Cohesion: 0.04
Nodes (45): AdmitSiblingDeviceFn, admitSiblingDeviceIfTrusted, alreadyPresent, deviceId, EnqueueDeferredGroupKeyDistributionFn, existingById, existingByTransport, latestKey (+37 more)
...
Cohesion: 0.06
Nodes (52): chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData(), addTrimmedData() (+44 more)

### Community 130 - "Community 130"
Cohesion: 0.03
Nodes (74): IntroductionListener, FakeGroupReactionReplayOutboxRepository, first_time_experience_screen.dart, GroupReactionReplayOutboxRepository, ImageSource, IntroductionListener, IntroReceived, IntroStatusChanged (+66 more)

### Community 131 - "Community 131"
Cohesion: 0.03
Nodes (78): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents, accountMigrationRunTransfer, accountMigrationSizeGate (+70 more)

### Community 132 - "Community 132"
Cohesion: 0.03
Nodes (74): _cleanDisplayName, groupPeerFallbackLabel, memberName, preferMemberName, resolveGroupSenderDisplayName, sanitized, senderPeerId, shortPeerId (+66 more)
...
Cohesion: 0.03
Nodes (61): contactRepo, main, requestRepo, testRequest, alice, alicePeerId, bob, bobPeerId (+53 more)
...
Cohesion: 0.03
Nodes (73): ShareBatchDeliveryResult, _expectCommandOrder, _GroupShareBgBridge, _imageProcessor, inboxStoreOk, isLocalPeer, joinedAt, _LanFakeP2PService (+65 more)
...
Cohesion: 0.03
Nodes (71): build, createState, initState, main, _SettleHarness, _SettleHarnessState, shareIntentService, clearCleared (+63 more)
...
Cohesion: 0.02
Nodes (81): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, archived, blocked, _contact, contacts, _FailAfterPostSaveRepository, lastSavedPostId (+73 more)
...
Cohesion: 0.03
Nodes (63): db, main, makeKeyRow, db, main, makeMemberRow, db, main (+55 more)
...
Cohesion: 0.10
Nodes (68): newMemoryInboxBackend(), requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionPlaintextEnvelope() (+60 more)
...
Cohesion: 0.03
Nodes (70): addContact, archiveContact, archivedPeerIds, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository (+62 more)
...
Cohesion: 0.03
Nodes (66): dismissedAt, dismissPin, savePinDismissal, activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager (+58 more)
...
Cohesion: 0.03
Nodes (65): package:flutter_app/core/utils/ring_avatar_generator.dart, package:flutter_app/core/utils/ring_avatar_spec.dart, package:flutter_app/features/home/presentation/widgets/ring_avatar_painter.dart, ring_avatar_painter.dart, _accent, background, borderColor, build (+57 more)

### Community 155 - "Community 155"
Cohesion: 0.03
Nodes (69): Request, appShellController, bridge, buildFeedWired, contactRepo, contactRequestRepo, _contactUpdateController, contactUpdatedStream (+61 more)
...
Cohesion: 0.03
Nodes (62): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+54 more)

### Community 158 - "Community 158"
Cohesion: 0.03
Nodes (64): attachment, _canLinkLocalMedia, deadline, decision, effectiveInterval, _findAttachmentById, hasLocalPath, kDefaultLocalMediaMetadataGrace (+56 more)
...
Cohesion: 0.03
Nodes (62): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, bridge, contactRepo, declinedAtUtc, declinePendingGroupInvite, DeclinePendingGroupInviteResult (+54 more)

### Community 161 - "Community 161"
Cohesion: 0.03
Nodes (65): accountMigrationNetworkGate, allowed, _allowsPostFollowOnNetworkSideEffects, _debounceTimer, dispose, _isOnline, _isRetrying, jobs (+57 more)

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (69): TestGroupGenerateNextKey_DoesNotMutateStoredKeyState(), TestGroupGenerateNextKey_GroupKeyGraceActiveRejectsSecondNativeRotation(), TestGroupGenerateNextKey_InvalidJSON(), TestGroupGenerateNextKey_KE002UsesLatestCommittedEpochWithoutMutating(), TestGroupGenerateNextKey_KE013BlocksWhenGroupKeyStateMissing(), TestGroupGenerateNextKey_KE013UsesRestoredEpochAfterRestartMemoryLoss(), TestGroupGenerateNextKey_MissingGroupId(), GroupCreate() (+61 more)

### Community 163 - "Community 163"
Cohesion: 0.03
Nodes (68): loadReactionsForConversation, result, buildShareTargetPickerRoute, _lastToneAt, NotificationToneTracker, shouldPlayTone, window, package:flutter_app/core/media/audio_recorder_service.dart (+60 more)
...
Cohesion: 0.03
Nodes (62): AudioRecorderService, compressed,, GroupRepository, _NoOpGroupRepo, RecordAudioRecorderService, fromStorageString, ImageQualityPreference, original (+54 more)

### Community 168 - "Community 168"
Cohesion: 0.06
Nodes (56): DecryptGroupMessage(), EncryptGroupMessage(), TestBuildGroupSignatureData_Deterministic(), TestBuildGroupSignatureData_Format(), TestDecryptGroupMessage_InvalidBase64(), TestEncryptGroupMessage_InvalidKey(), TestEncryptGroupMessage_WrongKeyLength(), TestGK002EncryptDecryptRoundTripForTextPayload() (+48 more)
...
Cohesion: 0.03
Nodes (63): actorPayload, actorPeerId, actorPublicKey, actorUsername, _aliceContact, _bobIdentity, bridge, buildConfigRequestListener (+55 more)
...
Cohesion: 0.03
Nodes (60): _attemptRegistration, dispose, _disposed, ensureStarted, _inFlightAttempt, _permissionState, _PushPermissionState, PushRegistrationCoordinator (+52 more)

### Community 183 - "Community 183"
Cohesion: 0.03
Nodes (57): Column, EdgeInsets, nav_bar_button.dart, nav_bar_theme.dart, package:flutter_app/features/feed/presentation/widgets/feed_navigation_bar.dart, package:flutter_app/features/feed/presentation/widgets/nav_bar_button.dart, package:flutter_app/features/feed/presentation/widgets/nav_bar_theme.dart, package:flutter_app/features/groups/presentation/widgets/expandable_fab.dart (+49 more)
...
Cohesion: 0.03
Nodes (60): main, expiresAt, issuedAt, main, makePackage, validMaterial, package:flutter_app/features/groups/application/group_invite_identity_callbacks.dart, package:flutter_app/features/groups/domain/models/group_welcome_key_package.dart (+52 more)
...
Cohesion: 0.04
Nodes (52): FadeTransition, package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/conversation/domain/models/media_preview_descriptor.dart, package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart, package:flutter_app/features/orbit/presentation/widgets/orbit_media_preview_label.dart, main (+44 more)
...
Cohesion: 0.03
Nodes (58): AccountMigrationNetworkGate, accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo, _coordinator, _debounceTimer, dispose (+50 more)

### Community 194 - "Community 194"
Cohesion: 0.03
Nodes (58): absolutePath, age, doneCount, emitRetryTiming, _isFreshOutgoingGroupSend, kFreshGroupUploadRetrySendingThreshold, _lateGroupSendAbortReason, pendingAttachment (+50 more)
...
Cohesion: 0.03
Nodes (58): media_attachment_repository.dart, MediaAttachment, ../models/media_attachment.dart, ../models/media_preview_descriptor.dart, package:flutter_app/features/conversation/domain/repositories/media_attachment_repository_impl.dart, deleteAttachmentsForContact, deleteAttachmentsForMessage, containsKey (+50 more)
...
Cohesion: 0.03
Nodes (52): acquire, activeHolds, _channel, _channelInvoke, channelName, _holds, _invoke, MigrationKeepAliveInvoker (+44 more)

### Community 201 - "Community 201"
Cohesion: 0.03
Nodes (56): c, calculateNearbyDistanceM, capturedAt, contact, contacts, currentTime, deltaLat, deltaLng (+48 more)
...
Cohesion: 0.03
Nodes (59): accept, _connectWs, _createTestFile, main, _startMockReceiver, ackStream, _ackTimeout, _boundPort (+51 more)

### Community 206 - "Community 206"
Cohesion: 0.03
Nodes (65): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+57 more)

### Community 207 - "Community 207"
Cohesion: 0.04
Nodes (56): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, package:flutter_app/shared/widgets/media/avatar_image_provider.dart, Uint8List, user_avatar.dart (+48 more)

### Community 208 - "Community 208"
Cohesion: 0.03
Nodes (70): _MemoryPairingSessionRepository, _SharedFakeDiscovery, _MemoryPairingSessionRepository, _SharedFakeDiscovery, SecureKeyStoreMigrationPairingSessionRepository, aad, acceptedSegmentIndexes, acceptManifest (+62 more)

### Community 209 - "Community 209"
Cohesion: 0.04
Nodes (56): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _MockBridge (+48 more)
...
Cohesion: 0.04
Nodes (54): _RecordingSnapshotExportAdapter, _FfiSnapshotExportAdapter, adapter, _applyCipherPragmas, captureCipherMetadata, cipherVersion, closeExportedDatabaseAfterValidation, computeFileChecksum (+46 more)

### Community 220 - "Community 220"
Cohesion: 0.04
Nodes (52): fromPreview, handleDeliveryReceipt, messageIds, main, count, emitRetryTiming, olderThan, retryStopwatch (+44 more)
...
Cohesion: 0.10
Nodes (31): decodeGroupInboxEntries(), encodeRedisComponent(), encodeRedisGroupInboxRecord(), encodeRedisGroupInboxRecords(), filterInboxEntries(), minInt(), newRedisClientFromURL(), newRedisPushTokenBackend() (+23 more)

### Community 225 - "Community 225"
Cohesion: 0.07
Nodes (48): failingStoreInboxBackend, scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), apnsCustomDataFromPushData(), buildCiphertextOnlyPushMessage(), buildGroupPushMessage(), buildOversizedFallbackPushMessage(), buildPushMessage() (+40 more)
...
Cohesion: 0.04
Nodes (49): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, appDir, canonicalPath, commitPreparedGroupAvatar (+41 more)

### Community 229 - "Community 229"
Cohesion: 0.04
Nodes (53): accuracyM, _availabilityForSettings, canOpenSettings, capturedAt, checkPermissionState, GeolocatorNearbyLocationPlatformAdapter, getCurrentPosition, handleSharingDisabled (+45 more)
...
Cohesion: 0.04
Nodes (52): _FakePresenceSetter, ../../features/p2p/domain/models/discovered_peer.dart, ../../features/p2p/domain/models/node_state.dart, ../../features/p2p/domain/models/send_message_result.dart, ../local_discovery/lan_ack.dart, clearResumeStarted, countNeedsAttentionInboxEntries, currentState (+44 more)

### Community 238 - "Community 238"
Cohesion: 0.04
Nodes (45): benchmark_helpers.dart, runAckBenchmark, runBridgeCrossingBenchmark, runConnectionReuseBenchmark, runInboxBenchmark, dispose, fixture, node (+37 more)
...
Cohesion: 0.04
Nodes (48): db, main, bridge, cliContact, cliPeer, contactRepo, db, _dbName (+40 more)
...
Cohesion: 0.07
Nodes (42): backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), relayResourcesFromServerLimits(), TestFiniteLimits_RejectExcessGroupMessages(), TestRelayService_EnforcesPerPeerConnectionCap() (+34 more)
...
Cohesion: 0.04
Nodes (44): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+36 more)
...
Cohesion: 0.06
Nodes (32): containsKey, create, createdAt, _createMigrationFixtureSchema, db, delete, execute, exportDir (+24 more)
...
Cohesion: 0.11
Nodes (48): boolFromMap(), buildGroupOfflineReplayEnvelope(), canonicalJSON(), canonicalStringList(), cmdBlobDecrypt(), cmdBlobEncrypt(), cmdBlobKeygen(), cmdClearMessages() (+40 more)
...
Cohesion: 0.04
Nodes (46): main, ../../../conversation/domain/repositories/fake_media_attachment_repository.dart, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart, currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose (+38 more)
...
Cohesion: 0.07
Nodes (23): pruneExpiredInboxMessages(), TestMemoryInbox_StoreAtCapEvictsOldestReturnsStored(), ensureInboxMessageID(), extractMessageId(), mergePeerIds(), stringSlicesEqual(), memoryGroupInboxBackend, memoryInboxBackend (+15 more)
...
Cohesion: 0.04
Nodes (40): accountKey, admit, drainSpy, groupId, main, member, memberPeerId, reopenSpy (+32 more)

### Community 269 - "Community 269"
Cohesion: 0.02
Nodes (100): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+92 more)

### Community 270 - "Community 270"
Cohesion: 0.04
Nodes (43): deliveredWritePatterns, main, scanDeliveredWrites, File, app, main, ownedCopy, _pumpFrames (+35 more)

### Community 271 - "Community 271"
Cohesion: 0.07
Nodes (26): main, run, main, events, h, main, missing, missingCalls (+18 more)
...
Cohesion: 0.04
Nodes (44): Amplitude, candidate, canonicalMembershipEventId, current, gate, group, _groupMembershipMutationLocks, isStaleGroupMembershipEvent (+36 more)
...
Cohesion: 0.04
Nodes (42): contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult, incomingTime (+34 more)

### Community 285 - "Community 285"
Cohesion: 0.05
Nodes (44): absolutePath, AccountMigrationAccountSizeEstimator, accountMigrationDisplayMegabytes, accountMigrationMaxAccountBytes, accountMigrationReceiverStorageInsufficientMessage, accountMigrationReceiverStorageUnavailableMessage, accountMigrationSizeCapBlockedMessage, accountMigrationSizeEstimateLabel (+36 more)
...
Cohesion: 0.05
Nodes (41): _kMnemonic12, recoverIdentityFromSecureStore, result, SecureStoreIdentityRecoveryResult, storedMnemonic, _FakeIdentityRepo, _fakeIdentityResponse, _fakeMlKemResponse (+33 more)
...
Cohesion: 0.05
Nodes (40): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, _FakeMediaAttachmentRepository, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+32 more)
...
Cohesion: 0.06
Nodes (40): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+32 more)
...
Cohesion: 0.05
Nodes (40): class, _attachments, count, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage, getAttachmentsForMessages (+32 more)
...
Cohesion: 0.05
Nodes (40): countNeedsAttentionEntries, countQuarantinedEntries, deleteEntry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, InboxStagingRepositoryImpl, markQuarantined (+32 more)
...
Cohesion: 0.05
Nodes (37): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+29 more)
...
Cohesion: 0.10
Nodes (38): handleCommand(), TestCommandResponseFormat(), TestHandleCommandBlobRoundTrip(), TestHandleCommandClearMessages(), TestHandleCommandDisconnectMissingPeerId(), TestHandleCommandDisconnectNotStarted(), TestHandleCommandGenerateIdentity(), TestHandleCommandGetMessagesEmpty() (+30 more)
...
Cohesion: 0.03
Nodes (67): clearPendingKeyRotation, clearPendingKeyRotations, _Clock, contact, contains, deleteGroup, deleteMessagesForGroup, endedAt (+59 more)
...
Cohesion: 0.05
Nodes (36): failureEvent, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage, envelope (+28 more)
...
Cohesion: 0.06
Nodes (34): AspectRatio, BoxFit, main, _makeMedia, _makeVideoMedia, tempDir, _tinyPng, videoPath (+26 more)
...
Cohesion: 0.03
Nodes (53): buildTestApp, main, setPhoneViewport, chatGroup, conversationApp, fortyMessages, localAfternoon, main (+45 more)

### Community 346 - "Community 346"
Cohesion: 0.12
Nodes (21): TestParseInboxStoreResponse_InboxFullTyped(), TestParseInboxStoreResponse_NewRelayFields(), TestParseInboxStoreResponse_OldRelayDefaults(), parseInboxStoreResponse(), parsePresenceResponse(), parsePresenceSetResponse(), InboxMessage, inboxRequest (+13 more)
...
Cohesion: 0.06
Nodes (27): conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart, group_delete_preserves_friends_simulator_test.dart, group_invite_accept_spinner_simulator_test.dart, group_new_member_media_simulator_proof_test.dart (+19 more)
...
Cohesion: 0.06
Nodes (30): OneToOneTestUser, consumeCalls, consumeIfRecentAnnouncement, markAnnouncement, markCalls, messageId, payload, RecentNotificationGateCall (+22 more)
...
Cohesion: 0.06
Nodes (33): _FakeP2PService, _FakeP2PService, RelayLiveSendObserver, DurableLanFakeP2PService, FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService (+25 more)
...
Cohesion: 0.06
Nodes (31): main, map, AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart, fake_notification_service.dart, bridge, contactRepo, conversationTracker (+23 more)
...
Cohesion: 0.06
Nodes (32): controller, currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox, incomingLocalMediaStream (+24 more)
...
Cohesion: 0.06
Nodes (31): _FakeIdentityRepo, _FakeIdentityRepo, _FakeIdentityRepository, _FakeIdentityRepository, IdentityRepository, _Section10IdentityRepository, _FakeIdentityRepository, _TrackingIdentityRepository (+23 more)
...
Cohesion: 0.10
Nodes (8): AggregateRelayState, recoveryPromise, RecoveryResult, RelayConnectionState, RelaySessionManager, RelaySessionState, Duration, RWMutex
...
Cohesion: 0.07
Nodes (27): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, acceptRequest, bridge, contactRepository (+19 more)
...
Cohesion: 0.07
Nodes (27): bridge, checkHealth, dispose, _FakeBridge, initialize, isInitialized, main, _otherPeerId (+19 more)
...
Cohesion: 0.07
Nodes (29): bridge, calledCommands, checkHealth, contactRepo, conversationTracker, directMessage, dispose, _FakeBridge (+21 more)
...
Cohesion: 0.07
Nodes (26): _activeDepth, _activeDepthListenable, begin, end, GroupRecoveryGate, groupRecoveryPendingError, isActive, isGroupRecoveryInProgress (+18 more)
...
Cohesion: 0.07
Nodes (27): bridge, checkHealth, dispose, eventNames, flowEvents, initialize, isInitialized, lastParsedRequest (+19 more)
...
Cohesion: 0.07
Nodes (27): delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce, group, _message (+19 more)
...
Cohesion: 0.07
Nodes (27): bridge, _confirmationValueForState, contactRepo, dispose, emitIntroStatusChanged, finish, introduction, IntroductionMessageProcessOutcome (+19 more)
...
Cohesion: 0.07
Nodes (27): buildWidget, _contact, contactRepository, createdAt, _delivery, _didInterleave, iconIndex, identityRepository (+19 more)
...
Cohesion: 0.07
Nodes (26): alice, aliceDevice, aliceLog, args, bob, bobDevice, bobLog, _detectBootedSimulators (+18 more)
...
Cohesion: 0.08
Nodes (24): canonicalPayload, deletePendingInvite, envelopeJson, invite, payload, revokedAt, revokePendingGroupInvite, RevokePendingGroupInviteResult (+16 more)
...
Cohesion: 0.04
Nodes (42): channel, log, main, GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync (+34 more)
...
Cohesion: 0.08
Nodes (22): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, gMsg, groupItem, main, _msg, _thread (+14 more)
...
Cohesion: 0.08
Nodes (24): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+16 more)
...
Cohesion: 0.01
Nodes (165): bobContact, bridge, declinedByPeerId, deliveryRepo, envelope, groupId, inviteId, main (+157 more)
...
Cohesion: 0.08
Nodes (23): bridge, createdAt, delay, _deviceBoundGroupConfig, _FailEncryptBridge, groupId, groupKey, keyEpoch (+15 more)
...
Cohesion: 0.08
Nodes (22): groupMediaPerTypeLimitBytes, GroupMediaSizePolicy, kGroupMediaAudioLimitBytes, kGroupMediaFileLimitBytes, kGroupMediaImageLimitBytes, kGroupMediaPerAttachmentLimitBytes, kGroupMediaTotalMessageLimitBytes, kGroupMediaVideoLimitBytes (+14 more)
...
Cohesion: 0.09
Nodes (21): main, package:fake_async/fake_async.dart, package:flutter_app/core/services/active_peer_keepalive_use_case.dart, package:flutter_app/features/groups/application/group_pending_key_repair_backoff_timer.dart, activePeer, build, drains, events (+13 more)
...
Cohesion: 0.09
Nodes (22): BuildContext, BackgroundReadableColorsContext, blurLetter, blurNav, borderSoft, canvas, copyWith, dark (+14 more)
...
Cohesion: 0.09
Nodes (20): DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream, dispose, getLocalPeer, isAdvertiseBroadcastGated, isLocalPeer, _peersController (+12 more)
...
Cohesion: 0.13
Nodes (11): BackgroundTimeouts(), InteractiveTimeouts(), RelayAddress(), TestForegroundRelayProbeIsNotRequiredForActiveSendPath(), TestInteractiveAndBackgroundTimeoutProfilesRemainDistinct(), NodeConfig, NodeState, TestOutboundStreams_ApplyDeadlineAcrossChatInboxRendezvousGroupInboxAndMedia() (+3 more)
...
Cohesion: 0.09
Nodes (21): _clearDropSignalIfAny, _consecutiveMisses, dispose, _dropHandled, _interval, isProbeActive, kKeepAliveInterval, kKeepAliveMissThreshold (+13 more)
...
Cohesion: 0.23
Nodes (19): startLocalRelayPairWithRegistrationTTL(), startNodeWithRelayConfig(), startNodeWithRelays(), startPersonalNodeWithExplicitInitialRegister(), startPersonalNodeWithExplicitInitialRegisterAndFlags(), TestPersonalNamespaceRecovery_ReRegistersAfterInPlaceRefresh(), TestPersonalNamespaceRefresh_AutoRegisterMakesNodeDiscoverableAfterCircuitReady(), TestPersonalNamespaceRefresh_KeepsDiscoverablePastShortTTL() (+11 more)
...
Cohesion: 0.12
Nodes (15): main, _attachment, main, consume, main, mark, notificationService, showLive (+7 more)
...
Cohesion: 0.11
Nodes (17): allSameType, backgroundDuplicateGuardDelay, ConsumeRecentRemoteNotificationAnnouncement, conversationKey, firstType, isViewingConversation, lifecycleState, MarkRecentRemoteNotificationAnnouncement (+9 more)
...
Cohesion: 0.11
Nodes (16): assertNotInsideDbWriteTransaction, body, BridgeCallInsideDbTransactionError, commandPreview, _dbWriteTxnZoneKey, main, isInsideDbWriteTransaction, runZoned (+8 more)
...
Cohesion: 0.23
Nodes (8): Int, LogPushPreviewEventEmitter, NotificationPreviewResolver, NotificationPreviewResult, PushPreviewEventEmitting, pushPreviewEventKind(), PushSharedKeyNames, Bool
...
Cohesion: 0.32
Nodes (13): bridgePlaintext(), BridgePushDecryptor, capPreview(), decodeJSONObject(), groupSystemPreviewBody(), groupUserPreviewBody(), jsonString(), KeychainPushKeyReader (+5 more)
...
Cohesion: 0.13
Nodes (12): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, main, value, write (+4 more)

### Community 633 - "Community 633"
Cohesion: 0.15
Nodes (14): _friend, _group, isBlocked, main, unreadCount, OrbitFriend, OrbitGroup, friend (+6 more)
...
Cohesion: 0.21
Nodes (15): ChatMessageListener, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, MyApp, _MyAppState, _FakeIncomingConversationListener (+7 more)
...
Cohesion: 0.31
Nodes (7): Any, AnyHashable, AppGroupPushDedupeStore, PushDedupeStoring, RecentRemoteShownMarkerStore, PushRouteData, URL
...
Cohesion: 0.07
Nodes (26): action, bridge, _callIndex, captureFlowEvents, deliveryStatus, _failCount, _FailFirstNInboxBridge, inboxStored (+18 more)
...
Cohesion: 0.18
Nodes (9): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, main, validHash, package:flutter_app/core/constants/retry_constants.dart (+1 more)

### Community 723 - "Community 723"
Cohesion: 0.18
Nodes (10): _CapturedFlowEvent, _captureFlowEvents, details, event, events, main, originalDebugPrint, previousLogging (+2 more)

### Community 724 - "Community 724"
Cohesion: 0.18
Nodes (10): contact, ContactRequestNotificationTarget, ContactRequestNotificationTargetState, conversation, missing, pendingRequest, request, resolveContactRequestNotificationTarget (+2 more)
...
Cohesion: 0.20
Nodes (9): emitRetryTiming, limit, messages, reactionEntries, remainingReactionSlots, retriedCount, retryFailedGroupInboxStores, retryStopwatch (+1 more)
...
Cohesion: 0.40
Nodes (4): _aliceTimeline, _bobTimeline, main, ../../integration_test/scripts/routing_smoke_group_criteria.dart
...
Cohesion: 0.09
Nodes (21): aliceBridge, aliceMediaRepo, _alicePeerId, basePath, bobBridge, bobContacts, bobFileManager, bobMediaRepo (+13 more)
...
Cohesion: 0.22
Nodes (9): GroupMessageListener, _FakeGroupMessageListener, _ControlledGroupMessageListener, FakeGroupMessageListener, FakeGroupMessageListener, _FakeGroupMessageListener, FakeGroupMessageListener, _FakeGroupMessageListener (+1 more)

### Community 936 - "Community 936"
Cohesion: 0.25
Nodes (6): package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, package:flutter_app/features/identity/presentation/widgets/choice_card.dart, main, wrap, main, wrap

### Community 937 - "Community 937"
Cohesion: 0.47
Nodes (4): PeerPing(), TestPeerPing_InvalidJSON(), TestPeerPing_MissingPeerId(), TestPeerPing_NodeNotInitialized()
...
## Knowledge Gaps
- **34657 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+34652 more)
...
- **Why does `incomingMessage` connect `Community 646` to `Community 595`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 324` to `Community 595`, `Community 261`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 62` to `Community 261`, `Community 265`, `Community 399`, `Community 146`, `Community 25`, `Community 287`, `Community 31`, `Community 162`, `Community 164`, `Community 38`, `Community 938`, `Community 42`, `Community 561`, `Community 307`, `Community 563`, `Community 313`, `Community 189`, `Community 446`, `Community 573`, `Community 450`, `Community 835`, `Community 74`, `Community 843`, `Community 589`, `Community 337`, `Community 100`, `Community 231`, `Community 616`, `Community 745`, `Community 371`, `Community 636`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _34657 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.005066425120772947 - nodes in this community are weakly interconnected._