...
## Summary
- 41830 nodes · 65085 edges · 888 communities (844 shown, 44 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2408 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16941e0b`
...
## Communities (888 total, 44 thin omitted)
...
Cohesion: 0.01
Nodes (375): AnimatedOpacity, main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames, events (+367 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (325): AlertDialog, Align, AnimatedContainer, showGroupMissingNotificationFeedback, CircularProgressIndicator, ClipRRect, Column, ConstrainedBox (+317 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (310): IconData, Key, SmokeTestApp, _SmokeTestApp, SmokeTestResultApp, MemberRole, AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock (+302 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (239): bridge, contactRepo, identityRepo, main, p2pService, retrier, bridge, contactRepo (+231 more)
...
Cohesion: 0.01
Nodes (246): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, blurb, build, _connector, ../../application/orbit3_archetype_data.dart (+238 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (242): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+234 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (242): bridge, buildMigrationQRData, buildValidQRData, contactRepo, identityRepo, main, ownPeerId, p2pService (+234 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (264): EncryptedMediaTestBridge, RelayMediaStore, InMemoryPostRepository, ImagePicker, bridge, _createdAt, encTempsUnder, imageProcessor (+256 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (224): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+216 more)
...
Cohesion: 0.01
Nodes (178): logOnlyToken, main, mainPath, nsePath, readSource, routerPath, senderToken, main (+170 more)
...
Cohesion: 0.01
Nodes (189): accountKey, admit, drainSpy, groupId, main, member, memberPeerId, reopenSpy (+181 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (193): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+185 more)
...
Cohesion: 0.03
Nodes (175): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation() (+167 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (185): CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+177 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (187): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+179 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (175): mapChatReplayOutcomeToDisposition, main, map, conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart (+167 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (186): AccountMigrationProductionBundleSource, failureEvent, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, ChatMessageListener, GroupMembershipUpdateListener, GroupMessageListener, GroupKeyRepairRequest (+178 more)

### Community 28 - "Community 28"
Cohesion: 0.01
Nodes (168): AnimatedBuilder, Animation, CustomPaint, dart:ui, package:flutter_app/core/theme/glassmorphism.dart, package:flutter_app/features/contact_profile/presentation/screens/contact_profile_screen.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, package:flutter_app/features/home/presentation/widgets/scan_friend_card.dart (+160 more)
...
Cohesion: 0.01
Nodes (156): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+148 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (154): GroupMessagePayload, builtGroupMessageEnvelope, normalizeGroupInboxRecipientPeerIds(), groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult (+146 more)
...
Cohesion: 0.02
Nodes (143): alice, bob, main, network, _originalText, FakeP2PNetwork, aliceService, _contact (+135 more)
...
Cohesion: 0.01
Nodes (142): _InstrumentedGroupMessageRepository, _InstrumentedGroupMessageRepository, _ContendedGroupMessageRepository, _LiveReplayRaceGroupMessageRepository, actorPeerId, bridge, groupId, groupRepo (+134 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (121): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+113 more)
...
Cohesion: 0.01
Nodes (155): client, lastCall, main, GoBridgeClient, GroupDiagnosticEvent, GroupMembershipUpdateListener, db, distributionRow (+147 more)
...
Cohesion: 0.02
Nodes (131): _incoming, main, isDeleted, isIncoming, main, _msg, package:flutter_app/core/theme/app_theme.dart, package:flutter_app/core/theme/feed_tokens.dart (+123 more)

### Community 47 - "Community 47"
Cohesion: 0.01
Nodes (162): db, main, db, main, makeMemberRow, db, main, makeGroupRow (+154 more)
...
Cohesion: 0.01
Nodes (130): archiveContact, bridge, contactRepo, declinedAtUtc, declinePendingGroupInvite, DeclinePendingGroupInviteResult, declinerPeerId, declinerPrivateKey (+122 more)
...
Cohesion: 0.02
Nodes (124): acceptDevice, acceptFor, addPage, attempts, bobMessageCount, charlieDeviceSet, charlieIncomingWith, charlieMember (+116 more)
...
Cohesion: 0.02
Nodes (118): _CursorInboxBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole, bridge (+110 more)
...
Cohesion: 0.01
Nodes (193): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, appWith, chatScreen, edgeDrag, logicalSize (+185 more)

### Community 64 - "Community 64"
Cohesion: 0.02
Nodes (106): @pragma, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey, _backgroundNotificationsInitialized (+98 more)
...
Cohesion: 0.02
Nodes (104): benchmark_helpers.dart, ../../features/conversation/integration/two_user_message_exchange_test.dart, runOneToOneSendBenchmark, runAckBenchmark, details, events, _findRecoveredOutage, firstEventDetails (+96 more)
...
Cohesion: 0.02
Nodes (100): GroupOfflineReplaySignatureException, bridge, expectRejectedBeforeDecrypt, groupRepo, main, bridge, groupRepo, groups (+92 more)
...
Cohesion: 0.02
Nodes (93): AccountMigrationNetworkGate, deleteGroupAndMessages, deleteLocallyIfDissolved, byMessage, loadLatestMediaDescriptors, repo, result, loadReactionsForConversation (+85 more)
...
Cohesion: 0.02
Nodes (91): _InstrumentedBridge, _DelayRevocationDecryptBridge, append, bridge, controller, _DelayedUpdateKeyBridge, entries, errorCode (+83 more)
...
Cohesion: 0.04
Nodes (92): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+84 more)
...
Cohesion: 0.01
Nodes (257): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+249 more)
...
Cohesion: 0.02
Nodes (84): adminPeerId, adminTransport, bridge, buildSender, groupId, groupRepo, main, requesterDeviceId (+76 more)

### Community 102 - "Community 102"
Cohesion: 0.03
Nodes (63): addContact, author, condition, contactRepo, create, deadline, dispose, main (+55 more)
...
Cohesion: 0.02
Nodes (89): main, package:flutter_app/features/conversation/presentation/navigation/conversation_route_transition.dart, package:flutter_app/features/posts/presentation/widgets/pass_post_along_sheet.dart, accountMigrationRunTransfer, accountMigrationSizeGate, activeTab, appShellController, audioRecorderService (+81 more)
...
Cohesion: 0.02
Nodes (80): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, package:flutter_app/features/identity/presentation/widgets/choice_card.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, backgroundPreference, build (+72 more)
...
Cohesion: 0.02
Nodes (83): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie (+75 more)

### Community 112 - "Community 112"
Cohesion: 0.03
Nodes (86): DatabaseExecutor, main, db, main, makeKeyRow, db, insertOutgoing, main (+78 more)
...
Cohesion: 0.02
Nodes (76): allowedPeers, groupMediaAllowedPeersForMembers, seen, actor, buildGroupDissolvedTimelineMessage, buildGroupDissolvedTimelineText, buildGroupMetadataUpdatedTimelineMessage, buildGroupMetadataUpdatedTimelineText (+68 more)

### Community 122 - "Community 122"
Cohesion: 0.02
Nodes (86): Color, LanAvailabilitySnapshot, accentColor, availableFriends, build, friend, _FriendPickerRow, FriendPickerScreen (+78 more)
...
Cohesion: 0.02
Nodes (89): appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn, _enqueueMessage (+81 more)

### Community 126 - "Community 126"
Cohesion: 0.03
Nodes (77): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents, accountMigrationRunTransfer (+69 more)
...
Cohesion: 0.03
Nodes (73): clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository, markCleared, feed_cleared_repository.dart, FeedClearedRepository (+65 more)
...
Cohesion: 0.03
Nodes (72): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+64 more)
...
Cohesion: 0.04
Nodes (62): authorPeerId, authorUsername, main, _post, posts, senderPeerId, authorPeerId, authorUsername (+54 more)
...
Cohesion: 0.03
Nodes (68): avatarByIndex, enterManage, innerMembers, innerWorkKey, main, manageToggle, openMessages, r (+60 more)
...
Cohesion: 0.03
Nodes (69): appendGroupEventLogEntry, _appendSignedCreateEvent, canonicalPayload, createGroup, deleteGroup, group, groupId, groupKey (+61 more)

### Community 144 - "Community 144"
Cohesion: 0.03
Nodes (68): addPage, bridge, buildSignedReplay, _Clock, contains, endedAt, getGroup, getKeyByGeneration (+60 more)
...
Cohesion: 0.03
Nodes (70): AccountMigrationSizeGate, FakeIntroductionRepository, FakeReactionRepository, AudioRecorderService, GroupInviteListener, _SimGroupInviteListener, _HarnessReactionRepository, IntroductionRepository (+62 more)

### Community 147 - "Community 147"
Cohesion: 0.03
Nodes (67): main, buildIdentity, main, tempDir, main, package:flutter_app/features/home/application/identity_avatar_resolver.dart, package:flutter_app/features/settings/application/background_preference_use_cases.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart (+59 more)
...
Cohesion: 0.03
Nodes (62): contactRepo, main, messageRepo, mutualIntro, byId, expireOldIntroductions, introducedRows, _loadMutualAcceptedIntroductions (+54 more)

### Community 154 - "Community 154"
Cohesion: 0.03
Nodes (67): main, actorPayload, actorPeerId, actorPublicKey, actorUsername, _aliceContact, _bobIdentity, bridge (+59 more)
...
Cohesion: 0.03
Nodes (66): captureFlowEvents, _FailFirstPublishBridge, _Gfr001GatedPublishBridge, id, main, _makeAttachment, _makeFailedGroupMessage, _makeGroup (+58 more)
...
Cohesion: 0.03
Nodes (67): bytesToWrite, captureCipherMetadata, commands, _createSeededAccountDb, execute, exportDestinationKey, exportDestinationPath, exportSqlCipherDatabase (+59 more)
...
Cohesion: 0.03
Nodes (60): main, dart:async, fake_group_pubsub_network.dart, fake_group_reaction_replay_outbox_repository.dart, deliveries, _Go012Run, main, publishBatch (+52 more)
...
Cohesion: 0.03
Nodes (59): _cleanDisplayName, groupPeerFallbackLabel, memberName, preferMemberName, resolveGroupSenderDisplayName, sanitized, senderPeerId, shortPeerId (+51 more)
...
Cohesion: 0.03
Nodes (57): groupInviteDeliveryErrorForSendResult, groupInviteDeliveryStatusForSendResult, recordGroupInviteDeliveryBatch, recordMissingGroupKeyInviteDeliveryAttempts, recordPendingGroupInviteFanoutAttempts, repo, timestamp, bridge (+49 more)
...
Cohesion: 0.04
Nodes (54): contactRepo, main, requestRepo, testRequest, acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer (+46 more)

### Community 194 - "Community 194"
Cohesion: 0.03
Nodes (57): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage (+49 more)

### Community 195 - "Community 195"
Cohesion: 0.03
Nodes (52): AdmitSiblingDeviceFn, admitSiblingDeviceIfTrusted, alreadyPresent, deviceId, EnqueueDeferredGroupKeyDistributionFn, existingById, existingByTransport, latestKey (+44 more)
...
Cohesion: 0.04
Nodes (52): fake_local_discovery_service.dart, HttpServer, ../local_discovery/fake_local_discovery_service.dart, accepted, committed, isAccepted, isCommitted, isRejected (+44 more)

### Community 198 - "Community 198"
Cohesion: 0.04
Nodes (55): avatarBase64, avatarBlob, candidate, contactRepo, current, currentLocalPassCount, currentLocalSharedToCount, currentPassRecipientCount (+47 more)

### Community 199 - "Community 199"
Cohesion: 0.04
Nodes (53): contactRepo, dispose, incomingPresenceStream, _onMessage, PostPresenceListener, postPresenceStream, _presenceController, snapshotRepo (+45 more)

### Community 200 - "Community 200"
Cohesion: 0.04
Nodes (49): addContact, AddContactResult, blockContact, addContact, archiveContact, blockContact, blockedPeerIds, contactExists (+41 more)
...
Cohesion: 0.04
Nodes (54): accuracyM, _availabilityForSettings, canOpenSettings, capturedAt, checkPermissionState, GeolocatorNearbyLocationPlatformAdapter, getCurrentPosition, handleSharingDisabled (+46 more)
...
Cohesion: 0.04
Nodes (49): handleShareIntent, ShareIntentRouteBuilder, build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt (+41 more)
...
Cohesion: 0.04
Nodes (50): dismissedAt, dismissPin, savePinDismissal, comments, loadPostComments, wait, avatarSnapshots, hydratePostSurfaceItems (+42 more)

### Community 212 - "Community 212"
Cohesion: 0.04
Nodes (51): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+43 more)
...
Cohesion: 0.04
Nodes (48): main, member, absolutePath, age, doneCount, emitRetryTiming, _isFreshOutgoingGroupSend, kFreshGroupUploadRetrySendingThreshold (+40 more)

### Community 234 - "Community 234"
Cohesion: 0.04
Nodes (44): DrainGroupOfflineInboxForGroupFn, DrainOfflineInboxFn, _emitMissingGroupId, _emitUnroutable, ForegroundRemoteMessageResult, handleForegroundRemoteMessage, routeTarget, DrainGroupOfflineInboxForGroupFn (+36 more)
...
Cohesion: 0.04
Nodes (49): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _AuditBridge (+41 more)

### Community 239 - "Community 239"
Cohesion: 0.04
Nodes (49): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepo, FakeContactRepository (+41 more)
...
Cohesion: 0.03
Nodes (77): _absoluteForRelativePath, acceptSizeDivergence, _addBestPathFailureIssue, addCandidate, _addChatMedia, _addPathBackedItem, _addPathCandidateIfUsable, _addPendingPostMedia (+69 more)
...
Cohesion: 0.02
Nodes (87): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, package:flutter_app/core/theme/feed_colors.dart, swipe_action_buttons.dart, AppTheme, main (+79 more)
...
Cohesion: 0.04
Nodes (47): announcedDevice, bobAccountKey, bridge, feed, groupId, groupRepo, holdCalls, holdSpy (+39 more)
...
Cohesion: 0.04
Nodes (46): media_display_helpers.dart, attachment, borderRadius, build, _buildContent, _buildGifBadge, _buildLoadingPlaceholder, _buildOverlayCount (+38 more)
...
Cohesion: 0.04
Nodes (42): attachments, byMessageId, doneCount, emitRetryTiming, identity, _lateSendAbortReason, _latestAttachmentForMessage, pendingAttachments (+34 more)
...
Cohesion: 0.04
Nodes (43): compressed,, fromStorageString, ImageQualityPreference, original, storageKey, toStorageString, videoStorageKey, package:flutter_app/features/feed/domain/models/feed_route_changes.dart (+35 more)
...
Cohesion: 0.05
Nodes (41): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+33 more)
...
Cohesion: 0.03
Nodes (67): package:flutter_app/core/utils/text_direction_utils.dart, package:url_launcher/url_launcher.dart, TextOverflow, build, ContactRequestDialog, _ContactRequestDialogState, createState, _handleAccept (+59 more)
...
Cohesion: 0.05
Nodes (40): bridge, buildHost, buildMaterializer, contactRepository, identityRepository, main, _makeContact, _makeRequest (+32 more)
...
Cohesion: 0.05
Nodes (36): bridge, checkHealth, dispose, _FakeBridge, initialize, isInitialized, main, _otherPeerId (+28 more)
...
Cohesion: 0.05
Nodes (34): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, acquire, activeHolds, _channel (+26 more)

### Community 321 - "Community 321"
Cohesion: 0.05
Nodes (35): _attachMedia, ids, loadConversation, loadConversationPage, mediaAttachmentRepo, mediaFileManager, mediaMap, messages (+27 more)
...
Cohesion: 0.05
Nodes (37): package:flutter_app/core/config/forward_rotate_on_add_flag.dart, _availableContacts, backgroundPreference, bridge, build, buildCompletionMessage, _buildInviteErrorMessage, cancelled (+29 more)
...
Cohesion: 0.05
Nodes (36): rejected, LocalMediaReady, acceptOffer, add, allowedMimePrefixes, _artifactExtension, _cleanupExpired, cleanupMedia (+28 more)
...
Cohesion: 0.03
Nodes (62): Alignment, nav_bar_button.dart, nav_bar_theme.dart, main, suppressAssetErrors, wrap, package:flutter_app/features/feed/presentation/widgets/feed_navigation_bar.dart, package:flutter_app/features/feed/presentation/widgets/feed_swipe_card.dart (+54 more)
...
Cohesion: 0.06
Nodes (32): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, contact_request_repository.dart, ContactRequestRepository, addRequest, count, deleteRequest (+24 more)

### Community 363 - "Community 363"
Cohesion: 0.06
Nodes (33): _contact, contactPeerId, contactRepo, createdAt, _group, groupId, _groupMessage, groupMessageRepo (+25 more)
...
Cohesion: 0.06
Nodes (31): package:flutter_app/core/permissions/mic_permission_gateway.dart, package:flutter_app/core/permissions/mic_permission_prompt.dart, package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, showMicPermissionDeniedPrompt, main, openPrompt, ConversationScreen, _ConversationScreenState (+23 more)
...
Cohesion: 0.03
Nodes (74): _contact, contacts, _ControlledP2PService, _dialedPeers, dialPeer, discoverPeer, dispose, _inFlightSends (+66 more)
...
Cohesion: 0.06
Nodes (29): contact, contactKey, group, groupKey, key, kind, label, requireContact (+21 more)
...
Cohesion: 0.06
Nodes (29): main, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/mnemonic_input_wired.dart, backgroundPreference, build, contactRepo, createState, dispose (+21 more)
...
Cohesion: 0.06
Nodes (29): DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream, dispose, getLocalPeer, isLocalPeer, _peersController, resolvePeer (+21 more)
...
Cohesion: 0.07
Nodes (25): main, events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness (+17 more)
...
Cohesion: 0.07
Nodes (26): captured, eventsNamed, line, main, thread, applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems (+18 more)
...
Cohesion: 0.07
Nodes (26): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, value, write, main (+18 more)
...
Cohesion: 0.07
Nodes (27): media_attachment.dart, ContactModel, count, fromAttachments, isGif, isMixed, MediaPreviewDescriptor, type (+19 more)
...
Cohesion: 0.08
Nodes (24): Image, main, wrap, package:flutter_app/features/home/presentation/widgets/profile_avatar_widget.dart, package:flutter_app/shared/widgets/media/full_screen_image_viewer.dart, ResizeImage, _audioMedia, build (+16 more)
...
Cohesion: 0.07
Nodes (25): package:clock/clock.dart, bridge, checkHealth, dispose, _FakeBridge, initialize, isInitialized, main (+17 more)
...
Cohesion: 0.08
Nodes (24): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, avatar, computeOrbit3ArchArcs, computeOrbit3ArcRow (+16 more)
...
Cohesion: 0.05
Nodes (38): _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _TrackingInviteDeliveryAttemptRepository, attemptCount, empty, PendingGroupInviteMetadataRefreshResult, refreshedAny, refreshedCount (+30 more)
...
Cohesion: 0.08
Nodes (23): countQuarantinedEntries, deleteEntry, _entries, entry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, markQuarantined (+15 more)
...
Cohesion: 0.10
Nodes (18): _attachment, main, consume, main, mark, notificationService, showLive, tracker (+10 more)
...
Cohesion: 0.09
Nodes (21): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, _FakeMediaAttachmentRepository, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+13 more)
...
Cohesion: 0.10
Nodes (20): addPage, _fixedDateFixtureRetentionNow, getLatestRepairForGroup, getRepair, getVisibleRepairsForGroup, _historyGaps, inboxRetrieveCount, _key (+12 more)
...
Cohesion: 0.11
Nodes (17): contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult, incomingTime (+9 more)
...
Cohesion: 0.12
Nodes (15): _MemorySecureKeyStore, _TrackingSecureKeyStore, _FakeSecureKeyStore, _InMemorySecureKeyStore, _FakeSecureKeyStore, _FakeSecureKeyStore, _FakeSecureKeyStore, CountingSecureKeyStore (+7 more)
...
- **Why does `incomingMessage` connect `Community 27` to `Community 586`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 325` to `Community 586`, `Community 543`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 543` to `Community 96`, `Community 325`, `Community 318`?**
