# Graph Report - graphify-arch  (2026-06-18)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 40141 nodes · 62674 edges · 871 communities (826 shown, 45 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2399 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd516bb9`
...
## Communities (871 total, 45 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (1938): 0, acceptedGroup, acceptedGroupAvatarBlobId, acceptedGroupMetadataFresh, acceptedRecipientPeerId, _acceptPromptPendingInvite, _acceptRa013DeviceInvite, acceptResult (+1930 more)

### Community 1 - "Community 1"
Cohesion: 0.00
Nodes (682): activeAvatarHashes, activeMemberPeerIds, activePeerIds, activeStateHashes, actual, actualPeerIds, adminPeerIds, afterCount (+674 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (323): AlertDialog, AnimatedContainer, showGroupMissingNotificationFeedback, CircularProgressIndicator, Column, Container, Directionality, ElevatedButton (+315 more)
...
Cohesion: 0.01
Nodes (200): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+192 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (291): main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames, events, main (+283 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (247): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, main, makeAttachment, makeMessage, mediaAttachmentRepo (+239 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (262): contactRepo, main, requestRepo, testRequest, bridge, buildHost, buildMaterializer, contactRepository (+254 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (238): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+230 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (224): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+216 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (172): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, ClipRRect, main, msg, _textWidget, wrap (+164 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (241): absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub, _applyMessageUpdate (+233 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (204): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+196 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (160): dbDeleteExpiredGroupInviteRevocations, dbLoadGroupInviteRevocation, dbUpsertGroupInviteRevocation, inviteId, dbDeleteExpiredGroupWelcomeKeyPackageTombstones, dbLoadGroupWelcomeKeyPackageTombstone, dbUpsertGroupWelcomeKeyPackageTombstone, packageId (+152 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (226): _ActiveAttachmentUpload, _ComposerSnapshot, conversation_screen.dart, _DeleteMessageAction, DeleteMessageForMeFn, EditChatMessageFn, PrepareEncryptedMediaArtifactFn, absoluteDurablePath (+218 more)
...
Cohesion: 0.01
Nodes (251): IconData, MemberRole, PostModel, package:flutter_app/features/groups/presentation/widgets/pending_group_invite_card.dart, AccountMigrationJourneyScreen, actionLabel, active, backgroundPreference (+243 more)
...
Cohesion: 0.01
Nodes (198): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, DeliveryReceiptListener, dispose, messageRepo, receiptStream, start (+190 more)

### Community 19 - "Community 19"
Cohesion: 0.01
Nodes (208): DeleteMessageForEveryoneFn, feed_screen.dart, FeedStore, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate, _activeFocusPeerId, _activeQuoteMessageIds (+200 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (195): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), disableGroupInboxRecoveryForFakeRelayTest(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50() (+187 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (197): main, ContactRequestNotificationMaterializer, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main, row (+189 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (103): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, Stopwatch, AppTheme, BackgroundReadableColors, blurSigma, borderRadius (+95 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (221): accountKey, admit, drainSpy, groupId, main, member, memberPeerId, reopenSpy (+213 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (221): main, benchmark_harness.dart, BenchmarkHarness, alice, bob, main, network, _originalText (+213 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (178): _CursorInboxBridge, _FailDecryptBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole (+170 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (248): Animation, Curve, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, _ConversationPerfHost, _ConversationPerfHostState, _ConversationHost, _ConversationHostState (+240 more)

### Community 27 - "Community 27"
Cohesion: 0.01
Nodes (181): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+173 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (147): bytesToWrite, captureCipherMetadata, commands, _createSeededAccountDb, execute, exportDestinationKey, exportDestinationPath, exportSqlCipherDatabase (+139 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (173): orbit_screen.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate, _activeFriends (+165 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (132): GroupMessagePayload, builtGroupMessageEnvelope, normalizeGroupInboxRecipientPeerIds(), groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult (+124 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (141): Alignment, buildTestApp, main, setPhoneViewport, chatGroup, conversationApp, fortyMessages, localAfternoon (+133 more)

### Community 32 - "Community 32"
Cohesion: 0.01
Nodes (164): _acceptedSignedTransitionAuditHashesBySourceId, _accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _allowsSnapshotBackedSystemSender, _appendGroupEventLogEntry, appendSystemEventLog, _applyAuthoritativeGroupConfigSnapshot, _autoDownloadMedia (+156 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (150): BuildGroupSignatureData(), ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), assertGK019DirectJumpKeyInfo() (+142 more)
...
Cohesion: 0.02
Nodes (94): deliveredWritePatterns, main, scanDeliveredWrites, AspectRatio, BoxFit, File, FileImage, IconButton (+86 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (142): AnnotatedRegion, main, BackgroundPreference, BoxDecoration, CustomPaint, DecoratedBox, activeFocusPeerId, activeQuoteMessageIds (+134 more)
...
Cohesion: 0.02
Nodes (134): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, FakeIntroductionRepository, GenerateIdentityResult, generateNewIdentity, identity, identityJson (+126 more)

### Community 41 - "Community 41"
Cohesion: 0.01
Nodes (141): GoBridgeClient, GroupDiagnosticEvent, GroupMembershipUpdateListener, bridge, bridgeExchanges, _buildCliJoinFixture, buildGroupFixture, buildMemberRoleUpdatedSystemPayload (+133 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (121): db, main, db, main, makeKeyRow, db, main, makeMemberRow (+113 more)

### Community 43 - "Community 43"
Cohesion: 0.02
Nodes (126): package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/conversation/presentation/widgets/voice_record_button.dart, amplitudeValues, build, _buildReviewActions, _buildReviewPreview, _canRecordVoice, _controller (+118 more)
...
Cohesion: 0.02
Nodes (124): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+116 more)

### Community 47 - "Community 47"
Cohesion: 0.02
Nodes (131): FakeReactionRepository, AudioRecorderService, compressed,, FakeGroupReactionReplayOutboxRepository, GroupMessageListener, GroupMessageRepository, GroupReactionReplayOutboxRepository, _FakeGroupMessageListener (+123 more)
...
Cohesion: 0.02
Nodes (94): CustomPainter, dart:math, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build, _minBarHeight (+86 more)
...
Cohesion: 0.02
Nodes (121): AccountMigrationReceiverEvents, AccountMigrationSizeGate, AccountMigrationMoveSizeEstimate, calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath (+113 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (114): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+106 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (115): fake_local_discovery_service.dart, HttpServer, main, peerA, peerB, ../local_discovery/fake_local_discovery_service.dart, addLocalPeer, configureInboundChatCommitHandler (+107 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (115): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, contacts, kMlKemReannouncePendingKey, peerIds (+107 more)
...
Cohesion: 0.02
Nodes (102): NearbyDevicePosition, addContact, author, bridge, _contact, contactRepo, create, deadline (+94 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (121): _DownloadWritingBridge, FakeMediaPicker, _FailingDownloadBridge, _FailOncePartialDownloadBridge, _activeDevice, addContact, _attachImageFromLibrary, base64Decode (+113 more)
...
Cohesion: 0.02
Nodes (112): addContact, author, comment, commentListener, condition, _contact, contactRepo, _ControlledP2PService (+104 more)
...
Cohesion: 0.01
Nodes (165): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _RealisticKemSizedStreamCrypto, _MigrationPostException, _DeterministicSegmentCrypto, _DeletionWireEnvelopeEncryptFailed, GroupOfflineReplaySignatureException, _cache (+157 more)
...
Cohesion: 0.02
Nodes (111): contactRepo, dispose, incomingPresenceStream, _onMessage, PostPresenceListener, postPresenceStream, _presenceController, snapshotRepo (+103 more)

### Community 71 - "Community 71"
Cohesion: 0.02
Nodes (111): package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/features/conversation/presentation/widgets/date_separator.dart, activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername (+103 more)
...
Cohesion: 0.03
Nodes (70): AppLocalizations, dart:ui, GestureDetector, LocalizationsDelegate, Opacity, package:flutter_app/features/feed/presentation/widgets/expanded_compose_input.dart, package:flutter_app/features/feed/presentation/widgets/inline_reply_input.dart, package:flutter_app/features/identity/presentation/screens/mnemonic_input_screen.dart (+62 more)

### Community 74 - "Community 74"
Cohesion: 0.02
Nodes (98): EncryptedMediaTestBridge, RelayMediaStore, bridge, _createdAt, encTempsUnder, imageProcessor, main, mediaFileManager (+90 more)

### Community 75 - "Community 75"
Cohesion: 0.02
Nodes (107): _InMemoryGroupPendingKeyRepairRepository, failureEvent, _InMemoryGroupPendingKeyRepairRepository, GroupMembershipUpdateListener, GroupMessageListener, bridge, buildSignedGroupKeyRepairRequestEnvelope, call (+99 more)

### Community 76 - "Community 76"
Cohesion: 0.02
Nodes (88): expectDbAndLatestConfig, expectDbMembers, joinedAt, main, _member, _payloadsFor, peerId, username (+80 more)
...
Cohesion: 0.02
Nodes (96): Color, amplitudeValues, build, elapsed, _formatDuration, onCancel, RecordingOverlay, ContactModel (+88 more)
...
Cohesion: 0.02
Nodes (105): MapEntry, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge, _broadcastSelfRemovalIfNeeded, build, _buildGroupConfig (+97 more)

### Community 82 - "Community 82"
Cohesion: 0.02
Nodes (92): AccountMigrationNetworkGate, deleteGroupAndMessages, deleteLocallyIfDissolved, contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId (+84 more)
...
Cohesion: 0.02
Nodes (131): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+123 more)

### Community 86 - "Community 86"
Cohesion: 0.02
Nodes (101): CountingGroupMessageRepository, DateSeparator, main, package:flutter_app/core/media/video_process_result.dart, _attempts, buildRecordingWidget, buildWidget, copyCalls (+93 more)
...
Cohesion: 0.02
Nodes (89): dismissedAt, dismissPin, savePinDismissal, activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager (+81 more)

### Community 94 - "Community 94"
Cohesion: 0.02
Nodes (90): _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiStagedDatabaseOpener, computeDatabaseChecksumForTesting, database, DefaultMigrationStagedDatabaseOpener, manifest, message (+82 more)

### Community 95 - "Community 95"
Cohesion: 0.03
Nodes (61): _MemoryPairingSessionRepository, _MemoryPairingSessionRepository, SecureKeyStoreMigrationPairingSessionRepository, aad, acceptedSegmentIndexes, acceptManifest, acceptSegment, acceptTranscript (+53 more)

### Community 96 - "Community 96"
Cohesion: 0.02
Nodes (93): db, main, makeIntroductionRow, makeOutboxRow, makePendingResponseRow, addresses, attempts, bridge (+85 more)
...
Cohesion: 0.02
Nodes (88): PendingGroupInvite, PendingSiblingDevice, package:flutter_app/features/groups/domain/models/pending_sibling_device.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_member_row.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, package:flutter_app/features/groups/presentation/widgets/pending_sibling_device_prompt.dart, buildTestWidget (+80 more)
...
Cohesion: 0.02
Nodes (90): _EventRecorder, appShellController, backingSecureKeyStore, baseIdentityRepo, binding, bridge, buildApp, _callback (+82 more)

### Community 104 - "Community 104"
Cohesion: 0.04
Nodes (56): InMemoryPostRepository, _BlockingWritePostRepository, buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage, innerPayload (+48 more)
...
Cohesion: 0.02
Nodes (84): AppendGroupEventLogEntry, _acceptedSignedTransitionAuditHashesBySourceId, _appendGroupEventLogEntry, _bridge, dispose, _enqueueMessage, GroupKeyUpdateListener, _groupRepo (+76 more)
...
Cohesion: 0.02
Nodes (86): GroupInviteListener, _TrackingReactionListener, _TrackingReactionListener, _SimGroupInviteListener, JoinedGroup, ReactionChange, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart, PendingInvite (+78 more)
...
Cohesion: 0.03
Nodes (84): ChatMessageListener, build, createState, initState, main, _SettleHarness, _SettleHarnessState, shareIntentService (+76 more)
...
Cohesion: 0.05
Nodes (58): chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData(), addTrimmedData() (+50 more)

### Community 120 - "Community 120"
Cohesion: 0.02
Nodes (80): buildIdentity, main, tempDir, _changes, dispose, load, save, setSharingEnabled (+72 more)
...
Cohesion: 0.03
Nodes (78): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+70 more)

### Community 123 - "Community 123"
Cohesion: 0.03
Nodes (74): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, main, value, write (+66 more)

### Community 124 - "Community 124"
Cohesion: 0.03
Nodes (81): _attempts, bridge, _bridgeCommandIndex, captureFlowEvents, ciphertext, _decodedGroupInboxReplayPayload, delay, deleteAttempt (+73 more)

### Community 125 - "Community 125"
Cohesion: 0.03
Nodes (78): comments, loadPostComments, wait, package:flutter_app/features/posts/application/load_post_comments_use_case.dart, package:flutter_app/features/posts/domain/models/post_comment_model.dart, package:flutter_app/features/posts/domain/models/post_comment_reaction_model.dart, main, postRepo (+70 more)

### Community 126 - "Community 126"
Cohesion: 0.03
Nodes (68): db, insertOutgoing, main, row, assertOutgoingTransition, db, main, makeRow (+60 more)

### Community 127 - "Community 127"
Cohesion: 0.02
Nodes (81): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+73 more)

### Community 128 - "Community 128"
Cohesion: 0.03
Nodes (76): main, actorPayload, actorPeerId, actorPublicKey, actorUsername, _aliceContact, _bobIdentity, bridge (+68 more)
...
Cohesion: 0.03
Nodes (73): _aggregatePostPassFollowOnSettlement, deliveries, _deliverPostPassFollowOnRecipients, envelope, eventId, eventType, isPostPassFollowOnEventType, _loadPersistedPostPassFollowOnResult (+65 more)

### Community 132 - "Community 132"
Cohesion: 0.03
Nodes (73): attemptCount, empty, PendingGroupInviteMetadataRefreshResult, refreshedAny, refreshedCount, refreshPendingGroupInvitesForMetadataChange, repo, main (+65 more)

### Community 133 - "Community 133"
Cohesion: 0.03
Nodes (74): avatarPath, _contact, contactPeerId, contactRepo, _group, groupId, _groupMessage, groupMessageRepo (+66 more)
...
Cohesion: 0.03
Nodes (68): contactRepo, createdAt, introRepo, main, makeIntro, makeRequest, messageRepo, otherPeerId (+60 more)

### Community 142 - "Community 142"
Cohesion: 0.03
Nodes (69): captureFlowEvents, _FailFirstPublishBridge, _Gfr001GatedPublishBridge, id, main, _makeAttachment, _makeFailedGroupMessage, _makeGroup (+61 more)
...
Cohesion: 0.03
Nodes (70): group_multi_party_device_criteria.dart, activeProcessLabelByRole, args, contains, deviceCheck, devices, displayArgs, exitCode (+62 more)
...
Cohesion: 0.03
Nodes (66): package:flutter_app/features/groups/presentation/widgets/contact_picker_row.dart, package:flutter_app/features/groups/presentation/widgets/group_name_panel.dart, backgroundPreference, build, _buildConfirmButton, _buildContactList, _buildEmptyState, _buildHeader (+58 more)
...
Cohesion: 0.03
Nodes (79): advertisedPeerId, captureCipherMetadata, clearAuthority, clearCutover, consumed, consumeSession, _controller, createdAt (+71 more)
...
Cohesion: 0.03
Nodes (64): addContact, archiveContact, blockContact, contactExists, deleteContact, dismissIntroBanner, existsResult, _FakeContactRepository (+56 more)
...
Cohesion: 0.03
Nodes (61): group_message_local_deletions_db_helpers.dart, args, contains, dbClearGroupMessageRetryBackoff, dbCountGroupMessages, dbCountTotalUnreadGroupMessages, dbCountUnreadGroupMessages, dbDeleteGroupMessage (+53 more)
...
Cohesion: 0.03
Nodes (58): attemptCap, bridge, drainAllPending, _drainOne, drainPendingForGroup, drainPendingForPeer, existingDevices, groupMemberRegainedDeliverableKey (+50 more)
...
Cohesion: 0.03
Nodes (74): _TrackingContactRepository, archived, blocked, _contact, contacts, _FailAfterPostSaveRepository, lastSavedPostId, main (+66 more)
...
Cohesion: 0.04
Nodes (51): archiveGroup, candidate, canonicalMembershipEventId, current, gate, group, _groupMembershipMutationLocks, isStaleGroupMembershipEvent (+43 more)
...
Cohesion: 0.03
Nodes (57): DiscoveredPeer, _changes, dispose, load, loadAll, save, snapshotChanges, _snapshots (+49 more)

### Community 181 - "Community 181"
Cohesion: 0.09
Nodes (21): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+13 more)
...
Cohesion: 0.04
Nodes (56): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, main, peerDiscoveredAt, BonsoirBroadcastFactory, BonsoirDiscoveryFactory (+48 more)

### Community 185 - "Community 185"
Cohesion: 0.03
Nodes (58): _AliceConversationDeps, _AliceHarnessApp, at, bridge, build, chatListener, clearDeliveredNotifications, consumeInitialPayload (+50 more)

### Community 186 - "Community 186"
Cohesion: 0.03
Nodes (56): addPage, bridge, buildSignedReplay, _Clock, contains, endedAt, getGroup, getKeyByGeneration (+48 more)
...
Cohesion: 0.05
Nodes (49): main, map, DetailedInboxStore, LifecycleBridge, bridge, main, service, bridge (+41 more)

### Community 189 - "Community 189"
Cohesion: 0.04
Nodes (52): ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, FakeGroupPubSubNetwork, expectRotatedRemainingMember, main, network, pump, saveKey (+44 more)
...
Cohesion: 0.03
Nodes (58): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+50 more)
...
Cohesion: 0.05
Nodes (61): FileMode, backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), relayResourcesFromServerLimits(), TestRelayService_EnforcesPerPeerConnectionCap() (+53 more)

### Community 199 - "Community 199"
Cohesion: 0.10
Nodes (30): decodeGroupInboxEntries(), encodeRedisComponent(), encodeRedisGroupInboxRecord(), encodeRedisGroupInboxRecords(), filterInboxEntries(), minInt(), newRedisClientFromURL(), newRedisPushTokenBackend() (+22 more)
...
Cohesion: 0.04
Nodes (55): additionalCount, avatarCacheBustKey, avatarPath, canReact, canWrite, collapsedPreviewMessage, connectedVia, contactAvatarPath (+47 more)
...
Cohesion: 0.04
Nodes (42): allowedPeers, groupMediaAllowedPeersForMembers, seen, asGroupMemberDeviceSnapshotRepository, compare, multiDeviceSyncEnabled, resolveGroupMemberDeviceSafety, savedDevices (+34 more)
...
Cohesion: 0.05
Nodes (35): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+27 more)
...
Cohesion: 0.04
Nodes (44): package:flutter_app/features/feed/domain/utils/has_significant_time_gap.dart, package:flutter_app/features/feed/presentation/widgets/more_messages_hint.dart, package:flutter_app/features/feed/presentation/widgets/time_gap_divider.dart, package:flutter_app/features/feed/presentation/widgets/view_earlier_link.dart, ScrollBehavior, main, main, wrap (+36 more)
...
Cohesion: 0.05
Nodes (47): archiveGroup, _FailingGroupRepository, groupId, groupRepo, main, runAckBenchmark, bridge, cmListener (+39 more)
...
Cohesion: 0.05
Nodes (47): _FakePathProvider, _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake (+39 more)
...
Cohesion: 0.05
Nodes (40): main, member, package:flutter_app/core/config/forward_rotate_on_add_flag.dart, package:flutter_app/features/groups/application/group_media_allowed_peers.dart, _availableContacts, backgroundPreference, bridge, build (+32 more)
...
Cohesion: 0.04
Nodes (49): alice, aliceDevice, aliceLog, args, bob, bobDevice, bobLog, _detectBootedSimulators (+41 more)

### Community 232 - "Community 232"
Cohesion: 0.04
Nodes (46): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, bytes, committedFile, contentHash (+38 more)
...
Cohesion: 0.04
Nodes (48): addContact, additionalRecipients, bridge, commentListener, _connectChain, _connectTriangle, contactRepo, create (+40 more)
...
Cohesion: 0.05
Nodes (47): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+39 more)

### Community 240 - "Community 240"
Cohesion: 0.04
Nodes (47): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _AuditBridge (+39 more)
...
Cohesion: 0.03
Nodes (60): attempts, contactAlice, contactBob, contactCharlie, contactDave, deleteAttempt, deleteAttemptsForGroup, _expectNoPublicRouteFields (+52 more)
...
Cohesion: 0.04
Nodes (47): clearRetryBackoff, count, deleteMessage, deleteMessageForMembershipRepair, deleteMessagesForGroup, _emitOutgoingRowsChangedIfNeeded, _emitOutgoingStatusChangeIfNeeded, existsByContent (+39 more)
...
Cohesion: 0.04
Nodes (46): _FakeP2PService, accountMigrationNetworkGate, allowed, _allowsPostDeliveryNetworkSideEffects, bridge, contactRepo, _debounceTimer, dispose (+38 more)
...
Cohesion: 0.04
Nodes (44): group_message_repository.dart, group_thread_summary_repository.dart, ../models/group_multi_device_policy.dart, clearRetryBackoff, dbRunGroupInboxPageTransactionFn, deleteMessage, deleteMessageForMembershipRepair, deleteMessagesForGroup (+36 more)

### Community 265 - "Community 265"
Cohesion: 0.04
Nodes (42): baseAttachment, buildApp, main, buildApp, main, package:flutter_app/shared/widgets/media/audio_player_widget.dart, package:flutter_app/shared/widgets/media/waveform_seek_bar.dart, _audioMedia (+34 more)
...
Cohesion: 0.05
Nodes (42): _InstrumentedBridge, _DelayRevocationDecryptBridge, _DelayedUpdateKeyBridge, _UpdateKeyFailBridge, _UpdateKeyTimeoutBridge, _InboxStoreFailPassthroughBridge, bridge, _bridgeCommandIndex (+34 more)
...
Cohesion: 0.04
Nodes (43): created, createdAt, createResult, createStopwatch, deduped, _deriveDraftMediaKind, emitPostTiming, firstKind (+35 more)
...
Cohesion: 0.05
Nodes (42): avatarBase64, avatarByteLength, maxBytes, normalizer, PreparedRepostAvatarSnapshot, prepareRepostAvatarSnapshot, sourceFile, tempDir (+34 more)
...
Cohesion: 0.05
Nodes (38): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+30 more)
...
Cohesion: 0.03
Nodes (55): ImagePicker, keyedAttachment, main, _contact, contacts, imageProcessor, lastSavedPostId, main (+47 more)
...
Cohesion: 0.05
Nodes (36): main, main, ../local_discovery/fake_local_p2p_service.dart, package:flutter_app/core/debug/transport_metrics.dart, bridge, _captureFlowEvents, checkHealth, dispose (+28 more)
...
Cohesion: 0.05
Nodes (36): _activeTab, AppShellController, _backgroundPreference, setBackgroundPreference, switchTo, clear, PendingPostTargetStore, setTarget (+28 more)
...
Cohesion: 0.05
Nodes (37): _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, BonsoirDiscoveryService, DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream (+29 more)
...
Cohesion: 0.06
Nodes (31): fake_secure_key_store.dart, db, main, makeAttachmentRow, makeMessageRow, db, main, db (+23 more)
...
Cohesion: 0.04
Nodes (43): main, _makeAttachment, mime, package:flutter_app/features/feed/presentation/widgets/replied_indicator.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, build, _buildExpandedContent (+35 more)
...
Cohesion: 0.06
Nodes (33): copyWith, createdAt, emoji, fromJson, fromMap, hashCode, id, isRemoved (+25 more)

### Community 346 - "Community 346"
Cohesion: 0.06
Nodes (34): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+26 more)
...
Cohesion: 0.06
Nodes (27): benchmark_helpers.dart, client, lastCall, main, runBridgeCrossingBenchmark, runConnectionReuseBenchmark, runEncryptionBenchmark, dispose (+19 more)
...
Cohesion: 0.06
Nodes (30): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, main, _makeSettings (+22 more)
...
Cohesion: 0.06
Nodes (30): _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity, _fakeIdentityJson (+22 more)

### Community 365 - "Community 365"
Cohesion: 0.06
Nodes (31): _FakeContactRequestRepository, acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer, declineRequest, _defaultShowError, handleRoute (+23 more)

### Community 366 - "Community 366"
Cohesion: 0.05
Nodes (39): avatarBase64, avatarBlob, candidate, contactRepo, current, currentLocalPassCount, currentLocalSharedToCount, currentPassRecipientCount (+31 more)
...
Cohesion: 0.06
Nodes (31): _attachments, count, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+23 more)
...
Cohesion: 0.06
Nodes (31): Brightness, BuildContext, BackgroundReadableColorsContext, border, copyWith, dark, disabledForeground, disabledSurface (+23 more)
...
Cohesion: 0.13
Nodes (30): mutateAndResignGroupEnvelope(), groupRendezvousNamespace(), TestGL020GroupRecoveryLimiterDrainsManyGroupsWithoutStarvingAffectedGroup(), TestGR019GroupRecoveryLimiterReleasesSlotsOnCanceledContext(), TestGroupDiscoveryCycle_NoKnownPeersUsesRendezvousFallback(), TestGroupRendezvousNamespace(), TestGroupRendezvousNamespace_EmptyGroupId(), TestGroupRendezvousNamespace_MatchesTopicName() (+22 more)
...
Cohesion: 0.07
Nodes (25): db, main, db, main, db, main, db, main (+17 more)
...
Cohesion: 0.04
Nodes (51): consumedSessions, consumeSession, empty, failClosed, isSessionConsumed, loadConsumedSession, loadPendingNewPhoneSession, _loadStore (+43 more)
...
Cohesion: 0.07
Nodes (28): bridge, command, _expectNoPublicRouteFields, expectRejected, _gl005ForbiddenPublicRouteKeys, groupRepo, main, send (+20 more)

### Community 404 - "Community 404"
Cohesion: 0.07
Nodes (27): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, copyToDurableStorage, deleteFile, deleteMediaForContact (+19 more)
...
Cohesion: 0.06
Nodes (28): body, commentedAt, commentId, createdAt, eventId, fromJson, _isValidCreatedAt, _maxFutureClockSkew (+20 more)

### Community 411 - "Community 411"
Cohesion: 0.07
Nodes (29): backingSecureKeyStore, containsKey, containsKeyCount, _delegate, delete, deleteCount, lastUpsertedRow, loadCallCount (+21 more)
...
Cohesion: 0.07
Nodes (24): refreshNearbyOnStartup, MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDOb012Private, package:flutter/foundation.dart, attemptPart, buildTextPreview, idPart, logChatIncoming, logChatOutgoing (+16 more)
...
Cohesion: 0.07
Nodes (26): GroupTestUser, GroupPendingKeyDistributionRunner, admit, alice, aliceIdentity, bob, createdAt, epochOneKey (+18 more)
...
Cohesion: 0.07
Nodes (25): _ControlledP2PService, dialAttempts, _dialedPeers, dialPeer, discoverAttempts, discoverPeer, _drainMicrotasks, inboxAttempts (+17 more)
...
Cohesion: 0.08
Nodes (25): attachment, borderRadius, build, _buildContent, _buildGifBadge, _buildLoadingPlaceholder, _buildOverlayCount, _buildUnavailablePlaceholder (+17 more)
...
Cohesion: 0.08
Nodes (23): contact, contactKey, group, groupKey, key, kind, label, requireContact (+15 more)
...
Cohesion: 0.08
Nodes (23): append, bridge, controller, entries, errorCode, _FakeEventLog, groupRepo, lastGroupOfflineReplayEnvelope (+15 more)
...
Cohesion: 0.08
Nodes (23): attachment, _downloadedBytesHash, _DownloadWritingBridge, expectNoForbiddenKeys, expectNoFragmentsInJson, expectOutgoingAttachment, expectSingleAttachment, expectVariantSchema (+15 more)
...
Cohesion: 0.03
Nodes (70): package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/domain/models/orbit_group.dart, package:flutter_app/features/orbit/presentation/widgets/group_row.dart, main, aboveDivider, belowDivider, byContact (+62 more)
...
Cohesion: 0.10
Nodes (20): _RecordingNavigatorObserver, NavigatorObserver, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, _RecordingNavigatorObserver, didPush, _fakeIdentityJson, _FakeIdentityRepo, _fakeMlKemResponse (+12 more)
...
Cohesion: 0.10
Nodes (19): avatarPath, contact, isArchived, isBlocked, lastActivity, lastMessageTimestamp, messageCount, OrbitFriend (+11 more)
...
Cohesion: 0.16
Nodes (15): scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), buildGroupPushMessage(), assertAPNSCustomString(), assertNoDirectPushSchemaVersionKeys(), TestBuildChatPushMessage_CarriesEncryptedDataWithoutPlaintextPreview(), TestBuildGroupPushMessage_CarriesEncryptedDataWithoutPlaintextPreview(), TestBuildGroupPushMessage_CarriesNativeV3EnvelopeEncryptedPreview() (+7 more)
...
Cohesion: 0.11
Nodes (17): nav_bar_button.dart, nav_bar_theme.dart, package:flutter_svg/flutter_svg.dart, activeTab, build, feedBadgeCount, FeedNavigationBar, orbitBadgeCount (+9 more)
...
Cohesion: 0.16
Nodes (12): handleShareIntent, ShareIntentRouteBuilder, pendingIntent, PendingShareRouteBuilder, settleShareIntentFlow, shareService, package:flutter_app/core/services/share_intent_model.dart, package:flutter_app/core/services/share_intent_service.dart (+4 more)
...
Cohesion: 0.12
Nodes (15): bridge, _bridgeCommandError, checkHealth, dispose, eventNamed, initialize, isInitialized, main (+7 more)
...
Cohesion: 0.15
Nodes (13): connectionItem, contact, ContactFeedSnapshot, loadContactFeedSnapshot, messages, threadItem, CardThreadFeedItem, ConnectionFeedItem (+5 more)
...
Cohesion: 0.15
Nodes (11): main, cases, _DrainExpectation, label, main, remoteData, _RouteContractCase, target (+3 more)
...
Cohesion: 0.15
Nodes (11): package:flutter_app/features/groups/domain/utils/group_message_ordering.dart, aboveDivider, belowDivider, byGroup, _compareGroupThreadFeedItemsDescending, groupGroupMessagesIntoThreads, groupMap, timestampCompare (+3 more)
...
Cohesion: 0.17
Nodes (11): imageResult, multipleMediaResult, pickImage, pickImageCalls, pickMultipleMedia, pickMultipleMediaCalls, pickVideo, pickVideoCalls (+3 more)

### Community 662 - "Community 662"
Cohesion: 0.06
Nodes (26): fake_message_repository.dart, ageOffset, base, contactPeerId, createdAt, id, makeAliceIdentity, makeBobContact (+18 more)
...
Cohesion: 0.20
Nodes (9): build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt, shareIntentService, package:flutter_app/features/share/application/handle_share_intent_use_case.dart (+1 more)
...
Cohesion: 0.22
Nodes (8): group, latestKey, main, maxTicks, members, mirrorJoinedGroupState, waitForCondition, package:flutter_app/features/groups/application/set_group_muted_use_case.dart
...
Cohesion: 0.25
Nodes (7): containsKey, env, main, _runRealVoiceMessageE2E, _safeHasPermission, _shouldSkipVoiceMessageE2E, package:flutter_app/core/media/record_audio_recorder_service.dart
...
Cohesion: 0.33
Nodes (5): burstThreshold, current, gap, splitThreadByTimeGap, threads

### Community 783 - "Community 783"
Cohesion: 0.40
Nodes (5): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepositoryImpl
...
Cohesion: 0.40
Nodes (5): FakeP2PService, ReadinessProofRecorder, FakeP2PService, P2PFullInboxDrain, _CensusFakeP2PService
...
Cohesion: 0.11
Nodes (16): GroupSystemPublishResult, inboxRetryPayload, inboxStored, publishGroupSystemMessage, publishResult, recipientPeerIds, replayStorageError, senderUsername (+8 more)
...
## Knowledge Gaps
- **32497 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+32492 more)
...
- **Why does `incomingMessage` connect `Community 117` to `Community 560`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 323` to `Community 512`, `Community 560`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 512` to `Community 323`, `Community 100`, `Community 278`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _32497 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.0010314595152140279 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0029282576866764276 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.007708568029062187 - nodes in this community are weakly interconnected._