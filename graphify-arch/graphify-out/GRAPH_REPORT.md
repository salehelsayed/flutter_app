...
## Summary
- 42203 nodes · 65605 edges · 912 communities (867 shown, 45 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2427 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6541b568`
...
## Communities (912 total, 45 thin omitted)
...
Cohesion: 0.01
Nodes (328): AlertDialog, AnimatedContainer, AnnotatedRegion, main, showGroupMissingNotificationFeedback, BoxDecoration, CircularProgressIndicator, DecoratedBox (+320 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (382): NearbyDevicePosition, InMemoryPostRepository, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox (+374 more)
...
Cohesion: 0.01
Nodes (309): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, contactRepo, hook, main, makeAttachment (+301 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (325): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+317 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (279): AnimatedBuilder, Animation, AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, ContactRequestListener, GroupPendingKeyRepairRunner, PostDeliveryRunner (+271 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (266): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+258 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (247): IconData, MemberRole, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, actionLabel, active, backgroundPreference (+239 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (246): main, mapChatReplayOutcomeToDisposition, main, map, DetailedInboxStore, InMemoryInboxStagingRepository, LifecycleBridge, bridge (+238 more)
...
Cohesion: 0.01
Nodes (154): @immutable, package:flutter_app/features/introduction/application/load_introductions_use_case.dart, package:flutter_app/features/introduction/presentation/widgets/intro_group_header.dart, package:flutter_app/features/introduction/presentation/widgets/intro_row.dart, package:flutter_app/features/introduction/presentation/widgets/intros_tab.dart, package:flutter_app/features/orbit/domain/models/orbit_item.dart, package:flutter_app/features/orbit/presentation/screens/orbit_screen.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart (+146 more)
...
Cohesion: 0.01
Nodes (183): buildReceipt, captureFlowEvents, contactPeerId, from, id, isIncoming, main, makeInboxedOutgoing (+175 more)
...
Cohesion: 0.01
Nodes (205): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+197 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (176): DatabaseException, db, main, makeContactRow, db, main, makeIdentityRow, db (+168 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (171): benchmark_harness.dart, BenchmarkHarness, alice, bob, main, network, _originalText, FakeP2PNetwork (+163 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (182): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), generateFakeRelayAddr(), TestBuildRelaySelector_FallsBackToDefault(), TestBuildRelaySelector_UsesServerAddresses() (+174 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (180): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+172 more)
...
Cohesion: 0.01
Nodes (172): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+164 more)

### Community 27 - "Community 27"
Cohesion: 0.01
Nodes (175): dart:async, runEventQueueBenchmark, main, package:flutter_app/core/services/contact_request_listener.dart, package:flutter_app/features/p2p/domain/models/discovered_peer.dart, dispose, load, loadAll (+167 more)

### Community 28 - "Community 28"
Cohesion: 0.01
Nodes (161): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, addPage (+153 more)
...
Cohesion: 0.01
Nodes (157): EncryptedMediaTestBridge, RelayMediaStore, ImagePicker, bridge, _createdAt, encTempsUnder, imageProcessor, main (+149 more)
...
Cohesion: 0.02
Nodes (143): bridge, groupRepo, main, ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, FakeGroupPubSubNetwork, GroupModel, GroupPendingKeyDistributionRunner (+135 more)
...
Cohesion: 0.02
Nodes (136): _DelayedBridge, _FailOncePartialDownloadBridge, _TimeoutAfterWriteBridge, _CursorInboxBridge, _FailDecryptBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge (+128 more)
...
Cohesion: 0.02
Nodes (126): AccountMigrationNetworkGate, buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo (+118 more)

### Community 44 - "Community 44"
Cohesion: 0.02
Nodes (133): main, makeInvite, pendingInviteRepo, ../../contacts/domain/repositories/fake_contact_repository.dart, ../../identity/domain/repositories/fake_identity_repository.dart, authorPeerId, authorUsername, buildWidget (+125 more)
...
Cohesion: 0.02
Nodes (128): archiveGroup, adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage (+120 more)

### Community 48 - "Community 48"
Cohesion: 0.02
Nodes (124): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, main, sendMessage (+116 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (118): _incoming, main, isDeleted, isIncoming, main, _msg, Image, main (+110 more)
...
Cohesion: 0.02
Nodes (118): addContact, AddContactResult, archiveContact, addContact, archiveContact, archivedPeerIds, blockContact, contactExists (+110 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (124): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+116 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (84): bridge, deleteMessagesForGroup, _FailingGroupMessageRepository, groupId, groupMessageRepo, groupRepo, main, _InstrumentedGroupMessageRepository (+76 more)
...
Cohesion: 0.02
Nodes (122): _DownloadWritingBridge, FakeMediaPicker, _FailingDownloadBridge, _FailOncePartialDownloadBridge, _activeDevice, addContact, _attachImageFromLibrary, base64Decode (+114 more)

### Community 63 - "Community 63"
Cohesion: 0.02
Nodes (128): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment, allowEditAction (+120 more)

### Community 64 - "Community 64"
Cohesion: 0.02
Nodes (119): emitRetryTiming, limit, messages, reactionEntries, remainingReactionSlots, retriedCount, retryFailedGroupInboxStores, retryStopwatch (+111 more)
...
Cohesion: 0.02
Nodes (113): _attachment, main, addContact, author, comment, commentListener, condition, _contact (+105 more)
...
Cohesion: 0.02
Nodes (106): conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart, group_delete_preserves_friends_simulator_test.dart, group_invite_accept_spinner_simulator_test.dart, group_new_member_media_simulator_proof_test.dart (+98 more)
...
Cohesion: 0.02
Nodes (103): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+95 more)
...
Cohesion: 0.02
Nodes (111): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+103 more)

### Community 78 - "Community 78"
Cohesion: 0.02
Nodes (84): _DeterministicSegmentCrypto, activeChunks, decapsulateSession, decryptChunk, encapsulateSession, encryptChunk, files, length (+76 more)
...
Cohesion: 0.02
Nodes (101): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, contactRepo, main, requestRepo, testRequest, addResult (+93 more)
...
Cohesion: 0.02
Nodes (104): dart:ui, LanAvailabilitySnapshot, Key, capture, drain, goTo, main, outDir (+96 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (106): MapEntry, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge, _broadcastSelfRemovalIfNeeded, build, _buildGroupConfig (+98 more)

### Community 84 - "Community 84"
Cohesion: 0.02
Nodes (104): CountingGroupMessageRepository, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay, deleteAttempt (+96 more)
...
Cohesion: 0.01
Nodes (181): AppLocalizations, DateSeparator, Directionality, main, wrapApp, wrapScrollable, app, main (+173 more)
...
Cohesion: 0.01
Nodes (175): addedMembers, _addMemberFailures, allMembers, buildCreateWarningMessage, byPeerId, CreateGroupMemberAddFailure, createGroupWithMembers, CreateGroupWithMembersResult (+167 more)

### Community 89 - "Community 89"
Cohesion: 0.03
Nodes (60): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, AccountMigrationBlockedScreen, _AccountMigrationBlockedScreenState, build, _confirmErase (+52 more)

### Community 90 - "Community 90"
Cohesion: 0.02
Nodes (94): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+86 more)
...
Cohesion: 0.02
Nodes (92): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, DeliveryReceiptListener, dispose, messageRepo, receiptStream, start (+84 more)
...
Cohesion: 0.02
Nodes (90): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, attachment (+82 more)
...
Cohesion: 0.02
Nodes (90): clearResumeStarted, clearResumeStartedCallCount, _currentState, dialPeer, dialPeerCallCount, dialPeerResult, discoverLocalPeer, discoverPeer (+82 more)
...
Cohesion: 0.02
Nodes (80): _contact, main, _msg, _expectCommandOrder, _GroupShareBgBridge, _imageProcessor, inboxStoreOk, isLocalPeer (+72 more)
...
Cohesion: 0.02
Nodes (80): applied, pendingEvents, reconcilePendingPostChildEvents, buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage (+72 more)
...
Cohesion: 0.03
Nodes (59): deliveredWritePatterns, main, scanDeliveredWrites, File, _attachment, contentHash, downloadStatus, gifFile (+51 more)
...
Cohesion: 0.02
Nodes (81): clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository, markCleared, feed_cleared_repository.dart, FeedClearedRepository (+73 more)
...
Cohesion: 0.03
Nodes (74): bridge, contactPeerId, contactRepo, _contactWithMlKem, _doneAttachment, durationMs, fakeUploadFn, id (+66 more)

### Community 126 - "Community 126"
Cohesion: 0.03
Nodes (60): logOnlyToken, main, mainPath, nsePath, readSource, routerPath, senderToken, main (+52 more)

### Community 127 - "Community 127"
Cohesion: 0.03
Nodes (68): Database, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, db (+60 more)
...
Cohesion: 0.03
Nodes (78): main, _MemoryCutoverRepository, _ThrowingCommitCoordinator, _MemoryCutoverRepository, _MemoryCutoverRepository, _authorityRepository, _baseRecord, clearLocalStalePushToken (+70 more)
...
Cohesion: 0.03
Nodes (74): buildIdentity, main, tempDir, main, main, package:flutter_app/features/home/application/identity_avatar_resolver.dart, package:flutter_app/features/posts/domain/repositories/posts_privacy_settings_repository.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart (+66 more)
...
Cohesion: 0.05
Nodes (39): addGroup, announceCalls, announceSpy, bridge, groupRepo, identity, main, run (+31 more)
...
Cohesion: 0.03
Nodes (71): main, _pendingRequest, requestRepo, ../../contact_request/domain/repositories/fake_contact_request_repository.dart, ContactRequestPresentationGate, FakeContactRequestRepository, ../features/contact_request/domain/repositories/fake_contact_request_repository.dart, bridge (+63 more)
...
Cohesion: 0.03
Nodes (72): build, createState, initState, main, _SettleHarness, _SettleHarnessState, shareIntentService, first_time_experience_screen.dart (+64 more)
...
Cohesion: 0.02
Nodes (132): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie (+124 more)
...
Cohesion: 0.02
Nodes (77): OrbitGroup, friend, group, OrbitFriendItem, OrbitGroupItem, OrbitItem, sortKey, package:flutter_app/core/utils/text_direction_utils.dart (+69 more)

### Community 149 - "Community 149"
Cohesion: 0.04
Nodes (50): deleteGroupAndMessages, deleteLocallyIfDissolved, fake_group_reaction_replay_outbox_repository.dart, addMember, bridge, broadcastMemberAdded, create, createGroup (+42 more)
...
Cohesion: 0.03
Nodes (65): main, main, package:flutter_app/core/debug/transport_metrics.dart, package:flutter_app/features/settings/presentation/widgets/settings_transport_diagnostics_card.dart, _buildTestWidget, chatListener, conditionalTransitionStatus, _contact (+57 more)
...
Cohesion: 0.02
Nodes (89): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+81 more)
...
Cohesion: 0.03
Nodes (63): main, payload, main, payload, main, resultFor, isAccountMigrationPairingQr, MigrationQrScannedHandler (+55 more)
...
Cohesion: 0.06
Nodes (45): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+37 more)
...
Cohesion: 0.03
Nodes (63): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, _bestEffortIncomingCleanup, blockedSenderOwnsStoredMessage, contact (+55 more)

### Community 167 - "Community 167"
Cohesion: 0.03
Nodes (63): byId, expireOldIntroductions, introducedRows, _loadMutualAcceptedIntroductions, pending, recipientRows, repairedCount, repairedMutualAcceptanceIds (+55 more)

### Community 168 - "Community 168"
Cohesion: 0.04
Nodes (59): fake_local_discovery_service.dart, main, peerA, peerB, ../local_discovery/fake_local_discovery_service.dart, LanSendAck, _createTestFile, main (+51 more)

### Community 169 - "Community 169"
Cohesion: 0.03
Nodes (61): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+53 more)
...
Cohesion: 0.03
Nodes (62): _attachmentsByMessage, basePath, bridge, captureFlowEvents, checkHealth, commandLog, copyWith, decryptResponse (+54 more)
...
Cohesion: 0.03
Nodes (58): main, member, main, _captureFlowEvents, creatorPeerId, generation, groupId, groupRepo (+50 more)
...
Cohesion: 0.03
Nodes (59): GroupMessage, GroupMessageListener, _FakeGroupMessageListener, _ControlledGroupMessageListener, package:flutter_app/features/groups/presentation/screens/create_group_picker_wired.dart, package:flutter_app/features/groups/presentation/screens/group_conversation_wired.dart, buildContact, buildWidget (+51 more)
...
Cohesion: 0.03
Nodes (56): checkHealth, _circuitMultiaddr, dispose, _FakeBridge, _flatten, initialize, _initialized, isInitialized (+48 more)

### Community 193 - "Community 193"
Cohesion: 0.03
Nodes (59): _TrackingReactionListener, _TrackingReactionListener, ReactionChange, Reaction, ReactionListener, _FakeReactionListener, appShellController, audioRecorderService (+51 more)
...
Cohesion: 0.03
Nodes (71): FocusNode, build, createState, dispose, _handleRestorePressed, _isLoading, _mnemonicController, MnemonicInputScreen (+63 more)
...
Cohesion: 0.04
Nodes (51): db, main, makeRow, countQuarantinedEntries, deleteEntry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds (+43 more)
...
Cohesion: 0.04
Nodes (52): _DigestSink, Digest, _DigestSink, MediaOffer, _CallbackSink, acceptOffer, add, allowedMimePrefixes (+44 more)
...
Cohesion: 0.04
Nodes (51): detailsFor, eventNames, events, main, mediaReady, pendingAttachment, FakeMediaFileManager, _ScopedMediaFileManager (+43 more)

### Community 221 - "Community 221"
Cohesion: 0.02
Nodes (82): Align, AspectRatio, ClipRRect, ConstrainedBox, main, _makeMedia, _makeVideoMedia, tempDir (+74 more)
...
Cohesion: 0.04
Nodes (52): ChatMessageListener, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, _FakeIncomingConversationListener, FeedWired, _FeedWiredState (+44 more)
...
Cohesion: 0.04
Nodes (49): _FakeIdentityRepo, acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer, declineRequest, _defaultShowError, handleRoute (+41 more)

### Community 239 - "Community 239"
Cohesion: 0.03
Nodes (75): _absoluteForRelativePath, acceptSizeDivergence, _addBestPathFailureIssue, addCandidate, _addChatMedia, _addPathBackedItem, _addPathCandidateIfUsable, _addPendingPostMedia (+67 more)
...
Cohesion: 0.04
Nodes (45): class, _attachments, count, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage, getAttachmentsForMessages (+37 more)
...
Cohesion: 0.04
Nodes (45): comments, loadPostComments, wait, _assertAllRecipientsStarted, _assertBoundedStart, _contact, contacts, _ControlledP2PService (+37 more)
...
Cohesion: 0.04
Nodes (47): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo (+39 more)
...
Cohesion: 0.04
Nodes (44): buildBridgeMigrationCutoverLeaseCleanup, dispose, fixture, node, profileNode, profileTmpDir, runMediaBenchmark, startAndWaitOnline (+36 more)
...
Cohesion: 0.04
Nodes (44): _bridge, dispose, DistributeGroupKeyAtEpochToPeer, _emitUnauthorized, _enqueue, GroupKeyRepairResponderListener, _groupRepo, _handle (+36 more)
...
Cohesion: 0.05
Nodes (42): blockingUpload, bridge, captureFlowEvents, _doneAttachment, file, groupMsgRepo, groupRepo, identityRepo (+34 more)
...
Cohesion: 0.05
Nodes (44): ContactRequestListener, _FakeContactRequestListener, appShellController, bridge, buildRouterApp, chatMessageListener, contactPresenceSnapshotRepository, contactRepository (+36 more)
...
Cohesion: 0.04
Nodes (42): _FakeNearbyLocationPlatformAdapter, _changes, dispose, load, save, setSharingEnabled, _settings, settingsChanges (+34 more)

### Community 285 - "Community 285"
Cohesion: 0.05
Nodes (42): InMemoryPostsPrivacySettingsRepository, package:flutter_app/features/feed/presentation/screens/feed_wired.dart, PendingPostTargetStore, archived, blocked, _contact, contacts, freshIso (+34 more)
...
Cohesion: 0.05
Nodes (40): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, declineContactRequest, DeclineContactRequestResult, peerIdPrefix (+32 more)
...
Cohesion: 0.05
Nodes (40): main, ../../core/secure_storage/fake_secure_key_store.dart, generateRandomKey, main, MobileScanner, package:flutter_app/features/qr_code/presentation/screens/qr_scanner_wired.dart, accountMigrationPairingQrKind, appShellController (+32 more)
...
Cohesion: 0.13
Nodes (42): cmdBlobDecrypt(), cmdBlobEncrypt(), cmdBlobKeygen(), cmdClearMessages(), cmdDial(), cmdDisconnect(), cmdDiscover(), cmdGenerateIdentity() (+34 more)
...
Cohesion: 0.05
Nodes (40): _FakeMediaFileManager, FakeMediaFileManager, _FakeMediaFileManager, _FakeMediaFileManager, _TempMediaFileManager, basePath, bridge, captureFlowEvents (+32 more)
...
Cohesion: 0.05
Nodes (37): _buildItems, clearClearedLocally, _clearedWatermarks, connectionForContact, _connectionsByContactId, contactMessageIds, containsMessageId, dispose (+29 more)
...
Cohesion: 0.02
Nodes (110): _RecordingSnapshotExportAdapter, _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiSnapshotExportAdapter, _FfiStagedDatabaseOpener, computeDatabaseChecksumForTesting, database, DefaultMigrationStagedDatabaseOpener (+102 more)
...
Cohesion: 0.05
Nodes (37): AnimatedOpacity, _RecordingMessageRepository, InMemoryMessageRepository, _TrackingMessageRepository, _CountingMessageRepository, appShellController, bridge, buildWired (+29 more)

### Community 340 - "Community 340"
Cohesion: 0.05
Nodes (34): dismissedAt, dismissPin, savePinDismissal, activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager (+26 more)
...
Cohesion: 0.05
Nodes (37): appShellController, bridge, buildSharePickerApp, buildStartupRouter, chatMessageListener, contactRepository, contactRequestRepository, deliver (+29 more)
...
Cohesion: 0.05
Nodes (35): captured, eventsNamed, line, main, thread, _contact, contactPeerId, contactRepo (+27 more)
...
Cohesion: 0.03
Nodes (73): Alignment, Color, package:flutter_app/features/feed/presentation/widgets/feed_swipe_card.dart, animatedOpacityDurations, animatedSizeDurations, buildFeedScreen, buildThreadItem, items (+65 more)
...
Cohesion: 0.06
Nodes (34): _buildOrbitFriend, contact, descriptor, descriptors, ids, includeArchived, isDeleted, latest (+26 more)
...
Cohesion: 0.06
Nodes (35): AppPausedResult, bridge, callBgEnd, candidates, capped, ceilingMs, delayedSec, deposited (+27 more)
...
Cohesion: 0.06
Nodes (31): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, gMsg, groupItem, main, _msg, _thread (+23 more)
...
Cohesion: 0.06
Nodes (34): RecordingSecureKeyStore, CountingSecureKeyStore, FakeSecureKeyStore, _CountingSecureKeyStore, backingSecureKeyStore, containsKey, containsKeyCount, _delegate (+26 more)
...
Cohesion: 0.06
Nodes (31): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, main, peerDiscoveredAt, _controller, emit (+23 more)
...
Cohesion: 0.06
Nodes (31): AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart, fake_notification_service.dart, bridge, contactRepo, conversationTracker, create, DirectMessageRouter (+23 more)

### Community 398 - "Community 398"
Cohesion: 0.07
Nodes (29): driver, main, disable, disableCalls, enable, enableCalls, FakeUploadWakeLockDriver, disable (+21 more)
...
Cohesion: 0.06
Nodes (31): BonsoirBroadcastFactory, BonsoirDiscoveryFactory, _broadcast, _createBroadcast, _createDiscovery, discoveredPeers, discoveredPeersStream, _discovery (+23 more)
...
Cohesion: 0.06
Nodes (28): DateTime, consumedAt, expiresAt, fromMap, groupId, GroupInviteConsumption, inviteId, isActiveAt (+20 more)

### Community 410 - "Community 410"
Cohesion: 0.06
Nodes (29): main, tempDir, directory, package:flutter_app/core/debug/auto_setup_config.dart, alice, aliceDevice, aliceLog, args (+21 more)
...
Cohesion: 0.12
Nodes (14): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, main, _makeSettings (+6 more)
...
Cohesion: 0.02
Nodes (91): _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo, BackgroundPreference, package:flutter_app/features/introduction/presentation/screens/sent_confirmation_screen.dart (+83 more)
...
Cohesion: 0.07
Nodes (26): add, attemptSilentIntroRecovery, bridge, _contactKeyUpdatedController, contactKeyUpdatedStream, contactRepo, contactRequestStream, contains (+18 more)
...
Cohesion: 0.08
Nodes (24): dataToVerify, existingRequest, handleIncomingMessage, HandleMessageResult, isContact, isValid, json, payload (+16 more)
...
Cohesion: 0.09
Nodes (20): _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity, _fakeIdentityJson (+12 more)
...
Cohesion: 0.10
Nodes (17): main, collectPendingMediaSizeRejections, hashCode, index, MediaRejection, normalizeMediaRejectionReason, operator, pendingMediaTotalSizeOverflow (+9 more)
...
Cohesion: 0.12
Nodes (16): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, group_history_gap_repair_repository.dart, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, ../models/group_history_gap_repair.dart, getLatestRepairForGroup, getRepair (+8 more)
...
Cohesion: 0.14
Nodes (14): acquire, _activeHolds, debugActiveHolds, debugReset, debugSetDriver, disable, _driver, enable (+6 more)
...
Cohesion: 0.11
Nodes (15): main, _CapturedFlowEvent, _captureFlowEvents, details, event, events, main, originalDebugPrint (+7 more)
...
Cohesion: 0.17
Nodes (11): consumeCalls, consumeIfRecentAnnouncement, markAnnouncement, markCalls, messageId, payload, RecentNotificationGateCall, _seq (+3 more)
...
Cohesion: 0.18
Nodes (10): encrypted, envelope, envelopeSenderPeerId, HandleGroupInviteDeclineAckResult, handleIncomingGroupInviteDeclineAck, payload, verifyOutcome, GroupInviteDeclineAckPayload (+2 more)
...
Cohesion: 0.18
Nodes (10): deleteEntry, deleteEntryCallCount, _entries, getEntry, loadRetryableEntries, saveEntry, saveEntryCallCount, updateEntryStatus (+2 more)
...
Cohesion: 0.18
Nodes (10): IdentityModel, FakeIdentityRepository, _identity, lastSavedIdentity, loadIdentity, loadIdentityCallCount, makeIdentity, saveIdentity (+2 more)
...
Cohesion: 0.10
Nodes (18): events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness, routedTargets (+10 more)
...
## Knowledge Gaps
- **34156 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+34151 more)
...
- **Why does `incomingMessage` connect `Community 224` to `Community 582`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 328` to `Community 582`, `Community 519`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 519` to `Community 328`, `Community 42`, `Community 308`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _34156 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.008112874779541446 - nodes in this community are weakly interconnected._