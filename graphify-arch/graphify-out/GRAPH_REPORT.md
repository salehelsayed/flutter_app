# Graph Report - graphify-arch  (2026-07-05)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 43002 nodes · 67315 edges · 919 communities (873 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2626 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f4f6093`
...
## Communities (919 total, 46 thin omitted)
...
Cohesion: 0.00
Nodes (580): AnimatedOpacity, contactRepo, main, requestRepo, testRequest, main, main, GateableMediaAttachmentRepository (+572 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (359): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, main, makeAttachment, makeMessage, mediaAttachmentRepo (+351 more)
...
Cohesion: 0.01
Nodes (301): AlertDialog, AnimatedContainer, AnnotatedRegion, showGroupMissingNotificationFeedback, BoxDecoration, CircularProgressIndicator, Column, DecoratedBox (+293 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (280): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+272 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (304): activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager, orderedPostIds, postRepo, posts (+296 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (256): bridge, buildHost, buildMaterializer, contactRepository, identityRepository, main, _makeContact, _makeRequest (+248 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (242): accountKey, admit, drainSpy, groupId, main, member, memberPeerId, reopenSpy (+234 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (266): absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub, _applyMessageUpdate (+258 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (243): _ActiveAttachmentUpload, _ComposerSnapshot, conversation_screen.dart, PrepareEncryptedMediaArtifactFn, absoluteDurablePath, _ActiveAttachmentUpload, _activeQuoteMessageId, _allowPopDuringActiveUpload (+235 more)
...
Cohesion: 0.01
Nodes (222): Animation, MediaThumbnailImage, _MediaThumbnailImageState, OrbitScreen, package:flutter_app/core/theme/glassmorphism.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, _AnimatedLetterCard, _AnimatedLetterCardState (+214 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (222): IconData, Key, PostModel, package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock, _AccountMigrationProgressWakeLockState (+214 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (222): main, mapMessageDeletionReplayResultToDisposition, mapReactionReplayResultToDisposition, main, ContactRequestNotificationMaterializer, FirebaseReadiness, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner (+214 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (217): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+209 more)
...
Cohesion: 0.01
Nodes (208): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+200 more)
...
Cohesion: 0.01
Nodes (257): NearbyDevicePosition, EncryptedMediaTestBridge, RelayMediaStore, addContact, bridge, contactRepo, create, dispose (+249 more)

### Community 22 - "Community 22"
Cohesion: 0.02
Nodes (189): db, main, makeContactRow, db, main, makeIdentityRow, db, main (+181 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (131): main, buildReceipt, captureFlowEvents, contactPeerId, from, id, isIncoming, main (+123 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (216): ContactRequestPresentationGate, dart:async, _changes, dispose, load, loadAll, save, snapshotChanges (+208 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (207): CurvedAnimation, orbit_screen.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate (+199 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (170): AnimatedBuilder, items, mergeInnerCircleItems, _friend, _group, isBlocked, main, unreadCount (+162 more)

### Community 27 - "Community 27"
Cohesion: 0.01
Nodes (174): CustomPainter, dart:math, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build, _minBarHeight (+166 more)

### Community 28 - "Community 28"
Cohesion: 0.01
Nodes (178): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, main, sendMessage (+170 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (183): NewEventDispatcher(), fakeHostWithAddrs, TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), disableGroupInboxRecoveryForFakeRelayTest(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation() (+175 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (228): alice, bob, main, network, _originalText, FakeP2PNetwork, ChaosP2PNetwork, ../../features/conversation/integration/two_user_message_exchange_test.dart (+220 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (135): buildRepo, main, Database, DatabaseException, fake_secure_key_store.dart, db, main, makeRequestRow (+127 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (105): GroupMessagePayload, builtGroupMessageEnvelope, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, groupSenderDeviceBinding (+97 more)

### Community 33 - "Community 33"
Cohesion: 0.01
Nodes (168): driver, main, disable, disableCalls, enable, enableCalls, addMember, addPage (+160 more)

### Community 34 - "Community 34"
Cohesion: 0.01
Nodes (154): _incoming, main, isDeleted, isIncoming, main, _msg, canWrite, contactPeerId (+146 more)

### Community 35 - "Community 35"
Cohesion: 0.01
Nodes (166): avatarBase64, avatarBlob, candidate, contactRepo, current, currentLocalPassCount, currentLocalSharedToCount, currentPassRecipientCount (+158 more)
...
Cohesion: 0.01
Nodes (155): main, _pendingRequest, requestRepo, calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath (+147 more)

### Community 38 - "Community 38"
Cohesion: 0.01
Nodes (146): deliveredWritePatterns, main, scanDeliveredWrites, AspectRatio, File, FileImage, GestureDetector, IconButton (+138 more)
...
Cohesion: 0.02
Nodes (148): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, ChatMessageListener, DeliveryReceiptListener, dispose, messageRepo, receiptStream (+140 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (154): buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash(), lp013GroupHarness (+146 more)

### Community 42 - "Community 42"
Cohesion: 0.03
Nodes (141): buildGroupKeyInfoWithGrace(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), findMember(), isAllowedWriter(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo() (+133 more)
...
Cohesion: 0.02
Nodes (120): db, main, makePassRow, openWithMigrations, db, main, makeRecipientRow, openWithMigrations (+112 more)
...
Cohesion: 0.01
Nodes (139): DateSeparator, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/conversation/presentation/screens/conversation_screen.dart, package:flutter_app/features/conversation/presentation/widgets/date_separator.dart, package:flutter_app/features/feed/presentation/widgets/swipe_to_quote_bubble.dart, package:flutter_app/features/groups/presentation/group_backlog_retention_notice.dart, package:flutter/services.dart, avatarsInList (+131 more)
...
Cohesion: 0.01
Nodes (135): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/features/conversation/presentation/widgets/undelivered_messages_banner.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment (+127 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (123): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, blockContact, acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer (+115 more)
...
Cohesion: 0.02
Nodes (120): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, bridge (+112 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (127): _CursorInboxBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole, bridge (+119 more)
...
Cohesion: 0.02
Nodes (131): Route, acceptedUpdates, acceptGate, allGroupsGate, alphaGroup, archivedContactsGate, bridge, buildOrbitWired (+123 more)
...
Cohesion: 0.02
Nodes (122): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+114 more)

### Community 59 - "Community 59"
Cohesion: 0.02
Nodes (118): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+110 more)

### Community 60 - "Community 60"
Cohesion: 0.02
Nodes (118): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, main, member, _CountingGroupMessageRepository (+110 more)

### Community 61 - "Community 61"
Cohesion: 0.02
Nodes (119): avatarPath, _contact, contactPeerId, contactRepo, _group, groupId, _groupMessage, groupMessageRepo (+111 more)

### Community 62 - "Community 62"
Cohesion: 0.02
Nodes (113): dart:ui, nav_bar_button.dart, nav_bar_theme.dart, package:flutter_svg/flutter_svg.dart, detectTextDirection, _isLtrChar, _isRtlChar, VoidCallback (+105 more)
...
Cohesion: 0.02
Nodes (123): AudioRecorderService, deleteEntry, deleteEntryCallCount, _entries, FakeGroupReactionReplayOutboxRepository, getEntry, loadRetryableEntries, saveEntry (+115 more)
...
Cohesion: 0.02
Nodes (118): NearbyLocationServiceImpl, refreshNearbyOnStartup, main, NearbyLocationService, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, package:flutter_app/features/posts/application/nearby_location_service.dart, package:flutter_app/features/posts/application/refresh_nearby_on_startup_use_case.dart (+110 more)

### Community 68 - "Community 68"
Cohesion: 0.02
Nodes (112): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, AccountMigrationStreamingEntry, _MigrationPostException, _DeterministicSegmentCrypto, _DeletionWireEnvelopeEncryptFailed, MigrationDatabaseImportStagingException, MigrationDatabaseSnapshotExportException (+104 more)

### Community 69 - "Community 69"
Cohesion: 0.04
Nodes (93): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+85 more)
...
Cohesion: 0.02
Nodes (116): GroupModel, _contactFor, _dm, main, pump, MapEntry, package:flutter_app/features/groups/application/delete_group_and_messages_use_case.dart, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart (+108 more)
...
Cohesion: 0.02
Nodes (115): actionButton, attempts, beginRecoveryOnNextLoad, bridge, button, ciphertext, command, confirmDeleteLocalGroupDialog (+107 more)
...
Cohesion: 0.02
Nodes (124): allFriends, fromMap, kind, peopleNearby, pickPeople, PostAudience, PostAudienceKind, PostAudienceKindWireValue (+116 more)
...
Cohesion: 0.02
Nodes (106): _InstrumentedBridge, _DelayRevocationDecryptBridge, append, bridge, controller, _DelayedUpdateKeyBridge, entries, errorCode (+98 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (101): _FakeIdentityRepo, _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity (+93 more)
...
Cohesion: 0.02
Nodes (106): CountingGroupMessageRepository, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay, deleteAttempt (+98 more)

### Community 85 - "Community 85"
Cohesion: 0.02
Nodes (93): main, cancelledImportCleanup, _deleteArtifacts, failedImportCleanup, failedSecureStorageCleanup, MigrationDatabaseImportCleanup, MigrationFailedSecureStorageCleanup, _sqliteSidecars (+85 more)

### Community 86 - "Community 86"
Cohesion: 0.02
Nodes (101): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, package:flutter_app/shared/widgets/media/avatar_image_provider.dart, backgroundPreference, _blueAccent (+93 more)
...
Cohesion: 0.03
Nodes (67): DetailedInboxStore, LifecycleBridge, bridge, main, service, bridge, main, service (+59 more)

### Community 93 - "Community 93"
Cohesion: 0.02
Nodes (97): _EventRecorder, _HarnessEnvironment, audioRecorderService, binding, bridge, build, _callback, _canUseVmServiceTimeline (+89 more)
...
Cohesion: 0.05
Nodes (46): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, lanDialHandler, classifyStreamTransport(), isRetryableChatStreamOpenError(), messageEnvelopeType() (+38 more)
...
Cohesion: 0.02
Nodes (95): main, BoxConstraints, Listenable, package:flutter_app/features/orbit/application/orbit_geometry_prefs_use_cases.dart, _allKnobs, _armed, _armKnob, _avatar (+87 more)

### Community 99 - "Community 99"
Cohesion: 0.02
Nodes (96): angle, _angleOf, arc, arcI, arcIndex, arcNumber, av, avatarSize (+88 more)

### Community 100 - "Community 100"
Cohesion: 0.03
Nodes (77): Request, appShellController, bridge, buildFeedWired, contactRepo, contactRequestRepo, _contactUpdateController, contactUpdatedStream (+69 more)

### Community 101 - "Community 101"
Cohesion: 0.05
Nodes (39): bytesToWrite, captureCipherMetadata, commands, _createSeededAccountDb, execute, exportDestinationKey, exportDestinationPath, exportSqlCipherDatabase (+31 more)

### Community 102 - "Community 102"
Cohesion: 0.08
Nodes (85): newMemoryInboxBackend(), failingStoreInboxBackend, TestGIRD004MemoryGroupInboxMalformedAndUnkeyedMessagesStoreTwice(), requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID() (+77 more)
...
Cohesion: 0.03
Nodes (70): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+62 more)

### Community 107 - "Community 107"
Cohesion: 0.02
Nodes (86): adminPeerId, bridge, controller, groupId, groupRepo, incoming, listener, main (+78 more)
...
Cohesion: 0.02
Nodes (85): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, Stopwatch, AppTheme, blurSigma, borderRadius (+77 more)
...
Cohesion: 0.03
Nodes (80): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, buildTestApp, main, setPhoneViewport, _assertBackgroundScrollDoesNotRegress, _assertThresholds (+72 more)
...
Cohesion: 0.05
Nodes (77): BuildGroupSignatureData(), DecryptGroupMessage(), EncryptGroupMessage(), TestBuildGroupSignatureData_Deterministic(), TestBuildGroupSignatureData_Format(), TestDecryptGroupMessage_InvalidBase64(), TestEncryptGroupMessage_InvalidKey(), TestEncryptGroupMessage_WrongKeyLength() (+69 more)
...
Cohesion: 0.02
Nodes (84): AccountMigrationNetworkGate, _FakeP2PService, accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo, _coordinator, _debounceTimer (+76 more)
...
Cohesion: 0.02
Nodes (84): DissolveGroupResult, eventAt, group, hadBridgeRecoveryGap, inboxPayload, members, preTransitionStateHash, recipientPeerIds (+76 more)
...
Cohesion: 0.02
Nodes (77): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+69 more)

### Community 123 - "Community 123"
Cohesion: 0.02
Nodes (79): appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn, _enqueueMessage (+71 more)

### Community 124 - "Community 124"
Cohesion: 0.02
Nodes (80): PendingSiblingDevice, package:flutter_app/features/groups/domain/models/pending_sibling_device.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_member_row.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, package:flutter_app/features/groups/presentation/widgets/pending_sibling_device_prompt.dart, buildTestWidget, main (+72 more)
...
Cohesion: 0.02
Nodes (81): buildIdentity, main, tempDir, package:flutter_app/features/home/application/identity_avatar_resolver.dart, package:flutter_app/features/posts/domain/repositories/posts_privacy_settings_repository.dart, package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart, package:flutter_app/features/settings/presentation/widgets/settings_introduction_debug_card.dart, dispose (+73 more)

### Community 128 - "Community 128"
Cohesion: 0.02
Nodes (82): addresses, attempts, bridge, chatListener, clear, cliMlKemPublicKey, cliPeer, cliPeerId (+74 more)
...
Cohesion: 0.02
Nodes (78): Color, LanAvailabilitySnapshot, accentColor, availableFriends, build, friend, _FriendPickerRow, FriendPickerScreen (+70 more)

### Community 131 - "Community 131"
Cohesion: 0.06
Nodes (54): chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData(), addTrimmedData() (+46 more)
...
Cohesion: 0.03
Nodes (63): AccountMigrationProductionBundleReceiver, _SharedFakeDiscovery, AccountMigrationLocalBundleCutoverReceiver, AccountMigrationLocalBundleReceiver, AccountMigrationLocalStreamBundleReceiver, _SharedFakeDiscovery, _DelayingBundleReceiver, _SharedFakeDiscovery (+55 more)

### Community 134 - "Community 134"
Cohesion: 0.02
Nodes (77): chatGroup, conversationApp, fortyMessages, localAfternoon, main, messageAt, pumpFrames, rectWithin (+69 more)

### Community 135 - "Community 135"
Cohesion: 0.03
Nodes (76): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, attempts, bridge, createdAt, envelope, groupRepo, keyEpoch (+68 more)
...
Cohesion: 0.03
Nodes (75): addContact, archiveContact, archivedPeerIds, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository (+67 more)

### Community 139 - "Community 139"
Cohesion: 0.03
Nodes (72): build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt, shareIntentService, ShareBatchDeliveryResult (+64 more)

### Community 140 - "Community 140"
Cohesion: 0.03
Nodes (73): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, main, value, write (+65 more)

### Community 141 - "Community 141"
Cohesion: 0.03
Nodes (77): _attempts, bridge, _bridgeCommandIndex, captureFlowEvents, ciphertext, _decodedGroupInboxReplayPayload, delay, deleteAttempt (+69 more)
...
Cohesion: 0.03
Nodes (73): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _MockBridge (+65 more)
...
Cohesion: 0.03
Nodes (55): addContact, AddContactResult, archiveContact, activeContacts, otherFriends, shouldShowIntroBanner, _diagnostic, _expected (+47 more)
...
Cohesion: 0.03
Nodes (65): benchmark_helpers.dart, runOneToOneSendBenchmark, runAckBenchmark, details, events, _findRecoveredOutage, firstEventDetails, firstInbox (+57 more)
...
Cohesion: 0.03
Nodes (53): logOnlyToken, main, mainPath, nsePath, readSource, routerPath, senderToken, main (+45 more)

### Community 151 - "Community 151"
Cohesion: 0.03
Nodes (65): AppLocalizations, LocalizationsDelegate, MemberRole, package:flutter_app/features/groups/presentation/group_invite_status_presentation.dart, package:flutter_app/features/identity/presentation/screens/mnemonic_input_screen.dart, package:flutter_app/features/posts/presentation/widgets/comments_sheet.dart, package:flutter_app/features/posts/presentation/widgets/edit_pinned_post_sheet.dart, package:flutter_localizations/flutter_localizations.dart (+57 more)
...
Cohesion: 0.03
Nodes (69): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+61 more)

### Community 155 - "Community 155"
Cohesion: 0.03
Nodes (61): main, events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness (+53 more)
...
Cohesion: 0.03
Nodes (62): contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult, incomingTime (+54 more)
...
Cohesion: 0.03
Nodes (63): FocusNode, build, createState, dispose, _handleRestorePressed, _isLoading, _mnemonicController, MnemonicInputScreen (+55 more)
...
Cohesion: 0.07
Nodes (64): Addr, avAddrsContain(), avBoundIP4QuicPorts(), avCaptureLogs(), avDenyNetroute(), avInstallAnetShaped(), avInstallDenial(), avIP4QuicPort() (+56 more)
...
Cohesion: 0.06
Nodes (56): DiscoverResponse, newMemoryRendezvousBackend(), Discover, MessageType, skipField(), UnmarshalDiscover(), UnmarshalRegister(), UnmarshalRegistration() (+48 more)

### Community 168 - "Community 168"
Cohesion: 0.03
Nodes (56): db, main, makeKeyRow, db, main, makeMemberRow, db, main (+48 more)
...
Cohesion: 0.03
Nodes (64): AccountMigrationReceiverEvents, AccountMigrationSizeGate, AccountMigrationExportAuthorizeFn, AccountMigrationJourneyWired, _AccountMigrationJourneyWiredState, AccountMigrationQrBuildFn, AccountMigrationQrScanFn, _activeReceiverSessionId (+56 more)

### Community 175 - "Community 175"
Cohesion: 0.04
Nodes (58): Align, ClipRRect, ConstrainedBox, main, wrapApp, wrapScrollable, package:flutter_app/core/utils/url_parser.dart, package:flutter_app/features/conversation/presentation/widgets/letter_card.dart (+50 more)

### Community 176 - "Community 176"
Cohesion: 0.03
Nodes (61): _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry, group, groupId (+53 more)

### Community 177 - "Community 177"
Cohesion: 0.03
Nodes (59): AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart, fake_notification_service.dart, bridge, contactRepo, conversationTracker, create, DirectMessageRouter (+51 more)
...
Cohesion: 0.03
Nodes (57): FadeTransition, package:flutter_app/features/conversation/domain/models/media_preview_descriptor.dart, package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart, package:flutter_app/features/orbit/presentation/widgets/orbit_media_preview_label.dart, main, aboveDivider (+49 more)

### Community 180 - "Community 180"
Cohesion: 0.03
Nodes (57): db, main, bridge, cliContact, cliPeer, contactRepo, db, _dbName (+49 more)
...
Cohesion: 0.03
Nodes (63): _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _TrackingInviteDeliveryAttemptRepository, _InMemoryInviteDeliveryAttemptRepository, GroupInviteDeliveryAttemptRepository, _TrackingInviteDeliveryAttemptRepository, _InMemoryGroupInviteDeliveryAttemptRepository, _SpyDeliveryRepo (+55 more)

### Community 184 - "Community 184"
Cohesion: 0.03
Nodes (61): addPage, bridge, buildSignedReplay, _Clock, contains, endedAt, getGroup, getKeyByGeneration (+53 more)

### Community 185 - "Community 185"
Cohesion: 0.03
Nodes (61): buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, expiresAt, issuedAt, main, makePackage, validMaterial (+53 more)

### Community 186 - "Community 186"
Cohesion: 0.06
Nodes (38): ConnectionState, ConnScope, ConnStats, directConfirmCallback, generatePeerIDStr(), TestGL011UpdateGroupConfigConcurrentValidatorReadsAreRaceFree(), TestGL011UpdateGroupConfigSnapshotsMembershipForValidatorReads(), stubStreamConn (+30 more)

### Community 187 - "Community 187"
Cohesion: 0.03
Nodes (59): main, main, package:flutter_app/core/debug/transport_metrics.dart, package:flutter_app/features/settings/presentation/widgets/settings_transport_diagnostics_card.dart, _buildTestWidget, callCount, chatListener, completeLast (+51 more)
...
Cohesion: 0.03
Nodes (63): _audioMedia, avatarOutsideBubble, _bubbleBorderRadius, bubbleLayout, build, _buildBodyChildren, _buildBubble, _buildFailedMessageAction (+55 more)
...
Cohesion: 0.02
Nodes (90): activeDatabase, importedRows, importedTables, importVerifiedStagedDatabase, message, MigrationDatabaseActiveImportException, MigrationDatabaseActiveImportResult, _runQuickCheck (+82 more)

### Community 192 - "Community 192"
Cohesion: 0.03
Nodes (61): bridge, contactRepository, DefaultShareBatchDeliveryCoordinator, deliver, detail, ext, failedTargetKeys, failureCount (+53 more)

### Community 193 - "Community 193"
Cohesion: 0.03
Nodes (60): BackgroundPreference, package:flutter_app/features/settings/presentation/widgets/settings_group.dart, package:flutter_app/features/settings/presentation/widgets/settings_qr_tiles.dart, backgroundPreference, build, introducedUsernames, introductionCount, onBackToConversation (+52 more)
...
Cohesion: 0.03
Nodes (61): _RealisticKemSizedStreamCrypto, _NeverUsedStreamCrypto, _assertSessionMatches, associatedDataSha256, base64Encode, bridge, BridgeMigrationStreamCrypto, bundleId (+53 more)

### Community 197 - "Community 197"
Cohesion: 0.03
Nodes (59): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState, chatMessageStream (+51 more)

### Community 198 - "Community 198"
Cohesion: 0.03
Nodes (61): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, _RecorderRepo, _FakeMediaAttachmentRepository (+53 more)
...
Cohesion: 0.03
Nodes (52): archiveGroup, candidate, canonicalMembershipEventId, current, gate, group, _groupMembershipMutationLocks, isStaleGroupMembershipEvent (+44 more)
...
Cohesion: 0.03
Nodes (60): DurableLanFakeP2PService, DurableLanSender, connectedPeers, currentState, dialAlwaysFails, dialDelay, dialPeer, discoverAlwaysFails (+52 more)

### Community 205 - "Community 205"
Cohesion: 0.03
Nodes (60): InMemoryInboxStagingRepository, _DeleteSpyStagingRepo, _ThrowingInboxStagingRepository, RecoveredInboxReplayOutcome, action, bridge, build, buildSweepService (+52 more)

### Community 206 - "Community 206"
Cohesion: 0.03
Nodes (59): package:flutter_app/core/permissions/mic_permission_prompt.dart, main, openPrompt, bgBeginResponse, ciphertext, commandDelays, commandGates, controller (+51 more)

### Community 207 - "Community 207"
Cohesion: 0.03
Nodes (58): FakeIntroductionRepository, bridge, _confirmationValueForState, contactRepo, dispose, emitIntroStatusChanged, finish, introduction (+50 more)
...
Cohesion: 0.03
Nodes (56): _bufferPendingReaction, currentReaction, currentTime, deleteExpired, device, dissolvedAt, group, HandleGroupReactionResult (+48 more)

### Community 210 - "Community 210"
Cohesion: 0.03
Nodes (78): main, payload, isAccountMigrationPairingQr, MigrationQrScannedHandler, aad, acceptedSegmentIndexes, acceptManifest, acceptSegment (+70 more)
...
Cohesion: 0.03
Nodes (56): ../local_discovery/fake_local_p2p_service.dart, FakeLocalP2PService, LocalMessage, LocalP2PService, _RecordingLocalP2PService, bridge, checkHealth, _circuitAddr (+48 more)
...
Cohesion: 0.04
Nodes (53): deliveryResult, EditPinnedPostResult, _editPinnedPostResultForSettlement, envelope, existingState, media, now, pinState (+45 more)
...
Cohesion: 0.04
Nodes (53): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+45 more)

### Community 217 - "Community 217"
Cohesion: 0.04
Nodes (49): DrainGroupOfflineInboxForGroupFn, DrainOfflineInboxFn, _emitMissingGroupId, _emitUnroutable, ForegroundRemoteMessageResult, handleForegroundRemoteMessage, routeTarget, DrainGroupOfflineInboxForGroupFn (+41 more)
...
Cohesion: 0.10
Nodes (32): decodeGroupInboxEntries(), encodeRedisComponent(), encodeRedisGroupInboxRecord(), encodeRedisGroupInboxRecords(), filterInboxEntries(), minInt(), newRedisClientFromURL(), newRedisPushTokenBackend() (+24 more)
...
Cohesion: 0.04
Nodes (50): authenticatedChannelBinding, AuthenticatedMigrationChannelTranscript, authorizationNonce, authorizedAt, authorizeMigrationExport, authorizes, bytes, consumeResult (+42 more)
...
Cohesion: 0.04
Nodes (48): package:flutter_app/features/feed/presentation/widgets/feed_header.dart, package:flutter_app/features/home/presentation/widgets/editable_username_widget.dart, package:flutter_app/features/p2p/presentation/widgets/connection_status_indicator.dart, avatarBytes, backgroundPreference, build, _buildHeader, _controller (+40 more)
...
Cohesion: 0.04
Nodes (49): bridge, contactRepo, declinedAtUtc, declinePendingGroupInvite, DeclinePendingGroupInviteResult, declinerPeerId, declinerPrivateKey, deletePendingInvite (+41 more)
...
Cohesion: 0.04
Nodes (45): createTimer, dispose, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairSweep, GroupPendingKeyRepairTimerFactory, isRunning, _onTick, _running (+37 more)
...
Cohesion: 0.04
Nodes (47): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, archived, blocked, _contact, contacts, freshIso, main (+39 more)
...
Cohesion: 0.03
Nodes (65): deleteGroupAndMessages, deleteLocallyIfDissolved, count, kStuckSendingGroupThreshold, recoverStopwatch, recoverStuckSendingGroupMessages, threshold, attachments (+57 more)
...
Cohesion: 0.04
Nodes (46): announcedDevice, bobAccountKey, bridge, feed, groupId, groupRepo, holdCalls, holdSpy (+38 more)

### Community 262 - "Community 262"
Cohesion: 0.05
Nodes (43): _drain, drainAll, drainForGroup, GroupPendingBroadcastRunner, repository, _safeId, all, _b (+35 more)

### Community 263 - "Community 263"
Cohesion: 0.04
Nodes (42): MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator, file (+34 more)
...
Cohesion: 0.07
Nodes (22): pruneExpiredInboxMessages(), TestMemoryInbox_StoreAtCapEvictsOldestReturnsStored(), ensureInboxMessageID(), extractMessageId(), stringSlicesEqual(), memoryGroupInboxBackend, memoryInboxBackend, memoryRendezvousBackend (+14 more)
...
Cohesion: 0.04
Nodes (43): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+35 more)
...
Cohesion: 0.06
Nodes (37): event, main, fake_local_discovery_service.dart, main, peerA, peerB, ../local_discovery/fake_local_discovery_service.dart, LanSendAck (+29 more)
...
Cohesion: 0.05
Nodes (41): countNeedsAttentionEntries, countQuarantinedEntries, deleteEntry, _entries, entry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds (+33 more)
...
Cohesion: 0.05
Nodes (42): ../models/group_key_info.dart, ../models/group_member.dart, ../models/group_model.dart, archiveGroup, attemptCount, clearGroupRejoinState, clearPendingKeyRotation, clearPendingKeyRotations (+34 more)
...
Cohesion: 0.05
Nodes (38): _activeDepth, _activeDepthListenable, begin, end, GroupRecoveryGate, groupRecoveryPendingError, isActive, isGroupRecoveryInProgress (+30 more)

### Community 301 - "Community 301"
Cohesion: 0.05
Nodes (39): groupRepo, main, makeReactionJson, msgRepo, reactionRepo, seedStored, bridge, _expectSignedReactionReplayEnvelope (+31 more)

### Community 302 - "Community 302"
Cohesion: 0.05
Nodes (40): call, callIndex, calls, captureFlowEvents, contactPeerId, fixedNow, id, main (+32 more)

### Community 303 - "Community 303"
Cohesion: 0.02
Nodes (82): contactRepo, createdAt, introRepo, main, makeIntro, makeRequest, messageRepo, otherPeerId (+74 more)
...
Cohesion: 0.12
Nodes (33): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), cloneGroupConfig(), countRemoteGroupMembers(), groupRendezvousNamespace(), assertGM030DiscoveryEventTotals(), pgc012CanAcquireNodeRLock(), TestGA022MalformedPeerIDsInConfigDoNotCrashDiscoveryDialAndCounters() (+25 more)
...
Cohesion: 0.05
Nodes (40): _badgeLabel, containsKey, env, _isPlainOnline, _isRelayReady, _isSendable, main, _relayPeerId (+32 more)
...
Cohesion: 0.05
Nodes (38): db, main, makeRow, InboxStagingRepositoryImpl, db, main, makeEntry, repo (+30 more)
...
Cohesion: 0.02
Nodes (105): _GateableReactionRepository, _OrderRecordingReactionRepository, bridge, _captureFlowEvents, contactRepo, deliver, envelope, events (+97 more)
...
Cohesion: 0.05
Nodes (36): block, contentHashValidation, copyWith, _emitGroupFeedMediaVerifyEvent, file, fileBytes, fileExists, _idPrefix (+28 more)
...
Cohesion: 0.05
Nodes (36): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, appDir, canonicalPath, commitPreparedGroupAvatar (+28 more)
...
Cohesion: 0.05
Nodes (37): rejected, LocalMediaReady, MediaOffer, acceptOffer, add, allowedMimePrefixes, _artifactExtension, _cleanupExpired (+29 more)

### Community 337 - "Community 337"
Cohesion: 0.12
Nodes (30): TestDcutrFlagOff_ForcesPrivate_ZeroPunches(), TestDcutrFlagOn_SelectsUpgradeReachability(), DefaultFeatureFlags(), TestFeatureFlags_FdcTransportFlagsShipDarkUntilDeviceProof(), TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), FeatureFlags, dialDirect(), hostHasProtocol() (+22 more)
...
Cohesion: 0.06
Nodes (33): main, processorReturningNull, processorUnwritten, processorWriting, solidJpeg, tempDir, compressAndGetFile, _compressFile (+25 more)
...
Cohesion: 0.05
Nodes (36): bridge, chatListener, cliMlKemPublicKey, cliPeer, cliPeerId, cliPublicKey, _configuredTempDir, _configuredWriteDir (+28 more)

### Community 344 - "Community 344"
Cohesion: 0.02
Nodes (89): main, package:flutter_app/features/p2p/domain/models/discovered_peer.dart, connectedPeerId, currentState, dialPeer, discoverLocalPeer, _DiscoverMissProbeConnectedP2PService, discoverPeer (+81 more)
...
Cohesion: 0.06
Nodes (32): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+24 more)
...
Cohesion: 0.06
Nodes (32): _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake, getApplicationDocumentsPath (+24 more)
...
Cohesion: 0.04
Nodes (43): benchmark_harness.dart, BenchmarkHarness, main, package:flutter_app/core/utils/notification_tap_timing.dart, package:flutter_app/features/p2p/domain/models/connection_state.dart, harness, main, harness (+35 more)
...
Cohesion: 0.06
Nodes (30): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, declineContactRequest, DeclineContactRequestResult, peerIdPrefix (+22 more)
...
Cohesion: 0.06
Nodes (30): channel, log, main, apnsToken, build, deadline, encoded, fcmToken (+22 more)
...
Cohesion: 0.06
Nodes (30): buildQRPayload, BuildQRPayloadResult, dataToSign, finalJson, identity, _redactedPeerId, signature, signedPayload (+22 more)

### Community 376 - "Community 376"
Cohesion: 0.06
Nodes (31): appendGroupEventLogEntry, _appendSignedCreateEvent, canonicalPayload, createGroup, deleteGroup, group, groupId, groupKey (+23 more)
...
Cohesion: 0.06
Nodes (31): main, map, bridge, calledCommands, checkHealth, contactRepo, conversationTracker, directMessage (+23 more)
...
Cohesion: 0.06
Nodes (31): attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage, envelope, excluded (+23 more)
...
Cohesion: 0.06
Nodes (28): clear, setTarget, showStatus, _statusMessage, _target, appShellController, _armTimers, _cancelTimers (+20 more)
...
Cohesion: 0.07
Nodes (28): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+20 more)
...
Cohesion: 0.07
Nodes (27): EdgeInsets, package:flutter_app/features/groups/presentation/widgets/expandable_fab.dart, package:flutter_app/features/groups/presentation/widgets/glow_fab.dart, Positioned, anchor, build, _buildMenuItem, _close (+19 more)
...
Cohesion: 0.07
Nodes (26): contactRepo, dispose, incomingPresenceStream, _onMessage, PostPresenceListener, postPresenceStream, _presenceController, snapshotRepo (+18 more)
...
Cohesion: 0.07
Nodes (28): at, buildVerdict, clearDeliveredNotifications, consumeInitialPayload, contactPeerId, _dbName, dispose, initialize (+20 more)
...
Cohesion: 0.05
Nodes (36): AppendGroupEventLogEntry, announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled (+28 more)
...
Cohesion: 0.12
Nodes (19): reserveLocalTCPPort(), Listener, Network, startDeadDialListener(), TestConcurrentSendDialNoSerialize(), TestStartEmitsColdStartLockWindow(), waitForStartupPhase(), deadDialListener (+11 more)
...
Cohesion: 0.07
Nodes (26): main, _acquireWakeLock, _amplitudeBridgeSub, _amplitudeController, amplitudeStream, cancel, _currentOutputPath, _defaultOutputPath (+18 more)
...
Cohesion: 0.08
Nodes (26): AccountMigrationMoveSizeEstimate, AccountMigrationOldPhonePresentationState, AccountMigrationOldPhoneStatus, AccountMigrationProgressStage, AccountMigrationProgressStageStatus, AccountMigrationQrPresentationState, AccountMigrationQrPresentationStatus, AccountMigrationRole (+18 more)
...
Cohesion: 0.08
Nodes (25): addPage, _fixedDateFixtureRetentionNow, getLatestRepairForGroup, getRepair, getVisibleRepairsForGroup, _historyGaps, inboxRetrieveCount, _InMemoryGroupHistoryGapRepairRepository (+17 more)

### Community 455 - "Community 455"
Cohesion: 0.08
Nodes (23): _defaultMintToken, issueForContacts, IssueWakeTokensUseCase, clear, events, eventsNamed, _InMemoryWakeTokenStore, main (+15 more)
...
Cohesion: 0.08
Nodes (25): package:flutter_app/features/groups/presentation/screens/group_conversation_wired.dart, bridge, buildWidget, contactRepo, _FakeIdentityRepository, groupMessageStream, groupReactionChangeStream, groupRemovedStream (+17 more)
...
Cohesion: 0.08
Nodes (24): Alignment, _active, alignment, build, child, color, createState, dismissFraction (+16 more)
...
Cohesion: 0.08
Nodes (22): main, MediaAttachment, MigrationSecureStorageKey, package:flutter_app/core/secure_storage/secret_storage_references.dart, package:flutter_app/features/account_migration/application/migration_secure_storage_reference_collector.dart, package:flutter_app/features/conversation/domain/repositories/media_attachment_repository_impl.dart, containsKey, delete (+14 more)
...
Cohesion: 0.08
Nodes (23): BoxFit, build, _buildImage, cacheHeight, cacheWidth, _configureThumbnailFuture, createState, didUpdateWidget (+15 more)
...
Cohesion: 0.08
Nodes (24): action, buildEncryptedEnvelope, buildEnvelopeMessageId, ensureEnvelopeMessageId, fromInnerJson, fromJson, introducedId, introducedMlKemPublicKey (+16 more)
...
Cohesion: 0.08
Nodes (23): bridge, daveRow, daveRowId, device, enqueue, finalizeDistributed, finalizeUnreachable, getDistribution (+15 more)
...
Cohesion: 0.08
Nodes (23): RelayLiveSendObserver, FakeP2PService, after, bridge, buildService, checkHealth, _classBlock, dispose (+15 more)
...
Cohesion: 0.08
Nodes (20): ../features/conversation/application/send_chat_message_use_case_test.dart, amplitudeStream, AudioRecorderService, cancel, dispose, durationStream, hasPermission, isRecording (+12 more)
...
Cohesion: 0.08
Nodes (23): countIncomingMessage, _dbName, deadline, _defaultDbName, hasIncomingMessage, incomingMessages, interval, loadIncomingMessage (+15 more)

### Community 499 - "Community 499"
Cohesion: 0.08
Nodes (23): configureInboundChatCommitHandler, discoveredPeers, discoveredPeersStream, discoverLocalPeer, _discovery, dispose, isLocalPeer, localMessageStream (+15 more)
...
Cohesion: 0.08
Nodes (23): MobileScannerController, package:mobile_scanner/mobile_scanner.dart, build, _buildCloseButton, _buildFlashButton, contactDefaults, _controller, copy (+15 more)
...
Cohesion: 0.09
Nodes (21): MessageReaction, main, testReaction, messageId, reaction, ReactionChangeType, senderPeerId, type (+13 more)
...
Cohesion: 0.09
Nodes (22): AudioRecorder, disable, disableCalls, dispose, enable, enableCalls, _FakeAudioRecorder, fakeDriver (+14 more)
...
Cohesion: 0.10
Nodes (19): _RecordingBridge, bridge, calledCommands, checkHealth, dispose, inboxStagingRepository, initialize, _initialized (+11 more)

### Community 517 - "Community 517"
Cohesion: 0.04
Nodes (44): _DigestSink, Digest, _DigestSink, add, _CallbackSink, close, complete, _computeSha256 (+36 more)
...
Cohesion: 0.09
Nodes (20): HttpServer, accepted, committed, isAccepted, isCommitted, isRejected, _kind, LanInboundChatCommitHandler (+12 more)
...
Cohesion: 0.13
Nodes (11): featureFlagsStatusMap(), limitRelayAddresses(), relayInfoAttemptCandidates(), RelayInfo, RelaySelector, FeatureFlags, Node, ID (+3 more)
...
Cohesion: 0.10
Nodes (20): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+12 more)

### Community 536 - "Community 536"
Cohesion: 0.10
Nodes (20): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, _FakeMediaAttachmentRepository, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+12 more)
...
Cohesion: 0.10
Nodes (19): commentExists, createdAt, deliveryResult, envelope, maxConcurrentRecipients, persistRepostEngagementParticipantIfNeeded, post, postId (+11 more)
...
Cohesion: 0.11
Nodes (18): _bridge, dispose, DistributeGroupKeyAtEpochToPeer, _emitUnauthorized, _enqueue, GroupKeyRepairResponderListener, _groupRepo, _handle (+10 more)
...
Cohesion: 0.11
Nodes (17): contact, contactKey, group, groupKey, key, kind, label, requireContact (+9 more)
...
Cohesion: 0.11
Nodes (18): package:flutter_app/core/services/active_peer_keepalive_use_case.dart, activePeer, build, drains, events, eventsNamed, _FakeProbe, interval (+10 more)
...
Cohesion: 0.11
Nodes (17): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, ContactRequestRepository, addRequest, count, deleteRequest, getPendingRequests (+9 more)

### Community 577 - "Community 577"
Cohesion: 0.11
Nodes (17): addContact, avatarPath, contact, dlFn, existingContact, handleMutualAcceptance, isIntroduced, isRecipient (+9 more)
...
Cohesion: 0.11
Nodes (17): attempts, deleteAttempt, deleteAttemptsForGroup, getAttempt, getAttemptsForGroup, getStatusesForGroupMembers, getStatusForMember, identity (+9 more)
...
Cohesion: 0.12
Nodes (15): group_pending_membership_message_repository.dart, ../models/group_pending_membership_message.dart, deletePendingMessage, deletePendingMessageByGroupAndMessageId, getPendingMessages, getPendingMessagesForGroupAndSenders, GroupPendingMembershipMessageRepository, deletePendingMessage (+7 more)
...
Cohesion: 0.12
Nodes (16): activeKey, appleAccessGroup, category, criticality, hashCode, includeInExportPayload, MigrationSecureStorageKeyCategory, MigrationSecureStorageKeyCriticality (+8 more)
...
Cohesion: 0.12
Nodes (15): EncryptedMediaArtifact, call, _callCount, _defaultResult, FakeUploadMediaFn, _lastAllowedPeers, _lastBlobId, _lastDeleteSourceWhenDone (+7 more)

### Community 620 - "Community 620"
Cohesion: 0.13
Nodes (15): acquire, _activeHolds, debugActiveHolds, debugReset, debugSetDriver, disable, _driver, enable (+7 more)
...
Cohesion: 0.15
Nodes (12): concurrentInbox, delivered, jsonString, payload, reaction, reactionId, saveReaction, sendReaction (+4 more)
...
Cohesion: 0.15
Nodes (12): media_grid_cell.dart, build, _buildFourPlus, _buildLayout, _buildSingle, _buildThree, _buildTwo, media (+4 more)
...
Cohesion: 0.17
Nodes (11): _activeTab, AppShellChangeKind, AppShellController, _backgroundPreference, _lastChangeKind, notifyIdentityChanged, notifyMediaQualityChanged, setBackgroundPreference (+3 more)
...
Cohesion: 0.17
Nodes (11): deletePendingMessage, deletePendingMessageByGroupAndMessageId, getPendingMessages, getPendingMessagesForGroupAndSenders, InMemoryGroupPendingMembershipMessageRepository, _messages, pruneGroup, savePendingMessage (+3 more)

### Community 689 - "Community 689"
Cohesion: 0.07
Nodes (25): ageOffset, base, contactPeerId, createdAt, id, makeAliceIdentity, makeBobContact, makeFailedMessageWithEnvelope (+17 more)
...
Cohesion: 0.17
Nodes (11): audioCount, gifCount, hasAudio, hasImage, hasVideo, imageCount, join, mediaPreviewIcon (+3 more)
...
Cohesion: 0.20
Nodes (8): comments, loadPostComments, wait, package:flutter_app/features/posts/application/load_post_comments_use_case.dart, package:flutter_app/features/posts/domain/models/post_comment_model.dart, package:flutter_app/features/posts/domain/models/post_comment_reaction_model.dart, main, postRepo
...
Cohesion: 0.20
Nodes (8): main, package:flutter_app/features/groups/domain/models/group_invite_delivery_attempt.dart, groupInviteCannotSendReason, groupInviteCannotSendSnackBarMessage, groupInviteStatusDetail, groupInviteStatusLabel, l10n, lastError
...
Cohesion: 0.20
Nodes (9): main, makePayload, testMlkem, testNs, testPk, testRv, testSig, testTs (+1 more)
...
Cohesion: 0.22
Nodes (8): avatarBase64, avatarByteLength, maxBytes, normalizer, PreparedRepostAvatarSnapshot, prepareRepostAvatarSnapshot, sourceFile, tempDir
...
Cohesion: 0.22
Nodes (8): IosApnsNotificationOpenBridge, bridge, channel, completer, data, main, _sendNativeMethodCall, package:flutter_app/core/notifications/ios_apns_notification_open_bridge.dart
...
Cohesion: 0.33
Nodes (5): db, main, main, package:flutter_app/core/database/helpers/group_rejoin_state_db_helpers.dart, package:flutter_app/core/database/migrations/088_group_rejoin_state.dart
...
Cohesion: 0.33
Nodes (6): NotificationTapLiveRenderTiming, NotificationTapTiming, ConversationWired, _ConversationWiredState, GroupConversationWired, _GroupConversationWiredState
...
Cohesion: 0.40
Nodes (5): failureEvent, GroupMembershipUpdateListener, GroupMessageListener, GroupKeyRepairRequest, GroupKeyRepairRequestSender
...
Cohesion: 0.40
Nodes (4): eventsNamed, flowEvents, main, package:flutter_app/features/account_migration/application/migration_transfer_keep_alive.dart
...
Cohesion: 0.40
Nodes (4): media_display_helpers.dart, build, durationMs, VideoThumbnailOverlay
...
Cohesion: 0.50
Nodes (3): buildIntroduction, main, package:flutter_app/features/introduction/application/introduction_copy.dart
...
Cohesion: 0.50
Nodes (3): package:flutter_app/features/introduction/domain/models/pending_introduction_response.dart, package:flutter_app/features/introduction/domain/repositories/introduction_repository_impl.dart, main

### Community 865 - "Community 865"
Cohesion: 0.50
Nodes (4): ReadinessProofRecorder, FakeP2PService, P2PFullInboxDrain, _CensusFakeP2PService
...
## Knowledge Gaps
- **34709 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+34704 more)
...
- **Why does `incomingMessage` connect `Community 40` to `Community 581`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 331` to `Community 504`, `Community 581`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 69` to `Community 393`, `Community 270`, `Community 530`, `Community 29`, `Community 32`, `Community 161`, `Community 164`, `Community 553`, `Community 41`, `Community 42`, `Community 810`, `Community 429`, `Community 304`, `Community 818`, `Community 434`, `Community 308`, `Community 562`, `Community 311`, `Community 186`, `Community 838`, `Community 458`, `Community 81`, `Community 337`, `Community 599`, `Community 727`, `Community 96`, `Community 228`, `Community 102`, `Community 621`, `Community 116`, `Community 504`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _34709 weakly-connected nodes found - possible documentation gaps or missing edges._
