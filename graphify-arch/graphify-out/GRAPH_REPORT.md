# Graph Report - graphify-arch  (2026-06-23)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 41399 nodes · 64440 edges · 898 communities (849 shown, 49 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2408 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1d2edae`
...
## Communities (898 total, 49 thin omitted)
...
Cohesion: 0.01
Nodes (415): AnimatedOpacity, contactRepo, main, requestRepo, testRequest, main, main, _pendingRequest (+407 more)
...
Cohesion: 0.01
Nodes (279): AlertDialog, Align, AnimatedContainer, CircularProgressIndicator, ClipRRect, ConstrainedBox, Directionality, buildTestApp (+271 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (268): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+260 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (243): LanAvailabilitySnapshot, IconData, Key, PostModel, AccountMigrationJourneyScreen, actionLabel, active, backgroundPreference (+235 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (250): absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub, _applyMessageUpdate (+242 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (228): main, ContactRequestNotificationMaterializer, buildRepo, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main (+220 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (226): _ActiveAttachmentUpload, _ComposerSnapshot, conversation_screen.dart, PrepareEncryptedMediaArtifactFn, absoluteDurablePath, _ActiveAttachmentUpload, _activeQuoteMessageId, _allowPopDuringActiveUpload (+218 more)
...
Cohesion: 0.01
Nodes (197): channel, log, main, logOnlyToken, main, mainPath, nsePath, readSource (+189 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (234): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+226 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (213): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie (+205 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (206): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+198 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (170): bridge, introRepo, main, p2pService, payload, probeRelay, probeRelayCallCount, _RelayProbeFakeP2PService (+162 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (196): DeleteMessageForEveryoneFn, DeleteMessageForMeFn, EditChatMessageFn, feed_screen.dart, FeedStore, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate (+188 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (184): main, main, main, orbit_screen.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart, package:flutter_app/features/settings/domain/models/image_quality_preference.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount (+176 more)
...
Cohesion: 0.01
Nodes (176): archiveGroup, _FailingGroupRepository, groupId, groupRepo, main, bridge, deleteMessagesForGroup, _FailingGroupMessageRepository (+168 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (153): dbDeleteExpiredGroupInviteConsumptions, dbLoadGroupInviteConsumption, dbUpsertGroupInviteConsumption, inviteId, dbClearGroupRejoinState, dbForceGroupRejoinEligible, dbLoadGroupRejoinStates, dbRecordGroupRejoinFailure (+145 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (170): comments, loadPostComments, wait, _changes, dispose, load, loadAll, save (+162 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (158): _badgeLabel, containsKey, env, _isPlainOnline, _isRelayReady, _isSendable, main, _relayPeerId (+150 more)
...
Cohesion: 0.01
Nodes (152): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, DeliveryReceiptListener, dispose, messageRepo, receiptStream, start (+144 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (146): bytesToWrite, captureCipherMetadata, commands, _createSeededAccountDb, execute, exportDestinationKey, exportDestinationPath, exportSqlCipherDatabase (+138 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (148): _InstrumentedGroupMessageRepository, _InstrumentedGroupMessageRepository, announcedDevice, bobAccountKey, bridge, feed, groupId, groupRepo (+140 more)

### Community 27 - "Community 27"
Cohesion: 0.01
Nodes (161): applied, pendingEvents, reconcilePendingPostChildEvents, InMemoryPostRepository, _BlockingWritePostRepository, buildJson, contacts, content (+153 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (115): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), buildGroupMessageExtra(), countRemoteGroupMembers(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), findMember(), groupRendezvousNamespace() (+107 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (161): ElevatedButton, EncryptedMediaTestBridge, RelayMediaStore, ImagePicker, bridge, _createdAt, encTempsUnder, imageProcessor (+153 more)

### Community 30 - "Community 30"
Cohesion: 0.02
Nodes (137): _incoming, main, isDeleted, isIncoming, main, _msg, canWrite, contactPeerId (+129 more)
...
Cohesion: 0.02
Nodes (143): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, ../../../conversation/domain/repositories/fake_reaction_repository.dart (+135 more)

### Community 33 - "Community 33"
Cohesion: 0.01
Nodes (167): _acceptedSignedTransitionAuditHashesBySourceId, _accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _allowsSnapshotBackedSystemSender, _appendGroupEventLogEntry, appendSystemEventLog, _applyAuthoritativeGroupConfigSnapshot, _autoDownloadMedia (+159 more)

### Community 34 - "Community 34"
Cohesion: 0.01
Nodes (154): NearbyDevicePosition, alice, alicePeerId, bob, bobPeerId, bridge, _buildBridge, chatListener (+146 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (155): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), generateFakeRelayAddr(), TestBuildRelaySelector_FallsBackToDefault(), TestBuildRelaySelector_UsesServerAddresses() (+147 more)

### Community 36 - "Community 36"
Cohesion: 0.01
Nodes (152): Animation, dart:ui, package:flutter_app/core/theme/glassmorphism.dart, avatarBytes, backgroundPreference, build, _buildHeader, _controller (+144 more)

### Community 37 - "Community 37"
Cohesion: 0.02
Nodes (112): showGroupMissingNotificationFeedback, CustomPaint, Material, Offset, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/contact_request/presentation/widgets/pending_requests_badge.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, package:flutter_app/features/home/presentation/widgets/scan_friend_card.dart (+104 more)
...
Cohesion: 0.01
Nodes (137): archiveContact, archiveGroup, deleteGroupAndMessages, deleteLocallyIfDissolved, absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial (+129 more)

### Community 41 - "Community 41"
Cohesion: 0.02
Nodes (124): CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+116 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (133): db, main, makeIntroductionRow, makeOutboxRow, makePendingResponseRow, buildIntroductionRepository, buildMessageRepository, db (+125 more)

### Community 43 - "Community 43"
Cohesion: 0.01
Nodes (163): _CursorInboxBridge, _FailDecryptBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, bridge, command, fullGroupConfig (+155 more)
...
Cohesion: 0.02
Nodes (136): AnnotatedRegion, _activeTab, _backgroundPreference, setBackgroundPreference, switchTo, main, BackgroundPreference, BoxDecoration (+128 more)

### Community 46 - "Community 46"
Cohesion: 0.06
Nodes (148): ParseGroupEnvelope(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash() (+140 more)
...
Cohesion: 0.02
Nodes (133): AccountMigrationReceiverEvents, AccountMigrationSizeGate, AccountMigrationMoveSizeEstimate, calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath (+125 more)
...
Cohesion: 0.02
Nodes (99): _bestEffortIncomingCleanup, blockedSenderOwnsStoredMessage, contact, envelopeSenderPeerId, handleIncomingMessageDeletion, HandleMessageDeletionResult, maybeSendDeliveryReceipt, mediaAttachmentRepo (+91 more)

### Community 51 - "Community 51"
Cohesion: 0.02
Nodes (128): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, bridge, contactPeerId, contactRepo, _contactWithMlKem (+120 more)
...
Cohesion: 0.02
Nodes (138): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, GroupPendingKeyRepairRunner, _IntroOrbitHarness, _IntroOrbitHarnessState, PostDeliveryRunner, FlowEvent (+130 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (125): FakeP2PNetwork, bridge, contact, _createdAt, deliver, inboxEnvelope, keyedAttachment, keylessLegacyAttachment (+117 more)

### Community 55 - "Community 55"
Cohesion: 0.01
Nodes (135): InkWell, durationMs, height, path, VideoProcessResult, width, addContact, archiveContact (+127 more)
...
Cohesion: 0.02
Nodes (126): Brightness, BuildContext, Color, ContactModel, _accent, background, borderColor, build (+118 more)
...
Cohesion: 0.02
Nodes (101): AccountMigrationNetworkGate, accountMigrationNetworkGate, prepareNotificationRouteTarget, result, count, kStuckSendingGroupThreshold, recoverStopwatch, recoverStuckSendingGroupMessages (+93 more)

### Community 62 - "Community 62"
Cohesion: 0.02
Nodes (111): main, alice, bob, main, network, _originalText, dart:async, fake_group_pubsub_network.dart (+103 more)

### Community 63 - "Community 63"
Cohesion: 0.02
Nodes (129): _RecordingNavigatorObserver, NavigatorObserver, Route, _RecordingNavigatorObserver, acceptedUpdates, acceptGate, allGroupsGate, archivedContactsGate (+121 more)
...
Cohesion: 0.02
Nodes (119): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, ../../domain/orbit3_one_circle_layout.dart, orbital_avatar.dart, orbital_ring_painter.dart, overflow_badge.dart (+111 more)
...
Cohesion: 0.02
Nodes (113): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+105 more)

### Community 68 - "Community 68"
Cohesion: 0.02
Nodes (114): created, createdAt, createResult, createStopwatch, deduped, _deriveDraftMediaKind, emitPostTiming, firstKind (+106 more)

### Community 69 - "Community 69"
Cohesion: 0.02
Nodes (119): main, _makeAttachment, mime, package:flutter_app/features/conversation/presentation/widgets/blocked_banner.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment, allowEditAction (+111 more)
...
Cohesion: 0.02
Nodes (114): package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/conversation/domain/utils/message_run_grouping.dart, bannerText, emptySubtitle, emptyTitle, GroupBacklogRetentionNotice, groupBacklogRetentionNoticeFor (+106 more)
...
Cohesion: 0.02
Nodes (108): AspectRatio, FileImage, GestureDetector, IconButton, Image, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen (+100 more)
...
Cohesion: 0.02
Nodes (89): buildBridgeMigrationCutoverLeaseCleanup, benchmark_helpers.dart, client, lastCall, main, details, events, _findRecoveredOutage (+81 more)

### Community 77 - "Community 77"
Cohesion: 0.02
Nodes (110): _InstrumentedBridge, _DelayRevocationDecryptBridge, append, bridge, controller, _DelayedUpdateKeyBridge, entries, errorCode (+102 more)
...
Cohesion: 0.03
Nodes (68): addContact, AddContactResult, addContact, archiveContact, blockContact, contactExists, deleteContact, dismissIntroBanner (+60 more)
...
Cohesion: 0.02
Nodes (101): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, addResult, contact (+93 more)

### Community 82 - "Community 82"
Cohesion: 0.02
Nodes (100): main, _dbKey, fixedKey, main, errors, hasError, isAccepted, MigrationDatabaseImportError (+92 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (111): main, member, MapEntry, package:flutter_app/features/groups/application/group_media_allowed_peers.dart, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge (+103 more)
...
Cohesion: 0.02
Nodes (105): package:flutter_app/core/utils/text_direction_utils.dart, backgroundPreference, build, _buildConfirmButton, _buildContactList, _buildEmptyState, _buildHeader, _buildLoadErrorState (+97 more)

### Community 86 - "Community 86"
Cohesion: 0.02
Nodes (110): AudioPlayerPlatform, audioAttachment, bob, BobTestHarness, clearNotifications, conversationTracker, currentState, dialPeer (+102 more)

### Community 87 - "Community 87"
Cohesion: 0.02
Nodes (81): AdmitSiblingDeviceFn, admitSiblingDeviceIfTrusted, alreadyPresent, deviceId, EnqueueDeferredGroupKeyDistributionFn, existingById, existingByTransport, latestKey (+73 more)
...
Cohesion: 0.02
Nodes (101): bridge, buildMigrationQRData, buildValidQRData, contactRepo, identityRepo, main, ownPeerId, p2pService (+93 more)

### Community 92 - "Community 92"
Cohesion: 0.02
Nodes (94): avatarSnapshots, hydratePostSurfaceItems, mediaMap, postList, repostHeartBaselines, viewerSharedToCounts, wait, authorPeerId (+86 more)
...
Cohesion: 0.03
Nodes (72): activeChunks, decapsulateSession, decryptChunk, encapsulateSession, encryptChunk, files, length, main (+64 more)

### Community 96 - "Community 96"
Cohesion: 0.02
Nodes (101): CountingGroupMessageRepository, DateSeparator, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay (+93 more)
...
Cohesion: 0.02
Nodes (84): runAckBenchmark, runConnectionReuseBenchmark, events, _logSendDetails, runRoutingPathsBenchmark, _sendAndCaptureTiming, substeps, timings (+76 more)

### Community 101 - "Community 101"
Cohesion: 0.02
Nodes (87): db, main, db, main, makeKeyRow, db, main, makeMemberRow (+79 more)
...
Cohesion: 0.03
Nodes (70): activeDatabase, importedRows, importedTables, importVerifiedStagedDatabase, message, MigrationDatabaseActiveImportException, MigrationDatabaseActiveImportResult, _runQuickCheck (+62 more)
...
Cohesion: 0.02
Nodes (93): addContact, author, bridge, _contact, contactRepo, create, deadline, dispose (+85 more)
...
Cohesion: 0.03
Nodes (76): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, accountMigrationNetworkGate (+68 more)
...
Cohesion: 0.05
Nodes (43): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, EventCallback, isRetryableChatStreamOpenError(), messageEnvelopeType(), readFrame() (+35 more)
...
Cohesion: 0.03
Nodes (71): db, insertOutgoing, main, row, assertOutgoingTransition, db, main, makeRow (+63 more)
...
Cohesion: 0.03
Nodes (78): _FakeIdentityRepo, _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity (+70 more)

### Community 132 - "Community 132"
Cohesion: 0.02
Nodes (79): ../../domain/models/orbit2_layout_template.dart, ../../domain/models/orbit2_view_mode.dart, Orbit2ViewMode, orbit2_mock_chat_screen.dart, activeTab, backgroundPreference, build, _canvasFriends (+71 more)
...
Cohesion: 0.03
Nodes (76): _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _TrackingInviteDeliveryAttemptRepository, _InMemoryInviteDeliveryAttemptRepository, _InMemoryInviteDeliveryAttemptRepository, contact, contactKey, group (+68 more)
...
Cohesion: 0.02
Nodes (120): build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt, shareIntentService, pendingIntent (+112 more)
...
Cohesion: 0.03
Nodes (65): Column, EdgeInsets, nav_bar_button.dart, nav_bar_theme.dart, package:flutter_app/features/conversation/presentation/widgets/compact_origin_marker.dart, package:flutter_app/features/conversation/presentation/widgets/empty_conversation_state.dart, package:flutter_app/features/feed/presentation/widgets/nav_bar_button.dart, package:flutter_app/features/feed/presentation/widgets/nav_bar_theme.dart (+57 more)
...
Cohesion: 0.03
Nodes (69): main, main, checkHealth, conditionalTransitionStatus, _contactB, _contactC, currentState, deleteMessage (+61 more)
...
Cohesion: 0.05
Nodes (40): package:flutter_app/features/conversation/presentation/widgets/reaction_bar.dart, Rect, anchorRect, backdropKey, build, _clampToViewport, color, _ContextMenuAction (+32 more)

### Community 148 - "Community 148"
Cohesion: 0.03
Nodes (65): ../../application/orbit2_mock_data.dart, Orbit2ChatLine, Orbit2InboxEntry, ../domain/models/orbit2_friend.dart, ../domain/models/orbit2_group.dart, orbit2_group_node.dart, package:flutter_app/features/home/presentation/widgets/profile_avatar_widget.dart, package:flutter_app/features/home/presentation/widgets/user_avatar.dart (+57 more)
...
Cohesion: 0.02
Nodes (84): _MemoryCutoverRepository, advertisedPeerId, captureCipherMetadata, clearAuthority, clearCutover, consumed, consumeSession, _controller (+76 more)
...
Cohesion: 0.03
Nodes (55): byId, expireOldIntroductions, introducedRows, _loadMutualAcceptedIntroductions, pending, recipientRows, repairedCount, repairedMutualAcceptanceIds (+47 more)
...
Cohesion: 0.03
Nodes (61): AudioRecorderService, compressed,, FakeGroupReactionReplayOutboxRepository, group_reaction_replay_outbox_repository.dart, GroupReactionReplayOutboxRepository, RecordAudioRecorderService, ../models/group_reaction_replay_outbox_entry.dart, fromStorageString (+53 more)

### Community 167 - "Community 167"
Cohesion: 0.03
Nodes (63): _FakeP2PService, _FakeP2PService, _FakeP2PService, FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService, _ThrowOnSendP2PService (+55 more)
...
Cohesion: 0.03
Nodes (60): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+52 more)

### Community 170 - "Community 170"
Cohesion: 0.03
Nodes (61): NearbyLocationServiceImpl, refreshNearbyOnStartup, _FakeNearbyLocationService, NearbyLocationService, package:flutter_app/features/posts/application/nearby_location_service.dart, package:flutter_app/features/posts/application/refresh_nearby_on_startup_use_case.dart, _FakeNearbyLocationService, activeContactsDelay (+53 more)
...
Cohesion: 0.03
Nodes (60): _assertBackgroundScrollDoesNotRegress, _assertThresholds, average, backgroundP99, backgroundPreference, baselineP99, build, buildTimesMs (+52 more)
...
Cohesion: 0.09
Nodes (35): decodeGroupInboxEntries(), encodeRedisComponent(), encodeRedisGroupInboxRecord(), encodeRedisGroupInboxRecords(), filterInboxEntries(), minInt(), newRedisClientFromURL(), newRedisPushTokenBackend() (+27 more)

### Community 182 - "Community 182"
Cohesion: 0.03
Nodes (60): additionalCount, avatarCacheBustKey, avatarPath, canReact, canWrite, CardThreadFeedItem, collapsedPreviewMessage, connectedVia (+52 more)
...
Cohesion: 0.03
Nodes (59): DurableLanFakeP2PService, DurableLanSender, connectedPeers, currentState, dialAlwaysFails, dialDelay, dialPeer, discoverAlwaysFails (+51 more)
...
Cohesion: 0.03
Nodes (77): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+69 more)
...
Cohesion: 0.04
Nodes (54): AccountMigrationImportPreconditionResult, AccountMigrationImportPreconditionStatus, activeAccountExists, allowed, authority, canStartImport, cleanupRequired, evaluateAccountMigrationImportPrecondition (+46 more)
...
Cohesion: 0.03
Nodes (56): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage (+48 more)
...
Cohesion: 0.04
Nodes (56): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, BonsoirBroadcastFactory, BonsoirDiscoveryFactory, _broadcast, _controller (+48 more)
...
Cohesion: 0.04
Nodes (56): Request, appShellController, bridge, buildFeedWired, contactRepo, contactRequestRepo, _contactUpdateController, contactUpdatedStream (+48 more)

### Community 204 - "Community 204"
Cohesion: 0.06
Nodes (84): buildGroupKeyInfoWithGrace(), decryptGroupEnvelopePayload(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo(), assertRingEpochsNewestFirst(), gk019DirectJumpKeyInfo(), gk020GenerateDistinctEpochKeys(), gk020SequentialRotationKeyInfo() (+76 more)
...
Cohesion: 0.04
Nodes (52): appendGroupEventLogEntry, _appendSignedCreateEvent, canonicalPayload, createGroup, deleteGroup, group, groupId, groupKey (+44 more)
...
Cohesion: 0.04
Nodes (50): Alignment, app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, AppTheme, blurSigma, borderRadius (+42 more)

### Community 222 - "Community 222"
Cohesion: 0.03
Nodes (77): main, events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness (+69 more)
...
Cohesion: 0.03
Nodes (60): package:flutter_app/features/conversation/domain/models/media_preview_descriptor.dart, package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/quote_preview_bar.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart, package:flutter_app/features/orbit/presentation/widgets/orbit_media_preview_label.dart, package:flutter_app/l10n/app_localizations_en.dart, main (+52 more)
...
Cohesion: 0.04
Nodes (44): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+36 more)

### Community 237 - "Community 237"
Cohesion: 0.04
Nodes (45): GenerateIdentityResult, generateNewIdentity, identity, identityJson, keygenStopwatch, mlKemFuture, mlKemResponse, ok (+37 more)
...
Cohesion: 0.04
Nodes (55): fake_group_reaction_replay_outbox_repository.dart, addMember, bridge, broadcastMemberAdded, create, createGroup, deviceId, deviceIdentity (+47 more)

### Community 245 - "Community 245"
Cohesion: 0.04
Nodes (43): DrainGroupOfflineInboxForGroupFn, DrainOfflineInboxFn, _emitMissingGroupId, _emitUnroutable, ForegroundRemoteMessageResult, handleForegroundRemoteMessage, routeTarget, handleShareIntent (+35 more)
...
Cohesion: 0.04
Nodes (46): main, messageRepo, call, callIndex, calls, captureFlowEvents, contactPeerId, fixedNow (+38 more)
...
Cohesion: 0.05
Nodes (45): AudioRecorder, acquire, _activeHolds, debugActiveHolds, debugReset, debugSetDriver, disable, _driver (+37 more)

### Community 250 - "Community 250"
Cohesion: 0.04
Nodes (46): fake_p2p_network.dart, fake_p2p_service_integration.dart, ChaosConfig, config, content, deliver, deliveredCount, _deliverWithDuplicate (+38 more)
...
Cohesion: 0.04
Nodes (47): _FakeMediaFileManager, FakeMediaFileManager, _FakeMediaFileManager, _FakeMediaFileManager, _TempMediaFileManager, accountMigrationNetworkGate, allowed, _allowsPostRetrierNetworkSideEffects (+39 more)
...
Cohesion: 0.05
Nodes (39): absolutePath, age, doneCount, emitRetryTiming, _isFreshOutgoingGroupSend, kFreshGroupUploadRetrySendingThreshold, _lateGroupSendAbortReason, pendingAttachment (+31 more)
...
Cohesion: 0.02
Nodes (84): avatarByIndex, enterManage, innerMembers, innerWorkKey, main, manageToggle, openMessages, r (+76 more)
...
Cohesion: 0.04
Nodes (43): AppendGroupEventLogEntry, _acceptedSignedTransitionAuditHashesBySourceId, _appendGroupEventLogEntry, _bridge, dispose, _enqueueMessage, GroupKeyUpdateListener, _groupRepo (+35 more)
...
Cohesion: 0.04
Nodes (42): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, main, package:flutter_app/features/p2p/application/discover_peer_use_case.dart (+34 more)
...
Cohesion: 0.04
Nodes (42): createdAt, effectiveAt, eventId, fromMap, isActive, pinEventId, pinnedAt, postId (+34 more)

### Community 290 - "Community 290"
Cohesion: 0.05
Nodes (42): package:flutter_app/core/secure_storage/ml_kem_secret_ring.dart, _cachedIdentity, _hasCachedIdentity, IdentityRepositoryImpl, invalidateCache, _kMlKemSecretKey, _kMnemonic12, _kPrivateKey (+34 more)
...
Cohesion: 0.03
Nodes (62): AppLocalizations, LocalizationsDelegate, MemberRole, package:flutter_app/features/identity/presentation/screens/mnemonic_input_screen.dart, package:flutter_app/features/posts/presentation/widgets/comments_sheet.dart, package:flutter_app/features/posts/presentation/widgets/edit_pinned_post_sheet.dart, package:flutter_localizations/flutter_localizations.dart, buildWidget (+54 more)
...
Cohesion: 0.05
Nodes (41): main, package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, _buildTestWidget, chatListener, conditionalTransitionStatus, _contact, _contactPeerId, _delayedSuccessSend (+33 more)
...
Cohesion: 0.04
Nodes (44): package:flutter_app/core/utils/ring_avatar_generator.dart, package:flutter_app/core/utils/ring_avatar_spec.dart, package:flutter_app/features/home/presentation/widgets/ring_avatar.dart, _avatarSnapshotBytes, fromList, main, wrap, ring_avatar_painter.dart (+36 more)
...
Cohesion: 0.05
Nodes (36): cleanupSessionArtifacts, MigrationFileImportCleanup, stagingRootPath, main, MigrationFileManifestBuilder, file, main, writeAsString (+28 more)

### Community 302 - "Community 302"
Cohesion: 0.05
Nodes (36): main, events, h, main, missing, missingCalls, _NotificationSmokeHarness, prepare (+28 more)
...
Cohesion: 0.08
Nodes (34): backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), relayResourcesFromServerLimits(), TestRelayService_EnforcesPerPeerConnectionCap(), TestRelayService_RejectsExcessReservationsPredictably() (+26 more)

### Community 315 - "Community 315"
Cohesion: 0.05
Nodes (38): bobPeerId, buildProfileUpdateMessage, checkHealth, _compressToBytes, dispose, docsPath, envelope, Fake (+30 more)
...
Cohesion: 0.03
Nodes (61): _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiStagedDatabaseOpener, computeDatabaseChecksumForTesting, database, DefaultMigrationStagedDatabaseOpener, manifest, message (+53 more)
...
Cohesion: 0.05
Nodes (33): chatGroup, conversationApp, fortyMessages, localAfternoon, main, messageAt, pumpFrames, rectWithin (+25 more)
...
Cohesion: 0.06
Nodes (34): deliveredWritePatterns, main, scanDeliveredWrites, basePath, bridge, captureFlowEvents, checkHealth, commandLog (+26 more)
...
Cohesion: 0.06
Nodes (33): _MemoryPairingSessionRepository, _MemoryPairingSessionRepository, consumedSessions, consumeSession, empty, failClosed, isSessionConsumed, loadConsumedSession (+25 more)
...
Cohesion: 0.06
Nodes (34): Stopwatch, animation, build, child, _clock, _controller, CosmicBackground, _CosmicBackgroundState (+26 more)
...
Cohesion: 0.06
Nodes (33): avatarPath, _contact, contactPeerId, contactRepo, _group, groupId, _groupMessage, groupMessageRepo (+25 more)
...
Cohesion: 0.06
Nodes (30): main, main, makeNodeState, testPeerId, package:clock/clock.dart, package:flutter_app/features/p2p/domain/models/connection_state.dart, checkHealth, dispose (+22 more)
...
Cohesion: 0.06
Nodes (30): flutter_secure_key_store.dart, FlutterSecureStorage, begin, clearAll, end, _inFlight, inFlightCount, isInFlight (+22 more)
...
Cohesion: 0.07
Nodes (25): fake_secure_key_store.dart, db, main, makeAttachmentRow, makeMessageRow, db, main, db (+17 more)
...
Cohesion: 0.07
Nodes (26): AudioPlayer, attachment, build, _buildUnavailableAudio, _canRetryUnavailableMedia, createState, didUpdateWidget, dispose (+18 more)
...
Cohesion: 0.08
Nodes (22): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+14 more)
...
Cohesion: 0.09
Nodes (19): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, main, cases (+11 more)
...
Cohesion: 0.09
Nodes (22): aliceBridge, aliceMediaRepo, _alicePeerId, basePath, bobBridge, bobContacts, bobFileManager, bobMediaRepo (+14 more)
...
Cohesion: 0.12
Nodes (22): ChatMessageListener, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, MyApp, _MyAppState, NotificationTapLiveRenderTiming (+14 more)

### Community 515 - "Community 515"
Cohesion: 0.10
Nodes (20): _drain, drainAll, drainForGroup, GroupPendingBroadcastRunner, repository, _safeId, all, _b (+12 more)
...
Cohesion: 0.10
Nodes (18): ../features/conversation/application/send_chat_message_use_case_test.dart, amplitudeStream, AudioRecorderService, cancel, dispose, durationStream, hasPermission, isRecording (+10 more)
...
Cohesion: 0.11
Nodes (18): copyWith, fromMap, fromP2PPayload, hashCode, mlKemPublicKey, operator, peerId, publicKey (+10 more)
...
Cohesion: 0.11
Nodes (17): bridge, buildHost, buildMaterializer, contactRepository, identityRepository, main, _makeContact, _makeRequest (+9 more)
...
Cohesion: 0.12
Nodes (14): collectPendingMediaSizeRejections, hashCode, index, MediaRejection, normalizeMediaRejectionReason, operator, reason, rejections (+6 more)
...
Cohesion: 0.13
Nodes (15): build, _controller, createState, didUpdateWidget, dispose, EditableUsernameWidget, _EditableUsernameWidgetState, _finishEditing (+7 more)
...
Cohesion: 0.18
Nodes (10): appWith, chatScreen, edgeDrag, logicalSize, main, seedMessages, settleFrames, main (+2 more)
...
## Knowledge Gaps
- **33497 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+33492 more)
...
- **Why does `incomingMessage` connect `Community 514` to `Community 575`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 326` to `Community 522`, `Community 575`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 522` to `Community 326`, `Community 52`, `Community 318`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _33497 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.006927325490685555 - nodes in this community are weakly interconnected._