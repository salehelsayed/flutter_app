...
## Summary
- 41865 nodes · 65132 edges · 902 communities (856 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2408 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3b15e8c`
...
## Communities (902 total, 46 thin omitted)
...
Cohesion: 0.01
Nodes (326): AlertDialog, showGroupMissingNotificationFeedback, CircularProgressIndicator, Directionality, buildTestApp, main, setPhoneViewport, FilledButton (+318 more)
...
Cohesion: 0.01
Nodes (361): AnimatedOpacity, main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames, events (+353 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (337): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, buildMigrationQRData (+329 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (286): dart:ui, LanAvailabilitySnapshot, ../../domain/orbit3_arch_layout.dart, IconData, Key, AccountMigrationJourneyScreen, actionLabel, active (+278 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (234): comments, loadPostComments, wait, DiscoveredPeer, _contact, contacts, _ControlledP2PService, _dialedPeers (+226 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (231): Animation, AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, GroupPendingKeyRepairRunner, PostDeliveryRunner, _SettleHarness, _SettleHarnessState (+223 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (258): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+250 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (289): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+281 more)
...
Cohesion: 0.01
Nodes (238): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+230 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (256): main, main, makeInvite, pendingInviteRepo, ../../contacts/domain/repositories/fake_contact_repository.dart, ElevatedButton, FakeContactRepository, _FakeNearbyLocationService (+248 more)
...
Cohesion: 0.01
Nodes (216): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+208 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (203): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie (+195 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (222): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+214 more)
...
Cohesion: 0.01
Nodes (210): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+202 more)
...
Cohesion: 0.02
Nodes (198): DatabaseException, db, main, makeContactRow, db, main, makeIdentityRow, db (+190 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (214): ContactRequestNotificationMaterializer, main, buildRepo, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, IosApnsNotificationOpenBridge, accountMigrationAuthorityRepository (+206 more)
...
Cohesion: 0.01
Nodes (179): CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+171 more)
...
Cohesion: 0.01
Nodes (167): AnimatedContainer, AnnotatedRegion, _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo (+159 more)
...
Cohesion: 0.01
Nodes (139): Database, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, db (+131 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (180): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), disableGroupInboxRecoveryForFakeRelayTest(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50() (+172 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (175): main, alice, bob, main, network, _originalText, FakeP2PNetwork, ChaosP2PNetwork (+167 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (240): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, main, makeAttachment, makeMessage, mediaAttachmentRepo (+232 more)

### Community 32 - "Community 32"
Cohesion: 0.01
Nodes (149): Align, ClipRRect, ConstrainedBox, _incoming, main, isDeleted, isIncoming, main (+141 more)
...
Cohesion: 0.04
Nodes (135): buildGroupKeyInfoWithGrace(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), findMember(), isAllowedWriter(), TestGK016GroupTopicValidatorAcceptsEpoch0PreviousKeyDuringFirstRotationGrace(), TestGK017DecryptGroupEnvelopePayloadAcceptsHeldPreviousEpochRegardlessOfGraceDeadline() (+127 more)
...
Cohesion: 0.02
Nodes (132): adminPeerId, baseGroup, bridge, createdAt, expectMembershipVersionWatermarkAlignment, groupId, groupRepo, laterMetadataEventAt (+124 more)

### Community 43 - "Community 43"
Cohesion: 0.02
Nodes (130): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, _InstrumentedGroupMessageRepository (+122 more)

### Community 44 - "Community 44"
Cohesion: 0.01
Nodes (134): main, member, asGroupMemberDeviceSnapshotRepository, compare, multiDeviceSyncEnabled, resolveGroupMemberDeviceSafety, savedDevices, deletePendingSiblingDevice (+126 more)
...
Cohesion: 0.04
Nodes (83): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+75 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (134): BuildGroupSignatureData(), ParseGroupEnvelope(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata() (+126 more)

### Community 48 - "Community 48"
Cohesion: 0.01
Nodes (173): main, ../../core/secure_storage/fake_secure_key_store.dart, generateRandomKey, main, EncryptedMediaTestBridge, RelayMediaStore, ImagePicker, bridge (+165 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (129): _TrackingInviteDeliveryAttemptRepository, appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn (+121 more)
...
Cohesion: 0.02
Nodes (116): ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, FakeGroupPubSubNetwork, GroupModel, GroupPendingKeyDistributionRunner, expectRotatedRemainingMember, main, network (+108 more)
...
Cohesion: 0.02
Nodes (115): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, contactRepo, main, requestRepo (+107 more)
...
Cohesion: 0.01
Nodes (166): @immutable, package:flutter_app/features/introduction/application/load_introductions_use_case.dart, package:flutter_app/features/introduction/presentation/widgets/intro_group_header.dart, package:flutter_app/features/introduction/presentation/widgets/intro_row.dart, package:flutter_app/features/introduction/presentation/widgets/intros_tab.dart, package:flutter_app/features/orbit/domain/models/orbit_group.dart, package:flutter_app/features/orbit/domain/models/orbit_item.dart, package:flutter_app/features/orbit/presentation/screens/orbit_screen.dart (+158 more)

### Community 67 - "Community 67"
Cohesion: 0.02
Nodes (117): bridge, contactRepo, dispose, incomingPostPassStream, _onMessage, _postController, PostPassListener, postPassStream (+109 more)
...
Cohesion: 0.02
Nodes (106): Orbit3ConstellationMode, avatarByIndex, enterManage, innerMembers, innerWorkKey, main, manageToggle, openMessages (+98 more)
...
Cohesion: 0.03
Nodes (57): _MemoryPairingSessionRepository, _MemoryPairingSessionRepository, authenticatedChannelBinding, AuthenticatedMigrationChannelTranscript, authorizationNonce, authorizedAt, authorizeMigrationExport, authorizes (+49 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (98): _dbKey, fixedKey, main, errors, hasError, isAccepted, MigrationDatabaseImportError, MigrationDatabaseImportResidual (+90 more)
...
Cohesion: 0.02
Nodes (98): Brightness, BuildContext, Color, main, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, backgroundPreference, build, contactRepo (+90 more)
...
Cohesion: 0.02
Nodes (75): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, BrandHeader, build, build, IdentityLoadingCard (+67 more)
...
Cohesion: 0.03
Nodes (84): DatabaseExecutor, db, insertOutgoing, main, row, assertOutgoingTransition, db, main (+76 more)
...
Cohesion: 0.02
Nodes (97): package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, activeQuoteText, alignment, amplitudeValues, backgroundPreference, backlogRetentionNotice, build (+89 more)
...
Cohesion: 0.02
Nodes (88): appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState, _IntroOrbitHarness (+80 more)

### Community 98 - "Community 98"
Cohesion: 0.02
Nodes (86): db, main, makeKeyRow, db, main, makeMemberRow, db, main (+78 more)
...
Cohesion: 0.02
Nodes (91): GroupMessage, GroupMessageListener, _FakeGroupMessageListener, _ControlledGroupMessageListener, package:flutter_app/features/groups/presentation/screens/group_conversation_wired.dart, FakeGroupMessageListener, FakeGroupMessageListener, bridge (+83 more)

### Community 104 - "Community 104"
Cohesion: 0.02
Nodes (91): _EventRecorder, _HarnessEnvironment, audioRecorderService, binding, bridge, build, _callback, _canUseVmServiceTimeline (+83 more)
...
Cohesion: 0.02
Nodes (63): main, main, dart:io, main, autoSetupConfigFileName, _compileTimeAutoSetupUsername, fileUsername, _normalizeUsername (+55 more)
...
Cohesion: 0.05
Nodes (41): _contact, main, _msg, aliceBridge, aliceMediaRepo, _alicePeerId, basePath, bobBridge (+33 more)

### Community 123 - "Community 123"
Cohesion: 0.03
Nodes (76): _FakeIdentityRepo, _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity (+68 more)
...
Cohesion: 0.03
Nodes (74): connectionItem, contact, ContactFeedSnapshot, loadContactFeedSnapshot, messages, summary, threadItem, allGroupMessages (+66 more)

### Community 128 - "Community 128"
Cohesion: 0.03
Nodes (77): deleteEntry, deleteEntryCallCount, _entries, FakeGroupReactionReplayOutboxRepository, getEntry, loadRetryableEntries, saveEntry, saveEntryCallCount (+69 more)
...
Cohesion: 0.03
Nodes (61): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, attachment, _canLinkLocalMedia, deadline (+53 more)
...
Cohesion: 0.03
Nodes (70): IntroductionListener, first_time_experience_screen.dart, ImageSource, IntroductionListener, IntroReceived, IntroStatusChanged, package:flutter_app/core/utils/startup_timing.dart, _FakeIntroductionListener (+62 more)
...
Cohesion: 0.04
Nodes (61): main, map, DetailedInboxStore, LifecycleBridge, bridge, main, service, bridge (+53 more)
...
Cohesion: 0.03
Nodes (64): main, loadReactionsForConversation, result, main, buildShareTargetPickerRoute, package:flutter_app/core/media/audio_recorder_service.dart, package:flutter_app/features/conversation/domain/repositories/reaction_repository.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart (+56 more)
...
Cohesion: 0.05
Nodes (37): MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator, validateRows (+29 more)
...
Cohesion: 0.03
Nodes (60): main, events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness (+52 more)
...
Cohesion: 0.02
Nodes (80): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, orbital_avatar.dart, orbital_ring_painter.dart, overflow_badge.dart (+72 more)
...
Cohesion: 0.03
Nodes (63): FakeIntroductionRepository, GroupInviteListener, _SimGroupInviteListener, IntroductionRepository, JoinedGroup, package:flutter_app/features/feed/presentation/navigation/feed_route_transition.dart, package:flutter_app/features/share/presentation/navigation/share_target_picker_route.dart, PendingInvite (+55 more)
...
Cohesion: 0.03
Nodes (60): AudioRecorderService, compressed,, GroupMessageRepository, _NoOpMsgRepo, RecordAudioRecorderService, fromStorageString, ImageQualityPreference, original (+52 more)
...
Cohesion: 0.03
Nodes (58): AudioPlayer, attachment, build, _buildUnavailableAudio, _canRetryUnavailableMedia, createState, didUpdateWidget, dispose (+50 more)
...
Cohesion: 0.04
Nodes (53): contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult, incomingTime (+45 more)
...
Cohesion: 0.03
Nodes (55): fromPreview, handleDeliveryReceipt, messageIds, main, actualTransport, allUploaded, bridge, contact (+47 more)
...
Cohesion: 0.04
Nodes (50): handleShareIntent, ShareIntentRouteBuilder, build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt (+42 more)
...
Cohesion: 0.04
Nodes (56): _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, BonsoirDiscoveryService, FakeLocalDiscoveryService, LocalDiscoveryService, acceptManifest (+48 more)
...
Cohesion: 0.04
Nodes (53): c, calculateNearbyDistanceM, capturedAt, contact, contacts, currentTime, deltaLat, deltaLng (+45 more)

### Community 199 - "Community 199"
Cohesion: 0.04
Nodes (49): isUnsafeLegacyOutboundEnvelope, _captureFlowEvents, creatorPeerId, generation, groupId, groupRepo, _InboxStoreOkFalseBridge, joinerPeerId (+41 more)
...
Cohesion: 0.04
Nodes (53): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, archived, blocked, _contact, contacts, _FailAfterPostSaveRepository, lastSavedPostId (+45 more)
...
Cohesion: 0.02
Nodes (97): archivedAt, avatarPath, avatarVersion, blockedAt, ContactModel, copyWith, fromMap, fromQRPayload (+89 more)
...
Cohesion: 0.04
Nodes (52): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, _MockBridge, FakeDecryptBridge (+44 more)
...
Cohesion: 0.05
Nodes (42): AppLocalizations, LocalizationsDelegate, MemberRole, contact, device, main, member, package:flutter_app/features/groups/domain/models/group_member_identity_safety.dart (+34 more)
...
Cohesion: 0.04
Nodes (43): addContact, AddContactResult, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, contacts, kMlKemReannouncePendingKey (+35 more)

### Community 249 - "Community 249"
Cohesion: 0.04
Nodes (49): _FakeMediaFileManager, FakeMediaFileManager, _FakeMediaFileManager, _FakeMediaFileManager, _TempMediaFileManager, accountMigrationNetworkGate, allowed, _allowsPostRetrierNetworkSideEffects (+41 more)
...
Cohesion: 0.03
Nodes (70): attachment, createdAt, cryptoEntry, envelope, main, addContact, _AvatarProcessingProbe, avatarsDir (+62 more)
...
Cohesion: 0.04
Nodes (43): dismissedAt, dismissPin, savePinDismissal, activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager (+35 more)
...
Cohesion: 0.05
Nodes (42): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, addResult, contact (+34 more)
...
Cohesion: 0.05
Nodes (40): allowStaging, commentExists, comments, compareTo, envelope, existing, handleIncomingPostCommentReaction, HandleIncomingPostCommentReactionResult (+32 more)
...
Cohesion: 0.07
Nodes (38): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+30 more)
...
Cohesion: 0.05
Nodes (35): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+27 more)
...
Cohesion: 0.05
Nodes (35): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, main, main (+27 more)
...
Cohesion: 0.05
Nodes (35): consumeInitialPayload, data, isNotificationRouteTargetAlreadyActive, NotificationOpenSideEffect, onBeforeOpen, onBeforeRouteTarget, onMissingGroupRouteId, onMissingRouteTarget (+27 more)
...
Cohesion: 0.05
Nodes (38): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+30 more)
...
Cohesion: 0.05
Nodes (36): lines, main, main, payload, _BundleDatabases, _bundleSource, captureCipherMetadata, close (+28 more)
...
Cohesion: 0.05
Nodes (38): _FakeP2PService, _FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService, _ThrowOnSendP2PService, _FakeP2PService, _FakeP2PService (+30 more)

### Community 319 - "Community 319"
Cohesion: 0.05
Nodes (34): DrainGroupOfflineInboxForGroupFn, DrainOfflineInboxFn, _emitMissingGroupId, _emitUnroutable, ForegroundRemoteMessageResult, handleForegroundRemoteMessage, routeTarget, cooldown (+26 more)
...
Cohesion: 0.09
Nodes (39): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), countRemoteGroupMembers(), groupRendezvousNamespace(), assertGM030DiscoveryEventTotals(), assertGP012NumericField(), assertGP014KnownMemberTopicMissingRelayFallback(), assertPGC011NoCollectedEvent() (+31 more)
...
Cohesion: 0.03
Nodes (58): PendingGroupInvite, package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, buildTestWidget, main, main (+50 more)
...
Cohesion: 0.04
Nodes (50): clearWriteLog, _contact, contacts, created, _createLocalPost, dialAttempts, _dialedPeers, dialPeer (+42 more)
...
Cohesion: 0.07
Nodes (29): attachment, basePath, bytes, checkHealth, delay, deleteAttachmentsForContact, deleteAttachmentsForMessage, dispose (+21 more)

### Community 416 - "Community 416"
Cohesion: 0.07
Nodes (28): bridge, contactRepo, dispose, incomingPostStream, notificationService, _onMessage, _postController, postCreateStream (+20 more)
...
Cohesion: 0.08
Nodes (24): benchmark_harness.dart, BenchmarkHarness, package:flutter_app/core/utils/notification_tap_timing.dart, bridge, captureBackgroundResumeEvents, details, harness, main (+16 more)
...
Cohesion: 0.07
Nodes (26): _cache, _cacheKey, _generation, IdentityAvatarDocumentsDirLoader, IdentityAvatarResolver, _inFlight, invalidatePeer, _loadFromDisk (+18 more)
...
Cohesion: 0.07
Nodes (26): appShellController, _armTimers, _cancelTimers, dispose, expiryBudget, _expiryTimer, _fallbackTimer, _handlePendingTargetMutation (+18 more)
...
Cohesion: 0.07
Nodes (26): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, _FakeMediaAttachmentRepository, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+18 more)
...
Cohesion: 0.07
Nodes (26): delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce, group, _message (+18 more)
...
Cohesion: 0.11
Nodes (21): idleTimeoutReader, copyMediaDownloadToFile(), newIdleTimeoutReader(), TestDownloadProgressEventsEmitted(), TestIdleTimeoutReader_IdleTimerResetsOnEachChunk(), TestIdleTimeoutReader_NormalCopyCompletes(), TestIdleTimeoutReader_SlowButSteadySucceeds(), TestIdleTimeoutReader_StalledDownloadFails() (+13 more)
...
Cohesion: 0.07
Nodes (25): GenerateIdentityResult, generateNewIdentity, identity, identityJson, keygenStopwatch, mlKemFuture, mlKemResponse, ok (+17 more)
...
Cohesion: 0.18
Nodes (15): MediaMeta, mediaDownloadResultFromStream(), mediaEventDetails(), relayMediaTelemetryFields(), sendMediaRequest(), TestMediaRelayTelemetryFieldsIdentifyRelayStore(), MediaDownloadResult, mediaRequest (+7 more)
...
Cohesion: 0.09
Nodes (22): MigrationGroupManifestBuilder, main, builder, MigrationGroupManifestValidator, _groupRow, main, _movedMemberRow, primaryKey (+14 more)
...
Cohesion: 0.07
Nodes (24): backgroundLuminance, contrastRatio, darker, effectiveForeground, expectComponentContrast, expectTextContrast, foregroundLuminance, lighter (+16 more)
...
Cohesion: 0.11
Nodes (14): DefaultFeatureFlags(), featureFlagsStatusMap(), limitRelayAddresses(), FeatureFlags, relayInfoAttemptCandidates(), TestFeatureFlags_DefaultAllTrue(), RelayInfo, RelaySelector (+6 more)

### Community 475 - "Community 475"
Cohesion: 0.16
Nodes (25): waitForCollectedEvent(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo(), assertRingEpochsNewestFirst(), gk019DirectJumpKeyInfo(), gk020GenerateDistinctEpochKeys(), gk020SequentialRotationKeyInfo(), hasCollectedEventName() (+17 more)
...
Cohesion: 0.08
Nodes (21): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, gMsg, groupItem, main, _msg, _thread (+13 more)

### Community 493 - "Community 493"
Cohesion: 0.08
Nodes (22): encrypted, envelope, envelopeSenderPeerId, HandleGroupInviteDeclineAckResult, handleIncomingGroupInviteDeclineAck, payload, verifyOutcome, canonicalPayload (+14 more)
...
Cohesion: 0.03
Nodes (68): AnimatedBuilder, CustomPaint, EdgeInsets, package:flutter_app/features/contact_profile/presentation/screens/contact_profile_screen.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, package:flutter_app/features/home/presentation/widgets/scan_friend_card.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, package:flutter_app/features/identity/presentation/widgets/choice_card.dart (+60 more)
...
Cohesion: 0.09
Nodes (20): _FakeContactRequestRepository, declineContactRequest, DeclineContactRequestResult, peerIdPrefix, request, FakeContactRequestRepository, _FakeContactRequestRepo, ContactRequestRepository (+12 more)
...
Cohesion: 0.09
Nodes (19): jsonString, payload, reactionId, removeReaction, RemoveReactionResult, timestamp, _uuid, jsonString (+11 more)
...
Cohesion: 0.10
Nodes (20): _callback, _fakeIdentityJson, _FakeIdentityRepo, _fakeMlKemResponse, _FrameTimingCollector, hasData, loadIdentity, printSummary (+12 more)
...
Cohesion: 0.18
Nodes (11): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, _RecorderRepo, _FakeMediaAttachmentRepository (+3 more)
...
Cohesion: 0.20
Nodes (9): cycles, groupMsgRepo, handleAppPaused, messageRepo, pauseBetween, result, simulateAppPaused, simulateBackgroundForegroundCycle (+1 more)
...
Cohesion: 0.22
Nodes (8): DeliveryReceiptListener, dispose, messageRepo, receiptStream, start, stop, _subscription, package:flutter_app/features/conversation/application/handle_delivery_receipt_use_case.dart
...
## Knowledge Gaps
- **33892 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+33887 more)
...
- **Why does `newMessageCollector()` connect `Community 315` to `Community 258`, `Community 395`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 258` to `Community 315`, `Community 46`, `Community 559`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _33892 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.007826870609730504 - nodes in this community are weakly interconnected._
