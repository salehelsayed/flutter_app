# Graph Report - graphify-arch  (2026-06-25)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 41853 nodes · 65115 edges · 914 communities (867 shown, 47 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2408 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9bd0eca`
...
Cohesion: 0.01
Nodes (337): AlertDialog, AnimatedContainer, AnnotatedRegion, main, main, showGroupMissingNotificationFeedback, BoxDecoration, CircularProgressIndicator (+329 more)
...
Cohesion: 0.01
Nodes (359): AnimatedOpacity, main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames, events (+351 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (184): main, benchmark_harness.dart, BenchmarkHarness, alice, bob, main, network, _originalText (+176 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (263): AnimatedBuilder, Animation, CustomPaint, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, _FeedTestHarness, _FeedTestHarnessState, package:flutter_app/core/theme/glassmorphism.dart (+255 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (282): BackgroundPreference, IconData, Key, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, actionLabel, active (+274 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (264): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+256 more)
...
Cohesion: 0.02
Nodes (224): DatabaseException, db, main, makeContactRow, db, main, makeIdentityRow, db (+216 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (226): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+218 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (226): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+218 more)
...
Cohesion: 0.01
Nodes (236): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, age, contactPeerId, id, main (+228 more)
...
Cohesion: 0.01
Nodes (215): ContactRequestNotificationMaterializer, buildRepo, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main, row (+207 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (136): CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+128 more)
...
Cohesion: 0.01
Nodes (198): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, bridge (+190 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (205): ../../application/orbit3_archetype_data.dart, build, ../../application/orbit3_mock_data.dart, _groups, _member, _names, Orbit3MockData, _orbitFriend (+197 more)
...
Cohesion: 0.01
Nodes (193): main, makeInvite, pendingInviteRepo, main, bridge, buildMigrationQRData, buildValidQRData, contactRepo (+185 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (188): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+180 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (188): orbit_screen.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate, _activeFriends (+180 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (179): attempts, contactAlice, contactBob, contactCharlie, contactDave, deleteAttempt, deleteAttemptsForGroup, _expectNoPublicRouteFields (+171 more)
...
Cohesion: 0.01
Nodes (144): Database, fake_secure_key_store.dart, db, main, makeRequestRow, GroupEventLogTamperException, db, main (+136 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (169): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation() (+161 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (151): Align, ClipRRect, ConstrainedBox, _incoming, main, isDeleted, isIncoming, main (+143 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (53): bridge, contactPeerId, contactRepo, _contactWithMlKem, _doneAttachment, durationMs, fakeUploadFn, id (+45 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (155): accountKey, admit, drainSpy, groupId, main, member, memberPeerId, reopenSpy (+147 more)

### Community 32 - "Community 32"
Cohesion: 0.01
Nodes (173): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+165 more)
...
Cohesion: 0.03
Nodes (146): ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), isAllowedWriter(), assertGK019DirectJumpKeyInfo() (+138 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (150): BuildGroupSignatureData(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash() (+142 more)
...
Cohesion: 0.02
Nodes (118): db, main, makePassRow, openWithMigrations, db, main, makeRecipientRow, openWithMigrations (+110 more)

### Community 45 - "Community 45"
Cohesion: 0.02
Nodes (134): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+126 more)

### Community 46 - "Community 46"
Cohesion: 0.02
Nodes (143): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+135 more)

### Community 47 - "Community 47"
Cohesion: 0.02
Nodes (126): _InstrumentedGroupMessageRepository, _InstrumentedGroupMessageRepository, _ContendedGroupMessageRepository, _LiveReplayRaceGroupMessageRepository, actorPeerId, bridge, groupId, groupRepo (+118 more)

### Community 48 - "Community 48"
Cohesion: 0.02
Nodes (126): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+118 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (123): _attachment, main, allSameType, backgroundDuplicateGuardDelay, ConsumeRecentRemoteNotificationAnnouncement, conversationKey, firstType, isViewingConversation (+115 more)
...
Cohesion: 0.02
Nodes (141): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, _FakeContactRepository, _FakeContactRepository, FakeContactRepository, DeliveryReceiptListener, dispose (+133 more)
...
Cohesion: 0.02
Nodes (120): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+112 more)
...
Cohesion: 0.02
Nodes (122): GroupMessage, GroupMessageListener, GroupMessageRepository, _FakeGroupMessageListener, _NoOpMsgRepo, _ControlledGroupMessageListener, package:flutter_app/features/groups/presentation/screens/create_group_picker_wired.dart, package:flutter_app/features/groups/presentation/screens/group_conversation_wired.dart (+114 more)
...
Cohesion: 0.02
Nodes (105): advertisedPeerId, captureCipherMetadata, clearAuthority, clearCutover, consumed, consumeSession, _controller, createdAt (+97 more)

### Community 70 - "Community 70"
Cohesion: 0.02
Nodes (105): archiveGroup, _FailingGroupRepository, groupId, groupRepo, main, bridge, command, _expectNoPublicRouteFields (+97 more)
...
Cohesion: 0.02
Nodes (117): addContact, _BaselineUser, bridge, commentListener, _connectTriangle, contactRepo, create, deadline (+109 more)
...
Cohesion: 0.02
Nodes (102): AccountMigrationNetworkGate, addPage, _fixedDateFixtureRetentionNow, getLatestRepairForGroup, getRepair, getVisibleRepairsForGroup, _historyGaps, inboxRetrieveCount (+94 more)

### Community 75 - "Community 75"
Cohesion: 0.02
Nodes (82): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, package:flutter_app/features/settings/presentation/widgets/settings_move_account_card.dart, avatarBytes, backgroundPreference (+74 more)
...
Cohesion: 0.02
Nodes (101): AppendGroupEventLogEntry, appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn (+93 more)
...
Cohesion: 0.01
Nodes (135): main, _makeAttachment, mime, PendingGroupInvite, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart (+127 more)
...
Cohesion: 0.02
Nodes (89): deliveryResult, EditPinnedPostResult, _editPinnedPostResultForSettlement, envelope, existingState, media, now, pinState (+81 more)
...
Cohesion: 0.02
Nodes (79): dart:ui, capture, drain, goTo, main, outDir, capture, main (+71 more)
...
Cohesion: 0.03
Nodes (81): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+73 more)
...
Cohesion: 0.02
Nodes (98): package:flutter_app/features/posts/application/attach_post_media_use_case.dart, package:flutter_app/features/posts/presentation/widgets/compose_post_sheet.dart, package:flutter_app/features/posts/presentation/widgets/pass_post_along_sheet.dart, _contact, isArchived, isBlocked, main, peerId (+90 more)

### Community 105 - "Community 105"
Cohesion: 0.02
Nodes (86): AccountMigrationReceiverEvents, eventsNamed, flowEvents, main, LinearProgressIndicator, package:flutter_app/features/account_migration/application/account_migration_transfer_flow.dart, package:flutter_app/features/account_migration/application/migration_transfer_keep_alive.dart, package:flutter_app/features/account_migration/presentation/models/account_migration_ui_state.dart (+78 more)
...
Cohesion: 0.02
Nodes (81): benchmark_helpers.dart, _HarnessScreen, runAckBenchmark, details, events, _findRecoveredOutage, firstEventDetails, firstInbox (+73 more)

### Community 110 - "Community 110"
Cohesion: 0.02
Nodes (83): Brightness, BuildContext, Color, accentColor, availableFriends, build, friend, _FriendPickerRow (+75 more)
...
Cohesion: 0.02
Nodes (77): allowedPeers, groupMediaAllowedPeersForMembers, seen, main, member, actor, buildGroupDissolvedTimelineMessage, buildGroupDissolvedTimelineText (+69 more)

### Community 114 - "Community 114"
Cohesion: 0.02
Nodes (80): attachment, _canLinkLocalMedia, deadline, decision, effectiveInterval, _findAttachmentById, hasLocalPath, kDefaultLocalMediaMetadataGrace (+72 more)
...
Cohesion: 0.02
Nodes (145): applied, pendingEvents, reconcilePendingPostChildEvents, _TrackingContactRepository, InMemoryPostRepository, _BlockingWritePostRepository, buildJson, contacts (+137 more)

### Community 120 - "Community 120"
Cohesion: 0.02
Nodes (99): OrbitGroup, friend, group, OrbitFriendItem, OrbitGroupItem, OrbitItem, sortKey, OrbitFriend (+91 more)

### Community 121 - "Community 121"
Cohesion: 0.02
Nodes (96): comments, loadPostComments, wait, avatarSnapshots, hydratePostSurfaceItems, mediaMap, postList, repostHeartBaselines (+88 more)
...
Cohesion: 0.02
Nodes (87): AspectRatio, DateSeparator, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce (+79 more)
...
Cohesion: 0.03
Nodes (76): main, avatarSizes, coreCentre, drain, main, tall, wrap, archAvatars (+68 more)

### Community 130 - "Community 130"
Cohesion: 0.03
Nodes (56): _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo, Column, FileImage (+48 more)

### Community 131 - "Community 131"
Cohesion: 0.03
Nodes (79): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents, accountMigrationRunTransfer (+71 more)

### Community 132 - "Community 132"
Cohesion: 0.03
Nodes (75): activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager, orderedPostIds, postRepo, posts (+67 more)

### Community 133 - "Community 133"
Cohesion: 0.09
Nodes (73): newMemoryInboxBackend(), failingStoreInboxBackend, requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs() (+65 more)
...
Cohesion: 0.03
Nodes (72): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+64 more)
...
Cohesion: 0.03
Nodes (69): main, fake_media_attachment_repository.dart, _attachments, count, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage (+61 more)

### Community 138 - "Community 138"
Cohesion: 0.03
Nodes (72): _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry, group, groupId (+64 more)
...
Cohesion: 0.03
Nodes (71): addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult, parseResult, clearCleared, FeedClearedRepositoryImpl (+63 more)
...
Cohesion: 0.06
Nodes (47): backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), newMemoryInboxBackendWithLimits(), relayResourcesFromServerLimits(), TestAdmissionControl_PreservesLatencyForAdmittedPeersUnderPressure() (+39 more)

### Community 150 - "Community 150"
Cohesion: 0.06
Nodes (48): chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData(), addTrimmedData() (+40 more)
...
Cohesion: 0.03
Nodes (69): AccountMigrationSizeGate, FakeIntroductionRepository, IntroductionRepository, package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart, package:flutter_app/features/settings/presentation/widgets/settings_introduction_debug_card.dart, package:flutter_app/features/settings/presentation/widgets/settings_transport_diagnostics_card.dart, IntroductionRepositoryImpl, accountMigrationRunTransfer (+61 more)

### Community 154 - "Community 154"
Cohesion: 0.03
Nodes (63): appendGroupEventLogEntry, _appendSignedCreateEvent, canonicalPayload, createGroup, deleteGroup, group, groupId, groupKey (+55 more)
...
Cohesion: 0.03
Nodes (67): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+59 more)

### Community 160 - "Community 160"
Cohesion: 0.02
Nodes (88): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, contactRepo, main, requestRepo, testRequest, contactRepo (+80 more)

### Community 161 - "Community 161"
Cohesion: 0.03
Nodes (65): ackRelayBlobDeletion, adoptCanonicalFileIfAvailable, adoptCompletePartFileIfAvailable, attachmentId, bridge, candidates, _collectLocalMediaCandidateDiagnostics, completedLocalAttachment (+57 more)
...
Cohesion: 0.02
Nodes (96): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+88 more)
...
Cohesion: 0.03
Nodes (65): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _HangingBridge (+57 more)
...
Cohesion: 0.03
Nodes (63): _bridge, dispose, DistributeGroupKeyAtEpochToPeer, _emitUnauthorized, _enqueue, GroupKeyRepairResponderListener, _groupRepo, _handle (+55 more)
...
Cohesion: 0.03
Nodes (60): conversation_wired_performance_harness.dart, conversation_wired_subscription_performance_harness.dart, feed_performance_test.dart, feed_wired_init_performance_harness.dart, group_admin_metadata_convergence_simulator_test.dart, group_delete_preserves_friends_simulator_test.dart, group_invite_accept_spinner_simulator_test.dart, group_new_member_media_simulator_proof_test.dart (+52 more)
...
Cohesion: 0.03
Nodes (66): first_time_experience_screen.dart, ImageSource, package:flutter_app/core/utils/startup_timing.dart, _acceptRequest, accountMigrationRunTransfer, accountMigrationSizeGate, appShellController, audioRecorderService (+58 more)
...
Cohesion: 0.03
Nodes (63): main, AudioRecorderService, RecordAudioRecorderService, buildShareTargetPickerRoute, package:flutter_app/core/media/audio_recorder_service.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart, package:flutter_app/features/share/application/share_batch_delivery_coordinator.dart, package:flutter_app/features/share/presentation/screens/share_target_picker_wired.dart (+55 more)
...
Cohesion: 0.05
Nodes (35): body, clearDeliveredNotifications, clearedDeliveredNotificationsCount, consumeInitialPayload, contactPeerId, dispose, FakeGenericNotification, FakeNotification (+27 more)
...
Cohesion: 0.03
Nodes (57): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+49 more)
...
Cohesion: 0.03
Nodes (41): main, cleanupSessionArtifacts, MigrationFileImportCleanup, stagingRootPath, main, dart:io, main, main (+33 more)

### Community 194 - "Community 194"
Cohesion: 0.03
Nodes (59): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, main, peerDiscoveredAt, BonsoirBroadcastFactory, BonsoirDiscoveryFactory (+51 more)
...
Cohesion: 0.03
Nodes (55): _attemptRegistration, dispose, _disposed, ensureStarted, _inFlightAttempt, _permissionState, _PushPermissionState, PushRegistrationCoordinator (+47 more)
...
Cohesion: 0.04
Nodes (55): block, contentHashValidation, copyWith, _emitGroupFeedMediaVerifyEvent, file, fileBytes, fileExists, _idPrefix (+47 more)

### Community 210 - "Community 210"
Cohesion: 0.04
Nodes (50): main, MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator (+42 more)
...
Cohesion: 0.04
Nodes (44): _CapturedFlowEvent, _captureFlowEvents, details, event, events, main, originalDebugPrint, previousLogging (+36 more)
...
Cohesion: 0.04
Nodes (51): appWith, chatScreen, edgeDrag, logicalSize, main, seedMessages, settleFrames, main (+43 more)
...
Cohesion: 0.03
Nodes (77): allFriends, fromMap, kind, peopleNearby, pickPeople, PostAudience, PostAudienceKind, PostAudienceKindWireValue (+69 more)
...
Cohesion: 0.02
Nodes (89): addContact, AddContactResult, archiveContact, archiveGroup, blockContact, activeContacts, otherFriends, shouldShowIntroBanner (+81 more)
...
Cohesion: 0.04
Nodes (48): _blobKeygenCount, checkHealth, checkHealthCallCount, checkHealthResult, commandLog, consumeUploadMediaResult, dispose, FakeBridge (+40 more)
...
Cohesion: 0.04
Nodes (48): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+40 more)

### Community 254 - "Community 254"
Cohesion: 0.04
Nodes (48): fromPreview, handleDeliveryReceipt, messageIds, actualTransport, allUploaded, bridge, contact, contactRepo (+40 more)
...
Cohesion: 0.04
Nodes (47): main, messageRepo, ../../../conversation/domain/repositories/fake_media_attachment_repository.dart, ../../conversation/domain/repositories/fake_message_repository.dart, package:flutter_app/features/conversation/application/mark_conversation_read_use_case.dart, currentState, dialPeer, discoverLocalPeer (+39 more)
...
Cohesion: 0.03
Nodes (76): package:flutter_app/core/theme/feed_colors.dart, package:url_launcher/url_launcher.dart, TextOverflow, main, build, _controller, createState, didUpdateWidget (+68 more)
...
Cohesion: 0.03
Nodes (79): ../../domain/orbit3_one_circle_layout.dart, build, _byId, center, count, createState, didUpdateWidget, _Dot (+71 more)

### Community 285 - "Community 285"
Cohesion: 0.03
Nodes (53): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+45 more)
...
Cohesion: 0.04
Nodes (44): addContact, author, comment, commentListener, condition, _contact, contactRepo, _ControlledP2PService (+36 more)
...
Cohesion: 0.05
Nodes (40): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, attempts, bridge, createdAt, envelope, groupRepo, keyEpoch (+32 more)

### Community 299 - "Community 299"
Cohesion: 0.05
Nodes (41): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState, chatMessageStream (+33 more)
...
Cohesion: 0.04
Nodes (47): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+39 more)
...
Cohesion: 0.03
Nodes (69): c, calculateNearbyDistanceM, capturedAt, contact, contacts, currentTime, deltaLat, deltaLng (+61 more)
...
Cohesion: 0.05
Nodes (36): _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake, getApplicationDocumentsPath (+28 more)
...
Cohesion: 0.05
Nodes (39): _assertBackgroundScrollDoesNotRegress, _assertThresholds, average, backgroundP99, backgroundPreference, baselineP99, build, buildTimesMs (+31 more)
...
Cohesion: 0.02
Nodes (79): _contact, main, _msg, aliceBridge, aliceMediaRepo, _alicePeerId, basePath, bobBridge (+71 more)
...
Cohesion: 0.05
Nodes (34): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+26 more)

### Community 337 - "Community 337"
Cohesion: 0.06
Nodes (36): ../../domain/models/orbit2_layout_template.dart, ../../domain/models/orbit2_view_mode.dart, Orbit2ViewMode, active, build, _close, _controller, createState (+28 more)
...
Cohesion: 0.05
Nodes (33): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, gMsg, groupItem, main, _msg, _thread (+25 more)

### Community 347 - "Community 347"
Cohesion: 0.07
Nodes (30): handleShareIntent, ShareIntentRouteBuilder, build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt (+22 more)
...
Cohesion: 0.06
Nodes (34): _FakeP2PService, _FakeP2PService, DurableLanFakeP2PService, FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService, _ThrowOnSendP2PService (+26 more)

### Community 368 - "Community 368"
Cohesion: 0.04
Nodes (45): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+37 more)

### Community 369 - "Community 369"
Cohesion: 0.06
Nodes (32): deliveredWritePatterns, main, scanDeliveredWrites, basePath, bridge, captureFlowEvents, checkHealth, commandLog (+24 more)
...
Cohesion: 0.06
Nodes (32): currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox, incomingLocalMediaStream, inject (+24 more)
...
Cohesion: 0.06
Nodes (31): controller, currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox, incomingLocalMediaStream (+23 more)
...
Cohesion: 0.07
Nodes (27): main, package:flutter_app/features/conversation/domain/utils/message_window_cap.dart, package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, main, msg, buildWidget, chatListener, _contactPeerId (+19 more)
...
Cohesion: 0.02
Nodes (103): app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, Stopwatch, AppTheme, blurSigma, borderRadius (+95 more)
...
Cohesion: 0.07
Nodes (25): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, value, write, budgetBytes (+17 more)
...
Cohesion: 0.07
Nodes (24): _RecordingNavigatorObserver, main, NavigatorObserver, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, didPush, _fakeIdentityJson (+16 more)
...
Cohesion: 0.09
Nodes (19): main, checkHealth, _circuitMultiaddr, dispose, _FakeBridge, _flatten, initialize, _initialized (+11 more)
...
Cohesion: 0.10
Nodes (19): fromPayload, _groupId, main, _makeGroup, _makeInvitePayload, _makeMember, _makePendingInvite, peerId (+11 more)
...
Cohesion: 0.10
Nodes (19): avatar, computeOrbit3ArchArcs, computeOrbit3ArcRow, dip, kOrbit3ArchPerRow, kOrbit3ArchRowAvatar, kOrbit3InnerSeats, left (+11 more)
...
Cohesion: 0.12
Nodes (16): FakeReactionRepository, _HarnessReactionRepository, ReactionRepository, deleteReactionsForContact, deleteReactionsForMessage, FakeReactionRepository, getReactionForSenderIncludingRemoved, getReactionsForMessage (+8 more)
...
Cohesion: 0.23
Nodes (13): ChatMessageListener, ChatMessageListener, ContactUpdate, Incoming, _TrackingChatMessageListener, _TrackingChatMessageListener, _FakeChatListener, _FakeIncomingConversationListener (+5 more)
...
## Knowledge Gaps
- **33881 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+33876 more)
...
- **Why does `incomingMessage` connect `Community 665` to `Community 581`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 332` to `Community 581`, `Community 526`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 526` to `Community 324`, `Community 332`, `Community 79`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _33881 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.008128112894299945 - nodes in this community are weakly interconnected._