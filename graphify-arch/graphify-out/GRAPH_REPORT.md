# Graph Report - graphify-arch  (2026-06-16)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 38806 nodes · 60653 edges · 836 communities (792 shown, 44 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2365 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3b657723`
...
1. `generateEd25519KeyPair()` - 207 edges
2. `parseJSON()` - 184 edges
3. `NewNode()` - 160 edges
4. `startLocalNodeForMultiRelayTest()` - 151 edges
5. `generateTestKey()` - 145 edges
6. `assertNotOk()` - 128 edges
7. `New()` - 111 edges
8. `startLocalNodeForMultiRelayTestWithCollector()` - 103 edges
9. `waitForGroupTopicPeerCount()` - 82 edges
10. `assertOk()` - 81 edges
...
## Communities (836 total, 44 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (1908): 0, acceptedGroup, acceptedGroupAvatarBlobId, acceptedGroupMetadataFresh, acceptedRecipientPeerId, _acceptPromptPendingInvite, _acceptRa013DeviceInvite, acceptResult (+1900 more)

### Community 1 - "Community 1"
Cohesion: 0.00
Nodes (678): activeAvatarHashes, activeMemberPeerIds, activePeerIds, activeStateHashes, actual, actualPeerIds, adminPeerIds, afterCount (+670 more)
...
Cohesion: 0.01
Nodes (291): AlertDialog, showGroupMissingNotificationFeedback, CircularProgressIndicator, Column, Container, Directionality, ElevatedButton, buildTestApp (+283 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (284): main, _pendingRequest, requestRepo, GateableMediaAttachmentRepository, detailsFor, eventNames, events, main (+276 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (241): contactRepo, main, requestRepo, testRequest, ../../contacts/domain/repositories/fake_contact_repository.dart, FakeContactRepository, _FakeNearbyLocationService, InMemoryPostRepository (+233 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (253): Animation, _IntroOrbitHarness, _IntroOrbitHarnessState, Curve, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, _ConversationPerfHost, _ConversationPerfHostState (+245 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (143): FakeP2PNetwork, bridge, contact, _createdAt, deliver, inboxEnvelope, keyedAttachment, keylessLegacyAttachment (+135 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (255): bridge, buildMigrationQRData, buildValidQRData, contactRepo, identityRepo, main, ownPeerId, p2pService (+247 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (200): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, main, makeAttachment, makeMessage, mediaAttachmentRepo (+192 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (235): absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub, _applyMessageUpdate (+227 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (111): channel, log, main, main, _makeAcceptPayload, _makeSendPayload, main, main (+103 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (223): active, activePeerIds, activeUsers, addOrReadd, alice, _attempts, baseTime, blockedSaveIds (+215 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (214): IconData, SmokeTestApp, _SmokeTestApp, PostModel, package:flutter_app/features/groups/presentation/widgets/pending_group_invite_card.dart, AccountMigrationJourneyScreen, actionLabel, active (+206 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (221): _ActiveAttachmentUpload, _ComposerSnapshot, conversation_screen.dart, PrepareEncryptedMediaArtifactFn, absoluteDurablePath, _ActiveAttachmentUpload, _activeQuoteMessageId, _allowPopDuringActiveUpload (+213 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (200): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+192 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (119): applied, pendingEvents, reconcilePendingPostChildEvents, buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage (+111 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (209): _DeleteMessageAction, DeleteMessageForEveryoneFn, DeleteMessageForMeFn, EditChatMessageFn, feed_screen.dart, FeedStore, _acceptRequest, accountMigrationRunTransfer (+201 more)

### Community 18 - "Community 18"
Cohesion: 0.01
Nodes (145): dbDeleteExpiredGroupInviteConsumptions, dbLoadGroupInviteConsumption, dbUpsertGroupInviteConsumption, inviteId, dbLoadIdentityRow, dbUpsertIdentityRow, identityId, dbDeletePendingIntroductionResponse (+137 more)

### Community 19 - "Community 19"
Cohesion: 0.01
Nodes (200): ContactRequestNotificationMaterializer, GroupPendingKeyDistributionRunner, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main, IosApnsNotificationOpenBridge, accountMigrationAuthorityRepository (+192 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (235): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+227 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (180): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+172 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (174): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, adminGroup (+166 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (161): mapChatReplayOutcomeToDisposition, main, map, _badgeLabel, containsKey, env, _isPlainOnline, _isRelayReady (+153 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (175): CustomPainter, dart:math, EdgeInsets, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+167 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (84): db, main, db, main, makeKeyRow, db, main, makeMemberRow (+76 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (180): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+172 more)
...
Cohesion: 0.01
Nodes (242): DatabaseException, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, makeContactRow (+234 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (160): NewEventDispatcher(), fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation() (+152 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (176): GroupInviteListener, _SimGroupInviteListener, JoinedGroup, orbit_screen.dart, PendingInvite, FakeGroupInviteListener, _FakeGroupInviteListener, _acceptPendingInviteWithRecoveryRetry (+168 more)
...
Cohesion: 0.01
Nodes (145): AnimatedContainer, AnnotatedRegion, _activeTab, _backgroundPreference, setBackgroundPreference, switchTo, main, BackgroundPreference (+137 more)

### Community 33 - "Community 33"
Cohesion: 0.02
Nodes (149): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, ClipRRect, main, msg, _textWidget, wrap (+141 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (161): comments, loadPostComments, wait, Database, db, main, db, main (+153 more)
...
Cohesion: 0.01
Nodes (158): absolutePath, acceptChunk, acceptManifest, acceptOldBlockProof, acceptSegment, acceptTranscript, _AccountMigrationBundleMetadata, activeDatabaseImporter (+150 more)

### Community 37 - "Community 37"
Cohesion: 0.01
Nodes (158): _acceptedSignedTransitionAuditHashesBySourceId, _accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _allowsSnapshotBackedSystemSender, _appendGroupEventLogEntry, appendSystemEventLog, _applyAuthoritativeGroupConfigSnapshot, _autoDownloadMedia (+150 more)
...
Cohesion: 0.01
Nodes (145): deleteGroupAndMessages, deleteLocallyIfDissolved, _CursorInboxBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, bridge, command (+137 more)

### Community 40 - "Community 40"
Cohesion: 0.01
Nodes (144): Color, ContactModel, package:flutter_app/core/media/pending_composer_media.dart, package:flutter_app/core/theme/feed_colors.dart, package:flutter_app/features/home/presentation/widgets/profile_avatar_widget.dart, package:flutter_app/features/home/presentation/widgets/user_avatar.dart, accentColor, availableFriends (+136 more)
...
Cohesion: 0.07
Nodes (143): buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash() (+135 more)

### Community 43 - "Community 43"
Cohesion: 0.03
Nodes (130): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), countRemoteGroupMembers(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), findMember(), groupRendezvousNamespace(), isAllowedWriter() (+122 more)
...
Cohesion: 0.01
Nodes (192): EncryptedMediaTestBridge, RelayMediaStore, bridge, _createdAt, encTempsUnder, imageProcessor, main, mediaFileManager (+184 more)

### Community 46 - "Community 46"
Cohesion: 0.02
Nodes (124): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+116 more)

### Community 47 - "Community 47"
Cohesion: 0.01
Nodes (147): addContact, archiveContact, archivedPeerIds, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository (+139 more)

### Community 48 - "Community 48"
Cohesion: 0.01
Nodes (227): dart:async, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+219 more)

### Community 49 - "Community 49"
Cohesion: 0.01
Nodes (133): client, lastCall, main, GoBridgeClient, GroupDiagnosticEvent, GroupMembershipUpdateListener, bridge, bridgeExchanges (+125 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (117): baseAttachment, buildApp, main, MediaGridCell, buildApp, main, package:flutter_app/shared/widgets/linkable_text.dart, package:flutter_app/shared/widgets/media/audio_player_widget.dart (+109 more)

### Community 51 - "Community 51"
Cohesion: 0.02
Nodes (121): fromPreview, handleDeliveryReceipt, messageIds, count, markConversationRead, main, count, kStuckSendingThreshold (+113 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (122): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+114 more)
...
Cohesion: 0.02
Nodes (128): allowDeletedGroupUnknownSender, appliedMessageIds, _applyRepairedHistoryMessages, authorizedPeerIds, canonical, _canonicalizeJson, ciphertext, computedHash (+120 more)
...
Cohesion: 0.02
Nodes (124): AudioRecorderService, compressed,, FakeGroupReactionReplayOutboxRepository, GroupMessageListener, GroupMessageRepository, GroupReactionReplayOutboxRepository, _FakeGroupMessageListener, _NoOpMsgRepo (+116 more)

### Community 57 - "Community 57"
Cohesion: 0.01
Nodes (191): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, main, benchmark_helpers.dart, conversation_wired_performance_harness.dart (+183 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (118): addedMembers, _addMemberFailures, allMembers, buildCreateWarningMessage, byPeerId, CreateGroupMemberAddFailure, createGroupWithMembers, CreateGroupWithMembersResult (+110 more)

### Community 59 - "Community 59"
Cohesion: 0.02
Nodes (116): _InstrumentedGroupMessageRepository, _InstrumentedGroupMessageRepository, _ContendedGroupMessageRepository, _LiveReplayRaceGroupMessageRepository, actorPeerId, bridge, groupId, groupRepo (+108 more)

### Community 60 - "Community 60"
Cohesion: 0.02
Nodes (85): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, orbital_avatar.dart, orbital_ring_painter.dart, overflow_badge.dart, package:flutter_app/features/home/presentation/widgets/editable_username_widget.dart (+77 more)

### Community 61 - "Community 61"
Cohesion: 0.02
Nodes (121): InkWell, addContact, archiveContact, blockContact, callOrder, conditionalTransitionStatus, contactExists, copyCalls (+113 more)

### Community 62 - "Community 62"
Cohesion: 0.02
Nodes (120): acceptedUpdates, acceptGate, allGroupsGate, archivedContactsGate, bridge, buildOrbitWired, byWidgetPredicate, contactRepo (+112 more)

### Community 63 - "Community 63"
Cohesion: 0.01
Nodes (144): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+136 more)
...
Cohesion: 0.06
Nodes (117): TestGroupGenerateNextKey_NodeNotInitialized(), assertGroupPublishMediaOnlyAcceptsEmptyText(), assertNotOk(), parseJSON(), ptrString(), TestConfirmDirectMessage_NotInitialized(), TestDecryptContactRequest_InvalidJSON(), TestDecryptContactRequest_MissingFields() (+109 more)
...
Cohesion: 0.02
Nodes (110): Alignment, main, package:flutter_app/features/conversation/presentation/screens/conversation_screen.dart, package:flutter_app/features/feed/presentation/widgets/swipe_to_quote_bubble.dart, package:flutter_app/features/groups/presentation/group_backlog_retention_notice.dart, package:flutter/services.dart, buildTestWidget, expectSingleRowFocusCue (+102 more)

### Community 71 - "Community 71"
Cohesion: 0.03
Nodes (69): _MemoryPairingSessionRepository, _SharedFakeDiscovery, _MemoryPairingSessionRepository, _SharedFakeDiscovery, SecureKeyStoreMigrationPairingSessionRepository, aad, acceptedSegmentIndexes, acceptManifest (+61 more)

### Community 72 - "Community 72"
Cohesion: 0.02
Nodes (96): addContact, AddContactResult, archiveContact, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, downloadProfilePicture (+88 more)

### Community 73 - "Community 73"
Cohesion: 0.02
Nodes (114): EditableText, Route, appShellController, bridge, buildFeedWired, contactRepo, contactRequestRepo, _contactUpdateController (+106 more)

### Community 74 - "Community 74"
Cohesion: 0.02
Nodes (114): acceptDevice, acceptFor, addPage, attempts, bobMessageCount, charlieDeviceSet, charlieIncomingWith, charlieMember (+106 more)

### Community 75 - "Community 75"
Cohesion: 0.02
Nodes (110): bridge, deleteMessagesForGroup, _FailingGroupMessageRepository, groupId, groupMessageRepo, groupRepo, main, core_fake_p2p.FakeP2PService (+102 more)
...
Cohesion: 0.02
Nodes (112): ackKind, acknowledged, action, actualTransport, attachments, best, bridge, budgetMs (+104 more)

### Community 78 - "Community 78"
Cohesion: 0.02
Nodes (110): package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/features/conversation/presentation/widgets/blocked_banner.dart, activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername (+102 more)

### Community 79 - "Community 79"
Cohesion: 0.02
Nodes (109): actionButton, attempts, beginRecoveryOnNextLoad, bridge, button, ciphertext, confirmDeleteLocalGroupDialog, confirmDissolveGroupDialog (+101 more)

### Community 80 - "Community 80"
Cohesion: 0.03
Nodes (69): calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath, listFilesRecursively, main, name (+61 more)
...
Cohesion: 0.02
Nodes (105): addContact, addRequest, archiveContact, blockContact, conditionalTransitionStatus, contactExists, countPendingIntroductions, deleteAttachmentsForContact (+97 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (104): _InMemoryGroupHistoryGapRepairRepository, activeRetrieves, addDelay, addFailOnce, addPage, addRepairResponse, addTimeout, bridge (+96 more)

### Community 84 - "Community 84"
Cohesion: 0.02
Nodes (92): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+84 more)
...
Cohesion: 0.02
Nodes (99): CountingGroupMessageRepository, DateSeparator, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay (+91 more)

### Community 88 - "Community 88"
Cohesion: 0.02
Nodes (99): _activeGroupId, _activePeerId, _backgroundPreOpenFixture, _backgroundUpdatedFixture, build, buildChatMessageListener, _buildConversation, _buildEventSummary (+91 more)
...
Cohesion: 0.02
Nodes (98): MapEntry, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge, _broadcastSelfRemovalIfNeeded, build, _buildGroupConfig (+90 more)

### Community 91 - "Community 91"
Cohesion: 0.02
Nodes (96): addDeleteEvent, append, attempts, baseAdmin, baseSender, blockedIds, bridge, buildMetadataConfig (+88 more)
...
Cohesion: 0.03
Nodes (74): AccountMigrationProductionBundleSource, failureEvent, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, ChatMessageListener, GroupInviteListener, GroupKeyUpdateListener, GroupMembershipUpdateListener (+66 more)
...
Cohesion: 0.05
Nodes (39): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, EventCallback, messageEnvelopeType(), readFrame(), relayConnectCandidates() (+31 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (65): chatPushMetadata, scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData() (+57 more)

### Community 100 - "Community 100"
Cohesion: 0.02
Nodes (91): _EventRecorder, appShellController, backingSecureKeyStore, baseIdentityRepo, binding, bridge, buildApp, _callback (+83 more)

### Community 101 - "Community 101"
Cohesion: 0.04
Nodes (88): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+80 more)

### Community 102 - "Community 102"
Cohesion: 0.05
Nodes (80): BuildGroupSignatureData(), DecryptGroupMessage(), EncryptGroupMessage(), TestBuildGroupSignatureData_Deterministic(), TestBuildGroupSignatureData_Format(), TestDecryptGroupMessage_InvalidBase64(), TestEncryptGroupMessage_InvalidKey(), TestEncryptGroupMessage_WrongKeyLength() (+72 more)
...
Cohesion: 0.02
Nodes (92): AccountMigrationStreamingEntry, build, chunkSize, entryId, _FileAccountMigrationStreamingEntry, filePath, fileReader, kind (+84 more)

### Community 105 - "Community 105"
Cohesion: 0.02
Nodes (89): _HarnessEnvironment, audioRecorderService, binding, bridge, build, _callback, _canUseVmServiceTimeline, _captureScenario (+81 more)
...
Cohesion: 0.02
Nodes (87): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, bridge, candidates, _confirmedGroupReplayCryptoFailureReasons, contains, _defaultGroupRepairNowUtc, emitGroupKeyRepairRequest (+79 more)
...
Cohesion: 0.02
Nodes (82): device, dissolvedAt, group, HandleGroupReactionResult, handleIncomingGroupReaction, _isReactionSenderDeviceBound, member, parse (+74 more)

### Community 110 - "Community 110"
Cohesion: 0.02
Nodes (126): appShellController, _armTimers, _cancelTimers, dispose, expiryBudget, _expiryTimer, _fallbackTimer, _handlePendingTargetMutation (+118 more)

### Community 111 - "Community 111"
Cohesion: 0.02
Nodes (86): _acceptedMemberJoinedAt, acceptedMembershipWatermarkAt, authResult, avatarBlobId, avatarMime, bridge, code, config (+78 more)

### Community 112 - "Community 112"
Cohesion: 0.08
Nodes (80): newMemoryInboxBackend(), failingStoreInboxBackend, requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs() (+72 more)
...
Cohesion: 0.02
Nodes (78): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+70 more)

### Community 117 - "Community 117"
Cohesion: 0.01
Nodes (134): amplitudeValues, build, elapsed, _formatDuration, onCancel, RecordingOverlay, package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/conversation/presentation/widgets/recording_overlay.dart (+126 more)

### Community 118 - "Community 118"
Cohesion: 0.02
Nodes (103): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, addContact, archiveContact, blockContact, contactExists, deleteContact (+95 more)

### Community 119 - "Community 119"
Cohesion: 0.03
Nodes (84): main, main, _dbKey, fixedKey, main, MigrationDatabaseImportStagingException, activeWrites, current (+76 more)

### Community 120 - "Community 120"
Cohesion: 0.02
Nodes (81): _TrackingInviteDeliveryAttemptRepository, _TrackingInviteDeliveryAttemptRepository, _InMemoryInviteDeliveryAttemptRepository, _InMemoryInviteDeliveryAttemptRepository, contact, contactKey, group, groupKey (+73 more)

### Community 121 - "Community 121"
Cohesion: 0.03
Nodes (76): FakeReactionRepository, contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult (+68 more)
...
Cohesion: 0.02
Nodes (75): app_colors.dart, background_readable_colors.dart, Brightness, BuildContext, EdgeInsetsGeometry, main, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart (+67 more)

### Community 124 - "Community 124"
Cohesion: 0.02
Nodes (87): Material, MobileScannerController, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, package:mobile_scanner/mobile_scanner.dart, build, _buildCloseButton (+79 more)

### Community 125 - "Community 125"
Cohesion: 0.03
Nodes (79): package:flutter_app/features/feed/presentation/widgets/feed_header.dart, activeFocusPeerId, activeQuoteMessageIds, activeTab, backgroundPreference, bottomInset, build, _buildFeedContent (+71 more)

### Community 126 - "Community 126"
Cohesion: 0.03
Nodes (70): archiveGroup, activeDevices, byDeviceId, bySigningKey, byTransport, device, deviceId, devicePublicKey (+62 more)

### Community 127 - "Community 127"
Cohesion: 0.04
Nodes (50): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, package:flutter_app/features/posts/application/post_presence_listener.dart, package:flutter_app/features/posts/domain/models/contact_presence_snapshot.dart, accuracyM, _activePayload, blocked, capturedAt (+42 more)

### Community 128 - "Community 128"
Cohesion: 0.03
Nodes (76): addContact, addTestContact, archiveContact, blockContact, buildChatJsonWithMedia, buildP2PMessage, buildV2EncryptedEnvelopeJson, buildValidChatJson (+68 more)
...
Cohesion: 0.03
Nodes (71): PendingGroupInvite, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_member_row.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, package:intl/intl.dart, buildTestWidget, main, _amberAccent (+63 more)
...
Cohesion: 0.04
Nodes (63): assertOutgoingTransition, db, main, makeRow, db, main, makeRow, db (+55 more)
...
Cohesion: 0.03
Nodes (69): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+61 more)

### Community 136 - "Community 136"
Cohesion: 0.03
Nodes (71): build, createState, initState, main, _SettleHarness, _SettleHarnessState, shareIntentService, first_time_experience_screen.dart (+63 more)

### Community 137 - "Community 137"
Cohesion: 0.05
Nodes (64): FileMode, newRedisClientFromURL(), newRedisPushTokenBackend(), backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv() (+56 more)
...
Cohesion: 0.03
Nodes (56): alice, alicePeerId, bob, bobPeerId, bridge, _buildBridge, chatListener, contactRepo (+48 more)

### Community 140 - "Community 140"
Cohesion: 0.03
Nodes (68): captureFlowEvents, _FailFirstPublishBridge, _Gfr001GatedPublishBridge, id, main, _makeAttachment, _makeFailedGroupMessage, _makeGroup (+60 more)
...
Cohesion: 0.03
Nodes (69): acceptedGroupAdvanced, _acceptedGroupAdvancedBeyondInviteMetadata, acceptedGroupId, acceptedInboxDrainMaxAttempts, acceptedInboxDrainRetryDelay, acceptedInboxPageSize, acceptedMetadataUpdatedAt, AcceptPendingGroupInviteResult (+61 more)

### Community 145 - "Community 145"
Cohesion: 0.03
Nodes (59): alice, bob, main, network, _originalText, alice, bob, checkHealth (+51 more)

### Community 146 - "Community 146"
Cohesion: 0.03
Nodes (69): package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents, accountMigrationRunTransfer, accountMigrationSizeGate, accountMigrationStartReceiver, accountMigrationStopReceiver, appShellController (+61 more)
...
Cohesion: 0.03
Nodes (67): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, _RecorderRepo, _FakeMediaAttachmentRepository (+59 more)

### Community 149 - "Community 149"
Cohesion: 0.02
Nodes (91): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+83 more)
...
Cohesion: 0.03
Nodes (67): group_multi_party_device_criteria.dart, activeProcessLabelByRole, args, contains, deviceCheck, devices, displayArgs, exitCode (+59 more)

### Community 152 - "Community 152"
Cohesion: 0.03
Nodes (66): _TrackingReactionListener, _TrackingReactionListener, ReactionChange, buildShareTargetPickerRoute, package:flutter_app/core/media/audio_recorder_service.dart, package:flutter_app/features/share/application/share_batch_delivery_coordinator.dart, package:flutter_app/features/share/presentation/screens/share_target_picker_wired.dart, Reaction (+58 more)
...
Cohesion: 0.03
Nodes (62): DissolveGroupResult, eventAt, group, hadBridgeRecoveryGap, inboxPayload, members, preTransitionStateHash, recipientPeerIds (+54 more)
...
Cohesion: 0.03
Nodes (63): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, attachment (+55 more)

### Community 162 - "Community 162"
Cohesion: 0.05
Nodes (41): ImagePicker, _contact, contacts, imageProcessor, main, mlKemKey, peerId, posts (+33 more)

### Community 163 - "Community 163"
Cohesion: 0.03
Nodes (57): avatarPath, contact, isArchived, isBlocked, lastActivity, lastMessageTimestamp, messageCount, OrbitFriend (+49 more)

### Community 164 - "Community 164"
Cohesion: 0.03
Nodes (60): package:flutter_app/features/groups/presentation/widgets/contact_picker_row.dart, package:flutter_app/features/home/presentation/widgets/ring_avatar.dart, _avatarSnapshotBytes, fromList, main, wrap, backgroundPreference, build (+52 more)
...
Cohesion: 0.03
Nodes (63): _AliceConversationDeps, _AliceHarnessApp, at, bridge, build, chatListener, clearDeliveredNotifications, consumeInitialPayload (+55 more)
...
Cohesion: 0.03
Nodes (60): LanAvailabilitySnapshot, Key, BackgroundChoiceControl, _BackgroundOption, build, description, errorText, isSelected (+52 more)
...
Cohesion: 0.03
Nodes (57): AccountMigrationNetworkGate, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage, envelope (+49 more)

### Community 173 - "Community 173"
Cohesion: 0.03
Nodes (61): AccountMigrationReceiverEvents, AccountMigrationExportAuthorizeFn, AccountMigrationQrBuildFn, AccountMigrationQrScanFn, _activeReceiverSessionId, _authorizationErrorText, _authorizedTranscript, authorizeExport (+53 more)

### Community 174 - "Community 174"
Cohesion: 0.03
Nodes (58): adminGroup, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected, groupRepo (+50 more)
...
Cohesion: 0.06
Nodes (36): ConnectionState, ConnScope, ConnStats, directConfirmCallback, classifyStreamTransport(), generatePeerIDStr(), TestGL011UpdateGroupConfigConcurrentValidatorReadsAreRaceFree(), stubStreamConn (+28 more)

### Community 178 - "Community 178"
Cohesion: 0.03
Nodes (58): Image, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce, group (+50 more)

### Community 179 - "Community 179"
Cohesion: 0.03
Nodes (61): additionalCount, avatarCacheBustKey, avatarPath, canReact, canWrite, CardThreadFeedItem, collapsedPreviewMessage, connectedVia (+53 more)

### Community 180 - "Community 180"
Cohesion: 0.03
Nodes (60): AccountMigrationSizeGate, package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart, package:flutter_app/features/settings/presentation/widgets/settings_introduction_debug_card.dart, accountMigrationRunTransfer, accountMigrationSizeGate, appShellController, _backgroundPreferenceError, bridge (+52 more)

### Community 181 - "Community 181"
Cohesion: 0.05
Nodes (42): _RecordingStagedDatabaseOpener, _ThrowingStagedDatabaseOpener, _FfiStagedDatabaseOpener, computeDatabaseChecksumForTesting, database, DefaultMigrationStagedDatabaseOpener, manifest, message (+34 more)
...
Cohesion: 0.03
Nodes (57): main, bgBeginResponse, ciphertext, commandDelays, commandGates, controller, _decodeReplayPayload, effectiveGroup (+49 more)

### Community 186 - "Community 186"
Cohesion: 0.04
Nodes (55): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, archiveGroup, _FailingGroupRepository, groupId, groupRepo, main (+47 more)
...
Cohesion: 0.03
Nodes (81): main, payload, main, payload, main, resultFor, main, LinearProgressIndicator (+73 more)
...
Cohesion: 0.08
Nodes (56): buildGroupKeyInfoWithGrace(), decryptGroupEnvelopePayload(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo(), gk019DirectJumpKeyInfo(), gk020GenerateDistinctEpochKeys(), gk020SequentialRotationKeyInfo(), TestGK016GroupTopicValidatorAcceptsEpoch0PreviousKeyDuringFirstRotationGrace() (+48 more)

### Community 193 - "Community 193"
Cohesion: 0.04
Nodes (54): AppendGroupEventLogEntry, appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, dispose, _enqueueMessage, groupInviteStream (+46 more)
...
Cohesion: 0.10
Nodes (30): decodeGroupInboxEntries(), encodeRedisComponent(), encodeRedisGroupInboxRecord(), encodeRedisGroupInboxRecords(), filterInboxEntries(), minInt(), newRedisRendezvousBackend(), normalizeInboxEntries() (+22 more)

### Community 196 - "Community 196"
Cohesion: 0.04
Nodes (55): group_message_local_deletions_db_helpers.dart, contains, dbCountGroupMessages, dbCountTotalUnreadGroupMessages, dbCountUnreadGroupMessages, dbDeleteGroupMessage, dbDeleteGroupMessageForMembershipRepair, dbDeleteGroupMessagesForGroup (+47 more)

### Community 197 - "Community 197"
Cohesion: 0.04
Nodes (55): _badgeFrames, binding, build, _callback, _canUseVmServiceTimeline, _captureScenario, _closeFrames, closeOrbit (+47 more)

### Community 198 - "Community 198"
Cohesion: 0.04
Nodes (53): bridge, daveRow, daveRowId, enqueue, finalizeDistributed, finalizeUnreachable, getDistribution, getPendingForGroup (+45 more)

### Community 199 - "Community 199"
Cohesion: 0.04
Nodes (52): id, insertIntroSystemMessage, message, now, saveMessage, ContactRequestSendIntent, dataToSign, identity (+44 more)
...
Cohesion: 0.04
Nodes (53): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, BonsoirBroadcastFactory, BonsoirDiscoveryFactory, _broadcast, _controller (+45 more)

### Community 202 - "Community 202"
Cohesion: 0.04
Nodes (54): connectedPeers, currentState, dialAlwaysFails, dialDelay, dialPeer, discoverAlwaysFails, discoverDelay, discoverLocalPeer (+46 more)
...
Cohesion: 0.04
Nodes (44): consumedSessions, consumeSession, empty, failClosed, isSessionConsumed, loadConsumedSession, loadPendingNewPhoneSession, _loadStore (+36 more)

### Community 210 - "Community 210"
Cohesion: 0.04
Nodes (52): addContact, archiveContact, blockContact, conditionalTransitionStatus, contactExists, contactPeerId, contacts, deleteContact (+44 more)
...
Cohesion: 0.04
Nodes (52): attemptCount, _awaitLateDeliveryResult, candidates, _deferredGroupKeyDistributionSink, deferredPeerIds, _deliverableDevicesForRotation, delivered, devices (+44 more)

### Community 213 - "Community 213"
Cohesion: 0.04
Nodes (49): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+41 more)

### Community 214 - "Community 214"
Cohesion: 0.05
Nodes (45): DetailedInboxStore, LifecycleBridge, bridge, main, service, bridge, main, service (+37 more)

### Community 215 - "Community 215"
Cohesion: 0.04
Nodes (50): group_multi_device_real_harness.dart, _buildCliJoinFixture, _configuredRunId, _configuredSharedDir, _createCliGroupNode, deadline, file, runGroupPublishBenchmark (+42 more)

### Community 216 - "Community 216"
Cohesion: 0.04
Nodes (51): _HarnessScreen, build, buildChatMessageListener, _buildMessage, _captureFlowEvents, contact, contactRepo, createState (+43 more)

### Community 217 - "Community 217"
Cohesion: 0.04
Nodes (49): _MemoryCutoverRepository, _MemoryCutoverRepository, _MemoryCutoverRepository, _authorityState, checkHealth, clearAuthority, clearCutover, clearLocalPushTokenCalls (+41 more)

### Community 218 - "Community 218"
Cohesion: 0.04
Nodes (43): events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness, routedTargets (+35 more)
...
Cohesion: 0.04
Nodes (50): ackRelayBlobDeletion, adoptCanonicalFileIfAvailable, adoptCompletePartFileIfAvailable, attachmentId, bridge, candidates, _collectLocalMediaCandidateDiagnostics, completedLocalAttachment (+42 more)
...
Cohesion: 0.04
Nodes (50): addContact, archiveContact, blockContact, conditionalTransitionStatus, contactExists, contacts, deleteContact, deleteMessage (+42 more)
...
Cohesion: 0.04
Nodes (49): package:flutter_app/features/groups/presentation/screens/contact_picker_wired.dart, contactAlice, contactBob, contactCharlie, FakeIdentityRepository, identity, loadIdentity, main (+41 more)
...
Cohesion: 0.04
Nodes (49): package:flutter_app/features/groups/presentation/screens/group_list_wired.dart, actorPayload, aliceContact, buildWidget, canonicalPayload, createdAt, effectiveReceivedAt, envelope (+41 more)
...
Cohesion: 0.04
Nodes (48): bridge, contactRepository, DefaultShareBatchDeliveryCoordinator, deliver, detail, ext, failedTargetKeys, failureCount (+40 more)
...
Cohesion: 0.04
Nodes (45): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+37 more)
...
Cohesion: 0.04
Nodes (47): InMemoryInboxStagingRepository, _ThrowingInboxStagingRepository, RecoveredInboxReplayOutcome, action, bridge, buildSweepService, calledCommands, _captureFlowEvents (+39 more)
...
Cohesion: 0.05
Nodes (35): benchmark_harness.dart, BenchmarkHarness, main, main, makeNodeState, testPeerId, package:flutter_app/core/utils/notification_tap_timing.dart, package:flutter_app/features/p2p/domain/models/connection_state.dart (+27 more)

### Community 246 - "Community 246"
Cohesion: 0.04
Nodes (43): main, _makeAttachment, mime, package:flutter_app/features/feed/presentation/widgets/more_messages_hint.dart, package:flutter_app/features/feed/presentation/widgets/view_earlier_link.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, ScrollBehavior, main (+35 more)
...
Cohesion: 0.04
Nodes (45): activeFocusPeerId, activeQuoteMessageIds, _assertBackgroundScrollDoesNotRegress, _assertThresholds, average, backgroundP99, backgroundPreference, baselineP99 (+37 more)
...
Cohesion: 0.04
Nodes (44): count, deleteMessage, deleteMessageForMembershipRepair, deleteMessagesForGroup, _emitOutgoingRowsChangedIfNeeded, _emitOutgoingStatusChangeIfNeeded, existsByContent, existsByMessageId (+36 more)

### Community 257 - "Community 257"
Cohesion: 0.05
Nodes (43): _MemorySecureKeyStore, _TrackingSecureKeyStore, _FakeSecureKeyStore, _InMemorySecureKeyStore, _FakeSecureKeyStore, _FakeSecureKeyStore, backingSecureKeyStore, containsKey (+35 more)
...
Cohesion: 0.04
Nodes (44): _chatMessageController, chatMessageStream, _contactRequestController, contactRequestStream, _deliveryReceiptController, deliveryReceiptStream, dispose, _groupInviteController (+36 more)

### Community 260 - "Community 260"
Cohesion: 0.05
Nodes (43): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+35 more)

### Community 261 - "Community 261"
Cohesion: 0.03
Nodes (79): _FakeP2PService, acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer, declineRequest, _defaultShowError, handleRoute (+71 more)
...
Cohesion: 0.04
Nodes (42): addContact, archiveContact, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository, getActiveContacts (+34 more)
...
Cohesion: 0.05
Nodes (42): ../../../features/groups/domain/models/group_pending_key_distribution.dart, ../../../features/groups/domain/models/group_pending_key_repair.dart, args, attempts, current, dbFinalizeGroupPendingKeyDistribution, dbLoadGroupPendingKeyDistribution, dbLoadPendingGroupKeyDistributionsForGroup (+34 more)
...
Cohesion: 0.05
Nodes (43): group_repository.dart, ../models/group_key_retention_policy.dart, archiveGroup, clearPendingKeyRotation, clearPendingKeyRotations, deleteGroup, _deleteGroupKeyMaterial, _deleteGroupKeyMirror (+35 more)
...
Cohesion: 0.05
Nodes (41): allowStaging, commentExists, comments, compareTo, envelope, existing, handleIncomingPostCommentReaction, HandleIncomingPostCommentReactionResult (+33 more)

### Community 273 - "Community 273"
Cohesion: 0.02
Nodes (100): AppLocalizations, dart:ui, LocalizationsDelegate, MemberRole, nav_bar_button.dart, nav_bar_theme.dart, package:flutter_app/features/groups/presentation/group_invite_status_presentation.dart, package:flutter_app/l10n/app_localizations_en.dart (+92 more)
...
Cohesion: 0.05
Nodes (41): absolutePath, _buildHiddenIncomingEditPlaceholder, compareTo, contact, conversationMessage, copyWith, current, editedAt (+33 more)
...
Cohesion: 0.13
Nodes (41): boolFromMap(), cmdBlobDecrypt(), cmdBlobEncrypt(), cmdBlobKeygen(), cmdClearMessages(), cmdDial(), cmdDisconnect(), cmdDiscover() (+33 more)
...
Cohesion: 0.05
Nodes (40): group_message_repository.dart, group_thread_summary_repository.dart, dbRunGroupInboxPageTransactionFn, deleteMessage, deleteMessageForMembershipRepair, deleteMessagesForGroup, _emitOutgoingRowsChangedIfNeeded, _emitOutgoingStatusChangeIfNeeded (+32 more)
...
Cohesion: 0.05
Nodes (40): ../models/group_message_receipt.dart, buildGroupRemovalCutoffMessageId, deleteMessage, deleteMessageForMembershipRepair, deleteMessagesForGroup, existsByContent, existsByMessageId, getFailedOutgoingMessages (+32 more)
...
Cohesion: 0.06
Nodes (34): main, _attachment, main, allSameType, backgroundDuplicateGuardDelay, ConsumeRecentRemoteNotificationAnnouncement, conversationKey, firstType (+26 more)
...
Cohesion: 0.05
Nodes (39): package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, _buildTestWidget, chatListener, conditionalTransitionStatus, _contact, _contactPeerId, _delayedSuccessSend, deleteMessage (+31 more)
...
Cohesion: 0.05
Nodes (38): basePath, conditionalTransitionStatus, deleteAttachmentsForContact, deleteAttachmentsForMessage, deleteMessage, deleteMessagesForContact, existsByContent, existsByDedupKey (+30 more)
...
Cohesion: 0.05
Nodes (37): admin,, GroupRole, archivedAt, avatarBlobId, avatarMime, avatarPath, copyWith, createdAt (+29 more)

### Community 306 - "Community 306"
Cohesion: 0.05
Nodes (37): allowMemberSnapshotBootstrap, _bootstrapInviterPublicKey, buildGroupInviteRevokerAuthorizationSnapshot, buildProof, computedStateHash, contact, _findMember, _findSenderMember (+29 more)

### Community 307 - "Community 307"
Cohesion: 0.05
Nodes (34): attachment, _canLinkLocalMedia, deadline, decision, effectiveInterval, _findAttachmentById, hasLocalPath, kDefaultLocalMediaMetadataGrace (+26 more)
...
Cohesion: 0.05
Nodes (34): package:flutter_app/core/utils/ring_avatar_generator.dart, package:flutter_app/core/utils/ring_avatar_spec.dart, ring_avatar_painter.dart, RingAvatarData, main, build, _buildAvatarSection, _buildCard (+26 more)
...
Cohesion: 0.04
Nodes (46): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState, chatMessageStream (+38 more)

### Community 315 - "Community 315"
Cohesion: 0.06
Nodes (36): FakeIntroductionRepository, bridge, _confirmationValueForState, contactRepo, dispose, emitIntroStatusChanged, finish, introduction (+28 more)

### Community 316 - "Community 316"
Cohesion: 0.05
Nodes (36): bytes, committedFile, contentHash, _copyToOwnedMediaPath, debugGroupMediaUploadPostCommitProbeDelays, deleteAppOwnedMediaFileIfExists, deleteSourceWhenDone, _DurableMediaCopyResult (+28 more)
...
Cohesion: 0.07
Nodes (34): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+26 more)

### Community 320 - "Community 320"
Cohesion: 0.06
Nodes (31): _activeDepth, _activeDepthListenable, begin, end, GroupRecoveryGate, groupRecoveryPendingError, isActive, isGroupRecoveryInProgress (+23 more)
...
Cohesion: 0.06
Nodes (34): config, configFile, delayed, delete, dir, exportIdentityForSmokeTest, file, friends (+26 more)
...
Cohesion: 0.06
Nodes (34): media_attachment_repository.dart, ../models/media_attachment.dart, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentById, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads (+26 more)
...
Cohesion: 0.06
Nodes (34): AudioPlayerPlatform, _FakeAudioPlayerPlatform, _FakeJustAudioPlatform, JustAudioPlatform, package:just_audio_platform_interface/just_audio_platform_interface.dart, _buildScreen, dispose, disposeAllPlayers (+26 more)
...
Cohesion: 0.06
Nodes (34): LocalMediaReady, acceptOffer, add, allowedMimePrefixes, _artifactExtension, _cleanupExpired, cleanupMedia, _cleanupTimer (+26 more)

### Community 337 - "Community 337"
Cohesion: 0.06
Nodes (34): contentHash, copyWith, createdAt, downloadStatus, durationMs, encryptionKeyBase64, encryptionNonce, encryptionScheme (+26 more)
...
Cohesion: 0.06
Nodes (33): _aliceContact, allowedDevices, assignedRole, bridge, contactRepo, _deviceBoundGroupConfig, envelope, expectRejected (+25 more)

### Community 343 - "Community 343"
Cohesion: 0.06
Nodes (33): archiveGroup, clearPendingKeyRotation, clearPendingKeyRotations, deleteGroup, getActiveGroups, getAllGroups, getGroup, getKeyByGeneration (+25 more)
...
Cohesion: 0.06
Nodes (28): fromStorageString, loadImageQualityPreference, loadVideoQualityPreference, saveImageQualityPreference, saveVideoQualityPreference, main, value, write (+20 more)
...
Cohesion: 0.06
Nodes (31): _attachment, id, main, mime, size, attachment, borderRadius, build (+23 more)

### Community 362 - "Community 362"
Cohesion: 0.06
Nodes (30): copyWith, createdAt, emoji, fromJson, fromMap, hashCode, id, messageId (+22 more)
...
Cohesion: 0.06
Nodes (31): _FakeIdentityRepo, _FakeIdentityRepo, _FakeIdentityRepository, _FakeIdentityRepository, IdentityRepository, _Section10IdentityRepository, _FakeIdentityRepository, _FakeIdentityRepository (+23 more)

### Community 368 - "Community 368"
Cohesion: 0.07
Nodes (28): buildIdentity, main, tempDir, AspectRatio, FileImage, main, _makeMedia, _makeVideoMedia (+20 more)
...
Cohesion: 0.06
Nodes (31): conditionalTransitionStatus, count, deleteMessage, deleteMessagesForContact, existsByContent, existsByDedupKey, getConversationThreadSummaries, getConversationThreadSummary (+23 more)

### Community 372 - "Community 372"
Cohesion: 0.06
Nodes (31): media_attachment.dart, contactPeerId, ConversationMessage, copyWith, createdAt, custodyCheckedAt, dedupKey, deletedAt (+23 more)

### Community 373 - "Community 373"
Cohesion: 0.06
Nodes (30): cases, _DrainExpectation, label, main, remoteData, _RouteContractCase, target, commentId (+22 more)
...
Cohesion: 0.07
Nodes (29): _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake, getApplicationDocumentsPath (+21 more)
...
Cohesion: 0.14
Nodes (23): newMemoryGroupInboxBackend(), opaqueGroupReplayEnvelope(), TestGI017GroupInboxStoreAuthorizedCursorPaginationReturns120MessagesExactlyOnce(), TestGI035GroupInboxStorePersistsEncryptedEnvelopeWithoutPlaintext(), TestGIRD004MemoryGroupInboxConflictingSameMessageIDRejected(), TestGIRD004MemoryGroupInboxDistinctMessageIDsPreserveOrder(), TestGIRD004MemoryGroupInboxDuplicateExpandedRecipientACLMerges(), TestGIRD004MemoryGroupInboxDuplicateMessageIDStoresOneRow() (+15 more)

### Community 383 - "Community 383"
Cohesion: 0.06
Nodes (30): _BundleDatabases, _bundleSource, captureCipherMetadata, close, _createGroupMessagesTable, _createIdentityTable, _createMediaAttachmentsTable, documentsRootPath (+22 more)
...
Cohesion: 0.07
Nodes (28): add, attemptSilentIntroRecovery, bridge, _contactKeyUpdatedController, contactKeyUpdatedStream, contactRepo, ContactRequestListener, contactRequestStream (+20 more)
...
Cohesion: 0.07
Nodes (28): AudioPlayer, attachment, AudioPlayerWidget, _AudioPlayerWidgetState, build, _buildUnavailableAudio, _canRetryUnavailableMedia, createState (+20 more)
...
Cohesion: 0.17
Nodes (28): newRedisGroupInboxBackend(), newRedisInboxBackend(), newTestRedisClient(), requireRedisInboxStoreResult(), TestGIRD004RedisGroupInboxConflictingSameMessageIDRejected(), TestGIRD004RedisGroupInboxDistinctMessageIDsPreserveOrder(), TestGIRD004RedisGroupInboxDuplicateExpandedRecipientACLMerges(), TestGIRD004RedisGroupInboxDuplicateMessageIDStoresOneRowAcrossClients() (+20 more)

### Community 399 - "Community 399"
Cohesion: 0.07
Nodes (26): media_display_helpers.dart, media_grid_cell.dart, build, _buildFourPlus, _buildLayout, _buildSingle, _buildThree, _buildTwo (+18 more)

### Community 400 - "Community 400"
Cohesion: 0.07
Nodes (28): ../models/group_key_info.dart, ../models/group_member.dart, ../models/group_model.dart, archiveGroup, clearPendingKeyRotation, clearPendingKeyRotations, deleteGroup, getActiveGroups (+20 more)
...
Cohesion: 0.07
Nodes (23): main, checkHealth, _circuitMultiaddr, dispose, _FakeBridge, _flatten, initialize, _initialized (+15 more)
...
Cohesion: 0.07
Nodes (27): copyWith, createdAt, fromMap, groupId, GroupMessage, hashCode, id, inboxRetryPayload (+19 more)
...
Cohesion: 0.07
Nodes (27): ring_avatar_spec.dart, _calculateRingRadii, color, dashGap, dashLength, djb2Hash, gap, generate (+19 more)
...
Cohesion: 0.10
Nodes (17): db, main, makeAttachmentRow, makeMessageRow, db, main, db, main (+9 more)
...
Cohesion: 0.19
Nodes (8): DefaultFeatureFlags(), featureFlagsStatusMap(), limitRelayAddresses(), FeatureFlags, TestFeatureFlags_DefaultAllTrue(), FeatureFlags, Node, Node
...
Cohesion: 0.08
Nodes (25): main, build, main, _openConversation, _openGroup, _handleNotificationRouteTarget, MaterialPageRoute, NavigatorState (+17 more)
...
Cohesion: 0.08
Nodes (23): deliveredWritePatterns, main, scanDeliveredWrites, File, _attachment, contentHash, downloadStatus, gifFile (+15 more)

### Community 443 - "Community 443"
Cohesion: 0.08
Nodes (22): block, contentHashValidation, copyWith, _emitGroupFeedMediaVerifyEvent, file, fileBytes, fileExists, _idPrefix (+14 more)
...
Cohesion: 0.08
Nodes (23): compressAndGetFile, _compressFile, CompressFileFn, _compressVideo, CompressVideoFn, _defaultCompress, _defaultVideoCompress, ImageProcessor (+15 more)
...
Cohesion: 0.08
Nodes (24): avatarBlobId, avatarMime, createdAt, createdBy, expiresAt, fromMap, fromPayload, groupDescription (+16 more)
...
Cohesion: 0.09
Nodes (21): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, declineContactRequest, DeclineContactRequestResult, peerIdPrefix (+13 more)
...
Cohesion: 0.15
Nodes (20): assert_log_contains(), assert_log_not_contains(), assert_scenario_markers(), discover_booted_devices(), install_app_on_device(), is_booted_ios_device(), launch_warm_app_for_host_push(), main() (+12 more)
...
Cohesion: 0.08
Nodes (22): secret_storage_references.dart, secure_key_store.dart, groupKeyCount, mediaCount, migrated, rows, _scrubLegacyGroupKeys, scrubLegacyGroupSecretsToSecureStorage (+14 more)
...
Cohesion: 0.09
Nodes (21): effectiveRequestPermission, granted, requestPushPermission, settings, client, closeMockGoBridgeEventChannel, defaultHandler, exerciseNativeFailure (+13 more)

### Community 472 - "Community 472"
Cohesion: 0.09
Nodes (20): CustomPaint, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, package:flutter_app/features/home/presentation/widgets/scan_friend_card.dart, backgroundPreference, build, _controller, createState, dispose (+12 more)

### Community 473 - "Community 473"
Cohesion: 0.09
Nodes (21): group_pending_key_distribution_repository.dart, ../models/group_pending_key_distribution.dart, GroupPendingKeyDistribution, created, distribution, enqueue, finalizeDistributed, finalizeUnreachable (+13 more)
...
Cohesion: 0.09
Nodes (21): _buildItems, _connectionsByContactId, contactMessageIds, containsMessageId, dispose, FeedStore, _groupThreadsById, hasConnection (+13 more)
...
Cohesion: 0.09
Nodes (20): contactRepo, dispose, incomingPresenceStream, _onMessage, PostPresenceListener, postPresenceStream, _presenceController, snapshotRepo (+12 more)
...
Cohesion: 0.09
Nodes (20): canonicalPayload, deletePendingInvite, envelopeJson, invite, payload, revokedAt, revokePendingGroupInvite, RevokePendingGroupInviteResult (+12 more)
...
Cohesion: 0.09
Nodes (21): canDisplayVerifiedGroupMedia, computeFileSha256Hex, GroupMediaIntegrityPolicy, hasRequiredVerificationMetadata, hasValidContentHash, isQuarantinedGroupMedia, isRetryableDownloadFailure, isUnavailableMedia (+13 more)
...
Cohesion: 0.10
Nodes (19): _bestEffortIncomingCleanup, blockedSenderOwnsStoredMessage, contact, envelopeSenderPeerId, handleIncomingMessageDeletion, HandleMessageDeletionResult, maybeSendDeliveryReceipt, mediaAttachmentRepo (+11 more)
...
Cohesion: 0.18
Nodes (20): buildGroupPublishOpts(), GroupJoinTopic(), GroupPublish(), GroupSendReliable(), generateTestIdentityMaterial(), TestBuildGroupPublishOpts_EmptyReturnsNil(), TestBuildGroupPublishOpts_IncludesQuotedMessageId(), TestGroupJoinTopic_BB007RoundTripsFullConfigAndAcceptsPublish() (+12 more)
...
Cohesion: 0.10
Nodes (18): copyToDurableStorage, deleteFile, deleteMediaForContact, deleteMediaForPost, deleteOwnedPendingUploadFilesForMessage, deletePendingUploadDir, _isOwnedPendingUploadPathForMessage, localPathForAttachment (+10 more)
...
Cohesion: 0.11
Nodes (18): consumeInitialPayload, data, isNotificationRouteTargetAlreadyActive, isViewing, NotificationOpenSideEffect, onBeforeOpen, onBeforeRouteTarget, onMissingGroupRouteId (+10 more)

### Community 527 - "Community 527"
Cohesion: 0.07
Nodes (26): GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync, main, data, getInitialMessage (+18 more)

### Community 528 - "Community 528"
Cohesion: 0.18
Nodes (14): device_arg_for_path(), extract_runner_targets(), four_device_ids(), ios_notification_tap_devices(), multi_device_ids(), path_needs_four_device(), path_needs_multi_device(), preflight_transport_census_processes() (+6 more)
...
Cohesion: 0.12
Nodes (15): db, distributionRow, main, columns, db, insert, main, package:flutter_app/core/database/helpers/group_pending_key_distributions_db_helpers.dart (+7 more)
...
Cohesion: 0.11
Nodes (17): package:flutter_app/features/posts/application/nearby_location_service.dart, handleSharingDisabled, handleSharingDisabledCallCount, loadComposeAvailability, loadComposeAvailabilityCallCount, main, openAppSettings, refreshInteractivelyFromCompose (+9 more)
...
Cohesion: 0.12
Nodes (16): NearbyDevicePosition, checkedPermissionState, checkPermissionState, _contact, currentPosition, getCurrentPosition, isLocationServiceEnabled, main (+8 more)
...
Cohesion: 0.12
Nodes (16): attemptedAt, dbCountQuarantinedInboxStagingEntries, dbDeleteInboxStagingEntry, dbInsertInboxStagingEntry, dbLoadInboxStagingEntry, dbLoadRecoverableInboxStagingEntries, dbMarkInboxStagingEntryQuarantined, dbMarkInboxStagingEntryRejected (+8 more)
...
Cohesion: 0.12
Nodes (16): package:flutter_app/features/groups/domain/models/group_invite_revocation.dart, pending_group_invite_repository.dart, deleteExpiredConsumedInvites, deleteExpiredPendingInvites, deleteExpiredRevokedInvites, deleteExpiredWelcomeKeyPackageTombstones, deletePendingInvite, getConsumedInvite (+8 more)
...
Cohesion: 0.12
Nodes (15): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, ContactRequestRepository, addRequest, count, deleteRequest, getPendingRequests (+7 more)
...
Cohesion: 0.12
Nodes (14): flutter_secure_key_store.dart, FlutterSecureStorage, package:flutter_secure_storage/flutter_secure_storage.dart, marker, wipeKeychainOnce, writeAsString, appleAccessGroup, containsKey (+6 more)
...
Cohesion: 0.12
Nodes (15): contactPeerId, createdAt, db, emoji, id, isIncoming, main, makeMessageRow (+7 more)
...
Cohesion: 0.12
Nodes (15): _allowedLiteral, _dartFiles, exactAllowed, file, _firstCapture, _lineNumber, _loadArb, main (+7 more)
...
Cohesion: 0.12
Nodes (15): attemptedAt, copyWith, fromMap, fromValue, groupId, GroupInviteDeliveryAttempt, GroupInviteDeliveryStatus, lastError (+7 more)
...
Cohesion: 0.12
Nodes (14): package:flutter_app/features/conversation/domain/repositories/reaction_repository_impl.dart, reaction_repository.dart, deleteReactionsForContact, deleteReactionsForMessage, getReactionsForMessage, getReactionsForMessages, ReactionRepositoryImpl, removeReaction (+6 more)
...
Cohesion: 0.11
Nodes (15): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, package:flutter_app/core/secure_storage/secure_key_store.dart, kMlKemSecretKeyRingCap, kMlKemSecretKeyRingKey (+7 more)

### Community 578 - "Community 578"
Cohesion: 0.13
Nodes (14): buildReceipt, captureFlowEvents, contactPeerId, from, id, isIncoming, main, makeInboxedOutgoing (+6 more)

### Community 579 - "Community 579"
Cohesion: 0.13
Nodes (14): _buildOrbitFriend, contact, ids, includeArchived, latestMessage, _loadConversationThreadSummaries, _loadConversationThreadSummary, loadOrbitData (+6 more)

### Community 580 - "Community 580"
Cohesion: 0.13
Nodes (14): _buildOrbitGroup, group, ids, includeArchived, latestMessage, _loadGroupThreadSummaries, _loadGroupThreadSummary, loadOrbitGroups (+6 more)
...
Cohesion: 0.13
Nodes (14): bridge, checkHealth, dispose, initialize, isInitialized, lastParsedRequest, lastRawRequest, main (+6 more)
...
Cohesion: 0.13
Nodes (14): ChatMessage, confirmNonce, content, copyWith, from, fromJson, hashCode, isIncoming (+6 more)
...
Cohesion: 0.14
Nodes (13): declinedAtUtc, declinePendingGroupInvite, DeclinePendingGroupInviteResult, deletePendingInvite, effectiveNow, invite, pendingInviteRepo, _recordDeclinedInviteTombstone (+5 more)
...
Cohesion: 0.14
Nodes (13): _FakeIdentityRepo, _fakeIdentityResponse, _fakeMlKemResponse, fakeRestore, lastRestoredMnemonic, loadIdentity, main, progressStages (+5 more)
...
Cohesion: 0.15
Nodes (12): dbCountGroupMembers, dbDeleteAllGroupMembers, dbDeleteGroupMember, dbInsertGroupMember, dbInsertRemovedGroupMemberSnapshot, dbLoadAllGroupMembers, dbLoadGroupMember, dbLoadRemovedGroupMemberSnapshot (+4 more)
...
Cohesion: 0.17
Nodes (11): _contact, _deterministicRestore, _FakeIdentityRepo, freshMlKem, loadIdentity, main, savedIdentity, saveIdentity (+3 more)
...
Cohesion: 0.17
Nodes (11): ../models/group_invite_delivery_attempt.dart, deleteAttempt, deleteAttemptsForGroup, getAttempt, getAttemptsForGroup, getStatusesForGroupMembers, getStatusForMember, GroupInviteDeliveryAttemptRepository (+3 more)
...
Cohesion: 0.11
Nodes (15): post, postCommentExpiryExtension, refreshPostExpiryForComment, savePost, timestamp, updatedPost, count, hasCount (+7 more)
...
Cohesion: 0.18
Nodes (10): DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream, dispose, getLocalPeer, isLocalPeer, _peersController, resolvePeer (+2 more)
...
Cohesion: 0.20
Nodes (9): current, gate, group, _groupMembershipMutationLocks, isStaleGroupMembershipEvent, normalizedEventAt, previous, recordGroupMembershipEventWatermark (+1 more)
...
Cohesion: 0.20
Nodes (9): BeforePersistGroupMetadataUpdate, group, resolvedDescription, resolvedEventAt, resolvedName, trimmedDescription, updated, updateGroup (+1 more)
...
Cohesion: 0.20
Nodes (8): main, compare, currentSafetyNumber, GroupMemberIdentitySafety, identityChanged, _normalize, savedSafetyNumber, package:flutter_app/features/contacts/domain/models/contact_safety_number.dart
...
Cohesion: 0.22
Nodes (8): GroupMediaSizePolicy, kGroupMediaPerAttachmentLimitBytes, kGroupMediaTotalMessageLimitBytes, validateAttachments, validateLocalFile, validateRawDescriptors, validateSize, package:flutter_app/core/constants/media_constants.dart
...
Cohesion: 0.22
Nodes (8): ../models/message_reaction.dart, deleteReactionsForContact, deleteReactionsForMessage, getReactionsForMessage, getReactionsForMessages, ReactionRepository, removeReaction, saveReaction
...
Cohesion: 0.22
Nodes (8): package:flutter_app/features/groups/domain/utils/group_message_ordering.dart, aboveDivider, belowDivider, byGroup, _compareGroupThreadFeedItemsDescending, groupGroupMessagesIntoThreads, groupMap, timestampCompare

### Community 706 - "Community 706"
Cohesion: 0.36
Nodes (7): GO_BRIDGE_CONNECTED_PEER_TEST, is_go_bridge_connected_peer_test(), ONE_TO_ONE_HOST_TESTS, print_command_for_path(), run_path(), usage(), run_host_test_gates.sh script
...
Cohesion: 0.25
Nodes (7): conversation_message.dart, ConversationMessage, contactPeerId, ConversationThreadSummary, latestMessage, messageCount, unreadCount
...
Cohesion: 0.25
Nodes (7): fake_group_pubsub_network.dart, deliveries, _Go012Run, main, publishBatch, runScenario, scheduledDelays
...
Cohesion: 0.25
Nodes (7): dbDeleteReaction, dbDeleteReactionsForContact, dbDeleteReactionsForMessage, dbInsertReaction, dbLoadReactionsForMessage, dbLoadReactionsForMessages, id
...
Cohesion: 0.25
Nodes (7): ../models/group_thread_summary.dart, GroupMembershipRepairDeletionRepository, GroupOutgoingLocalMessageChangeSource, GroupMessageRepositoryImpl, getGroupThreadSummaries, getGroupThreadSummary, GroupThreadSummaryRepository

### Community 724 - "Community 724"
Cohesion: 0.39
Nodes (7): GroupConfig, GroupKeyInfo, GroupMember, GroupMemberDevice, GroupRole, GroupType, Time
...
Cohesion: 0.29
Nodes (6): GroupMultiDeviceFacet, GroupMultiDeviceScope, groupMultiDeviceScopeFor, groupMultiDeviceScopes, isGroupMultiDeviceDeviceLocal, isGroupMultiDeviceShared
...
Cohesion: 0.29
Nodes (7): ForEachWithResult(), relayInfoAttemptCandidates(), RelayInfo, RelaySelector, ID, Multiaddr, RWMutex
...
Cohesion: 0.50
Nodes (3): aLocal, bLocal, hasSignificantTimeGap
...
Cohesion: 0.67
Nodes (3): GroupKeyRotationDraftRepository, GroupRepositoryImpl, RemovedGroupMemberSnapshotRepository

### Community 833 - "Community 833"
Cohesion: 0.22
Nodes (8): main, makeIdentity, testCreatedAt, testMnemonic, testPeerId, testPrivateKey, testPublicKey, testUpdatedAt
...
## Knowledge Gaps
- **31388 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+31383 more)
...
- **Why does `incomingMessage` connect `Community 94` to `Community 529`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 304` to `Community 529`, `Community 285`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 285` to `Community 304`, `Community 101`, `Community 525`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _31388 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.0010476689366160294 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0029455081001472753 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.005037783375314861 - nodes in this community are weakly interconnected._