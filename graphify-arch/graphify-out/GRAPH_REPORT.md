# Graph Report - graphify-arch  (2026-07-10)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 44789 nodes · 70067 edges · 962 communities (910 shown, 52 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2663 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a331c491`
...
3. `NewNode()` - 168 edges
4. `startLocalNodeForMultiRelayTest()` - 163 edges
5. `generateTestKey()` - 161 edges
6. `New()` - 148 edges
7. `assertNotOk()` - 133 edges
8. `startLocalNodeForMultiRelayTestWithCollector()` - 103 edges
9. `buildTestEnvelope()` - 86 edges
10. `InMemoryPostRepository` - 86 edges

## Surprising Connections (you probably didn't know these)
- `newHLLRegister()` --calls--> `New()`  [INFERRED]
  go-relay-server/business_metrics.go → go-mknoon/node/node.go
- `ensureInboxMessageID()` --calls--> `New()`  [INFERRED]
  go-relay-server/inbox.go → go-mknoon/node/node.go
- `setupInboxStreamEnv()` --calls--> `New()`  [INFERRED]
  go-relay-server/inbox_test.go → go-mknoon/node/node.go
- `main()` --calls--> `New()`  [INFERRED]
  go-relay-server/main.go → go-mknoon/node/node.go
- `setupTestEnv()` --calls--> `New()`  [INFERRED]
  go-relay-server/media_test.go → go-mknoon/node/node.go
...
Cohesion: 0.00
Nodes (1947): 0, acceptedGroup, acceptedGroupAvatarBlobId, acceptedGroupMetadataFresh, acceptedRecipientPeerId, _acceptPromptPendingInvite, _acceptRa013DeviceInvite, acceptResult (+1939 more)
...
Cohesion: 0.00
Nodes (622): AnimatedOpacity, main, ChatMessageListener, main, _pendingRequest, requestRepo, _CanonicalPathFakeMediaFileManager, GateableMediaAttachmentRepository (+614 more)
...
Cohesion: 0.01
Nodes (318): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, buildMigrationQRData (+310 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (319): DiscoveredPeer, _contact, contacts, _ControlledP2PService, _dialedPeers, dialPeer, discoverPeer, dispose (+311 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (244): AlertDialog, AnimatedContainer, BoxDecoration, CircularProgressIndicator, Column, Directionality, FilledButton, GestureDetector (+236 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (270): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+262 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (255): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+247 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (261): AnimatedBuilder, Animation, _IntroOrbitHarness, _IntroOrbitHarnessState, _FeedTestHarness, _FeedTestHarnessState, package:flutter_app/core/theme/glassmorphism.dart, package:flutter_app/features/contact_profile/presentation/screens/contact_profile_screen.dart (+253 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (272): NotificationTapTiming, absoluteDurablePath, _activeAttachmentUpload, _activeGroupConversationKey, _activeQuoteMessageId, _allowPopDuringActiveUpload, _amplitudeBuffer, _amplitudeSub (+264 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (239): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, main, makeAttachment, makeMessage, mediaAttachmentRepo (+231 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (245): _ActiveAttachmentUpload, _ComposerSnapshot, conversation_screen.dart, PrepareEncryptedMediaArtifactFn, absoluteDurablePath, _ActiveAttachmentUpload, _activeQuoteMessageId, _allowPopDuringActiveUpload (+237 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (234): LanAvailabilitySnapshot, IconData, Key, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, actionLabel, active (+226 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (242): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../../features/push/domain/received_wake_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart (+234 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (222): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+214 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (159): dbClearFeedClearedThread, dbLoadFeedClearedThreads, dbMarkFeedClearedThread, delete, insert, query, dbDeleteExpiredGroupInviteConsumptions, dbLoadGroupInviteConsumption (+151 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (222): main, main, ContactRequestNotificationMaterializer, main, FirebaseReadiness, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, IosApnsNotificationOpenBridge (+214 more)
...
Cohesion: 0.01
Nodes (209): InMemoryPostRepository, _BlockingWritePostRepository, buildJson, contacts, content, _createdAt, _encryptedMediaPostMessage, innerPayload (+201 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (218): main, CurvedAnimation, orbit_screen.dart, package:flutter_app/features/introduction/application/unseen_review_count.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, _acceptRequest (+210 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (193): alice, bob, main, network, _originalText, FakeP2PNetwork, ChaosP2PNetwork, ../../features/conversation/integration/two_user_message_exchange_test.dart (+185 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (217): DeleteMessageForEveryoneFn, DeleteMessageForMeFn, EditChatMessageFn, feed_screen.dart, FeedStore, main, package:flutter_app/features/feed/domain/models/session_reply.dart, _acceptRequest (+209 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (194): items, mergeInnerCircleItems, _friend, _group, isBlocked, main, unreadCount, _friend (+186 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (190): @immutable, MediaViewerActionCapabilities, MediaViewerItem, MediaViewerProtection, OrbitViewMode, orbit_screen_pump_harness.dart, OrbitScreen, package:flutter_app/features/feed/presentation/widgets/feed_header.dart (+182 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (176): AnnotatedRegion, fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, applyContactFeedSnapshot, applyGroupFeedSnapshot (+168 more)

### Community 26 - "Community 26"
Cohesion: 0.01
Nodes (191): _CursorInboxBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole, bridge (+183 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (180): NewEventDispatcher(), fakeHostWithAddrs, TestFeatureFlags_FdcTransportFlagsShipDarkUntilDeviceProof(), TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50() (+172 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (149): Database, GroupEventLogTamperException, db, main, db, main, db, main (+141 more)

### Community 29 - "Community 29"
Cohesion: 0.01
Nodes (164): deleteGroupAndMessages, deleteLocallyIfDissolved, GroupModel, expectRotatedRemainingMember, main, network, pump, saveKey (+156 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (158): _FakeIdentityRepo, _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity (+150 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (154): archiveContact, archiveGroup, appendGroupEventLogEntry, _appendSignedCreateEvent, canonicalPayload, createGroup, deleteGroup, group (+146 more)
...
Cohesion: 0.01
Nodes (155): CustomPainter, dart:math, generateRandomKey, main, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth (+147 more)
...
Cohesion: 0.02
Nodes (139): db, main, makeIntroductionRow, makeOutboxRow, makePendingResponseRow, buildIntroductionRepository, buildMessageRepository, db (+131 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (150): buildGroupKeyInfoWithGrace(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), findMember(), isAllowedWriter(), assertGK019DirectJumpKeyInfo(), assertGK020SequentialRotationKeyInfo() (+142 more)
...
Cohesion: 0.02
Nodes (134): showGroupMissingNotificationFeedback, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+126 more)

### Community 39 - "Community 39"
Cohesion: 0.01
Nodes (147): addGroupMember, addGroupMemberElevatedTargetBlockedMessage, addGroupMemberGroupMismatchMessage, _addMemberOperationId, _bridgeErrorCode, _diagnosticPrefix, groupMembershipMutationDissolvedMessage, _isIdenticalDuplicateMemberAdd (+139 more)
...
Cohesion: 0.06
Nodes (148): BuildGroupSignatureData(), ParseGroupEnvelope(), buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateAndResignGroupEnvelope(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata() (+140 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (122): main, DatabaseException, fake_secure_key_store.dart, db, main, makeRequestRow, db, main (+114 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (102): GroupMessagePayload, groupDialSummary, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, activeGroupMemberDialTargetSummary() (+94 more)
...
Cohesion: 0.02
Nodes (116): main, main, ../bridge/fake_bridge.dart, _contact, _deterministicRestore, _FakeIdentityRepo, freshMlKem, loadIdentity (+108 more)

### Community 46 - "Community 46"
Cohesion: 0.01
Nodes (142): GroupMembershipUpdateListener, db, distributionRow, main, bridge, bridgeExchanges, _buildCliJoinFixture, buildGroupFixture (+134 more)

### Community 47 - "Community 47"
Cohesion: 0.01
Nodes (142): InkWell, addContact, archiveContact, blockContact, callOrder, conditionalTransitionStatus, contactExists, copyCalls (+134 more)

### Community 48 - "Community 48"
Cohesion: 0.01
Nodes (141): action, captureFlowEvents, capturePrintedLines, circuitOnlyState, clearResumeStarted, conditionalTransitionStatus, _currentState, decodeWirePayload (+133 more)

### Community 49 - "Community 49"
Cohesion: 0.02
Nodes (126): Align, ClipRRect, ConstrainedBox, DateSeparator, main, wrapApp, wrapScrollable, app (+118 more)

### Community 50 - "Community 50"
Cohesion: 0.02
Nodes (130): emoji, id, main, messageId, _reaction, senderPeerId, attempts, bridge (+122 more)
...
Cohesion: 0.02
Nodes (128): Alignment, app_colors.dart, background_readable_colors.dart, Color, EdgeInsetsGeometry, feed_tokens.dart, accentColor, availableFriends (+120 more)

### Community 53 - "Community 53"
Cohesion: 0.02
Nodes (129): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, contactRepo, main, requestRepo (+121 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (118): Brightness, _incoming, main, isDeleted, isIncoming, main, _msg, canWrite (+110 more)

### Community 55 - "Community 55"
Cohesion: 0.02
Nodes (128): EncryptedMediaTestBridge, RelayMediaStore, ImagePicker, bridge, _createdAt, encTempsUnder, imageProcessor, main (+120 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (123): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, _DeletionWireEnvelopeEncryptFailed, GroupOfflineReplaySignatureException, MigrationDatabaseImportStagingException, MigrationDatabaseSnapshotExportException, activeChunks (+115 more)

### Community 57 - "Community 57"
Cohesion: 0.02
Nodes (124): AccountMigrationNetworkGate, addPage, _fixedDateFixtureRetentionNow, getLatestRepairForGroup, getRepair, getVisibleRepairsForGroup, _historyGaps, inboxRetrieveCount (+116 more)

### Community 58 - "Community 58"
Cohesion: 0.02
Nodes (131): package:flutter_app/features/conversation/presentation/widgets/blocked_banner.dart, package:flutter_app/features/conversation/presentation/widgets/undelivered_messages_banner.dart, activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername (+123 more)
...
Cohesion: 0.02
Nodes (131): ackKind, acknowledged, action, actualTransport, attachments, best, bridge, completer (+123 more)

### Community 61 - "Community 61"
Cohesion: 0.02
Nodes (129): AccountMigrationProductionBundleReceiver, acceptChunk, acceptedSegmentIndexes, acceptManifest, acceptOldBlockProof, acceptSegment, acceptTranscript, AccountMigrationChunkAcceptCode (+121 more)

### Community 62 - "Community 62"
Cohesion: 0.02
Nodes (126): main, compare, currentSafetyNumber, _fingerprints, GroupMemberIdentitySafety, identityChanged, _normalize, _sameFingerprints (+118 more)

### Community 63 - "Community 63"
Cohesion: 0.02
Nodes (119): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+111 more)

### Community 64 - "Community 64"
Cohesion: 0.02
Nodes (122): AccountMigrationReceiverEvents, AccountMigrationMoveSizeEstimate, calls, _F, fileLength, filesByRoot, lengthsByAbsolutePath, listFilesRecursively (+114 more)
...
Cohesion: 0.05
Nodes (122): TestPeerPing_InvalidJSON(), TestPeerPing_MissingPeerId(), TestPeerPing_NodeNotInitialized(), assertGroupPublishMediaOnlyAcceptsEmptyText(), assertNotOk(), parseJSON(), ptrString(), TestConfirmDirectMessage_InvalidJSON() (+114 more)

### Community 67 - "Community 67"
Cohesion: 0.02
Nodes (110): dart:ui, detectTextDirection, _isLtrChar, _isRtlChar, VoidCallback, BackgroundChoiceControl, _BackgroundOption, build (+102 more)
...
Cohesion: 0.02
Nodes (119): action, _amplitudeController, amplitudeStream, audioRecorderService, binding, bridge, build, buildConversation (+111 more)

### Community 70 - "Community 70"
Cohesion: 0.03
Nodes (103): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+95 more)

### Community 71 - "Community 71"
Cohesion: 0.02
Nodes (107): PendingGroupInvite, package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/feed/domain/utils/format_message_time.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, buildTestWidget, main (+99 more)
...
Cohesion: 0.02
Nodes (98): benchmark_harness.dart, BenchmarkHarness, DetailedInboxStore, LifecycleBridge, ../features/conversation/application/send_chat_message_use_case_test.dart, bridge, main, service (+90 more)
...
Cohesion: 0.02
Nodes (104): AspectRatio, FileImage, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen, _expectVoiceCanPlay, _fixtureEncryptionKeyBase64, _fixtureEncryptionNonce (+96 more)

### Community 76 - "Community 76"
Cohesion: 0.02
Nodes (110): core_fake_p2p.FakeP2PService, GroupTestUser, addPage, addSignedInboxPage, admin, create, _CursorInboxBridge, dispose (+102 more)

### Community 77 - "Community 77"
Cohesion: 0.02
Nodes (106): _badgeLabel, containsKey, env, _isPlainOnline, _isRelayReady, _isSendable, main, _relayPeerId (+98 more)

### Community 78 - "Community 78"
Cohesion: 0.02
Nodes (111): _activeDevice, addContact, _attachImageFromLibrary, base64Decode, binding, bridge, build, _buildConversation (+103 more)

### Community 79 - "Community 79"
Cohesion: 0.02
Nodes (111): MapEntry, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge, _broadcastSelfRemovalIfNeeded, build, _buildGroupConfig (+103 more)

### Community 80 - "Community 80"
Cohesion: 0.02
Nodes (107): _InstrumentedBridge, _DelayRevocationDecryptBridge, append, bridge, controller, _DelayedUpdateKeyBridge, entries, errorCode (+99 more)

### Community 81 - "Community 81"
Cohesion: 0.02
Nodes (101): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+93 more)

### Community 82 - "Community 82"
Cohesion: 0.02
Nodes (109): CountingGroupMessageRepository, _attempts, buildRecordingWidget, buildWidget, copyCalls, copyToDurableStorage, delay, deleteAttempt (+101 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (107): addContact, addRequest, archiveContact, blockContact, conditionalTransitionStatus, contactExists, countPendingIntroductions, deleteAttachmentsForContact (+99 more)
...
Cohesion: 0.02
Nodes (92): main, _dbKey, fixedKey, main, computeDatabaseChecksumForTesting, database, manifest, message (+84 more)

### Community 87 - "Community 87"
Cohesion: 0.02
Nodes (97): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+89 more)

### Community 88 - "Community 88"
Cohesion: 0.02
Nodes (104): BoxConstraints, Listenable, OrbitFriend, OrbitGroup, friend, group, OrbitFriendItem, OrbitGroupItem (+96 more)
...
Cohesion: 0.04
Nodes (50): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, lanDialHandler, EventCallback, defaultNewHost(), isRetryableChatStreamOpenError() (+42 more)

### Community 91 - "Community 91"
Cohesion: 0.02
Nodes (103): name, productionCreateMigrations, ProductionMigrationEntry, productionUpgradeMigrations, runProductionOnCreate, runProductionOnUpgrade, version, migrations/001_identity_table.dart (+95 more)
...
Cohesion: 0.02
Nodes (98): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment (+90 more)

### Community 95 - "Community 95"
Cohesion: 0.02
Nodes (87): detailsFor, eventNames, events, main, mediaReady, pendingAttachment, absolutePath, age (+79 more)
...
Cohesion: 0.02
Nodes (94): _EventRecorder, _applyWideSurface, appShellController, backingSecureKeyStore, baseIdentityRepo, binding, bridge, buildApp (+86 more)
...
Cohesion: 0.02
Nodes (92): InMemoryInboxStagingRepository, addContact, addContactCount, addRequest, _aPeerId, bridge, callLog, checkHealth (+84 more)

### Community 103 - "Community 103"
Cohesion: 0.02
Nodes (82): db, main, makeKeyRow, db, main, makeMemberRow, db, main (+74 more)
...
Cohesion: 0.02
Nodes (88): AppendGroupEventLogEntry, appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn (+80 more)

### Community 107 - "Community 107"
Cohesion: 0.02
Nodes (85): authenticatedChannelBinding, AuthenticatedMigrationChannelTranscript, authorizationNonce, authorizedAt, authorizeMigrationExport, authorizes, bytes, consumeResult (+77 more)

### Community 108 - "Community 108"
Cohesion: 0.02
Nodes (91): _HarnessEnvironment, audioRecorderService, binding, bridge, build, _callback, _canUseVmServiceTimeline, _captureScenario (+83 more)

### Community 109 - "Community 109"
Cohesion: 0.02
Nodes (87): main, buildIdentity, main, tempDir, _changes, dispose, load, save (+79 more)

### Community 110 - "Community 110"
Cohesion: 0.02
Nodes (89): addContact, archiveContact, blockContact, _captureDebugPrintedLines, checkHealth, conditionalTransitionStatus, contactExists, _contacts (+81 more)
...
Cohesion: 0.02
Nodes (89): package:flutter_app/features/posts/presentation/widgets/pass_post_along_sheet.dart, accountMigrationRunTransfer, accountMigrationSizeGate, activeTab, appShellController, audioRecorderService, bridge, build (+81 more)

### Community 113 - "Community 113"
Cohesion: 0.08
Nodes (79): newMemoryInboxBackend(), failingStoreInboxBackend, requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs() (+71 more)
...
Cohesion: 0.02
Nodes (86): aad, acceptedManifest, acceptManifest, acceptOldBlockProof, acceptSegment, acceptTranscript, advertisedPeerId, bundleId (+78 more)

### Community 118 - "Community 118"
Cohesion: 0.02
Nodes (84): FakeIntroductionRepository, FakeReactionRepository, AudioRecorderService, clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository (+76 more)

### Community 119 - "Community 119"
Cohesion: 0.03
Nodes (79): activeDatabase, importedRows, importedTables, importVerifiedStagedDatabase, message, MigrationDatabaseActiveImportException, MigrationDatabaseActiveImportResult, _runQuickCheck (+71 more)

### Community 120 - "Community 120"
Cohesion: 0.06
Nodes (82): BlobDecrypt(), BlobEncrypt(), BlobKeygen(), bridgeGroupMemberDeviceHasDistributionMaterial(), bridgeGroupMemberDeviceIsActive(), bridgeGroupMemberHasLegacyDistributionMaterial(), bridgeGroupMemberHasUsableActiveDevice(), buildGroupBridgeMessageOpts() (+74 more)

### Community 121 - "Community 121"
Cohesion: 0.03
Nodes (77): event, main, fake_local_discovery_service.dart, HttpServer, main, peerA, peerB, accepted (+69 more)
...
Cohesion: 0.02
Nodes (82): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, package:flutter_app/shared/widgets/media/avatar_image_provider.dart, avatarBytes, backgroundPreference (+74 more)

### Community 124 - "Community 124"
Cohesion: 0.03
Nodes (84): _FakeMediaAttachmentRepo, FakeMediaAttachmentRepository, _FakeMediaAttachmentRepo, _FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, FakeMediaAttachmentRepository, _LaneRecordingMediaRepo, _RecorderRepo (+76 more)

### Community 125 - "Community 125"
Cohesion: 0.05
Nodes (56): TestMemoryInbox_StoreAtCapEvictsOldestReturnsStored(), chatPushMetadata, groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData(), addJSONScalarData() (+48 more)
...
Cohesion: 0.02
Nodes (81): _InMemoryGroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, GroupHistoryGapRepairRepository, _InMemoryGroupHistoryGapRepairRepository, buildShareTargetPickerRoute, package:flutter_app/core/media/audio_recorder_service.dart, package:flutter_app/features/share/application/share_batch_delivery_coordinator.dart, package:flutter_app/features/share/presentation/screens/share_target_picker_wired.dart (+73 more)

### Community 129 - "Community 129"
Cohesion: 0.02
Nodes (79): main, main, main, NotificationTapLiveRenderTiming, package:flutter_app/features/introduction/domain/repositories/intro_review_seen_repository.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart, package:flutter_app/features/settings/domain/models/image_quality_preference.dart, Request (+71 more)

### Community 130 - "Community 130"
Cohesion: 0.03
Nodes (77): main, _MemoryCutoverRepository, _MemoryCutoverRepository, _MemoryCutoverRepository, _authorityRepository, _baseRecord, clearLocalStalePushToken, commitNewActive (+69 more)

### Community 131 - "Community 131"
Cohesion: 0.03
Nodes (76): dismissedAt, dismissPin, savePinDismissal, accountMigrationNetworkGate, allowed, _allowsPostDeliveryNetworkSideEffects, bridge, contactRepo (+68 more)

### Community 132 - "Community 132"
Cohesion: 0.02
Nodes (81): addContact, addTestContact, archiveContact, blockContact, buildChatJsonWithMedia, buildP2PMessage, buildV2EncryptedEnvelopeJson, buildValidChatJson (+73 more)

### Community 133 - "Community 133"
Cohesion: 0.03
Nodes (74): AdmitSiblingDeviceFn, admitSiblingDeviceIfTrusted, alreadyPresent, deviceId, EnqueueDeferredGroupKeyDistributionFn, existingById, existingByTransport, latestKey (+66 more)

### Community 134 - "Community 134"
Cohesion: 0.02
Nodes (79): addresses, attempts, bridge, chatListener, clear, cliMlKemPublicKey, cliPeer, cliPeerId (+71 more)

### Community 135 - "Community 135"
Cohesion: 0.03
Nodes (74): loadReactionsForConversation, result, _attemptRemoveReactionInboxStore, bridge, canonical, _deterministicRemoveReactionId, digest, entry (+66 more)

### Community 136 - "Community 136"
Cohesion: 0.03
Nodes (75): create, db, dispose, rawAttachmentRow, RecordingSecureKeyStore, repo, secureKeyStore, seedDirectParent (+67 more)

### Community 137 - "Community 137"
Cohesion: 0.03
Nodes (55): deliveredWritePatterns, main, scanDeliveredWrites, logOnlyToken, main, mainPath, nsePath, readSource (+47 more)

### Community 138 - "Community 138"
Cohesion: 0.03
Nodes (77): announcedDevice, bobAccountKey, bridge, feed, groupId, groupRepo, holdCalls, holdSpy (+69 more)

### Community 139 - "Community 139"
Cohesion: 0.03
Nodes (68): benchmark_1_1_send_harness.dart, benchmark_ack_harness.dart, benchmark_background_resume_harness.dart, benchmark_bridge_crossing_harness.dart, benchmark_connection_reuse_harness.dart, benchmark_encryption_harness.dart, benchmark_event_queue_harness.dart, benchmark_group_publish_harness.dart (+60 more)

### Community 140 - "Community 140"
Cohesion: 0.03
Nodes (75): ../local_discovery/fake_local_p2p_service.dart, FakeLocalP2PService, LocalMessage, LocalP2PService, _RecordingBridge, bridge, calledCommands, checkHealth (+67 more)

### Community 141 - "Community 141"
Cohesion: 0.03
Nodes (76): AccountMigrationSizeGate, IntroductionListener, build, createState, initState, main, _SettleHarness, _SettleHarnessState (+68 more)

### Community 142 - "Community 142"
Cohesion: 0.03
Nodes (77): acceptAll, _activeChunks, activeDatabase, buildBundle, buildReceiver, _bundleFileRelativePaths, bytes, captureCipherMetadata (+69 more)

### Community 143 - "Community 143"
Cohesion: 0.03
Nodes (74): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, MediaDownloadPolicy, shouldAutoDownload, cleared (+66 more)

### Community 144 - "Community 144"
Cohesion: 0.03
Nodes (73): avatarBase64, avatarBlob, candidate, contactRepo, current, currentLocalPassCount, currentLocalSharedToCount, currentPassRecipientCount (+65 more)

### Community 145 - "Community 145"
Cohesion: 0.03
Nodes (71): countNeedsAttentionEntries, countQuarantinedEntries, deleteEntry, _entries, entry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds (+63 more)
...
Cohesion: 0.03
Nodes (73): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+65 more)
...
Cohesion: 0.03
Nodes (70): _aggregatePostPassFollowOnSettlement, deliveries, _deliverPostPassFollowOnRecipients, envelope, eventId, eventType, isPostPassFollowOnEventType, _loadPersistedPostPassFollowOnResult (+62 more)

### Community 152 - "Community 152"
Cohesion: 0.03
Nodes (69): _absoluteForRelativePath, acceptSizeDivergence, _addBestPathFailureIssue, addCandidate, _addChatMedia, _addPathBackedItem, _addPathCandidateIfUsable, _addPendingPostMedia (+61 more)
...
Cohesion: 0.03
Nodes (69): broadcast, enqueueGroupPendingBroadcast, groupId, groupPendingBroadcastCount, hasGroupPendingBroadcastEnqueueSink, setGroupPendingBroadcastCountSink, setGroupPendingBroadcastDrainSinks, setGroupPendingBroadcastEnqueueSink (+61 more)

### Community 155 - "Community 155"
Cohesion: 0.03
Nodes (72): actedOn, chatMessages, _collectSnapshot, config, _configFile, contacts, conversationPeerIds, decoded (+64 more)

### Community 156 - "Community 156"
Cohesion: 0.03
Nodes (64): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, build, createState, footer, IdentityProgressScreen (+56 more)
...
Cohesion: 0.08
Nodes (43): Any, AnyHashable, assertNotInsideDbWriteTransaction, body, BridgeCallInsideDbTransactionError, commandPreview, _dbWriteTxnZoneKey, isInsideDbWriteTransaction (+35 more)

### Community 164 - "Community 164"
Cohesion: 0.03
Nodes (64): addContact, AddContactResult, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, absolutePath, _buildHiddenIncomingEditPlaceholder (+56 more)

### Community 165 - "Community 165"
Cohesion: 0.03
Nodes (63): BackdropFilter, nav_bar_button.dart, nav_bar_theme.dart, package:flutter_app/features/feed/presentation/widgets/feed_navigation_bar.dart, package:flutter_app/features/settings/presentation/widgets/settings_group.dart, package:flutter_app/features/settings/presentation/widgets/settings_orbit_nav_button.dart, package:flutter_app/features/settings/presentation/widgets/settings_qr_tiles.dart, package:flutter_svg/flutter_svg.dart (+55 more)

### Community 166 - "Community 166"
Cohesion: 0.03
Nodes (64): ElevatedButton, _FakeNearbyLocationService, _buildWidget, _contact, contactRepository, _CountingPostRepository, _delivery, identityRepository (+56 more)

### Community 167 - "Community 167"
Cohesion: 0.03
Nodes (64): _barCount, _barGap, _barWidth, build, _minBarHeight, onSeek, paint, _playedColor (+56 more)
...
Cohesion: 0.03
Nodes (63): accountMigrationNetworkGate, _allowMigrationNetwork, _allowSender, attempted, blocked, call, clearedMalformed, committed (+55 more)

### Community 170 - "Community 170"
Cohesion: 0.03
Nodes (63): _methodChannel, _Gateway, androidMode, before, binding, completer, _copyFixture, data (+55 more)
...
Cohesion: 0.03
Nodes (67): _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, attempt, audioRecorderService, backgroundPreference, _beginLoadGroups, bridge (+59 more)

### Community 173 - "Community 173"
Cohesion: 0.03
Nodes (66): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+58 more)

### Community 174 - "Community 174"
Cohesion: 0.03
Nodes (66): AccountMigrationLocalTransferBundle, MigrationDatabaseImportStaging, add, advertisedPeerId, _BenchmarkBundleArtifacts, _BenchmarkDatabaseImportStaging, _benchmarkFileRelativePath, _benchMb (+58 more)
...
Cohesion: 0.03
Nodes (59): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, buildBridgeMigrationCutoverLeaseCleanup, _notifyProfileUpdateContact, recovered (+51 more)

### Community 177 - "Community 177"
Cohesion: 0.03
Nodes (66): callGroupAcknowledgeRecovery, callGroupCreate, callGroupDecrypt, callGroupEncrypt, callGroupGenerateNextKey, callGroupHistoryRepairRange, callGroupInboxRetrieve, callGroupInboxRetrieveWithCursor (+58 more)
...
Cohesion: 0.03
Nodes (64): PendingSiblingDevice, package:flutter_app/features/groups/domain/models/pending_sibling_device.dart, package:flutter_app/features/groups/presentation/widgets/group_member_row.dart, package:flutter_app/features/groups/presentation/widgets/pending_sibling_device_prompt.dart, _amberAccent, backgroundPreference, _blueAccent, build (+56 more)
...
Cohesion: 0.03
Nodes (62): chatGroup, conversationApp, fortyMessages, localAfternoon, main, messageAt, pumpFrames, rectWithin (+54 more)

### Community 184 - "Community 184"
Cohesion: 0.03
Nodes (57): package:flutter_app/features/home/presentation/widgets/editable_username_widget.dart, package:flutter_app/features/identity/presentation/screens/mnemonic_input_screen.dart, package:flutter_app/features/posts/presentation/widgets/comments_sheet.dart, package:flutter_app/features/posts/presentation/widgets/edit_pinned_post_sheet.dart, package:flutter_app/features/settings/presentation/widgets/settings_profile_section.dart, _buildSheet, finder, main (+49 more)

### Community 185 - "Community 185"
Cohesion: 0.03
Nodes (65): addContact, archiveContact, blockContact, checkHealth, contactExists, currentState, deleteContact, dialPeer (+57 more)
...
Cohesion: 0.03
Nodes (58): dispose, _fire, _pending, _subscriptions, _timer, trigger, WakeTokenReissueCoalescer, window (+50 more)

### Community 188 - "Community 188"
Cohesion: 0.03
Nodes (60): AudioRecorder, driver, main, UploadWakeLockDriver, WakelockPlusUploadWakeLockDriver, disable, disableCalls, enable (+52 more)

### Community 189 - "Community 189"
Cohesion: 0.03
Nodes (64): ageMs, armStallTimer, autoRegister, callP2PConfirmDirectMessage, callP2PInboxAck, callP2PInboxRegisterToken, callP2PInboxRetrieve, callP2PInboxRetrievePending (+56 more)

### Community 190 - "Community 190"
Cohesion: 0.03
Nodes (61): ContactPresenceSnapshotRepository, InMemoryContactPresenceSnapshotRepository, archived, blocked, _contact, contacts, _FailAfterPostSaveRepository, lastSavedPostId (+53 more)

### Community 191 - "Community 191"
Cohesion: 0.03
Nodes (64): bridge, buf, _buildFreshStack, census, _censusToJson, chatListener, _cold, _condition (+56 more)

### Community 192 - "Community 192"
Cohesion: 0.03
Nodes (63): addPeer, advertisedPeerId, advertisedPort, advertisedQuicPort, advertisedTcpPort, discoveredPeers, discoveredPeersStream, dispose (+55 more)

### Community 193 - "Community 193"
Cohesion: 0.03
Nodes (61): media_display_helpers.dart, media_grid_cell.dart, build, _buildFourPlus, _buildLayout, _buildSingle, _buildThree, _buildTwo (+53 more)

### Community 194 - "Community 194"
Cohesion: 0.03
Nodes (64): package:flutter_app/features/feed/domain/models/feed_session_reply.dart, activeTab, backgroundPreference, bottomInset, build, _buildComposer, _buildFeedContent, _buildFeedEntries (+56 more)
...
Cohesion: 0.03
Nodes (61): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _FakeBridge (+53 more)

### Community 197 - "Community 197"
Cohesion: 0.03
Nodes (59): _buildOrbitFriend, contact, descriptor, descriptors, ids, includeArchived, isDeleted, latest (+51 more)
...
Cohesion: 0.03
Nodes (59): AmplitudeBuffer, main, main, package:flutter_app/core/media/amplitude_buffer.dart, package:flutter_app/core/media/downsample_waveform.dart, package:flutter_app/shared/widgets/media/recording_overlay.dart, activePinCount, _amplitudeBuffer (+51 more)

### Community 200 - "Community 200"
Cohesion: 0.03
Nodes (60): _RecordingSnapshotExportAdapter, _FfiSnapshotExportAdapter, adapter, _applyCipherPragmas, captureCipherMetadata, cipherVersion, closeExportedDatabaseAfterValidation, computeFileChecksum (+52 more)

### Community 201 - "Community 201"
Cohesion: 0.03
Nodes (56): isUnsafeLegacyOutboundEnvelope, contact, dataToVerify, isValid, json, maxAge, parseQRPayload, ParseQRResult (+48 more)

### Community 202 - "Community 202"
Cohesion: 0.03
Nodes (60): main, map, AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart, fake_notification_service.dart, bridge, contactRepo, conversationTracker (+52 more)

### Community 203 - "Community 203"
Cohesion: 0.03
Nodes (60): ShareBatchDeliveryResult, _expectCommandOrder, _GroupShareBgBridge, _GroupShareReliableNoCustodyBridge, _imageProcessor, inboxStoreOk, isLocalPeer, joinedAt (+52 more)

### Community 204 - "Community 204"
Cohesion: 0.06
Nodes (37): ConnectionState, ConnScope, ConnStats, directConfirmCallback, classifyStreamTransport(), generatePeerIDStr(), stubStreamConn, stubTransportStream (+29 more)

### Community 205 - "Community 205"
Cohesion: 0.06
Nodes (54): DecryptGroupMessage(), EncryptGroupMessage(), TestBuildGroupSignatureData_Deterministic(), TestBuildGroupSignatureData_Format(), TestDecryptGroupMessage_InvalidBase64(), TestEncryptGroupMessage_InvalidKey(), TestEncryptGroupMessage_WrongKeyLength(), TestGK002EncryptDecryptRoundTripForTextPayload() (+46 more)
...
Cohesion: 0.06
Nodes (48): backendConfig, controlPlaneStores, DefaultServerLimits(), loadServerLimitsFromEnv(), newMemoryInboxBackendWithLimits(), relayResourcesFromServerLimits(), TestAdmissionControl_PreservesLatencyForAdmittedPeersUnderPressure(), TestFiniteLimits_EvictOldestWhenInboxFull() (+40 more)

### Community 210 - "Community 210"
Cohesion: 0.03
Nodes (59): amplitudeValues, build, elapsed, _formatDuration, onCancel, RecordingOverlay, package:flutter_app/features/conversation/presentation/widgets/recording_overlay.dart, package:flutter_app/shared/widgets/media/amplitude_bars.dart (+51 more)
...
Cohesion: 0.03
Nodes (60): callLog, checkHealth, conditionalTransitionStatus, _ctrl, currentState, deleteMessage, deleteMessagesForContact, dialPeer (+52 more)

### Community 215 - "Community 215"
Cohesion: 0.04
Nodes (57): _consumption, createdAt, expiresAt, groupId, _invite, main, repo, _revocation (+49 more)
...
Cohesion: 0.03
Nodes (58): _SharedFakeDiscovery, _SharedFakeDiscovery, aad, acceptedSegmentIndexes, acceptManifest, acceptSegment, acceptTranscript, advertisedPeerId (+50 more)

### Community 220 - "Community 220"
Cohesion: 0.03
Nodes (57): addPage, bridge, buildSignedReplay, _Clock, contains, endedAt, getGroup, getKeyByGeneration (+49 more)

### Community 221 - "Community 221"
Cohesion: 0.04
Nodes (52): contact, currentReaction, currentTime, encrypted, envelopeSenderPeerId, handleIncomingReaction, HandleReactionResult, incomingTime (+44 more)
...
Cohesion: 0.04
Nodes (56): group_multi_device_real_harness.dart, _buildCliJoinFixture, _configuredRunId, _configuredSharedDir, _createCliGroupNode, deadline, file, runGroupPublishBenchmark (+48 more)

### Community 225 - "Community 225"
Cohesion: 0.03
Nodes (57): addContact, addRequest, addTestContact, archiveContact, blockContact, bridge, checkHealth, confirmRequests (+49 more)

### Community 226 - "Community 226"
Cohesion: 0.03
Nodes (52): _activeDepth, _activeDepthListenable, begin, end, GroupRecoveryGate, groupRecoveryPendingError, isActive, isGroupRecoveryInProgress (+44 more)

### Community 227 - "Community 227"
Cohesion: 0.03
Nodes (54): bridge, checkHealth, dispose, _FakeBridge, initialize, isInitialized, main, _otherPeerId (+46 more)

### Community 228 - "Community 228"
Cohesion: 0.04
Nodes (55): CountingSecureKeyStore, _MemorySecureKeyStore, _TrackingSecureKeyStore, _FakeSecureKeyStore, _InMemorySecureKeyStore, package:flutter_app/core/secure_storage/ml_kem_secret_ring.dart, _cachedIdentity, _hasCachedIdentity (+47 more)
...
Cohesion: 0.04
Nodes (57): _actionIcon, _actionOrder, _actionTooltip, _adapter, adapterFactory, build, _buildActions, _buildError (+49 more)
...
Cohesion: 0.04
Nodes (56): bridge, checkHealth, currentState, dialPeer, dialResult, discoveredPeer, discoverLocalPeer, discoverPeer (+48 more)
...
Cohesion: 0.04
Nodes (50): ClearedWatermarks, feedItemMatchesThreadId, feedThreadKindConnection, feedThreadKindContact, feedThreadKindGroup, isPendingFeedItem, kept, projectPendingFeed (+42 more)

### Community 237 - "Community 237"
Cohesion: 0.04
Nodes (49): clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey, markGroupDeviceAnnouncePending, raw, readGroupDeviceAnnounceMarker, write, fromStorageString (+41 more)
...
Cohesion: 0.04
Nodes (54): bridge, contactRepo, dispose, incomingPostPassStream, _onMessage, _postController, PostPassListener, postPassStream (+46 more)

### Community 240 - "Community 240"
Cohesion: 0.04
Nodes (55): appShellController, audioRecorderService, batchShareCoordinator, bridge, build, _buildComposedShareIntent, _buildSummary, _captionController (+47 more)
...
Cohesion: 0.04
Nodes (51): _cache, _cacheKey, _generation, IdentityAvatarDocumentsDirLoader, IdentityAvatarResolver, _inFlight, invalidatePeer, _loadFromDisk (+43 more)
...
Cohesion: 0.04
Nodes (50): allow, backgroundPushDefaultBody, backgroundPushDefaultTitle, backgroundPushFallbackDedupeKey, BackgroundPushNotificationFallback, body, buildBackgroundPushFallbackNotification, collapseKey (+42 more)
...
Cohesion: 0.04
Nodes (51): block, contentHashValidation, copyWith, _emitGroupFeedMediaVerifyEvent, file, fileBytes, fileExists, _idPrefix (+43 more)

### Community 250 - "Community 250"
Cohesion: 0.04
Nodes (50): allowStaging, authorUsername, comment, envelope, handleIncomingPostComment, HandleIncomingPostCommentResult, parent, persistRepostEngagementParticipantIfNeeded (+42 more)
...
Cohesion: 0.04
Nodes (47): introduced, introducer, main, network, recipient, _waitForIntroReceived, _waitForIntroStatusChanged, IntroTestUser (+39 more)
...
Cohesion: 0.04
Nodes (50): attachment, _downloadedBytesHash, _DownloadWritingBridge, expectNoForbiddenKeys, expectNoFragmentsInJson, expectOutgoingAttachment, expectSingleAttachment, expectVariantSchema (+42 more)

### Community 257 - "Community 257"
Cohesion: 0.04
Nodes (51): ContactModel, backgroundPreference, _blueAccent, build, _buildCaptionField, _buildContactRow, _buildGroupRow, _buildHeader (+43 more)

### Community 258 - "Community 258"
Cohesion: 0.04
Nodes (52): package:flutter_app/features/groups/presentation/screens/group_list_wired.dart, actorPayload, aliceContact, buildWidget, canonicalPayload, createdAt, effectiveReceivedAt, envelope (+44 more)
...
Cohesion: 0.04
Nodes (44): channel, log, main, staged, GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn (+36 more)

### Community 261 - "Community 261"
Cohesion: 0.04
Nodes (50): main, member, GroupMessageRepository, _NoOpMsgRepo, package:flutter_app/core/config/forward_rotate_on_add_flag.dart, package:flutter_app/features/groups/application/group_media_allowed_peers.dart, _NoOpMsgRepo, _NoOpMsgRepo (+42 more)
...
Cohesion: 0.08
Nodes (30): TestParseInboxStoreResponse_InboxFullTyped(), TestParseInboxStoreResponse_NewRelayFields(), TestParseInboxStoreResponse_OldRelayDefaults(), parseInboxStoreResponse(), parsePresenceResponse(), parsePresenceSetResponse(), InboxMessage, inboxRequest (+22 more)

### Community 266 - "Community 266"
Cohesion: 0.04
Nodes (51): _buildTestWidget, callCount, chatListener, completeLast, completeLastWithMessage, conditionalTransitionStatus, _contact, _contactPeerId (+43 more)
...
Cohesion: 0.04
Nodes (47): AppLocalizations, LocalizationsDelegate, MemberRole, package:flutter_app/features/conversation/presentation/widgets/voice_record_button.dart, package:flutter_app/features/groups/presentation/group_invite_status_presentation.dart, package:flutter_localizations/flutter_localizations.dart, l10n, main (+39 more)

### Community 271 - "Community 271"
Cohesion: 0.04
Nodes (50): ../../features/p2p/domain/models/discovered_peer.dart, ../../features/p2p/domain/models/node_state.dart, ../../features/p2p/domain/models/send_message_result.dart, ../local_discovery/lan_ack.dart, clearResumeStarted, countNeedsAttentionInboxEntries, currentState, dialPeer (+42 more)
...
Cohesion: 0.04
Nodes (42): OneToOneTestUser, consumeCalls, consumeIfRecentAnnouncement, markAnnouncement, markCalls, messageId, payload, RecentNotificationGateCall (+34 more)
...
Cohesion: 0.05
Nodes (42): events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness, routedTargets (+34 more)
...
Cohesion: 0.04
Nodes (46): blockingUpload, bridge, captureFlowEvents, _doneAttachment, file, groupMsgRepo, groupRepo, identityRepo (+38 more)
...
Cohesion: 0.04
Nodes (46): _bridgeResponses, _canonicalize, canonicalJson, _diagnostics, _failure, _operations, recordBridgeResponse, recordDiagnostic (+38 more)
...
Cohesion: 0.04
Nodes (44): adminCount, bridge, broadcastVoluntaryLeaveAndRotateKey, callGroupPublish, didBroadcast, identity, leaveTimelineMessage, leftAt (+36 more)

### Community 289 - "Community 289"
Cohesion: 0.04
Nodes (45): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, autoDownloadDecider, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState (+37 more)

### Community 290 - "Community 290"
Cohesion: 0.04
Nodes (44): main, package:fake_async/fake_async.dart, package:flutter_app/core/services/active_peer_keepalive_use_case.dart, package:flutter_app/features/groups/application/group_pending_key_repair_backoff_timer.dart, activePeer, build, drains, events (+36 more)

### Community 291 - "Community 291"
Cohesion: 0.05
Nodes (41): build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt, shareIntentService, pendingIntent (+33 more)

### Community 292 - "Community 292"
Cohesion: 0.04
Nodes (45): compressed,, fromStorageString, ImageQualityPreference, original, storageKey, toStorageString, videoStorageKey, package:flutter_app/features/feed/domain/models/feed_route_changes.dart (+37 more)

### Community 293 - "Community 293"
Cohesion: 0.04
Nodes (46): action, bakPath, bytes, _configureDbBusyTimeout, db, dbFileExists, dbName, dbPath (+38 more)
...
Cohesion: 0.09
Nodes (35): marshalDiscoverResponseMessage(), marshalRegisterResponseMessage(), marshalRegistration(), newLocalRelayServer(), readLocalRelayFrame(), remotePeerNamespace(), startLocalRelayPairWithSharedState(), startLocalRelayWithInboxCapacity() (+27 more)
...
Cohesion: 0.04
Nodes (43): allowStaging, commentExists, comments, compareTo, envelope, existing, handleIncomingPostCommentReaction, HandleIncomingPostCommentReactionResult (+35 more)
...
Cohesion: 0.04
Nodes (45): allowedKeys, Bridge, callBgBegin, callBgEnd, callBgGrantProbe, callBgTimeRemaining, callBlobDecrypt, callBlobKeygen (+37 more)
...
Cohesion: 0.05
Nodes (38): DrainGroupOfflineInboxForGroupFn, DrainOfflineInboxFn, _emitMissingGroupId, _emitUnroutable, ForegroundRemoteMessageResult, handleForegroundRemoteMessage, routeTarget, main (+30 more)

### Community 305 - "Community 305"
Cohesion: 0.05
Nodes (43): NearbyLocationServiceImpl, NearbyLocationService, package:flutter_app/features/posts/application/nearby_location_service.dart, package:flutter_app/features/posts/application/refresh_nearby_on_startup_use_case.dart, _FakeNearbyLocationService, handleSharingDisabled, handleSharingDisabledCallCount, loadComposeAvailability (+35 more)
...
Cohesion: 0.04
Nodes (44): bridge.dart, allowRawStringResponse, checkHealth, _cmdMap, _CmdSpec, debugMalformedPushEventCountForTest, debugUnknownPushEventCountForTest, _diagnosticDetails (+36 more)
...
Cohesion: 0.04
Nodes (37): main, main, main, after, end, main, mainSrc, _member (+29 more)

### Community 310 - "Community 310"
Cohesion: 0.04
Nodes (42): canDisplayVerifiedGroupMedia, computeFileSha256Hex, GroupMediaIntegrityPolicy, hasRequiredVerificationMetadata, hasValidContentHash, isQuarantinedGroupMedia, isRetryableDownloadFailure, isUnavailableMedia (+34 more)

### Community 311 - "Community 311"
Cohesion: 0.06
Nodes (41): _FakePathProvider, _AvatarDownloadBridge, checkHealth, commandLog, dispose, docsPath, downloadBytes, Fake (+33 more)
...
Cohesion: 0.05
Nodes (38): fromSecureKeyStore, PreferenceBackedMediaAutoDownloadDecider, resolveMediaDownloadNetwork, shouldAutoDownload, MediaAutoDownloadDecider, allKinds, allNetworks, allTypes (+30 more)
...
Cohesion: 0.05
Nodes (42): call, callIndex, calls, captureFlowEvents, contactPeerId, fixedNow, id, main (+34 more)

### Community 317 - "Community 317"
Cohesion: 0.05
Nodes (42): conversation_thread_summary_repository.dart, message_repository.dart, ../models/conversation_thread_summary.dart, getConversationThreadSummaries, getConversationThreadSummary, conditionalTransitionStatus, _conversationReadController, conversationReadStream (+34 more)

### Community 318 - "Community 318"
Cohesion: 0.05
Nodes (40): main, processorReturningNull, processorUnwritten, processorWriting, solidJpeg, tempDir, avatarBase64, avatarByteLength (+32 more)

### Community 319 - "Community 319"
Cohesion: 0.05
Nodes (43): addListener, _aspectRatio, attachmentId, buildSurface, defaultStored, dispose, disposeCount, _duration (+35 more)
...
Cohesion: 0.05
Nodes (42): package:flutter_app/features/conversation/presentation/widgets/reaction_bar.dart, Rect, anchorRect, backdropKey, build, _clampToViewport, color, _ContextMenuAction (+34 more)

### Community 322 - "Community 322"
Cohesion: 0.05
Nodes (43): currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox, incomingLocalMediaStream, isConnectedToPeer (+35 more)

### Community 323 - "Community 323"
Cohesion: 0.13
Nodes (43): cmdBlobDecrypt(), cmdBlobEncrypt(), cmdBlobKeygen(), cmdClearMessages(), cmdDial(), cmdDisconnect(), cmdDiscover(), cmdGenerateIdentity() (+35 more)
...
Cohesion: 0.05
Nodes (38): clear, main, readTokens, _SeededWakeTokenStore, _tokens, writeTokens, _defaultMintToken, issueForContacts (+30 more)
...
Cohesion: 0.08
Nodes (35): EvtPeerConnectednessChanged, FileMode, envIntOrDefault(), logPeerConnected(), logStatsPeriodically(), main(), shortPeerId(), NewPresenceStore() (+27 more)

### Community 328 - "Community 328"
Cohesion: 0.05
Nodes (42): _armSuspectedDenialProbe, BonsoirBroadcastFactory, BonsoirDiscoveryFactory, _broadcast, _buildLibp2pAddresses, _commitResolvedPeer, _createBroadcast, _createDiscovery (+34 more)
...
Cohesion: 0.05
Nodes (40): ContactAutoAddRateLimiter, maxPerWindow, _recent, tryAcquire, window, add, attemptSilentIntroRecovery, _autoAddedController (+32 more)
...
Cohesion: 0.05
Nodes (40): body, clearDeliveredNotifications, clearedDeliveredNotificationsCount, consumeInitialPayload, contactPeerId, dispose, FakeGenericNotification, FakeNotification (+32 more)
...
Cohesion: 0.16
Nodes (37): eventCollector, TestRelayProfileDownloadNotFound(), TestRelayProfileReplace(), TestRelayProfileSizeLimit(), TestRelayProfileUploadDownload(), extractRelayPeerID(), generatePrivateKeyHex(), randomNamespace() (+29 more)
...
Cohesion: 0.05
Nodes (39): bridge, createRecording, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessages, getPendingDownloads, getUploadPendingAttachments (+31 more)
...
Cohesion: 0.11
Nodes (33): Event, newNodeHolePunchTracer(), sanitizeTracerErr(), shortPeerID(), hasEventWithStep(), newTracerTestNode(), TestHolePunchTracer_AlreadyDirect_NoDoubleUpgrade(), TestHolePunchTracer_AttemptThenSuccess_CountsAndEmits() (+25 more)

### Community 342 - "Community 342"
Cohesion: 0.05
Nodes (40): GestureDragEndCallback, GestureDragStartCallback, GestureDragUpdateCallback, armed, build, color, createState, didChangeDependencies (+32 more)

### Community 343 - "Community 343"
Cohesion: 0.10
Nodes (30): newMemoryGroupInboxBackend(), assertGroupInboxCapEvictionSurfacesRepairableGap(), opaqueGroupReplayEnvelope(), TestGI017GroupInboxStoreAuthorizedCursorPaginationReturns120MessagesExactlyOnce(), TestGI035GroupInboxStorePersistsEncryptedEnvelopeWithoutPlaintext(), TestGIRD004MemoryGroupInboxConflictingSameMessageIDRejected(), TestGIRD004MemoryGroupInboxDistinctMessageIDsPreserveOrder(), TestGIRD004MemoryGroupInboxDuplicateExpandedRecipientACLMerges() (+22 more)
...
Cohesion: 0.05
Nodes (40): allowed, allows, attachmentId, cancelled, canDispatch, capabilities, caption, durationMs (+32 more)

### Community 346 - "Community 346"
Cohesion: 0.05
Nodes (40): swipe_action_buttons.dart, _actionCount, _actionWidth, addButton, build, _buildActionButtons, child, createState (+32 more)
...
Cohesion: 0.11
Nodes (31): blockedHostStart, groupDialStats, addGroupDialTargets(), countedFunctionLines(), decodePeerID(), errorCallReturnsWithin(), groupMemberAddrInfos(), medianDuration() (+23 more)

### Community 350 - "Community 350"
Cohesion: 0.10
Nodes (39): activeGroupMemberDialTargets(), activeGroupMemberDialTargetSet(), cloneGroupConfig(), countRemoteGroupMembers(), groupRendezvousNamespace(), assertGM030DiscoveryEventTotals(), assertGP012NumericField(), assertGP014KnownMemberTopicMissingRelayFallback() (+31 more)
...
Cohesion: 0.05
Nodes (38): appGroupPath, buffer, bytes, ciphertext, clear, _clearMalformedIfAged, _compareEntry, directory (+30 more)

### Community 359 - "Community 359"
Cohesion: 0.05
Nodes (38): content, discoveredAt, discoveredPeers, discoveredPeersStream, dispose, durationMs, enc, encScheme (+30 more)

### Community 360 - "Community 360"
Cohesion: 0.05
Nodes (38): contentHash, copyWith, createdAt, downloadRetryCount, downloadStatus, durationMs, encryptionKeyBase64, encryptionNonce (+30 more)
...
Cohesion: 0.05
Nodes (35): main, main, _makeAcceptPayload, _makeSendPayload, completed, deliverStagedIntroductionDelivery, deliveryForIntroduced, deliveryForRecipient (+27 more)
...
Cohesion: 0.05
Nodes (37): addContact, _aliceContact, archiveContact, attemptedSecrets, blockContact, _chatPlaintext, checkHealth, contactExists (+29 more)

### Community 369 - "Community 369"
Cohesion: 0.05
Nodes (36): captureFlowEvents, _FailFirstPublishBridge, _Gfr001GatedPublishBridge, id, main, _makeAttachment, _makeFailedGroupMessage, _makeGroup (+28 more)

### Community 370 - "Community 370"
Cohesion: 0.05
Nodes (35): confirmatoryDirectLanEnabled, DeliveryReceiptMintDecision, DeliveryReceiptMintSkipReason, envelope, idPreview, kConfirmatoryDirectLanReceiptEnabled, mint, sendDeliveryReceipt (+27 more)
...
Cohesion: 0.05
Nodes (35): package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart, package:flutter_app/features/settings/presentation/screens/settings_wired.dart, main, pageScrollPosition, pumpWired, _rowKeysInOrder, setPhoneViewport, setViewport (+27 more)

### Community 375 - "Community 375"
Cohesion: 0.06
Nodes (34): declineContactRequest, DeclineContactRequestResult, peerIdPrefix, request, contact, ContactRequestNotificationTarget, ContactRequestNotificationTargetState, conversation (+26 more)

### Community 376 - "Community 376"
Cohesion: 0.05
Nodes (36): currentState, dialPeer, discoverLocalPeer, discoverPeer, dispose, drainOfflineInbox, _FakeP2PService, incomingLocalMediaStream (+28 more)

### Community 377 - "Community 377"
Cohesion: 0.05
Nodes (33): DateTime, createdAt, cursor, fromMap, groupId, GroupInboxCursor, toMap, updatedAt (+25 more)

### Community 378 - "Community 378"
Cohesion: 0.05
Nodes (34): FlutterSecureStorage, package:flutter_secure_storage/flutter_secure_storage.dart, secret_storage_references.dart, secure_key_store.dart, appleAccessGroup, containsKey, delete, FlutterSecureKeyStore (+26 more)
...
Cohesion: 0.06
Nodes (32): db, main, row, contactPeerId, createdAt, db, emoji, id (+24 more)

### Community 381 - "Community 381"
Cohesion: 0.05
Nodes (34): copyWith, createdAt, emoji, fromJson, fromMap, hashCode, id, isRemoved (+26 more)
...
Cohesion: 0.06
Nodes (35): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+27 more)

### Community 384 - "Community 384"
Cohesion: 0.06
Nodes (34): AccountMigrationProductionBundleSource, failureEvent, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, ContactRequestListener, GroupMembershipUpdateListener, GroupMessageListener, GroupKeyRepairRequest (+26 more)

### Community 385 - "Community 385"
Cohesion: 0.06
Nodes (30): channel, log, main, channel, log, main, _sendNotificationResponse, android (+22 more)
...
Cohesion: 0.06
Nodes (35): _adminContact, _adminMlKemPublicKey, _adminPeerId, assignedRole, createdAt, deadline, expectConvergedReceiver, expectNoReceiverState (+27 more)

### Community 389 - "Community 389"
Cohesion: 0.06
Nodes (35): clear, _coerceTimestamp, consumeIfRecentAnnouncement, consumeIfRecentPayload, _consumeSidecarMarker, debugResetRecentRemoteNotificationGate, debugSetRecentRemoteNotificationGate, _defaultRecentRemoteGateLoadError (+27 more)
...
Cohesion: 0.06
Nodes (32): encrypted, envelope, envelopeSenderPeerId, HandleGroupInviteDeclineAckResult, handleIncomingGroupInviteDeclineAck, payload, bobContact, bridge (+24 more)
...
Cohesion: 0.06
Nodes (33): criticality, _item, main, path, size, transferManifest, blocking, code (+25 more)
...
Cohesion: 0.06
Nodes (34): _FakeP2PService, _FakeP2PService, RelayLiveSendObserver, DurableLanFakeP2PService, FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService (+26 more)
...
Cohesion: 0.06
Nodes (31): buildQRPayload, BuildQRPayloadResult, dataToSign, finalJson, identity, _redactedPeerId, signature, signedPayload (+23 more)
...
Cohesion: 0.06
Nodes (33): any, contains, debugSetFlowEventSink, emitFlowEvent, flowEventLoggingEnabled, FlowEventSink, _flowEventTestSink, _isPeerIdKey (+25 more)
...
Cohesion: 0.06
Nodes (32): affected, dbBeginMediaDownload, dbClaimMediaEvicted, dbCommitMediaDownloadLocalPath, dbDeleteMediaForContact, dbDeleteMediaForMessage, dbFinalizeMediaEvictedPathCleared, dbInsertMediaAttachment (+24 more)
...
Cohesion: 0.06
Nodes (29): main, Incoming, package:flutter_app/features/conversation/domain/utils/message_window_cap.dart, package:flutter_app/features/conversation/presentation/screens/conversation_wired.dart, main, msg, buildWidget, chatListener (+21 more)

### Community 424 - "Community 424"
Cohesion: 0.06
Nodes (31): FakeMediaPlaybackAdapter, addListener, aspectRatio, buildSurface, _controller, defaultMediaPlaybackAdapterFactory, dispose, duration (+23 more)
...
Cohesion: 0.06
Nodes (31): copyWith, createdAt, fromMap, groupId, GroupMessage, hashCode, id, inboxRetryPayload (+23 more)

### Community 427 - "Community 427"
Cohesion: 0.10
Nodes (5): AggregateRelayState, RelaySessionManager, ID, RWMutex, Time

### Community 428 - "Community 428"
Cohesion: 0.12
Nodes (26): TestDcutrFlagOff_ForcesPrivate_ZeroPunches(), TestDcutrFlagOn_SelectsUpgradeReachability(), DefaultFeatureFlags(), TestMergeFeatureFlags_EveryStructFieldIsMergeable(), TestMergeFeatureFlagsOverDefaults_OmittedKeyKeepsDefaultNotZeroValue(), MergeFeatureFlagsOverDefaults(), FeatureFlags, drainLANEvents() (+18 more)

### Community 429 - "Community 429"
Cohesion: 0.15
Nodes (29): NewRelaySessionManager(), fakePeerID(), TestGR003RelaySessionStalledRecoveryClearsGateAfterTimeout(), TestGR008RecordWatchdogRestartPreservesRecoverySignalAcrossReset(), TestGR009RefreshFailuresTriggerWatchdogOnlyAfterAllRelaysReachThreshold(), TestGR010RefreshSuccessResetsFailureCounterAndStaleError(), TestGR012StaleCircuitAddressesDoNotReportHealthyWithoutReservation(), TestNW004WatchdogRestartSignalsGroupRecoveryUntilFlutterAck() (+21 more)
...
Cohesion: 0.07
Nodes (28): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult (+20 more)

### Community 434 - "Community 434"
Cohesion: 0.09
Nodes (31): _FakeMessageRepository, FakeMessageRepository, _FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, FakeMessageRepository, _FakeMessageRepo (+23 more)
...
Cohesion: 0.07
Nodes (27): activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager, orderedPostIds, postRepo, posts (+19 more)
...
Cohesion: 0.07
Nodes (27): EdgeInsets, package:flutter_app/features/groups/presentation/widgets/expandable_fab.dart, package:flutter_app/features/groups/presentation/widgets/glow_fab.dart, anchor, build, _buildMenuItem, _close, _controller (+19 more)

### Community 450 - "Community 450"
Cohesion: 0.08
Nodes (25): fake_media_playback_adapter.dart, IconButton, imageItem, main, record, videoItem, wrap, main (+17 more)

### Community 451 - "Community 451"
Cohesion: 0.07
Nodes (28): allowedPeersByBlobId, baseDir, blobIds, ciphertextByBlobId, deletedBlobIds, deriveTestBlobKey, deriveTestBlobNonce, failBlobDecrypt (+20 more)
...
Cohesion: 0.07
Nodes (29): bridge, calledCommands, _captureFlowEvents, checkHealth, circuitAddresses, dispose, drains, enqueue (+21 more)
...
Cohesion: 0.12
Nodes (27): GO_BRIDGE_CONNECTED_PEER_TEST, GO_BRIDGE_ENTRYPOINT_REFACTOR_RUN, GO_BRIDGE_ENTRYPOINT_REFACTOR_TEST, GO_BRIDGE_FEATUREFLAGS_RUN, GO_BRIDGE_FEATUREFLAGS_TEST, GO_NODE_ADDR_VISIBILITY_RUN, GO_NODE_ADDR_VISIBILITY_TEST, GO_NODE_FEATUREFLAGS_RUN (+19 more)

### Community 464 - "Community 464"
Cohesion: 0.08
Nodes (25): _drain, drainAll, drainForGroup, GroupPendingBroadcastRunner, repository, _safeId, all, _b (+17 more)
...
Cohesion: 0.07
Nodes (25): concurrentInbox, delivered, jsonString, payload, reactionId, removeReaction, RemoveReactionResult, timestamp (+17 more)

### Community 468 - "Community 468"
Cohesion: 0.07
Nodes (26): client, lastCall, main, GoBridgeClient, client, closeMockGoBridgeEventChannel, defaultHandler, exerciseNativeFailure (+18 more)
...
Cohesion: 0.12
Nodes (27): scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), apnsCustomDataFromPushData(), buildCiphertextOnlyPushMessage(), buildGroupPushMessage(), buildOversizedFallbackPushMessage(), buildPushMessage(), pushDataSize() (+19 more)

### Community 472 - "Community 472"
Cohesion: 0.07
Nodes (27): _contactFor, decrypted, deleteGroup, encrypted, _generateIdentity, _groupDecrypt, _groupDecryptRaw, _groupEncrypt (+19 more)

### Community 473 - "Community 473"
Cohesion: 0.07
Nodes (27): ../models/conversation_message.dart, conditionalTransitionStatus, conversationReadStream, deleteMessage, deleteMessagesForContact, existsByContent, existsByDedupKey, getFailedOutgoingMessages (+19 more)
...
Cohesion: 0.07
Nodes (27): _buildScreen, dispose, disposeAllPlayers, _disposed, disposePlayer, _emitPlayback, _firstUri, init (+19 more)
...
Cohesion: 0.07
Nodes (25): accountMigrationNetworkGate, _allowsKeyExchangeRetry, bridge, contactRepo, _coordinator, _debounceTimer, dispose, identityRepo (+17 more)
...
Cohesion: 0.07
Nodes (24): contact_request_repository.dart, ../models/contact_request_model.dart, package:flutter_app/features/contact_request/domain/repositories/contact_request_repository_impl.dart, addRequest, ContactRequestRepository, deleteRequest, getPendingRequests, getRequest (+16 more)
...
Cohesion: 0.07
Nodes (25): group_pending_key_repair_repository.dart, ../models/group_pending_key_repair.dart, GroupPendingKeyRepair, created, deleteRepair, finalizeRepaired, finalizeUndecryptable, getAllPendingRepairs (+17 more)
...
Cohesion: 0.18
Nodes (24): TestDialPeerViaRelayMultiAddrFailover(), TestDualStackNodeWithIPv4Relay(), newLocalRelaySharedState(), startLocalRelayPairWithRegistrationTTL(), startNodeWithRelayConfig(), startNodeWithRelays(), startPersonalNodeWithExplicitInitialRegister(), startPersonalNodeWithExplicitInitialRegisterAndFlags() (+16 more)
...
Cohesion: 0.08
Nodes (25): attachmentId, destination, displayName, isSupportedMediaEgressMime, isValidMediaEgressRequestId, items, kMaxMediaEgressItems, MediaEgressDestination (+17 more)
...
Cohesion: 0.08
Nodes (23): package:flutter_app/core/theme/feed_colors.dart, main, build, onDismiss, QuotePreviewBar, text, build, child (+15 more)
...
Cohesion: 0.14
Nodes (22): assert_log_contains(), assert_log_not_contains(), assert_scenario_markers(), discover_booted_devices(), install_app_on_device(), is_booted_ios_device(), launch_warm_app_for_host_push(), main() (+14 more)
...
Cohesion: 0.08
Nodes (22): _activeTab, AppShellChangeKind, AppShellController, _backgroundPreference, _lastChangeKind, notifyIdentityChanged, notifyMediaQualityChanged, setBackgroundPreference (+14 more)
...
Cohesion: 0.08
Nodes (24): dispose, disposeAllPlayers, _disposed, disposePlayer, _emitPlayback, init, installFakeJustAudioPlatform, load (+16 more)
...
Cohesion: 0.08
Nodes (22): authorPeerId, authorUsername, main, _post, senderPeerId, totalSharedToCount, viewerHasPassed, viewerSharedToCount (+14 more)
...
Cohesion: 0.08
Nodes (24): addContact, addContactCallCount, archiveContact, blockContact, contactExists, _contacts, deleteContact, deleteContactCallCount (+16 more)

### Community 519 - "Community 519"
Cohesion: 0.19
Nodes (20): classify_path(), emit_failures_if_any(), expand_1to1_device_real(), expand_dart_test_declarations(), expand_group_multi_party_device_real(), expand_intro_smoke(), expand_ios_notification_tap(), expand_notification_sound() (+12 more)
...
Cohesion: 0.09
Nodes (21): contactRepo, main, messageRepo, mutualIntro, byId, expireOldIntroductions, introducedRows, _loadMutualAcceptedIntroductions (+13 more)

### Community 523 - "Community 523"
Cohesion: 0.09
Nodes (21): bridge, contactRepo, dispose, incomingReactionChangeStream, incomingReactionStream, messageRepo, _onMessage, _reactionChangeController (+13 more)
...
Cohesion: 0.23
Nodes (23): genDisconnectedPeerID(), newPresenceTestEnv(), rawKeys(), sendPresenceGet(), sendPresenceSet(), TestConnectednessHandlerSeedsLastSeen(), TestPresenceGet_ConnectedPeerReportsFreshAgeDespiteStaleLastSeen(), TestPresenceGet_ReturnsReachableForConnectedPeer() (+15 more)
...
Cohesion: 0.08
Nodes (22): _RecordingNavigatorObserver, main, NavigatorObserver, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, didPush, _fakeIdentityJson, _FakeIdentityRepo (+14 more)

### Community 533 - "Community 533"
Cohesion: 0.08
Nodes (23): build, _controller, emit, eventStream, flush, isReady, isStopped, main (+15 more)

### Community 534 - "Community 534"
Cohesion: 0.08
Nodes (23): RecordingResumeStore, adapter, checkpointInterval, _clampMs, _clock, _completionWritten, _enabled, flush (+15 more)
...
Cohesion: 0.14
Nodes (13): featureFlagsStatusMap(), limitRelayAddresses(), fanOutRelay(), ForEachWithResult(), relayInfoAttemptCandidates(), RelayInfo, RelaySelector, FeatureFlags (+5 more)
...
Cohesion: 0.09
Nodes (21): DeliveryReceiptListener, dispose, messageRepo, receiptStream, start, stop, _subscription, buildReceipt (+13 more)
...
Cohesion: 0.09
Nodes (22): countIncomingMessage, _dbName, deadline, _defaultDbName, hasIncomingMessage, incomingMessages, interval, loadIncomingMessage (+14 more)

### Community 550 - "Community 550"
Cohesion: 0.09
Nodes (22): add, close, complete, _computeSha256, defaultOfferTimeout, defaultUploadedTimeout, emitSendTiming, failure (+14 more)
...
Cohesion: 0.18
Nodes (22): TestHandleLANPeerFound_ConnectsDirect_IdentifyCompletes(), s2Budget(), s2BuildHost(), s2Iters(), s2Max(), s2Pctl(), s2PickListenAddr(), s2Reach() (+14 more)

### Community 553 - "Community 553"
Cohesion: 0.26
Nodes (21): dialDirect(), hostHasProtocol(), lanLoopbackQUICAddr(), lanMediaNodeConfig(), sha256Hex(), startLANMediaNode(), TestHandleIncomingLANMedia_ConcurrentDuplicateId_RaceClean(), TestHandleIncomingLANMedia_DedupesDuplicateId() (+13 more)
...
Cohesion: 0.13
Nodes (14): Cond, _TrackingChatMessageListener, _FakeIncomingConversationListener, incomingGroupMessage, incomingMessage, int64Val(), strVal(), emitAsyncEvent() (+6 more)
...
Cohesion: 0.09
Nodes (18): db, main, db, main, db, main, package:flutter_app/core/database/helpers/group_invite_consumptions_db_helpers.dart, package:flutter_app/core/database/helpers/group_invite_revocations_db_helpers.dart (+10 more)

### Community 565 - "Community 565"
Cohesion: 0.10
Nodes (21): attachment, bookmarkedOnly, direct, entries, group, hashCode, id, kind (+13 more)
...
Cohesion: 0.10
Nodes (21): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepo, FakeContactRepository (+13 more)

### Community 569 - "Community 569"
Cohesion: 0.10
Nodes (18): main, expectInvalid, expectTamperRejected, main, makeFreshnessProof, makePayload, makePolicy, makeWelcomePackage (+10 more)
...
Cohesion: 0.10
Nodes (19): group_invite_delivery_attempt_repository.dart, package:flutter_app/features/groups/domain/repositories/group_invite_delivery_attempt_repository_impl.dart, deleteAttempt, deleteAttemptsForGroup, getAttempt, getAttemptsForGroup, getStatusesForGroupMembers, getStatusForMember (+11 more)
...
Cohesion: 0.10
Nodes (19): _channel, channelName, consumeInitialNotificationOpen, consumeInitialNotificationOpenMethod, dispose, _emitOpenError, IosApnsNotificationOpenBridge, IosApnsNotificationOpenHandler (+11 more)
...
Cohesion: 0.10
Nodes (20): allSavedAttachments, _attachments, deleteAttachmentsForContact, deleteAttachmentsForMessage, getAttachmentsForMessage, getAttachmentsForMessageCallCount, getAttachmentsForMessages, getPendingDownloads (+12 more)
...
Cohesion: 0.10
Nodes (19): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, _byCreatedThenId, deleteRepair, finalizeRepaired, finalizeUndecryptable, getAllPendingRepairs, getPendingRepairsForGroup (+11 more)
...
Cohesion: 0.10
Nodes (19): deadline, _freshnessProof, fromPayload, groupConfig, groupId, inviteId, main, network (+11 more)
...
Cohesion: 0.19
Nodes (19): IP, classifyStreamTransportConn(), firstDirectConn(), firstDirectTCPConn(), reserveLocalRelay(), startNW002RelayNodeWithTracer(), TestFeasibility_DirectUpgrade_TcpLane(), TestHolePunchFeasibility_LoopbackUpgradeObservable() (+11 more)
...
Cohesion: 0.10
Nodes (19): artifactDir, devices, id, listScenarios, main, matches, mode, ok (+11 more)

### Community 600 - "Community 600"
Cohesion: 0.10
Nodes (19): bridge, _captureFlowEvents, checkHealth, dispose, _FakeBridge, inboxStagingRepository, initialize, _initialized (+11 more)
...
Cohesion: 0.12
Nodes (15): ../../account_migration/application/account_migration_runtime_network_gate.dart, dialP2PPeer, discoverP2PPeer, DiscoverPeerResult, SendMessageResult, sendP2PMessage, accountMigrationNetworkGate, StartNodeResult (+7 more)

### Community 603 - "Community 603"
Cohesion: 0.11
Nodes (18): _DigestSink, Digest, _DigestSink, _CallbackSink, _CallbackSink, add, _CallbackSink, close (+10 more)
...
Cohesion: 0.11
Nodes (18): appShellController, _armTimers, _cancelTimers, dispose, expiryBudget, _expiryTimer, _fallbackTimer, _handlePendingTargetMutation (+10 more)

### Community 606 - "Community 606"
Cohesion: 0.11
Nodes (18): connected, discoverLocalPeer, discoverPeer, _emphasis, _has, inboxDelay, isConnectedToPeer, lookupRelayPresence (+10 more)

### Community 607 - "Community 607"
Cohesion: 0.11
Nodes (17): bridge, _bridgeCommandError, checkHealth, dispose, eventNamed, initialize, isInitialized, main (+9 more)
...
Cohesion: 0.11
Nodes (18): ControlledPostPinDeliveryP2PService, _dialedPeers, dialPeer, discoverPeer, drainPostPinDeliveryMicrotasks, inboxAttempts, _inFlightSends, maxInFlightSends (+10 more)
...
Cohesion: 0.11
Nodes (16): FakeGroupReactionReplayOutboxRepository, group_reaction_replay_outbox_repository.dart, GroupReactionReplayOutboxRepository, ../models/group_reaction_replay_outbox_entry.dart, deleteEntry, getEntry, GroupReactionReplayOutboxRepository, deleteEntry (+8 more)
...
Cohesion: 0.11
Nodes (17): baseName, contains, debugSetVideoThumbnailGenerator, _defaultThumbnailGenerator, derivedVideoThumbnailPath, directory, dotIndex, ext (+9 more)
...
Cohesion: 0.22
Nodes (11): hasNonCircuitAddr(), newLANDialHandler(), lanDialHandler, AddrInfo, Context, Host, ID, Multiaddr (+3 more)

### Community 634 - "Community 634"
Cohesion: 0.20
Nodes (12): lanMediaAck, lanMediaDecision, lanMediaHeader, LANMediaSendResult, fileSha256AndSize(), firstNonCircuitConn(), writeLANMediaAck(), writeLANMediaDecision() (+4 more)

### Community 635 - "Community 635"
Cohesion: 0.11
Nodes (17): cv, devices, id, listScenarios, main, match, mode, _parseDevices (+9 more)

### Community 636 - "Community 636"
Cohesion: 0.11
Nodes (17): ../secure_storage/fake_secure_key_store.dart, _CapturingBridge, checkHealth, containsKey, _CountingSecureKeyStore, delete, dispose, initialize (+9 more)
...
Cohesion: 0.12
Nodes (16): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, ContactRequestRepository, addRequest, count, deleteRequest, getPendingRequests (+8 more)

### Community 640 - "Community 640"
Cohesion: 0.12
Nodes (16): acceptRequest, bridge, contactRepository, ContactRequestNotificationMaterializer, declineRequest, _defaultShowError, handleRoute, identityRepository (+8 more)
...
Cohesion: 0.12
Nodes (16): _attemptRegistration, dispose, _disposed, ensureStarted, _inFlightAttempt, _permissionState, _PushPermissionState, PushRegistrationCoordinator (+8 more)

### Community 643 - "Community 643"
Cohesion: 0.12
Nodes (16): dispose, _heartbeat, _heartbeatInterval, isHeartbeatActive, kPresenceForegroundHeartbeat, kPresenceSelfTtl, onBackgrounded, onForegrounded (+8 more)

### Community 644 - "Community 644"
Cohesion: 0.12
Nodes (16): copyToDurableStorage, deletedContactIds, deletedFilePaths, deletedPostIds, deleteFile, deleteMediaForContact, deleteMediaForPost, deletePendingUploadDir (+8 more)
...
Cohesion: 0.12
Nodes (16): attemptCount, copyWith, entryId, envelope, fromMap, lastAttemptedAt, messageType, ownerPeerId (+8 more)
...
Cohesion: 0.12
Nodes (15): _FakeReceivedWakeTokenStore, _cache, clear, _ensureLoaded, _load, _loading, _persist, readTokenFor (+7 more)

### Community 656 - "Community 656"
Cohesion: 0.12
Nodes (15): bridge, contactRepo, _contactUpdatedController, contactUpdatedStream, dispose, downloadProfilePictureFn, _downloadProfilePictureWithRetry, _onMessage (+7 more)
...
Cohesion: 0.12
Nodes (15): codecVersion, copyWithChoice, defaults, _disabled, _entryKey, fromStorageString, hashCode, isAutoDownloadEnabled (+7 more)
...
Cohesion: 0.13
Nodes (12): fromPreview, handleDeliveryReceipt, messageIds, main, count, emitRetryTiming, olderThan, retryStopwatch (+4 more)
...
Cohesion: 0.13
Nodes (14): FakeMediaPicker, imageResult, multipleMediaResult, pickImage, pickImageCalls, pickMultipleMedia, pickMultipleMediaCalls, pickVideo (+6 more)
...
Cohesion: 0.25
Nodes (9): reserveLocalTCPPort(), Network, newPeerSessionNotifiee(), selectBestConnAddr(), peerSessionNotifiee, Conn, ID, Multiaddr (+1 more)
...
Cohesion: 0.13
Nodes (12): fake_message_repository.dart, _aliceTimeline, _bobTimeline, main, ../../integration_test/scripts/routing_smoke_group_criteria.dart, id, isIncoming, main (+4 more)
...
Cohesion: 0.16
Nodes (13): FakeNativeMdnsResolver, attributes, _events, host, _method, NativeMdnsResolver, NativeResolvedPeer, peerId (+5 more)

### Community 692 - "Community 692"
Cohesion: 0.14
Nodes (13): connectedAt, ConnectionState, copyWith, direction, fromJson, hashCode, isRelay, multiaddrs (+5 more)
...
Cohesion: 0.14
Nodes (13): avatarPath, contact, isArchived, isBlocked, isLatestDeleted, lastActivity, lastMessageTimestamp, latestMedia (+5 more)
...
Cohesion: 0.32
Nodes (13): GroupJoinTopic(), GroupPublish(), generateTestIdentityMaterial(), TestGroupJoinTopic_BB007RoundTripsFullConfigAndAcceptsPublish(), TestGroupJoinTopic_BB008AlreadyJoinedRefreshesNewerKeyAndConfig(), TestGroupJoinTopic_BB008AlreadyJoinedSameEpochConfigRevisionUpdatesConfigOnly(), TestGroupJoinTopic_BB008AlreadyJoinedSameOrOlderEpochDoesNotReplaceCurrentKey(), TestGroupLeaveTopic_BB009RemovesNativeTopicAndBlocksPublish() (+5 more)
...
Cohesion: 0.15
Nodes (12): countNeedsAttentionEntries, countQuarantinedEntries, deleteEntry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, InboxStagingRepository, markQuarantined (+4 more)

### Community 707 - "Community 707"
Cohesion: 0.23
Nodes (10): Listener, startDeadDialListener(), TestConcurrentSendDialNoSerialize(), TestStartEmitsColdStartLockWindow(), waitForStartupPhase(), deadDialListener, Conn, Duration (+2 more)
...
Cohesion: 0.15
Nodes (12): copyWith, group, groupId, lastActivityTimestamp, latestMedia, latestMessage, latestMessageSenderUsername, latestMessageText (+4 more)
...
Cohesion: 0.29
Nodes (7): Activity, Bundle, ReceiverActivity, Intent, Override, Uri, String
...
Cohesion: 0.17
Nodes (11): contacts, eligible, identity, markerStore, reannouncePending, retryIncompleteKeyExchanges, rng, sent (+3 more)
...
Cohesion: 0.23
Nodes (9): backendConfig, setBackendDurabilityGauge(), histogramSampleCount(), metricValue(), TestInboxCappedAndTTLPruneTelemetry(), TestRelayBackendDurableGauge(), TestRelayMetricsDeltas(), Metric (+1 more)

### Community 719 - "Community 719"
Cohesion: 0.17
Nodes (10): buildRepo, main, columnNames, db, main, primaryKeyColumns, tableExists, package:flutter_app/core/database/helpers/feed_cleared_threads_db_helpers.dart (+2 more)
...
Cohesion: 0.20
Nodes (10): loadArb, main, newFeedKeys, removedFeedKeys, loadArb, main, newOrbitKeys, package:flutter_app/l10n/app_localizations_ar.dart (+2 more)
...
Cohesion: 0.21
Nodes (5): recoveryPromise, RecoveryResult, RelayConnectionState, RelaySessionState, Duration

### Community 732 - "Community 732"
Cohesion: 0.17
Nodes (11): startup_timing.dart, ColdStartNotifAnchor, _emitted, instance, _maybeEmit, _nodeReady, _notifTapSeen, _pushId (+3 more)
...
Cohesion: 0.18
Nodes (10): clearCallCount, clearToken, hasToken, readCallCount, simulateRestart, _storedPlatform, _storedToken, throwOnWrite (+2 more)
...
Cohesion: 0.18
Nodes (10): _controller, dispose, emit, resolvedPeers, start, startCallCount, startedServiceType, stop (+2 more)

### Community 742 - "Community 742"
Cohesion: 0.18
Nodes (9): begin, clearAll, end, _inFlight, inFlightCount, isInFlight, MediaUploadInFlightTracker, main (+1 more)
...
Cohesion: 0.20
Nodes (9): _CapturedFlowEvent, _captureFlowEvents, details, event, events, main, originalDebugPrint, previousLogging (+1 more)

### Community 756 - "Community 756"
Cohesion: 0.20
Nodes (9): DrainGroupOfflineInboxForGroupFn, error, failed, IngestStagedPushEnvelopesFn, ok, prepareNotificationOpen, PrepareNotificationOpenResult, stagedPushEnvelopeIngestTimeout (+1 more)
...
Cohesion: 0.38
Nodes (9): migrationNonce(), migrationTestSession(), TestMigrationChunkDecryptRejectsTampering(), TestMigrationChunkEncryptRejectsBadNonceAndKey(), TestMigrationChunkRoundTripWithRealAAD(), TestMigrationSessionKeyBindsSessionBundleAndDirection(), TestMigrationSessionKeyMatchesAcrossEncapDecap(), MigrationSession (+1 more)

### Community 759 - "Community 759"
Cohesion: 0.20
Nodes (9): dart:developer, flow_event_emitter.dart, details, line, logPushDiagnostic, prefix, sanitizedDetails, suffix (+1 more)

### Community 760 - "Community 760"
Cohesion: 0.20
Nodes (9): FakePushTokenStore, clearToken, pushFcmPlatformSecureStorageKey, pushFcmTokenSecureStorageKey, PushTokenStoreImpl, _secureKeyStore, writeToken, package:flutter_app/features/push/domain/push_token_store.dart (+1 more)

### Community 761 - "Community 761"
Cohesion: 0.20
Nodes (9): rolloutState, routeData, ciphertext, envelope_version, kem, message_id, nonce, sender_id (+1 more)
...
Cohesion: 0.20
Nodes (9): dbDeleteReaction, dbDeleteReactionsForContact, dbDeleteReactionsForMessage, dbInsertReaction, dbLoadActiveOrTombstonedReactionForSender, dbLoadReactionsForMessage, dbLoadReactionsForMessages, id (+1 more)
...
Cohesion: 0.40
Nodes (9): relayDNS4Addr(), startSingleLocalRelay(), startWedgedReserveOkNode(), TestDefaultFlagsKeepPrivateReachability_CircuitPublished(), TestNoCircuitCyclesDoNotChurnGroupsOrRestartUnbounded(), TestPeerCanDialReservationAfterRecovery(), TestReserveSuccessCountsAsCircuitTruth_NoRestartLoop(), localRelayServer (+1 more)
...
Cohesion: 0.33
Nodes (3): Duration, Node, RecoveryResult
...
Cohesion: 0.25
Nodes (3): memoryPushTokenStore, RWMutex, tokenEntry
...
Cohesion: 0.22
Nodes (8): dbDeleteGroupReactionReplayOutboxEntry, dbLoadGroupReactionReplayOutboxEntry, dbLoadRetryableGroupReactionReplayOutboxEntries, dbUpdateGroupReactionReplayOutboxEntryStatus, dbUpsertGroupReactionReplayOutboxEntry, limit, reactionId, rows
...
Cohesion: 0.25
Nodes (8): dbValue, kMediaOwnerLaneUnresolved, MediaAttachmentOwnerViolation, MediaOwnerLane, MediaOwnerLaneDbValue, mediaOwnerLaneFromDbValue, message, toString
...
Cohesion: 0.22
Nodes (8): _createGroupInviteRevocationsExpiresAtIndexSql, _createGroupInviteRevocationsGroupIdIndexSql, _createGroupInviteRevocationsTableSql, expires_at, group_id, group_invite_revocations, runGroupInviteRevocationsMigration, TEXT
...
Cohesion: 0.22
Nodes (8): addresses, DiscoveredPeer, fromJson, hashCode, id, operator, toJson, toString
...
Cohesion: 0.25
Nodes (7): intro_review_seen_repository.dart, IntroReviewSeenRepository, IntroReviewSeenRepositoryImpl, loadSeenKeys, markAllSeen, _InMemoryIntroReviewSeenRepository, _InMemoryIntroReviewSeenRepository
...
Cohesion: 0.25
Nodes (7): formatDaySeparatorLabel, local, messageDay, nowLocal, pattern, today, yesterday
...
Cohesion: 0.29
Nodes (4): main, main, package:flutter_app/core/debug/transport_metrics.dart, main
...
Cohesion: 0.29
Nodes (6): _attachmentColumns, _attachmentSelectList, dbLoadMediaLibraryPage, dbLoadMediaStoragePage, map, mediaLibraryRowToAttachmentMap
...
Cohesion: 0.29
Nodes (6): dbInsertPostComment, dbLoadPostComment, dbLoadPostComments, insert, query, rows
...
Cohesion: 0.29
Nodes (6): connectivityRestoredSignal, controller, restoredEdges, sub, wasConnected, StreamSubscription
...
Cohesion: 0.40
Nodes (4): main, main, package:flutter_app/features/push/application/push_registration_coordinator.dart, package:flutter_app/features/push/application/register_push_token_use_case.dart

### Community 842 - "Community 842"
Cohesion: 0.33
Nodes (5): effectiveRequestPermission, granted, requestPushPermission, settings, package:flutter_app/core/utils/push_diagnostics_logger.dart
...
Cohesion: 0.33
Nodes (5): clear, readTokenFor, ReceivedWakeTokenStore, removeTokenFor, writeTokenFor
...
Cohesion: 0.33
Nodes (5): main, ../test/core/services/fake_p2p_service.dart, ../test/features/contacts/domain/repositories/fake_contact_repository.dart, ../test/features/conversation/domain/repositories/fake_message_repository.dart, ../test/features/identity/domain/repositories/fake_identity_repository.dart
...
Cohesion: 0.33
Nodes (5): columnNames, columns, needsContentHash, needsThumbnailHash, runMediaAttachmentIntegrityColumnsMigration
...
Cohesion: 0.47
Nodes (5): testRelayCircuitAddr(), TestRelaySessionRuntimeSync_EndsReservationWhenCircuitAddressDisappears(), TestRelaySessionRuntimeSync_IgnoresStaleCircuitAddressWithoutConnectedRelay(), TestRelaySessionRuntimeSync_OpensReservationAndEmitsRelayState(), ID
...
Cohesion: 0.40
Nodes (4): clear, readTokens, WakeTokenStore, writeTokens
...
Cohesion: 0.40
Nodes (3): relayPeerHasCircuitAddress(), ID, Node
...
Cohesion: 0.50
Nodes (4): AudioPlayerPlatform, _FakeAudioPlayer, _FakeAudioPlayerPlatform, _FakeAudioPlayerPlatform
...
Cohesion: 0.50
Nodes (4): buildGroupPublishOpts(), TestBuildGroupPublishOpts_EmptyReturnsNil(), TestBuildGroupPublishOpts_IncludesQuotedMessageId(), TestPL012GroupPublishOptsPreserveMediaSchemaVariants()
...
Cohesion: 0.50
Nodes (4): FakeJustAudioPlatform, _FakeJustAudioPlatform, JustAudioPlatform, _FakeJustAudioPlatform
...
Cohesion: 0.50
Nodes (3): main, peerDiscoveredAt, package:flutter_app/core/local_discovery/bonsoir_discovery_service.dart
...
Cohesion: 0.50
Nodes (3): columnNames, columns, runMediaAttachmentReliabilityColumnsMigration

### Community 890 - "Community 890"
Cohesion: 0.50
Nodes (3): columns, hasColumn, runMessagesEditedAtMigration

### Community 891 - "Community 891"
Cohesion: 0.50
Nodes (3): _createIntroReviewSeenSql, NULL, runIntroReviewSeenMigration
...
Cohesion: 0.50
Nodes (3): IntroReviewSeenRepository, loadSeenKeys, markAllSeen
...
Cohesion: 0.67
Nodes (4): buildGroupOfflineReplayEnvelope(), canonicalJSON(), canonicalStringList(), hashString()
...
Cohesion: 0.67
Nodes (3): GroupUpdateKey(), TestGroupUpdateKey_RejectsInvalidKeyState(), validateBridgeGroupKeyMaterial()
...
Cohesion: 0.67
Nodes (3): _RecordingResolver, _RecordingResolver, ServiceResolver

## Knowledge Gaps
- **36022 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Node`, `Identity` (+36017 more)
...
- **Why does `incomingMessage` connect `Community 559` to `Community 2`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 364` to `Community 537`, `Community 559`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 537` to `Community 323`, `Community 364`, `Community 70`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _36022 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.001026694045174538 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0029239766081871343 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.004964076371829214 - nodes in this community are weakly interconnected._