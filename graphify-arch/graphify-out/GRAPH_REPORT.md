...
## Summary
- 41856 nodes · 65118 edges · 893 communities (849 shown, 44 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2408 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88ebe9c2`
...
## Communities (893 total, 44 thin omitted)
...
Cohesion: 0.01
Nodes (363): AlertDialog, Align, showGroupMissingNotificationFeedback, CircularProgressIndicator, ClipRRect, ConstrainedBox, Directionality, ElevatedButton (+355 more)
...
Cohesion: 0.01
Nodes (365): AnimatedOpacity, contactRepo, main, requestRepo, testRequest, main, GateableMediaAttachmentRepository, detailsFor (+357 more)
...
Cohesion: 0.01
Nodes (291): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, bridge, introRepo (+283 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (271): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+263 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (274): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+266 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (235): main, makeInvite, pendingInviteRepo, bridge, buildMigrationQRData, buildValidQRData, contactRepo, identityRepo (+227 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (245): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, friend (+237 more)

### Community 11 - "Community 11"
Cohesion: 0.01
Nodes (249): ../../application/orbit2_mock_data.dart, Orbit2ChatLine, Orbit2InboxEntry, ../domain/models/orbit2_group.dart, id, members, name, Orbit2Group (+241 more)
...
Cohesion: 0.01
Nodes (232): adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie, device, expectBlocked, expectOverflowRejected (+224 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (233): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+225 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (200): NearbyDevicePosition, addContact, bridge, contactRepo, create, dispose, drainOfflineInbox, p2pService (+192 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (240): applied, pendingEvents, reconcilePendingPostChildEvents, InMemoryPostRepository, attachment, createdAt, cryptoEntry, envelope (+232 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (233): ContactRequestNotificationMaterializer, main, buildRepo, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db, main (+225 more)

### Community 18 - "Community 18"
Cohesion: 0.01
Nodes (223): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+215 more)
...
Cohesion: 0.02
Nodes (230): DatabaseException, db, main, makeContactRow, db, main, makeIdentityRow, db (+222 more)
...
Cohesion: 0.02
Nodes (114): Stopwatch, swipe_action_buttons.dart, Widget, animation, build, child, _clock, _controller (+106 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (193): ../../../conversation/domain/repositories/fake_reaction_repository.dart, DecryptionFailureDiagnostic, fake_group_reaction_replay_outbox_repository.dart, FakeGroupPubSubNetwork, addMember, bridge, broadcastMemberAdded, create (+185 more)
...
Cohesion: 0.01
Nodes (198): Color, CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth (+190 more)

### Community 28 - "Community 28"
Cohesion: 0.02
Nodes (168): benchmark_harness.dart, BenchmarkHarness, alice, bob, main, network, _originalText, FakeP2PNetwork (+160 more)
...
Cohesion: 0.01
Nodes (246): Animation, CustomPaint, _NotificationBenchmarkApp, _NotificationBenchmarkAppState, _ConversationPerfHost, _ConversationPerfHostState, _ConversationHost, _ConversationHostState (+238 more)

### Community 31 - "Community 31"
Cohesion: 0.01
Nodes (144): main, dart:async, fake_group_pubsub_network.dart, deliveries, _Go012Run, main, publishBatch, runScenario (+136 more)
...
Cohesion: 0.01
Nodes (162): main, tempDir, _incoming, main, isDeleted, isIncoming, main, _msg (+154 more)
...
Cohesion: 0.01
Nodes (179): _CursorInboxBridge, _FailDecryptBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole (+171 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (142): GroupMessagePayload, builtGroupMessageEnvelope, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, groupSenderDeviceBinding (+134 more)

### Community 37 - "Community 37"
Cohesion: 0.01
Nodes (150): Database, fake_secure_key_store.dart, db, main, makeRequestRow, db, main, repairRow (+142 more)
...
Cohesion: 0.01
Nodes (180): main, fake_media_attachment_repository.dart, EncryptedMediaTestBridge, RelayMediaStore, ImagePicker, bridge, _createdAt, encTempsUnder (+172 more)
...
Cohesion: 0.03
Nodes (154): BuildGroupSignatureData(), ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), isAllowedWriter() (+146 more)
...
Cohesion: 0.02
Nodes (138): bridge, deleteMessagesForGroup, _FailingGroupMessageRepository, groupId, groupMessageRepo, groupRepo, main, baseGroup (+130 more)

### Community 46 - "Community 46"
Cohesion: 0.02
Nodes (93): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, package:flutter_app/features/home/presentation/widgets/editable_username_widget.dart, avatarBytes, backgroundPreference, build (+85 more)
...
Cohesion: 0.02
Nodes (137): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+129 more)

### Community 50 - "Community 50"
Cohesion: 0.01
Nodes (142): openAppSettings, openAppSettingsCallCount, openAppSettingsReturn, request, requestCallCount, statusToReturn, InkWell, package:flutter_app/core/permissions/mic_permission_gateway.dart (+134 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (141): buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateGroupEnvelope(), publishRawGroupEnvelope(), waitForCollectedEvent(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash(), lp013GroupHarness, TestGA002NonMemberCannotPublishValidEnvelope() (+133 more)

### Community 52 - "Community 52"
Cohesion: 0.01
Nodes (132): deliveredWritePatterns, main, scanDeliveredWrites, AspectRatio, File, FileImage, delay, _expectReport89RowsVisible (+124 more)

### Community 53 - "Community 53"
Cohesion: 0.01
Nodes (135): main, member, deletePendingSiblingDevice, holdPendingSiblingDevice, HoldPendingSiblingDeviceFn, multiDeviceSyncEnabled, outcome, rejectPendingSiblingDevice (+127 more)

### Community 54 - "Community 54"
Cohesion: 0.02
Nodes (97): applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, buildTestApp, main, setPhoneViewport, _assertBackgroundScrollDoesNotRegress, _assertThresholds (+89 more)
...
Cohesion: 0.02
Nodes (126): package:flutter_app/features/conversation/presentation/widgets/blocked_banner.dart, activeQuoteText, alignment, allowEditAction, amplitudeValues, backgroundPreference, bannerContactUsername, build (+118 more)
...
Cohesion: 0.02
Nodes (116): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/core/widgets/quiet_confirm.dart, package:flutter_app/features/conversation/domain/utils/message_run_grouping.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, bannerText (+108 more)
...
Cohesion: 0.02
Nodes (119): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, _DeletionWireEnvelopeEncryptFailed, GroupOfflineReplaySignatureException, activeDatabase, importedRows, importedTables (+111 more)
...
Cohesion: 0.03
Nodes (63): OrbitGroup, friend, group, OrbitFriendItem, OrbitGroupItem, OrbitItem, sortKey, OrbitFriend (+55 more)
...
Cohesion: 0.02
Nodes (102): core_fake_p2p.FakeP2PService, addPage, addSignedInboxPage, admin, create, _CursorInboxBridge, dispose, _downloadedBytesHash (+94 more)
...
Cohesion: 0.02
Nodes (99): bridge, cmListener, crListener, gmListener, imageProcessor, main, mediaFileManager, orbit (+91 more)

### Community 85 - "Community 85"
Cohesion: 0.02
Nodes (93): buildIdentity, main, tempDir, main, main, _changes, dispose, load (+85 more)
...
Cohesion: 0.02
Nodes (87): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+79 more)
...
Cohesion: 0.02
Nodes (82): byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists, _loadCandidateMessagesForCleanup (+74 more)

### Community 100 - "Community 100"
Cohesion: 0.02
Nodes (64): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, main, cleanupSessionArtifacts, MigrationFileImportCleanup (+56 more)

### Community 101 - "Community 101"
Cohesion: 0.02
Nodes (81): _CapturedFlowEvent, _captureFlowEvents, details, event, events, main, originalDebugPrint, previousLogging (+73 more)
...
Cohesion: 0.02
Nodes (84): deleteEntry, deleteEntryCallCount, _entries, FakeGroupReactionReplayOutboxRepository, getEntry, loadRetryableEntries, saveEntry, saveEntryCallCount (+76 more)

### Community 117 - "Community 117"
Cohesion: 0.03
Nodes (76): benchmark_helpers.dart, runOneToOneSendBenchmark, runAckBenchmark, details, events, _findRecoveredOutage, firstEventDetails, firstInbox (+68 more)

### Community 118 - "Community 118"
Cohesion: 0.05
Nodes (41): Column, nav_bar_button.dart, nav_bar_theme.dart, main, suppressAssetErrors, wrap, package:flutter_app/features/conversation/presentation/widgets/empty_conversation_state.dart, package:flutter_app/features/feed/domain/models/app_shell_tab.dart (+33 more)
...
Cohesion: 0.03
Nodes (83): ChatMessageListener, main, _pendingRequest, requestRepo, ChatMessageListener, ContactUpdate, first_time_experience_screen.dart, ImageSource (+75 more)
...
Cohesion: 0.02
Nodes (81): build, createState, initState, main, _SettleHarness, _SettleHarnessState, shareIntentService, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart (+73 more)
...
Cohesion: 0.02
Nodes (85): dart:ui, capture, drain, goTo, main, outDir, capture, main (+77 more)
...
Cohesion: 0.03
Nodes (72): _InMemoryGroupPendingKeyRepairRepository, _InMemoryGroupPendingKeyRepairRepository, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose, _enqueueMessage (+64 more)
...
Cohesion: 0.03
Nodes (69): Alignment, EdgeInsets, IconData, anchor, build, _buildMenuItem, _close, _controller (+61 more)
...
Cohesion: 0.03
Nodes (68): FakeIntroductionRepository, clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository, markCleared, feed_cleared_repository.dart (+60 more)
...
Cohesion: 0.03
Nodes (66): main, actorPayload, actorPeerId, actorPublicKey, actorUsername, _aliceContact, _bobIdentity, bridge (+58 more)
...
Cohesion: 0.02
Nodes (106): ShareBatchDeliveryResult, _expectCommandOrder, _GroupShareBgBridge, _imageProcessor, inboxStoreOk, isLocalPeer, joinedAt, _LanFakeP2PService (+98 more)
...
Cohesion: 0.03
Nodes (65): package:flutter_app/features/groups/presentation/widgets/group_dissolved_badge.dart, package:flutter_app/features/groups/presentation/widgets/group_member_row.dart, package:flutter_app/features/groups/presentation/widgets/group_type_badge.dart, buildTestWidget, main, _amberAccent, backgroundPreference, _blueAccent (+57 more)
...
Cohesion: 0.03
Nodes (64): bridge, contactRepository, DefaultShareBatchDeliveryCoordinator, deliver, detail, ext, failedTargetKeys, failureCount (+56 more)

### Community 155 - "Community 155"
Cohesion: 0.03
Nodes (61): consume, main, mark, notificationService, showLive, tracker, AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart (+53 more)

### Community 156 - "Community 156"
Cohesion: 0.04
Nodes (50): benchmark_1_1_send_harness.dart, benchmark_ack_harness.dart, benchmark_background_resume_harness.dart, benchmark_bridge_crossing_harness.dart, benchmark_connection_reuse_harness.dart, benchmark_encryption_harness.dart, benchmark_event_queue_harness.dart, benchmark_group_publish_harness.dart (+42 more)
...
Cohesion: 0.03
Nodes (63): addPage, bridge, buildSignedReplay, _Clock, contains, endedAt, getGroup, getKeyByGeneration (+55 more)
...
Cohesion: 0.04
Nodes (59): @pragma, @visibleForTesting, accountNetworkAllowed, allowCurrentMember, allowsAccountNetworkSideEffects, _allowsBackgroundAccountNotificationDisplay, _backgroundAccountMigrationNetworkGate, _backgroundDbEncryptionKey (+51 more)

### Community 173 - "Community 173"
Cohesion: 0.05
Nodes (38): main, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, package:flutter_app/features/identity/presentation/screens/identity_progress_screen.dart, backgroundPreference, build, contactRepo, createState (+30 more)
...
Cohesion: 0.04
Nodes (54): DeliveryReceiptListener, dispose, messageRepo, receiptStream, start, stop, _subscription, _commentController (+46 more)
...
Cohesion: 0.04
Nodes (53): avatarByIndex, enterManage, innerMembers, innerWorkKey, main, manageToggle, openMessages, r (+45 more)
...
Cohesion: 0.03
Nodes (74): package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, activePinnedPostIds, activeTab, backgroundPreference, build, _EmptyState, focusedPostId, _groupPosts (+66 more)

### Community 198 - "Community 198"
Cohesion: 0.04
Nodes (51): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, _FakeContactRequestRepository, acceptRequest, bridge (+43 more)
...
Cohesion: 0.04
Nodes (53): AudioRecorderService, GroupMessageRepository, _NoOpMsgRepo, RecordAudioRecorderService, ActiveConversationTracker, _activePeerId, clear, clearIfActive (+45 more)
...
Cohesion: 0.04
Nodes (52): AppendGroupEventLogEntry, _bridge, dispose, DistributeGroupKeyAtEpochToPeer, _emitUnauthorized, _enqueue, GroupKeyRepairResponderListener, _groupRepo (+44 more)
...
Cohesion: 0.03
Nodes (69): chatGroup, conversationApp, fortyMessages, localAfternoon, main, messageAt, pumpFrames, rectWithin (+61 more)

### Community 222 - "Community 222"
Cohesion: 0.04
Nodes (50): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _MockBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, _FakeBridge (+42 more)
...
Cohesion: 0.04
Nodes (43): package:flutter_app/core/theme/feed_colors.dart, package:flutter_app/core/utils/url_parser.dart, package:url_launcher/url_launcher.dart, TextOverflow, main, main, build, createState (+35 more)
...
Cohesion: 0.04
Nodes (52): InMemoryInboxStagingRepository, InboxStagingRepositoryImpl, InboxStagingRepository, _ThrowingInboxStagingRepository, RecoveredInboxReplayOutcome, action, bridge, buildSweepService (+44 more)
...
Cohesion: 0.04
Nodes (40): addContact, AddContactResult, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, contacts, kMlKemReannouncePendingKey (+32 more)
...
Cohesion: 0.03
Nodes (74): _captureFlowEvents, _dbName, events, _filter, _generateUnreachableContact, identity, identityResponse, identityResult (+66 more)
...
Cohesion: 0.05
Nodes (44): AccountMigrationProductionBundleSource, failureEvent, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, GroupMembershipUpdateListener, GroupMessageListener, GroupKeyRepairRequest, GroupKeyRepairRequestSender (+36 more)
...
Cohesion: 0.04
Nodes (43): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState, chatMessageStream (+35 more)
...
Cohesion: 0.04
Nodes (38): applyChange, clearMessageIds, dispose, FeedReactionStore, listenableForMessage, _notifierFor, _notifiers, reactionsForMessage (+30 more)
...
Cohesion: 0.05
Nodes (37): loadReactionsForConversation, result, jsonString, payload, reactionId, removeReaction, RemoveReactionResult, timestamp (+29 more)
...
Cohesion: 0.05
Nodes (40): _TrackingReactionListener, _TrackingReactionListener, copyWith, createdAt, emoji, fromJson, fromMap, hashCode (+32 more)
...
Cohesion: 0.05
Nodes (37): countQuarantinedEntries, deleteEntry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, markQuarantined, markRejected, markRetryable (+29 more)
...
Cohesion: 0.01
Nodes (174): AnimatedBuilder, AnimatedContainer, AnnotatedRegion, _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference (+166 more)
...
Cohesion: 0.05
Nodes (35): byId, expireOldIntroductions, introducedRows, _loadMutualAcceptedIntroductions, pending, recipientRows, repairedCount, repairedMutualAcceptanceIds (+27 more)
...
Cohesion: 0.06
Nodes (31): buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, _kMnemonic12, recoverIdentityFromSecureStore, result, SecureStoreIdentityRecoveryResult, storedMnemonic (+23 more)
...
Cohesion: 0.02
Nodes (107): identityRepo, main, p2pService, startNode, _testIdentity, _ThrowingP2PService, DiscoveredPeer, FakeP2PService (+99 more)
...
Cohesion: 0.06
Nodes (32): HttpServer, DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream, dispose, getLocalPeer, isLocalPeer, _peersController (+24 more)
...
Cohesion: 0.06
Nodes (32): _FakeIdentityRepo, _FakeIdentityRepo, _FakeIdentityRepository, _FakeIdentityRepository, IdentityRepository, _Section10IdentityRepository, _FakeIdentityRepository, _TrackingIdentityRepository (+24 more)
...
Cohesion: 0.06
Nodes (29): handleShareIntent, ShareIntentRouteBuilder, acquire, activeHolds, _channel, _channelInvoke, channelName, _holds (+21 more)
...
Cohesion: 0.07
Nodes (29): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult (+21 more)
...
Cohesion: 0.06
Nodes (30): _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepository, _FakeContactRepository, FakeContactRepository, _FakeContactRepo, FakeContactRepository (+22 more)
...
Cohesion: 0.07
Nodes (29): _FakeMediaFileManager, FakeMediaFileManager, FakeReactionRepository, _FakeMediaFileManager, _FakeMediaFileManager, _TempMediaFileManager, bridge, contactRepo (+21 more)
...
Cohesion: 0.07
Nodes (25): main, main, events, h, main, missing, missingCalls, _NotificationSmokeHarness (+17 more)
...
Cohesion: 0.08
Nodes (23): emoji, id, main, messageId, _reaction, senderPeerId, bridge, contactRepo (+15 more)
...
Cohesion: 0.08
Nodes (22): announcedAt, deviceId, deviceSigningPublicKey, fromMap, groupId, id, keyPackageId, memberPeerId (+14 more)
...
Cohesion: 0.10
Nodes (21): _FakeP2PService, _FakeP2PService, _FlakyDiscoverP2PService, _SlowLocalFastDirectP2PService, _ThrowOnInboxP2PService, _ThrowOnSendP2PService, _FakeP2PService, _FakeP2PService (+13 more)
...
Cohesion: 0.10
Nodes (18): dismissedAt, dismissPin, savePinDismissal, avatarSnapshots, hydratePostSurfaceItems, mediaMap, postList, repostHeartBaselines (+10 more)
...
Cohesion: 0.11
Nodes (18): encrypted, envelope, envelopeSenderPeerId, HandleGroupInviteDeclineAckResult, handleIncomingGroupInviteDeclineAck, payload, verifyOutcome, canonicalPayload (+10 more)
...
Cohesion: 0.12
Nodes (15): PendingGroupInvite, build, _formatExpiry, groupName, invite, isProcessing, onAccept, onDecline (+7 more)
...
Cohesion: 0.14
Nodes (12): amplitudeStream, AudioRecorderService, cancel, dispose, durationStream, hasPermission, isRecording, requestPermission (+4 more)
...
Cohesion: 0.15
Nodes (12): _MemorySecureKeyStore, _TrackingSecureKeyStore, _FakeSecureKeyStore, _InMemorySecureKeyStore, CountingSecureKeyStore, containsKey, delete, FakeSecureKeyStore (+4 more)
...
Cohesion: 0.22
Nodes (8): FakeMicPermissionGateway, MicPermissionGateway, package:permission_handler/permission_handler.dart, MicPermissionGateway, MicPermissionStatus, openAppSettings, PermissionHandlerMicGateway, request
...
Cohesion: 0.29
Nodes (5): isRetryableChatStreamOpenError(), GroupEnvelope, ID, Node, Stream
...
## Knowledge Gaps
- **33884 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+33879 more)
...
- **Why does `incomingMessage` connect `Community 122` to `Community 575`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 309` to `Community 528`, `Community 575`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `cmdStart()` connect `Community 528` to `Community 96`, `Community 276`, `Community 309`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _33884 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.006700115943813423 - nodes in this community are weakly interconnected._