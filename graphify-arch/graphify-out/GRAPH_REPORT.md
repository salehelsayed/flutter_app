...
## Summary
- 42459 nodes · 66089 edges · 927 communities (881 shown, 46 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 2479 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a32454c2`
...
3. `NewNode()` - 163 edges
4. `startLocalNodeForMultiRelayTest()` - 154 edges
5. `generateTestKey()` - 153 edges
6. `assertNotOk()` - 129 edges
7. `New()` - 123 edges
...
## Communities (927 total, 46 thin omitted)
...
Cohesion: 0.01
Nodes (318): copyWith, hiddenAt, isOutgoingDeletedTombstone, normalizeOutgoingDeleteTombstoneVisibility, bridge, contactPeerId, contactRepo, _contactWithMlKem (+310 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (282): AlertDialog, AnimatedContainer, AnnotatedRegion, main, applyContactFeedSnapshot, applyGroupFeedSnapshot, nextItems, BoxDecoration (+274 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (213): @immutable, appShellController, build, createState, dispose, feedUnreadCountListenable, _headerNotifier, initState (+205 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (250): AnimatedBuilder, Animation, CustomPaint, package:flutter_app/core/theme/glassmorphism.dart, package:flutter_app/features/contact_profile/presentation/screens/contact_profile_screen.dart, package:flutter_app/features/home/presentation/widgets/empty_circle_state.dart, ContactProfileScreen, _ContactProfileScreenState (+242 more)
...
Cohesion: 0.01
Nodes (275): addFriend, addGroup, build, _buildGroups, canvas, _canvasNames, _clockLabel, ../../application/orbit2_mock_data.dart (+267 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (232): ../../domain/orbit3_arch_layout.dart, IconData, Key, PostModel, package:flutter_app/features/posts/presentation/widgets/post_repost_visual_state.dart, AccountMigrationJourneyScreen, AccountMigrationProgressWakeLock, _AccountMigrationProgressWakeLockState (+224 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (271): AccountMigrationBundleAssemblyException, AccountMigrationBundleImportException, _MigrationPostException, adminGroup, b5NewMember, _BlockingUpdateConfigBridge, bridge, charlie (+263 more)
...
Cohesion: 0.01
Nodes (216): blurb, build, _connector, ../../application/orbit3_archetype_data.dart, _h, _item, label, _loud (+208 more)

### Community 14 - "Community 14"
Cohesion: 0.01
Nodes (154): dbDeleteExpiredGroupInviteConsumptions, dbLoadGroupInviteConsumption, dbUpsertGroupInviteConsumption, inviteId, dbDeleteExpiredGroupWelcomeKeyPackageTombstones, dbLoadGroupWelcomeKeyPackageTombstone, dbUpsertGroupWelcomeKeyPackageTombstone, packageId (+146 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (213): ContactRequestNotificationMaterializer, main, buildRepo, main, main, GroupPendingKeyRepairBackoffTimer, GroupPendingKeyRepairRunner, db (+205 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (110): DatabaseException, db, main, makeRequestRow, db, main, makeContactRow, db (+102 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (215): ../bridge/bridge.dart, ../bridge/p2p_bridge_client.dart, ../debug/transport_metrics.dart, ../../features/account_migration/application/account_migration_runtime_network_gate.dart, ../../features/push/domain/push_token_store.dart, ../inbox/inbox_staging_entry.dart, ../inbox/inbox_staging_repository.dart, inbox_store_outcome.dart (+207 more)
...
Cohesion: 0.01
Nodes (171): _CursorInboxBridge, _DelayedGroupLeaveBridge, _DelayedMediaDownloadBridge, SequencedUpdateConfigBridge, _aliceContact, allowedDevices, assignedRole, bridge (+163 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (190): aliceContact, bridge, configWithReceiverKeys, contactRepo, deleteRepair, expectNoAcceptedState, expectRejected, expectRejectedAccept (+182 more)

### Community 21 - "Community 21"
Cohesion: 0.01
Nodes (191): main, main, main, orbit_screen.dart, package:flutter_app/features/settings/application/image_quality_preference_use_cases.dart, package:flutter_app/features/settings/domain/models/image_quality_preference.dart, _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount (+183 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (152): GroupMessagePayload, builtGroupMessageEnvelope, groupMemberDialTarget, groupMemberDialTargetSummary, groupPeerConnectResult, groupPeerDialState, GroupReliableSendResult, groupSenderDeviceBinding (+144 more)

### Community 23 - "Community 23"
Cohesion: 0.01
Nodes (165): avatarSnapshots, hydratePostSurfaceItems, mediaMap, postList, repostHeartBaselines, viewerSharedToCounts, wait, InMemoryPostRepository (+157 more)

### Community 24 - "Community 24"
Cohesion: 0.01
Nodes (176): DateSeparator, Directionality, main, wrapApp, wrapScrollable, app, main, ownedCopy (+168 more)

### Community 25 - "Community 25"
Cohesion: 0.01
Nodes (175): acceptIntroduction, acceptPayload, bridge, contact, contactMlKemPublicKey, createIntroductionOutboxDelivery, _createPayloadDeliveryForContact, deliverStagedIntroductionDelivery (+167 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (82): backgroundPreference, build, _buildConfirmButton, _buildContactList, _buildEmptyState, _buildHeader, _buildLoadErrorState, _buildLoadingState (+74 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (146): bridge, contactRepo, introRepo, main, network, now, p2pServiceB, alice (+138 more)
...
Cohesion: 0.01
Nodes (136): main, member, main, main, sendMessage, startedState, _ThrowingSendFakeP2PService, ../bridge/fake_bridge.dart (+128 more)
...
Cohesion: 0.01
Nodes (152): _incoming, main, isDeleted, isIncoming, main, _msg, authorPeerId, authorUsername (+144 more)
...
Cohesion: 0.03
Nodes (170): fakeHostWithAddrs, TestNodeStatus_DisablesReservationAwareHealthWhenFlagFalse(), TestReconnectRelays_DisablesInPlaceRecoveryWhenFlagFalse(), TestStartNode_DisablesMultiRelayRoutingWhenFlagFalse(), disableGroupInboxRecoveryForFakeRelayTest(), TestGroupInboxRetrieveCursor_DefaultsLimitWhenZero(), TestGroupInboxRetrieveCursor_NegativeLimitDefaultsTo50(), TestGroupInboxRetrieveCursor_NoDuplicateOnContinuation() (+162 more)

### Community 34 - "Community 34"
Cohesion: 0.02
Nodes (127): Color, dart:ui, LanAvailabilitySnapshot, accentColor, availableFriends, build, friend, _FriendPickerRow (+119 more)

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (141): AccountMigrationNetworkGate, byId, deleteContactAndMessages, _deleteIntroductionsForPeer, _deleteLocalMediaArtifacts, deleteMediaForContact, introductions, introLists (+133 more)
...
Cohesion: 0.01
Nodes (145): GoBridgeClient, GroupDiagnosticEvent, GroupMembershipUpdateListener, db, distributionRow, main, bridge, bridgeExchanges (+137 more)
...
Cohesion: 0.02
Nodes (147): basePath, file, flowEvents, _ImportedDocsFileManager, localPathForAttachment, main, resolveStoredPath, writeAsString (+139 more)

### Community 40 - "Community 40"
Cohesion: 0.01
Nodes (189): CustomPainter, dart:math, Orbit3ConstellationGeometry, AmplitudeBars, _AmplitudeBarsPainter, _barGap, _barWidth, build (+181 more)

### Community 41 - "Community 41"
Cohesion: 0.01
Nodes (148): AccountMigrationProductionBundleSource, _ReceiverStageTracker, AccountMigrationLocalTransferRuntime, _FakeContactRepository, _FakeContactRepository, FakeContactRepository, DeliveryReceiptListener, dispose (+140 more)

### Community 42 - "Community 42"
Cohesion: 0.02
Nodes (135): contactRepo, introsBannerDismissed, isArchived, isBlocked, main, _makeContact, username, applied (+127 more)
...
Cohesion: 0.02
Nodes (131): addContact, AddContactResult, archiveContact, blockContact, activeContacts, otherFriends, shouldShowIntroBanner, bridge (+123 more)
...
Cohesion: 0.02
Nodes (133): main, _contact, main, _msg, ../../contacts/domain/repositories/fake_contact_repository.dart, FakeContactRepository, FakeIdentityRepository, _FakeNearbyLocationService (+125 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (133): BuildGroupSignatureData(), ParseGroupEnvelope(), buildGroupKeyInfoWithGrace(), TestMutateGroupEnvelope_RewritesEncryptedFieldsWithoutChangingRoutingMetadata(), decryptGroupEnvelopePayload(), filterDiscoveredGroupMembers(), filterDiscoveredPeers(), TestGK016GroupTopicValidatorAcceptsEpoch0PreviousKeyDuringFirstRotationGrace() (+125 more)

### Community 48 - "Community 48"
Cohesion: 0.01
Nodes (147): showGroupMissingNotificationFeedback, main, AspectRatio, dart:typed_data, Image, delay, _expectReport89RowsVisible, _expectVideoViewerCanOpen (+139 more)
...
Cohesion: 0.07
Nodes (130): buildGroupEnvelopeWithPlaintext(), connectLocalGroupNodes(), mutateGroupEnvelope(), publishRawGroupEnvelope(), TestHolePunchNegativeControl_RelayOnly_NoUpgradeNoThrash(), lp013GroupHarness, TestGA002NonMemberCannotPublishValidEnvelope(), TestGA006SenderTransportPeerMismatchRejects() (+122 more)
...
Cohesion: 0.01
Nodes (130): main, _makeAttachment, mime, package:flutter_app/core/utils/format_day_separator_label.dart, package:flutter_app/features/conversation/presentation/widgets/blocked_banner.dart, package:flutter_app/shared/widgets/media/media_preview_text.dart, activeQuoteText, alignment (+122 more)
...
Cohesion: 0.02
Nodes (121): comments, loadPostComments, wait, _assertAllRecipientsStarted, _assertBoundedStart, _contact, contacts, _createControlledService (+113 more)
...
Cohesion: 0.06
Nodes (120): TestGroupGenerateNextKey_NodeNotInitialized(), GroupSendReliable(), assertGroupPublishMediaOnlyAcceptsEmptyText(), assertNotOk(), parseJSON(), ptrString(), TestConfirmDirectMessage_NotInitialized(), TestDecryptContactRequest_InvalidJSON() (+112 more)
...
Cohesion: 0.02
Nodes (107): main, _dbKey, fixedKey, main, errors, hasError, isAccepted, MigrationDatabaseImportError (+99 more)

### Community 63 - "Community 63"
Cohesion: 0.02
Nodes (81): main, blockingUpload, bridge, captureFlowEvents, _doneAttachment, file, groupMsgRepo, groupRepo (+73 more)

### Community 64 - "Community 64"
Cohesion: 0.02
Nodes (125): main, makeAttachment, makeMessage, mediaAttachmentRepo, mediaFileManager, messageRepo, reactionRepo, recipientMlKemPublicKey (+117 more)
...
Cohesion: 0.01
Nodes (156): baseGroup, bridge, groupRepo, main, msgRepo, now, publishedDissolveAuditActor, _InstrumentedGroupMessageRepository (+148 more)
...
Cohesion: 0.02
Nodes (120): core_fake_p2p.FakeP2PService, GroupMessageListener, _FakeGroupMessageListener, addPage, _addSignedInboxPage, attempts, _CursorInboxBridge, _groupPublishPayloads (+112 more)

### Community 73 - "Community 73"
Cohesion: 0.02
Nodes (104): fromStorageString, loadBackgroundPreference, saveBackgroundPreference, value, write, clearGroupDeviceAnnounceMarker, delete, kGroupDeviceAnnouncePendingKey (+96 more)

### Community 74 - "Community 74"
Cohesion: 0.02
Nodes (107): _FakeIdentityRepo, identity, loadIdentity, main, repo, saveIdentity, _testIdentity, _FakeIdentityRepo (+99 more)

### Community 75 - "Community 75"
Cohesion: 0.01
Nodes (170): AnimatedOpacity, GateableMediaAttachmentRepository, detailsFor, eventNames, events, main, mediaReady, pendingAttachment (+162 more)

### Community 76 - "Community 76"
Cohesion: 0.02
Nodes (112): MapEntry, package:flutter_app/features/groups/application/refresh_pending_group_invites_for_metadata_change_use_case.dart, _applyMetadataEdit, backgroundPreference, bridge, _broadcastSelfRemovalIfNeeded, build, _buildGroupConfig (+104 more)

### Community 77 - "Community 77"
Cohesion: 0.02
Nodes (102): buildGroupIdentityCallbacks, GroupIdentityCallbacks, peerId, id, insertIntroSystemMessage, message, now, saveMessage (+94 more)
...
Cohesion: 0.04
Nodes (84): TestBenchmark_DirectAck_FastConfirm(), TestBenchmark_DirectAck_MultipleMessages(), TestBenchmark_EventQueue_BurstDelivery(), TestBenchmark_EventQueue_IdleDelivery(), TestBenchmark_EventQueue_NoDropUnderLoad(), TestBenchmark_InboxRetrieve_ReturnsEmpty(), TestBenchmark_InboxStore_RequiresConnection(), TestBenchmark_MediaUpload_ProgressEvents() (+76 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (111): main, announcedDevice, bobAccountKey, bridge, feed, groupId, groupRepo, holdCalls (+103 more)
...
Cohesion: 0.02
Nodes (96): AccountMigrationAuthorityRepository, clearAuthority, loadAuthority, saveAuthority, _secureKeyStore, SecureKeyStoreAccountMigrationAuthorityRepository, storageKey, storageKeyPrefix (+88 more)

### Community 87 - "Community 87"
Cohesion: 0.02
Nodes (96): NearbyDevicePosition, addContact, author, bridge, _contact, contactRepo, create, deadline (+88 more)
...
Cohesion: 0.02
Nodes (95): fromPreview, handleDeliveryReceipt, messageIds, main, actualTransport, allUploaded, bridge, contact (+87 more)
...
Cohesion: 0.02
Nodes (91): accountMigrationNetworkGate, _allowsInboundAccountSideEffects, _autoDownloadMedia, backgroundNotificationDuplicateGuardDelay, bridge, ChatMessageProcessOutcome, ChatMessageProcessState, chatMessageStream (+83 more)
...
Cohesion: 0.03
Nodes (67): buildReceipt, captureFlowEvents, contactPeerId, from, id, isIncoming, main, makeInboxedOutgoing (+59 more)

### Community 97 - "Community 97"
Cohesion: 0.02
Nodes (97): activeDatabase, importedRows, importedTables, importVerifiedStagedDatabase, message, MigrationDatabaseActiveImportException, MigrationDatabaseActiveImportResult, _runQuickCheck (+89 more)
...
Cohesion: 0.03
Nodes (71): Material, package:flutter_app/core/theme/app_colors.dart, package:flutter_app/features/identity/presentation/widgets/startup_loading_gate.dart, package:flutter_app/features/qr_code/presentation/widgets/scan_overlay.dart, AccountMigrationBlockedScreen, _AccountMigrationBlockedScreenState, build, _confirmErase (+63 more)

### Community 100 - "Community 100"
Cohesion: 0.02
Nodes (94): _RecordingNavigatorObserver, main, NavigatorObserver, package:flutter_app/features/identity/presentation/navigation/startup_route_transition.dart, package:flutter_app/features/identity/presentation/screens/identity_choice_wired.dart, _accountMigrationActivationRerouteStarted, accountMigrationReceiverEvents, accountMigrationRunTransfer (+86 more)

### Community 101 - "Community 101"
Cohesion: 0.02
Nodes (91): dialPeer, discoverPeer, main, startedState, _ThrowingDialFakeP2PService, _ThrowingDiscoverFakeP2PService, DiscoveredPeer, FakeP2PService (+83 more)
...
Cohesion: 0.05
Nodes (43): connectionInfo, EventDispatcher, EventTracer, groupPeerDialState, lanDialHandler, EventCallback, isRetryableChatStreamOpenError(), messageEnvelopeType() (+35 more)
...
Cohesion: 0.08
Nodes (82): newMemoryInboxBackend(), failingStoreInboxBackend, requireInboxStoreResult(), TestInboxStoreDedup(), TestInboxStoreDedup_DifferentMessageIds(), TestInboxStoreDedup_IntroductionEncryptedDifferentActionMessageIDs(), TestInboxStoreDedup_IntroductionEncryptedEnvelopeWithMessageID(), TestInboxStoreDedup_IntroductionPlaintextDifferentActionMessageIDs() (+74 more)

### Community 110 - "Community 110"
Cohesion: 0.02
Nodes (87): EncryptedMediaTestBridge, RelayMediaStore, bridge, _createdAt, encTempsUnder, imageProcessor, main, mediaFileManager (+79 more)
...
Cohesion: 0.02
Nodes (80): Database, fake_secure_key_store.dart, db, main, db, main, repairRow, db (+72 more)

### Community 114 - "Community 114"
Cohesion: 0.03
Nodes (67): package:flutter_app/features/feed/domain/models/feed_session_reply.dart, package:flutter_app/features/feed/presentation/widgets/feed_header.dart, activeTab, backgroundPreference, bottomInset, build, _buildComposer, _buildFeedContent (+59 more)
...
Cohesion: 0.02
Nodes (83): acceptAndReciprocateContactRequest, downloadProfilePictureFn, result, add, attemptSilentIntroRecovery, bridge, _contactKeyUpdatedController, contactKeyUpdatedStream (+75 more)
...
Cohesion: 0.05
Nodes (36): MobileScanner, package:flutter_app/features/qr_code/presentation/screens/qr_scanner_wired.dart, accountMigrationPairingQrKind, appShellController, bridge, _buildMigrationQrData, buildScanner, _buildValidQrData (+28 more)

### Community 128 - "Community 128"
Cohesion: 0.03
Nodes (76): activeChunks, decapsulateSession, decryptChunk, encapsulateSession, encryptChunk, files, length, main (+68 more)

### Community 129 - "Community 129"
Cohesion: 0.02
Nodes (80): DeliveryReceiptListener, fake_p2p_network.dart, ChaosConfig, config, content, deliver, deliveredCount, _deliverWithDuplicate (+72 more)
...
Cohesion: 0.03
Nodes (78): clearCleared, FeedClearedRepositoryImpl, markCleared, clearCleared, InMemoryFeedClearedRepository, markCleared, feed_cleared_repository.dart, FeedClearedRepository (+70 more)

### Community 133 - "Community 133"
Cohesion: 0.03
Nodes (72): introsBannerDismissed, isArchived, isBlocked, main, _makeContact, username, ElevatedButton, ageOffset (+64 more)

### Community 134 - "Community 134"
Cohesion: 0.03
Nodes (79): _FakeContactRequestRepository, FakeContactRequestRepository, _FakeContactRequestRepo, contactRepo, createdAt, introRepo, main, makeIntro (+71 more)

### Community 135 - "Community 135"
Cohesion: 0.03
Nodes (74): _MemoryCutoverRepository, _MemoryCutoverRepository, _MemoryCutoverRepository, _authorityRepository, _baseRecord, clearLocalStalePushToken, commitNewActive, _cutoverRepository (+66 more)

### Community 136 - "Community 136"
Cohesion: 0.03
Nodes (92): db, main, makeIntroductionRow, makeOutboxRow, makePendingResponseRow, buildIntroductionRepository, buildMessageRepository, db (+84 more)
...
Cohesion: 0.03
Nodes (55): addContact, archiveContact, archivedPeerIds, blockContact, contactExists, deleteContact, dismissIntroBanner, FakeContactRepository (+47 more)

### Community 139 - "Community 139"
Cohesion: 0.02
Nodes (89): _FakeBridge, _FakeDecryptBridge, _ThrowingBridge, _FakeBridge, _ThrowingBridge, FakeDecryptBridge, attachment, basePath (+81 more)
...
Cohesion: 0.03
Nodes (55): addPage, _fixedDateFixtureRetentionNow, getLatestRepairForGroup, getRepair, getVisibleRepairsForGroup, _historyGaps, inboxRetrieveCount, _InMemoryGroupHistoryGapRepairRepository (+47 more)
...
Cohesion: 0.04
Nodes (74): chatPushMetadata, scanPushMessage(), TestForbiddenFieldClassifier_MessagePushesDoNotExposePreviewCanaries(), groupInboxHistoryGap, groupInboxMessage, GroupInboxStore, addChatEncryptedPushData(), addGroupEncryptedPushData() (+66 more)
...
Cohesion: 0.03
Nodes (75): addResult, contact, downloadProfilePictureFn, handleScannedQR, HandleScannedQRResult, parseResult, bridge, checkHealth (+67 more)

### Community 149 - "Community 149"
Cohesion: 0.07
Nodes (71): BlobDecrypt(), BlobEncrypt(), BlobKeygen(), bridgeGroupMemberDeviceHasDistributionMaterial(), bridgeGroupMemberDeviceIsActive(), bridgeGroupMemberHasLegacyDistributionMaterial(), bridgeGroupMemberHasUsableActiveDevice(), DecryptContactRequest() (+63 more)
...
Cohesion: 0.03
Nodes (70): captured, eventsNamed, line, main, thread, avatarPath, _contact, contactPeerId (+62 more)

### Community 152 - "Community 152"
Cohesion: 0.02
Nodes (104): Canvas, Orbit3ConstellationMode, orbit3_constellation_painters.dart, capture, drain, goTo, main, outDir (+96 more)
...
Cohesion: 0.05
Nodes (48): ChatMessageListener, ShareBatchDeliveryResult, ChatMessageListener, ContactUpdate, _TrackingChatMessageListener, _TrackingChatMessageListener, activeContact, archivedContact (+40 more)
...
Cohesion: 0.03
Nodes (68): _acceptPendingInviteWithRecoveryRetry, _acceptRecoveryRetryCount, _acceptRecoveryRetryDelay, attempt, audioRecorderService, backgroundPreference, _beginLoadGroups, bridge (+60 more)
...
Cohesion: 0.03
Nodes (65): buildIdentity, main, tempDir, package:flutter_app/features/home/application/identity_avatar_resolver.dart, package:flutter_app/features/settings/presentation/navigation/settings_route_transition.dart, package:flutter_app/features/settings/presentation/widgets/settings_introduction_debug_card.dart, accountMigrationRunTransfer, accountMigrationSizeGate (+57 more)

### Community 166 - "Community 166"
Cohesion: 0.03
Nodes (46): main, cleanupSessionArtifacts, MigrationFileImportCleanup, stagingRootPath, main, dart:io, main, autoSetupConfigFileName (+38 more)
...
Cohesion: 0.03
Nodes (63): BonsoirBroadcast, BonsoirDiscovery, BonsoirDiscoveryEvent, BonsoirService, main, peerDiscoveredAt, BonsoirBroadcastFactory, BonsoirDiscoveryFactory (+55 more)
...
Cohesion: 0.04
Nodes (56): downloadProfilePicture, DownloadProfilePictureFn, now, token, _uniqueSuffix, appDir, canonicalPath, commitPreparedGroupAvatar (+48 more)

### Community 174 - "Community 174"
Cohesion: 0.03
Nodes (61): addContact, author, condition, contactRepo, create, deadline, dispose, main (+53 more)
...
Cohesion: 0.04
Nodes (53): chatGroup, conversationApp, fortyMessages, localAfternoon, main, messageAt, pumpFrames, rectWithin (+45 more)
...
Cohesion: 0.06
Nodes (33): clearPendingKeyRotation, clearPendingKeyRotations, _Clock, contact, contains, deleteGroup, deleteMessagesForGroup, endedAt (+25 more)
...
Cohesion: 0.03
Nodes (56): acceptContactRequest, AcceptContactRequestResult, contact, peerIdPrefix, request, contactRepo, main, requestRepo (+48 more)
...
Cohesion: 0.03
Nodes (61): appendGroupEventLogEntry, bridge, contactRepo, _defaultNow, deliveryRepo, dispose, downloadGroupAvatarFn, _enqueueMessage (+53 more)

### Community 185 - "Community 185"
Cohesion: 0.03
Nodes (59): candidate, contactRepo, copyWith, current, envelope, existingById, existingMedia, existingPost (+51 more)
...
Cohesion: 0.03
Nodes (57): countQuarantinedEntries, deleteEntry, _entries, entry, getEntry, getRecoverableEntries, getRecoverableEntriesByIds, markQuarantined (+49 more)
...
Cohesion: 0.03
Nodes (56): AudioRecorderService, FakeGroupReactionReplayOutboxRepository, group_reaction_replay_outbox_repository.dart, GroupReactionReplayOutboxRepository, RecordAudioRecorderService, ../models/group_reaction_replay_outbox_entry.dart, package:flutter_app/features/feed/domain/models/feed_route_changes.dart, deleteEntry (+48 more)

### Community 202 - "Community 202"
Cohesion: 0.05
Nodes (38): benchmark_helpers.dart, runAckBenchmark, details, events, _findRecoveredOutage, firstEventDetails, firstInbox, firstSend (+30 more)
...
Cohesion: 0.07
Nodes (34): TestParseInboxStoreResponse_InboxFullTyped(), TestParseInboxStoreResponse_NewRelayFields(), TestParseInboxStoreResponse_OldRelayDefaults(), parseInboxStoreResponse(), parsePresenceResponse(), InboxMessage, inboxRequest, inboxResponse (+26 more)

### Community 205 - "Community 205"
Cohesion: 0.02
Nodes (85): package:flutter_app/core/utils/text_direction_utils.dart, package:flutter_app/features/feed/presentation/widgets/quote_preview_bar.dart, package:flutter_app/features/feed/presentation/widgets/unread_count_badge.dart, main, build, ContactRequestDialog, _ContactRequestDialogState, createState (+77 more)
...
Cohesion: 0.04
Nodes (55): _InMemoryGroupPendingKeyRepairRepository, failureEvent, _InMemoryGroupPendingKeyRepairRepository, attemptCount, _bridge, buildGroupMembershipUpdateDirectEnvelope, deliveryPeerId, dispose (+47 more)
...
Cohesion: 0.04
Nodes (56): ageMs, armStallTimer, autoRegister, callP2PConfirmDirectMessage, callP2PInboxAck, callP2PInboxRegisterToken, callP2PInboxRetrieve, callP2PInboxRetrievePending (+48 more)
...
Cohesion: 0.04
Nodes (46): archiveGroup, bridge, callGroupLeave, clearGroupRejoinState, deleteGroup, group, groupId, lastAdminLeaveBlockedMessage (+38 more)

### Community 231 - "Community 231"
Cohesion: 0.04
Nodes (46): introsBannerDismissed, isArchived, isBlocked, main, _makeContact, username, introsBannerDismissed, isArchived (+38 more)
...
Cohesion: 0.03
Nodes (56): ../../core/secure_storage/fake_secure_key_store.dart, generateRandomKey, main, main, package:flutter_app/features/settings/presentation/screens/settings_wired.dart, checkHealth, currentState, dialPeer (+48 more)

### Community 238 - "Community 238"
Cohesion: 0.04
Nodes (45): channel, log, main, GetInitialRemoteMessageFn, handleInitialRemoteMessage, message, OnInitialRemoteMessageFn, sync (+37 more)
...
Cohesion: 0.04
Nodes (49): addContact, additionalRecipients, bridge, commentListener, _connectChain, _connectTriangle, contactRepo, create (+41 more)
...
Cohesion: 0.04
Nodes (46): contactRepo, introRepo, main, now, ownPeerId, seedIntro, main, bridge (+38 more)
...
Cohesion: 0.05
Nodes (66): FileMode, backendConfig, controlPlaneStores, DefaultServerLimits(), envIntOrDefault(), loadServerLimitsFromEnv(), relayResourcesFromServerLimits(), TestFiniteLimits_RejectExcessGroupMessages() (+58 more)
...
Cohesion: 0.04
Nodes (47): ../models/group_key_info.dart, ../models/group_member.dart, ../models/group_model.dart, ../models/pending_sibling_device.dart, archiveGroup, attemptCount, clearGroupRejoinState, clearPendingKeyRotation (+39 more)
...
Cohesion: 0.05
Nodes (42): contactRepo, introRepo, main, messageRepo, IntroductionListener, bridge, captureFlowEvents, contactRepo (+34 more)

### Community 265 - "Community 265"
Cohesion: 0.04
Nodes (49): ContactPresenceSnapshotRepository, _changes, dispose, InMemoryContactPresenceSnapshotRepository, load, loadAll, save, snapshotChanges (+41 more)
...
Cohesion: 0.04
Nodes (46): ../../features/p2p/domain/models/discovered_peer.dart, ../../features/p2p/domain/models/node_state.dart, ../../features/p2p/domain/models/send_message_result.dart, ../local_discovery/lan_ack.dart, ../local_discovery/local_discovery_service.dart, clearResumeStarted, currentState, dialPeer (+38 more)

### Community 269 - "Community 269"
Cohesion: 0.04
Nodes (44): db, main, messageColumns, messageIndexes, package:flutter_app/core/database/migrations/079_message_dedup_key.dart, db, dbName, defaultE2EDbName (+36 more)
...
Cohesion: 0.03
Nodes (67): _FakeP2PService, accountMigrationNetworkGate, allowed, _allowsPostDeliveryNetworkSideEffects, bridge, contactRepo, _debounceTimer, dispose (+59 more)
...
Cohesion: 0.02
Nodes (106): _GuardedEntryFileReader, IoMigrationEntryFileReader, MigrationEntryFileReader, _RecordingEntryReader, BorderRadius, ../../domain/orbit3_one_circle_layout.dart, Uint8List, avatarBytes (+98 more)
...
Cohesion: 0.05
Nodes (40): _aggregatePostPassFollowOnSettlement, deliveries, _deliverPostPassFollowOnRecipients, envelope, eventId, eventType, isPostPassFollowOnEventType, _loadPersistedPostPassFollowOnResult (+32 more)
...
Cohesion: 0.03
Nodes (65): build, _HandleShareHarness, homeLabel, intent, main, onRouteBuilt, shareIntentService, pendingIntent (+57 more)
...
Cohesion: 0.09
Nodes (41): NewEventDispatcher(), waitForCollectedEvent(), assertSaneQueueWaitMs(), TestDE010EventDispatcherCallbackPanicDoesNotStopLoopAndLogsFailure(), TestDE011EventDispatcherPreservesGroupMessagesBelowCapacityUnderPressure(), TestDE012EventDispatcherOverflowDiagnosticIdentifiesPreservedGroupEventForReplayRecovery(), TestDE020EventDispatcherLargeGroupPayloadDoesNotStarveLaterMessage(), TestEventDispatcher_ClonesCallerDataBeforeQueueWaitMutation() (+33 more)
...
Cohesion: 0.05
Nodes (40): build, _buildCommittedKeyItem, _buildGroup, _buildInboxCursors, _buildMembers, _buildPendingKeyItem, _buildPendingKeyRepairs, _buildPendingMembershipMessages (+32 more)

### Community 298 - "Community 298"
Cohesion: 0.03
Nodes (58): AppLocalizations, LocalizationsDelegate, MemberRole, package:flutter_app/features/conversation/domain/models/media_preview_descriptor.dart, package:flutter_app/features/orbit/presentation/widgets/friend_row.dart, package:flutter_app/features/orbit/presentation/widgets/orbit_media_preview_label.dart, package:flutter_app/l10n/app_localizations_en.dart, package:flutter_localizations/flutter_localizations.dart (+50 more)
...
Cohesion: 0.05
Nodes (40): ContactRequestPresentationGate, ../features/contact_request/domain/repositories/fake_contact_request_repository.dart, bridge, contactRepository, contactRequestStream, _flushMicrotasks, listener, liveRequests (+32 more)
...
Cohesion: 0.03
Nodes (70): Column, EdgeInsets, nav_bar_button.dart, nav_bar_theme.dart, main, suppressAssetErrors, wrap, package:flutter_app/features/conversation/presentation/widgets/compact_origin_marker.dart (+62 more)
...
Cohesion: 0.05
Nodes (39): _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, _SharedFakeDiscovery, BonsoirDiscoveryService, DisabledLocalDiscoveryService, discoveredPeers, discoveredPeersStream (+31 more)

### Community 315 - "Community 315"
Cohesion: 0.05
Nodes (35): debugSetMigrationBreadcrumbSink, fields, kAccountMigrationTelemetry, line, migrationBreadcrumb, MigrationBreadcrumbSink, sink, _testSink (+27 more)
...
Cohesion: 0.05
Nodes (39): _FakeIdentityRepo, _FakeIdentityRepo, _FakeIdentityRepository, IdentityRepository, _Section10IdentityRepository, _FakeIdentityRepository, _TrackingIdentityRepository, _MatrixIdentityRepository (+31 more)

### Community 321 - "Community 321"
Cohesion: 0.05
Nodes (34): announce, announced, announceRestoredDeviceToGroups, AnnounceRestoredDeviceToGroupsFn, groups, maybeAnnounceRestoredDeviceOnStartup, multiDeviceSyncEnabled, now (+26 more)

### Community 322 - "Community 322"
Cohesion: 0.06
Nodes (36): main, appShellController, _armTimers, _cancelTimers, dispose, expiryBudget, _expiryTimer, _fallbackTimer (+28 more)

### Community 323 - "Community 323"
Cohesion: 0.05
Nodes (33): events, handleMissingRouteTarget, handleRouteTarget, main, missingRouteTargetCalls, prepare, _PushOpenHarness, routedTargets (+25 more)

### Community 324 - "Community 324"
Cohesion: 0.09
Nodes (22): _expectCommandOrder, _GroupShareBgBridge, _imageProcessor, inboxStoreOk, isLocalPeer, joinedAt, _LanFakeP2PService, main (+14 more)
...
Cohesion: 0.05
Nodes (39): package:flutter_app/core/config/forward_rotate_on_add_flag.dart, _availableContacts, backgroundPreference, bridge, build, buildCompletionMessage, _buildInviteErrorMessage, cancelled (+31 more)
...
Cohesion: 0.06
Nodes (34): groupInviteDeliveryErrorForSendResult, groupInviteDeliveryStatusForSendResult, recordGroupInviteDeliveryBatch, recordMissingGroupKeyInviteDeliveryAttempts, recordPendingGroupInviteFanoutAttempts, repo, timestamp, attemptCount (+26 more)
...
Cohesion: 0.05
Nodes (36): action, actionAdd, actionRemove, emoji, fromDecryptedJson, GroupReactionPayload, id, messageId (+28 more)
...
Cohesion: 0.07
Nodes (28): benchmark_harness.dart, BenchmarkHarness, ../features/conversation/application/send_chat_message_use_case_test.dart, main, package:flutter_app/core/utils/notification_tap_timing.dart, package:flutter_app/features/conversation/application/send_voice_message_use_case.dart, package:flutter_app/features/p2p/domain/models/connection_state.dart, harness (+20 more)
...
Cohesion: 0.03
Nodes (76): _activeTab, AppShellChangeKind, _backgroundPreference, _lastChangeKind, setBackgroundPreference, switchTo, BackgroundPreference, package:flutter_app/features/groups/presentation/widgets/group_name_panel.dart (+68 more)
...
Cohesion: 0.06
Nodes (30): dismissedAt, dismissPin, savePinDismissal, activePins, dismissedPostIds, hydratePostSurfaceItems, loadPinnedPosts, mediaFileManager (+22 more)
...
Cohesion: 0.06
Nodes (33): addContact, _BaselineUser, bridge, commentListener, _connectTriangle, contactRepo, create, deadline (+25 more)
...
Cohesion: 0.04
Nodes (54): attempts, contactAlice, contactBob, contactCharlie, contactDave, deleteAttempt, deleteAttemptsForGroup, _expectNoPublicRouteFields (+46 more)
...
Cohesion: 0.06
Nodes (32): AppLifecycleState, ../../core/local_discovery/fake_local_p2p_service.dart, fake_notification_service.dart, bridge, contactRepo, conversationTracker, create, DirectMessageRouter (+24 more)
...
Cohesion: 0.07
Nodes (29): bridge, contactRepo, _CrashAfterNthOutboxSaveIntroductionRepository, crashOnSaveNumber, introRepo, main, network, now (+21 more)

### Community 418 - "Community 418"
Cohesion: 0.06
Nodes (28): _cleanDisplayName, groupPeerFallbackLabel, memberName, preferMemberName, resolveGroupSenderDisplayName, sanitized, senderPeerId, shortPeerId (+20 more)
...
Cohesion: 0.04
Nodes (41): OneToOneTestUser, consumeCalls, consumeIfRecentAnnouncement, markAnnouncement, markCalls, messageId, payload, RecentNotificationGateCall (+33 more)
...
Cohesion: 0.07
Nodes (27): package:clock/clock.dart, ageMs, bridge, checkHealth, _CountingBridge, dispose, initialize, isInitialized (+19 more)

### Community 452 - "Community 452"
Cohesion: 0.07
Nodes (26): absolutePath, downloadPath, downloadPostMedia, hasKeyMaterial, updatePostMediaDownloadStatus, _attachment, contentHash, downloadStatus (+18 more)
...
Cohesion: 0.07
Nodes (26): AppendGroupEventLogEntry, _acceptedSignedTransitionAuditHashesBySourceId, _appendGroupEventLogEntry, _bridge, dispose, _enqueueMessage, GroupKeyUpdateListener, _groupRepo (+18 more)
...
Cohesion: 0.08
Nodes (25): FakeIntroductionRepository, IntroductionRepository, IntroductionRepositoryImpl, _availableFriends, backgroundPreference, bridge, build, contactRepo (+17 more)
...
Cohesion: 0.08
Nodes (22): EncryptedMediaArtifact, call, _callCount, _defaultResult, FakeUploadMediaFn, _lastAllowedPeers, _lastBlobId, _lastDeleteSourceWhenDone (+14 more)
...
Cohesion: 0.09
Nodes (20): handleShareIntent, ShareIntentRouteBuilder, _cache, _cacheKey, _generation, IdentityAvatarDocumentsDirLoader, IdentityAvatarResolver, _inFlight (+12 more)
...
Cohesion: 0.18
Nodes (23): GroupCreate(), GroupJoinTopic(), GroupPublish(), isSupportedBridgeGroupType(), generateBridgePeerIDStr(), generateTestIdentityMaterial(), TestBB005GroupCreateRejectsUnsupportedTypesWithoutPartialState(), TestBB016GroupCreatePreservesDescriptionInReturnedConfig() (+15 more)
...
Cohesion: 0.02
Nodes (89): Alignment, app_colors.dart, background_readable_colors.dart, EdgeInsetsGeometry, feed_tokens.dart, SystemUiOverlayStyle, AppTheme, BackgroundReadableTone (+81 more)
...
Cohesion: 0.12
Nodes (15): MigrationFileManifestBuilder, file, main, writeAsString, _writeRelative, _builder, MigrationFileManifestValidator, file (+7 more)
...
Cohesion: 0.14
Nodes (27): EvtPeerConnectednessChanged, genDisconnectedPeerID(), newPresenceTestEnv(), rawKeys(), sendPresenceGet(), TestConnectednessHandlerSeedsLastSeen(), TestPresenceGet_ConnectedPeerReportsFreshAgeDespiteStaleLastSeen(), TestPresenceGet_ReturnsReachableForConnectedPeer() (+19 more)
...
Cohesion: 0.02
Nodes (78): Align, ClipRRect, ConstrainedBox, media_display_helpers.dart, media_grid_cell.dart, build, _buildFourPlus, _buildLayout (+70 more)
...
Cohesion: 0.12
Nodes (15): _changes, dispose, load, save, setSharingEnabled, _settings, settingsChanges, package:flutter_app/features/posts/domain/repositories/posts_privacy_settings_repository.dart (+7 more)
...
Cohesion: 0.12
Nodes (16): archived, blocked, _contact, contacts, controller, createdAt, envelope, expiresAt (+8 more)
...
Cohesion: 0.13
Nodes (14): bobContact, bridge, declinedByPeerId, deliveryRepo, envelope, groupId, inviteId, main (+6 more)
...
Cohesion: 0.14
Nodes (14): _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _TrackingInviteDeliveryAttemptRepository, _SpyDeliveryRepo, _InMemoryInviteDeliveryAttemptRepository, GroupInviteDeliveryAttemptRepository, _TrackingInviteDeliveryAttemptRepository, _InMemoryGroupInviteDeliveryAttemptRepository (+6 more)
...
Cohesion: 0.15
Nodes (11): main, run, cases, _DrainExpectation, label, main, remoteData, _RouteContractCase (+3 more)
...
Cohesion: 0.15
Nodes (12): events, h, main, missing, missingCalls, _NotificationSmokeHarness, prepare, reset (+4 more)
...
Cohesion: 0.17
Nodes (11): _fakeIdentityJson, _FakeIdentityRepo, _fakeMlKemResponse, loadIdentity, main, progressStages, repo, savedIdentity (+3 more)
...
Cohesion: 0.17
Nodes (8): main, main, package:flutter_app/core/debug/transport_metrics.dart, package:flutter_app/features/settings/presentation/widgets/settings_transport_diagnostics_card.dart, SelectableText, main, main, wrap
...
Cohesion: 0.20
Nodes (9): _groupRow, main, _movedMemberRow, primaryKey, _stageCommittedKey, value, write, writeShared (+1 more)
...
Cohesion: 0.25
Nodes (7): criticality, _item, main, path, size, transferManifest, MigrationFileCriticality
...
Cohesion: 0.29
Nodes (6): loadArb, main, newFeedKeys, removedFeedKeys, package:flutter_app/l10n/app_localizations_ar.dart, package:flutter_app/l10n/app_localizations_de.dart
...
Cohesion: 0.50
Nodes (3): main, ../../../conversation/domain/repositories/fake_media_attachment_repository.dart, package:flutter_app/features/push/application/prepare_notification_route_target_use_case.dart
...
## Knowledge Gaps
- **34311 isolated node(s):** `RWMutex`, `InboxStoreOutcome`, `GroupConfig`, `Identity`, `Writer` (+34306 more)
...
- **Why does `incomingMessage` connect `Community 158` to `Community 597`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `newMessageCollector()` connect `Community 340` to `Community 520`, `Community 597`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `New()` connect `Community 82` to `Community 643`, `Community 388`, `Community 520`, `Community 531`, `Community 278`, `Community 22`, `Community 536`, `Community 33`, `Community 546`, `Community 548`, `Community 47`, `Community 561`, `Community 51`, `Community 695`, `Community 316`, `Community 833`, `Community 195`, `Community 579`, `Community 199`, `Community 78`, `Community 349`, `Community 225`, `Community 610`, `Community 355`, `Community 103`, `Community 109`, `Community 750`, `Community 251`, `Community 509`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **What connects `RWMutex`, `InboxStoreOutcome`, `GroupConfig` to the rest of the system?**
  _34311 weakly-connected nodes found - possible documentation gaps or missing edges._
