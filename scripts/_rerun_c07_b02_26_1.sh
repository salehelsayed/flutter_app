#!/usr/bin/env bash
# Re-run C07 + B02 after the generic-convergence-check exemption.
# Expect: C07 PASS (divergence), B02 RED-by-design (bob never receives).
set -u
