...
readonly ONE_TO_ONE_HOST_TESTS=(
  ...
  # Plan 371 (GAP-N04): shared Dart authority/adoption owners are pinned into
  # the curated 1:1 host inventory as well as auto-discovered core/feature.
